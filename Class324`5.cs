...
internal sealed class Class324<T, U, V, W, X>
{
    ...
    public override bool Equals(object value)
    {
        ...
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        return class324 != null && EqualityComparer<T>.Default.Equals(this.gparam_0, class324.gparam_0) &&
               EqualityComparer<U>.Default.Equals(this.gparam_1, class324.gparam_1) &&
               EqualityComparer<V>.Default.Equals(this.gparam_2, class324.gparam_2) &&
               EqualityComparer<W>.Default.Equals(this.gparam_3, class324.gparam_3) &&
               EqualityComparer<X>.Default.Equals(this.gparam_4, class324.gparam_4);
    }
    ...
    public override int GetHashCode()
    {
        ...
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        return ((((1062766478 + EqualityComparer<T>.Default.GetHashCode(this.gparam_0)) * -1521134295 +
    ...
    public override string ToString()
    {
        ...
        return string.Format(null,
            "{{ SensorRace = {0}, SensorSystem = {1}, EMStrength = {2}, Xcor = {3}, Ycor = {4} }}", objArray);
    }
}