...
public class TacticalMap : Form
{
    ...
    public TacticalMap()
    {
        ...
        this.MouseWheel += this.TacticalMap_MouseWheel;
    }
    ...
    private void TacticalMap_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            this.lblVersion.Text = AuroraUtils.string_0;
            this.gclass0_0.bool_10 = false;
        }
        catch (Exception ex)
        {
            AuroraUtils.ShowExceptionPopup(ex, 138);
        }
    }
    ...
    public void method_0(int int_5)
    {
        try
        {
            if (int_5 == 0)
            {
                IEnumerator enumerator = new SQLiteDatabaseC1181()
                    .ExecuteQuery("select * from FCT_Game order by LastViewed desc").Rows.GetEnumerator();
                try
                {
            ...
            if (int_5 > 0)
            {
                ...
                this.gclass0_0.double_0 = this.Width;
                this.gclass0_0.double_1 = this.Height;
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 139);
        }
    }
    ...
    public void method_1()
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 3205);
        }
    }
    ...
    private void method_2()
    {
        ...
        {
            int num = (int)new GameDetails(this).ShowDialog();
            if (this.gclass0_1.GameID == this.gclass0_0.GameID)
                return;
            Cursor.Current = Cursors.WaitCursor;
            this.method_0(this.gclass0_1.GameID);
            Cursor.Current = Cursors.Default;
        }
        catch (Exception ex)
        {
            AuroraUtils.ShowExceptionPopup(ex, 140);
        }
    }
    ...
    public GClass0 method_3(int int_5)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 141);
            return null;
        }
    }
    ...
    private void TacticalMap_Paint(object sender, PaintEventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 142);
        }
    }
    ...
    public void method_4(GameRace gclass21_1)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 143);
        }
    }
    ...
    public void method_5()
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 144 /*0x90*/);
        }
    }
    ...
    public void method_6()
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 3213);
        }
    }
    ...
    public void method_7()
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 3208);
        }
    }
    ...
    private void cboRaces_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 145);
        }
    }
    ...
    public void method_8()
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 146);
        }
    }

    public void method_9(RacialSystemSurvey gclass202_1)
    {
        try
        {
            ...
            if (this.cboSystems.SelectedValue == gclass202_1 || !this.cboSystems.Items.Contains(gclass202_1))
                return;
            this.cboSystems.SelectedItem = gclass202_1;
        }
        catch (Exception ex)
        {
            AuroraUtils.ShowExceptionPopup(ex, 147);
        }
    }
    ...
    private void cboSystems_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 148);
        }
    }
    ...
    public void method_10()
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 149);
        }
    }
    ...
    private void cboContactRaceFilter_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 150);
        }
    }
    ...
    private void chkTracking_Click(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 151);
        }
    }
    ...
    private void chkShowCivilianOOB_Click(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 152);
        }
    }
    ...
    private void cmdIncrement30D_Click(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 153);
        }
        finally
        {
            Cursor.Current = Cursors.Default;
    ...
    private void cmdSubPulse30D_Click(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 154);
        }
    }
    ...
    private void cmdRight_Click(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 155);
        }
    }
    ...
    private void TacticalMap_MouseWheel(object sender, MouseEventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 156);
        }
    }
    ...
    private void method_11()
    {
        ...
        toolTip.SetToolTip(this.cmdToolbarColony, "Open Colony Summary Tab on the Colonies Window");
        toolTip.SetToolTip(this.cmdToolbarIndustry, "Open Industry Tab on the Colonies Window");
        toolTip.SetToolTip(this.cmdToolbarMining, "Open Mining Summary Tab on the Colonies Window");
        toolTip.SetToolTip(this.cmdToolbarResearch, "Open Research Tab on the Colonies Window");
        toolTip.SetToolTip(this.cmdToolbarWealth, "Open Wealth Tab on the Colonies Window");
        toolTip.SetToolTip(this.cmdToolbarClass, "Open Class Design Window");
        toolTip.SetToolTip(this.cmdToolbarProject, "Open Create Project Window");
        toolTip.SetToolTip(this.cmdToolbarFleet, "Open Fleet Organization Window");
        toolTip.SetToolTip(this.cmdToolbarMissileDesign, "Open Missile Design Window");
        toolTip.SetToolTip(this.cmdToolbarTurret, "Open Turret Design Window");
        toolTip.SetToolTip(this.cmdToolbarGroundForces, "Open Ground Forces Window");
        toolTip.SetToolTip(this.cmdToolbarCommanders, "Open Commanders Window");
        toolTip.SetToolTip(this.cmdToolbarMedals, "Open Medal Creation Window");
        toolTip.SetToolTip(this.cmdToolbarRace, "Open Race Window");
        toolTip.SetToolTip(this.cmdToolbarSystem, "Open System View Window");
        toolTip.SetToolTip(this.cmdToolbarGalactic, "Open Galactic Map Window");
        toolTip.SetToolTip(this.cmdToolbarComparison, "Open Race Comparison Window");
        toolTip.SetToolTip(this.cmdToolbarIntelligence, "Open Intelligence Window");
        toolTip.SetToolTip(this.cmdToolbarTechnology, "Open Technology Report Window");
        toolTip.SetToolTip(this.cmdToolbarSurvey, "Open Mineral Survey Window");
        toolTip.SetToolTip(this.cmdToolbarSector, "Open Sector Window");
        toolTip.SetToolTip(this.cmdToolbarEvents, "Open Events Window");
        toolTip.SetToolTip(this.cmdToolbarRefreshTactical, "Refresh the Tactical Map Window");
        toolTip.SetToolTip(this.cmdToolbarSave, "Save Current Game");
        toolTip.SetToolTip(this.cmdToolbarGame, "View Current Game and Create New Game");
        toolTip.SetToolTip(this.cmdSM, "Spacemaster Mode On/Off");
        toolTip.SetToolTip(this.cmdToolbarAuto, "Automated Turns On/Off");
        toolTip.SetToolTip(this.cboRaces, "Select Default Races");
        toolTip.SetToolTip(this.cboSystems, "Select System to View Tactical Map");
        toolTip.SetToolTip(this.chkPassive10, "The range of passive sensors vs a signature of 10");
        toolTip.SetToolTip(this.chkPassive100, "The range of passive sensors vs a signature of 100");
    ...
    public void method_12()
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 157);
        }
    }
    ...
    public void method_14(RacialSystemSurvey gclass202_1)
    {
        try
        {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 158);
        }
    }

    public RacialSystemSurvey method_15()
    {
        try
        {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 159);
            return null;
        }
    }
    ...
    private void tvMilitary_AfterSelect(object sender, TreeViewEventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 160 /*0xA0*/);
        }
    }
    ...
    private void ckNoSensors_CheckedChanged(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 161);
        }
    }
    ...
    private void tvSystemBodies_AfterSelect(object sender, TreeViewEventArgs e)
    {
        try
        {
            if (e.Node.Tag is Star197)
            {
                Star197 tag = (Star197)e.Node.Tag;
                this.gclass0_0.method_712(tag.XCoord, tag.YCoord, this.gclass202_0);
                this.Refresh();
            }
            else
            {
                if (!(e.Node.Tag is SystemBodyData))
                    return;
                SystemBodyData tag = (SystemBodyData)e.Node.Tag;
                this.gclass0_0.method_712(tag.XCoordinate, tag.YCoordinate, this.gclass202_0);
                this.Refresh();
            }
        }
        catch (Exception ex)
        {
            AuroraUtils.ShowExceptionPopup(ex, 162);
        }
    }
    ...
    private void cmdNormalWP_Click(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 163);
        }
    }
    ...
    private void cmdLastClickedWP_Click(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 164);
        }
    }
    ...
    private void cmdRendezvousWP_Click(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 165);
        }
    }
    ...
    private void cmdPOIWP_Click(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 166);
        }
    }
    ...
    private void cmdUrgentPOIWP_Click(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 167);
        }
    }
    ...
    private void lstvWaypoints_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 168);
        }
    }
    ...
    private void cmdDeleteWP_Click(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 169);
        }
    }
    ...
    private void cmdAddNameTheme_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (this.gclass0_0.bool_21)
                return;
            NamingTheme gclass140_1 = new NamingTheme();
            gclass140_1.ThemeID = this.gclass0_0.method_26(GEnum0.const_47);
            gclass140_1.Description = this.gclass0_0.string_4;
            this.gclass0_0.ThemeDictionary.Add(gclass140_1.ThemeID, gclass140_1);
            using (StreamReader streamReader = new StreamReader(AuroraUtils.smethod_18("")))
            {
                while (!streamReader.EndOfStream)
                {
                    string[] strArray = streamReader.ReadLine().Split(',');
                    gclass140_1.NameList.Add(strArray[0]);
                }
            }

            this.gclass0_0.AddNamingThemeToDB(gclass140_1);
        }
        catch (Exception ex)
        {
            AuroraUtils.ShowExceptionPopup(ex, 172);
        }
    }
    ...
    private void TacticalMap_MouseClick(object sender, MouseEventArgs e)
    {
        try
        {
            ...
            if (e.Button != MouseButtons.Left || !(Cursor.Current == Cursors.Cross))
                return;
            SystemBodyData gclass1_0_1 = this.gclass0_0.method_711(mouseEventArgs.X, mouseEventArgs.Y);
            if (this.gclass214_0 == null)
            {
                if (this.wayPointType_0 != WayPointType.Named && this.wayPointType_0 != WayPointType.Rendezvous)
                {
                    if (this.wayPointType_0 == WayPointType.DeepSpaceLocation)
                    {
                        ...
                        if (gclass1_0_1 != null && (gclass1_0_1.BodyTypeId == AuroraSystemBodyType.GasGiant ||
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 173);
        }
    }
    ...
    public void method_18(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 174);
        }
    }
    ...
    private void cmdAddCmdrTheme_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (this.gclass0_0.bool_21)
                return;
            CommanderNameThemeData gclass58_0 = new CommanderNameThemeData();
            gclass58_0.NameThemeID = this.gclass0_0.method_26(GEnum0.const_49);
            gclass58_0.Description = this.gclass0_0.string_4;
            gclass58_0.NameOne = 1;
            gclass58_0.NameOneAddition = "";
            this.gclass0_0.NameThemeDictionary.Add(gclass58_0.NameThemeID, gclass58_0);
            List<CommanderNameDefinition> list_33 = new List<CommanderNameDefinition>();
            ...
            using (StreamReader streamReader = new StreamReader(AuroraUtils.smethod_18("")))
            {
                while (!streamReader.EndOfStream)
                {
                    ...
                    if (!(strArray[0] == ""))
                    {
                        ...
                        gclass57.CommanderNameTheme = gclass58_0;
                        gclass57.AllowedForFirstName = true;
                        gclass57.AllowedForLastName = false;
                        gclass57.AllowedForThirdName = false;
                        gclass57.AllowedForFemale = false;
                        gclass57.Name = strArray[0].Trim();
                        this.gclass0_0.CommanderNameList.Add(gclass57);
            ...
            string path1 = AuroraUtils.smethod_18("");
            if (path1 != "")
            {
                using (StreamReader streamReader = new StreamReader(path1))
                {
                    while (!streamReader.EndOfStream)
                    {
                        ...
                        if (!(strArray[0] == ""))
                        {
                            ...
                            gclass57.AllowedForLastName = false;
                            gclass57.AllowedForThirdName = false;
                            gclass57.AllowedForFemale = true;
                            gclass57.Name = strArray[0].Trim();
                            this.gclass0_0.CommanderNameList.Add(gclass57);
                            list_33.Add(gclass57);
                        }
            ...
            string path2 = AuroraUtils.smethod_18("");
            if (path2 != "")
            {
                gclass58_0.NameTwo = 2;
                using (StreamReader streamReader = new StreamReader(path2))
                {
                    while (!streamReader.EndOfStream)
                    {
                        ...
                        if (!(strArray[0] == ""))
                        {
                            CommanderNameDefinition gclass57 = new CommanderNameDefinition();
                            gclass57.CommanderNameTheme = gclass58_0;
                            gclass57.AllowedForFirstName = false;
                            gclass57.AllowedForLastName = true;
                            gclass57.AllowedForThirdName = false;
                            gclass57.AllowedForFemale = false;
                            gclass57.Name = strArray[0].Trim();
                            this.gclass0_0.CommanderNameList.Add(gclass57);
            ...
            this.gclass0_0.AddCommanderNameThemeToDB(gclass58_0);
            this.gclass0_0.AddCommanderNamesToDB(list_33);
        }
        catch (Exception ex)
        {
    ...
    private void chkLostContactsOneYear_CheckedChanged(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 176 /*0xB0*/);
        }
    }
    ...
    private void TacticalMap_KeyDown(object sender, KeyEventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 3269);
        }
    }
    ...
    private void tvContacts_AfterSelect(object sender, TreeViewEventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 3297);
        }
    }
    ...
    private void TacticalMap_MouseDoubleClick(object sender, MouseEventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 3300);
        }
    }
    ...
    private void cdmDeepSpaceLocation_Click(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 3552);
        }
    }
    ...
    private void cmdCeaseFireAll_Click(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 3560);
        }
    }
    ...
    private void cmdMoveWaypoint_Click(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 3769);
        }
    }
    ...
    private void cmdTempWaypoint_Click(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 3770);
        }
    }
    ...
    private void cmdDeleteAll_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                if (MessageBox.Show(" Are you sure you want to delete all waypoints in this system?",
                        "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
                    return;
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 3778);
        }
    }
    ...
    private void cmdEmpire_Click(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 3837);
        }
    }
    ...
    private void button1_Click(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 3867);
        }
    }
    ...
    private void cmdCreateFleetWaypoint_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else if (this.tvMilitary.SelectedNode.Tag is FleetData)
            {
                FleetData tag = (FleetData)this.tvMilitary.SelectedNode.Tag;
                if (tag == null)
                    return;
                tag.method_0(true, null, null, 0.0, 0.0);
                this.gclass202_0.method_14(this.lstvWaypoints);
                this.gclass0_0.method_703(this.gclass202_0);
                this.Refresh();
            }
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 3921);
        }
    }
    ...
    private void cmdSetFleetWaypoint_Click(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 3922);
        }
    }
    ...
    private void cmdResetWindows_Click(object sender, EventArgs e)
    {
        try
        {
            this.gclass0_0.WindowPositionDictionary.Clear();
        }
        catch (Exception ex)
        {
            AuroraUtils.ShowExceptionPopup(ex, 177);
        }
    }
    ...
    private void TacticalMap_FormClosing(object sender, FormClosingEventArgs e)
    {
        try
        {
            if (MessageBox.Show("Are you sure you wish to close C# Aurora? Any unsaved play will be lost.", "C# Aurora",
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 3195);
        }
    }
    ...
    private void TacticalMap_MouseMove(object sender, MouseEventArgs e)
    {
        try
        {
            if (!this.bool_0)
                return;
            this.bool_1 = true;
            double num1 = Math.Abs(this.double_0 - e.X);
            double num2 = Math.Abs(this.double_0 - e.Y);
            ...
            {
                this.gclass227_0.method_0(e.X, e.Y);
            }
            else
            {
                this.gclass227_0 = null;
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 178);
        }
    }
    ...
    private void TacticalMap_MouseDown(object sender, MouseEventArgs e)
    {
        try
        {
            if (e.Button == MouseButtons.Left)
            {
                ...
                if (this.gclass202_0 == null || (Control.ModifierKeys & Keys.Shift) != Keys.Shift)
                    return;
                this.gclass227_0 = new GClass227(this.int_0, this.int_1, this.gclass202_0);
            }
            else
            {
                ...
                if (source.Count > 0)
                {
                    var capturedList = source
                        .SelectMany<GClass222, SystemBodyData>(gclass222_0 => gclass222_0.list_1)
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 179);
        }
    }
    ...
    private void TacticalMap_MouseUp(object sender, MouseEventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 180);
        }
    }
    ...
    public void method_20()
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 181);
        }
    }
    ...
    private void InitializeComponent()
    {
        ...
        this.tlbMainToolbar.Controls.Add(this.cmdToolbarGalactic);
        this.tlbMainToolbar.Controls.Add(this.cmdToolbarComparison);
        ...
        this.tlbMainToolbar.Controls.Add(this.cmdToolbarRefreshTactical);
        this.tlbMainToolbar.Controls.Add(this.cmdToolbarSave);
        this.tlbMainToolbar.Controls.Add(this.cmdToolbarGame);
        ...
        this.cmdToolbarColony.Click += this.cmdRight_Click;
        ...
        this.cmdToolbarIndustry.Click += this.cmdRight_Click;
        ...
        this.cmdToolbarMining.Click += this.cmdRight_Click;
        ...
        this.cmdToolbarResearch.Click += this.cmdRight_Click;
        ...
        this.cmdToolbarWealth.Click += this.cmdRight_Click;
        ...
        this.cmdToolbarClass.Click += this.cmdRight_Click;
        ...
        this.cmdToolbarProject.Click += this.cmdRight_Click;
        ...
        this.cmdToolbarFleet.Click += this.cmdRight_Click;
        ...
        this.cmdToolbarMissileDesign.Click += this.cmdRight_Click;
        ...
        this.cmdToolbarTurret.Click += this.cmdRight_Click;
        ...
        this.cmdToolbarGroundForces.Click += this.cmdRight_Click;
        ...
        this.cmdToolbarCommanders.Click += this.cmdRight_Click;
        ...
        this.cmdToolbarMedals.Click += this.cmdRight_Click;
        ...
        this.cmdToolbarRace.Click += this.cmdRight_Click;
        ...
        this.cmdToolbarSystem.Click += this.cmdRight_Click;
        this.cmdToolbarGalactic.AccessibleName = "Galactic Map";
        this.cmdToolbarGalactic.BackgroundImage =
            (Image)componentResourceManager.GetObject("cmdToolbarGalactic.BackgroundImage");
        ...
        this.cmdToolbarGalactic.Click += this.cmdRight_Click;
        this.cmdToolbarComparison.AccessibleName = "Race Comparison";
        this.cmdToolbarComparison.BackgroundImage =
            (Image)componentResourceManager.GetObject("cmdToolbarComparison.BackgroundImage");
        ...
        this.cmdToolbarComparison.Click += this.cmdRight_Click;
        ...
        this.cmdToolbarIntelligence.Click += this.cmdRight_Click;
        ...
        this.cmdToolbarTechnology.Click += this.cmdRight_Click;
        ...
        this.cmdToolbarSurvey.Click += this.cmdRight_Click;
        ...
        this.cmdToolbarSector.Click += this.cmdRight_Click;
        ...
        this.cmdToolbarEvents.Click += this.cmdRight_Click;
        this.cmdToolbarRefreshTactical.AccessibleName = "Refresh";
        this.cmdToolbarRefreshTactical.BackgroundImage =
            (Image)componentResourceManager.GetObject("cmdToolbarRefreshTactical.BackgroundImage");
        ...
        this.cmdToolbarRefreshTactical.Click += this.cmdRight_Click;
        this.cmdToolbarSave.AccessibleName = "Save Game";
        this.cmdToolbarSave.BackgroundImage =
            (Image)componentResourceManager.GetObject("cmdToolbarSave.BackgroundImage");
        ...
        this.cmdToolbarSave.Click += this.cmdRight_Click;
        this.cmdToolbarGame.AccessibleName = "Game Window";
        this.cmdToolbarGame.BackgroundImage =
            (Image)componentResourceManager.GetObject("cmdToolbarGame.BackgroundImage");
        ...
        this.cmdToolbarGame.Click += this.cmdRight_Click;
        ...
        this.cmdSM.Click += this.cmdRight_Click;
        ...
        this.cmdToolbarAuto.Click += this.cmdRight_Click;
        this.flowLayoutPanel3.Controls.Add(this.cmdZoomIn);
        this.flowLayoutPanel3.Controls.Add(this.cmdUp);
        this.flowLayoutPanel3.Controls.Add(this.cmdZoomOut);
        this.flowLayoutPanel3.Controls.Add(this.cmdLeft);
        this.flowLayoutPanel3.Controls.Add(this.cmdDown);
        this.flowLayoutPanel3.Controls.Add(this.cmdRight);
        ...
        this.cmdZoomIn.Click += this.cmdRight_Click;
        ...
        this.cmdUp.Click += this.cmdRight_Click;
        ...
        this.cmdZoomOut.Click += this.cmdRight_Click;
        ...
        this.cmdLeft.Click += this.cmdRight_Click;
        ...
        this.cmdDown.Click += this.cmdRight_Click;
        ...
        this.tblIncrement.Controls.Add(this.cmdIncrement5S);
        this.tblIncrement.Controls.Add(this.cmdIncrement30S);
        ...
        this.cmdIncrement5S.Tag = "5";
        this.cmdIncrement5S.Text = "5 Seconds";
        this.cmdIncrement5S.UseVisualStyleBackColor = false;
        this.cmdIncrement5S.Click += this.cmdIncrement30D_Click;
        this.cmdIncrement30S.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.cmdIncrement30S.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.tblSubPulse.Controls.Add(this.cmdSubPulse);
        this.tblSubPulse.Controls.Add(this.cmdSubPulse5S);
        this.tblSubPulse.Controls.Add(this.cmdSubPulse30S);
        this.tblSubPulse.Controls.Add(this.cmdSubPulse2M);
        this.tblSubPulse.Controls.Add(this.cmdSubPulse5M);
        this.tblSubPulse.Controls.Add(this.cmdSubPulse20M);
        this.tblSubPulse.Controls.Add(this.cmdSubPulse1H);
        this.tblSubPulse.Controls.Add(this.cmdSubPulse3H);
        this.tblSubPulse.Controls.Add(this.cmdSubPulse8H);
        this.tblSubPulse.Controls.Add(this.cmdSubPulse1D);
        this.tblSubPulse.Controls.Add(this.cmdSubPulse5D);
        this.tblSubPulse.Controls.Add(this.cmdSubPulse30D);
        ...
        this.cmdSubPulse.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdSubPulse5S.Tag = "5";
        this.cmdSubPulse5S.Text = "5 Seconds";
        this.cmdSubPulse5S.UseVisualStyleBackColor = false;
        this.cmdSubPulse5S.Click += this.cmdSubPulse30D_Click;
        this.cmdSubPulse30S.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.cmdSubPulse30S.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdSubPulse30S.Tag = "30";
        this.cmdSubPulse30S.Text = "30 Seconds";
        this.cmdSubPulse30S.UseVisualStyleBackColor = false;
        this.cmdSubPulse30S.Click += this.cmdSubPulse30D_Click;
        this.cmdSubPulse2M.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.cmdSubPulse2M.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdSubPulse2M.Tag = "120";
        this.cmdSubPulse2M.Text = "2 Minutes";
        this.cmdSubPulse2M.UseVisualStyleBackColor = false;
        this.cmdSubPulse2M.Click += this.cmdSubPulse30D_Click;
        this.cmdSubPulse5M.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.cmdSubPulse5M.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdSubPulse5M.Tag = "300";
        this.cmdSubPulse5M.Text = "5 Minutes";
        this.cmdSubPulse5M.UseVisualStyleBackColor = false;
        this.cmdSubPulse5M.Click += this.cmdSubPulse30D_Click;
        this.cmdSubPulse20M.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.cmdSubPulse20M.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdSubPulse20M.Tag = "1200";
        this.cmdSubPulse20M.Text = "20 Minutes";
        this.cmdSubPulse20M.UseVisualStyleBackColor = false;
        this.cmdSubPulse20M.Click += this.cmdSubPulse30D_Click;
        this.cmdSubPulse1H.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.cmdSubPulse1H.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdSubPulse1H.Tag = "3600";
        this.cmdSubPulse1H.Text = "1 Hour";
        this.cmdSubPulse1H.UseVisualStyleBackColor = false;
        this.cmdSubPulse1H.Click += this.cmdSubPulse30D_Click;
        this.cmdSubPulse3H.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.cmdSubPulse3H.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdSubPulse3H.Tag = "10800";
        this.cmdSubPulse3H.Text = "3 Hours";
        this.cmdSubPulse3H.UseVisualStyleBackColor = false;
        this.cmdSubPulse3H.Click += this.cmdSubPulse30D_Click;
        this.cmdSubPulse8H.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.cmdSubPulse8H.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdSubPulse8H.Tag = "28800";
        this.cmdSubPulse8H.Text = "8 Hours";
        this.cmdSubPulse8H.UseVisualStyleBackColor = false;
        this.cmdSubPulse8H.Click += this.cmdSubPulse30D_Click;
        this.cmdSubPulse1D.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.cmdSubPulse1D.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdSubPulse1D.Tag = "86400";
        this.cmdSubPulse1D.Text = "1 Day";
        this.cmdSubPulse1D.UseVisualStyleBackColor = false;
        this.cmdSubPulse1D.Click += this.cmdSubPulse30D_Click;
        this.cmdSubPulse5D.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.cmdSubPulse5D.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdSubPulse5D.Tag = "432000";
        this.cmdSubPulse5D.Text = "5 Days";
        this.cmdSubPulse5D.UseVisualStyleBackColor = false;
        this.cmdSubPulse5D.Click += this.cmdSubPulse30D_Click;
        this.cmdSubPulse30D.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.cmdSubPulse30D.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdSubPulse30D.Tag = "2592000";
        this.cmdSubPulse30D.Text = "30 Days";
        this.cmdSubPulse30D.UseVisualStyleBackColor = false;
        this.cmdSubPulse30D.Click += this.cmdSubPulse30D_Click;
        this.flowLayoutPanel2.Controls.Add(this.cboRaces);
        this.flowLayoutPanel2.Controls.Add(this.cboSystems);
        this.flowLayoutPanel2.Controls.Add(this.tabSidebar);
        ...
        this.cboSystems.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.tabSidebar.Controls.Add(this.tabMinerals);
        this.tabSidebar.Controls.Add(this.tabMineralText);
        this.tabSidebar.Controls.Add(this.tabJump);
        this.tabSidebar.Controls.Add(this.tabGroundSurvey);
        this.tabSidebar.Controls.Add(this.tabBodyInfo);
        this.tabSidebar.Controls.Add(this.tabAllBodies);
        this.tabSidebar.Controls.Add(this.tabMilitary);
        this.tabSidebar.Controls.Add(this.tabWaypoints);
        this.tabSidebar.Controls.Add(this.tabMisc);
        ...
        this.flowLayoutPanelDisplay.Controls.Add(this.chkEvents);
        this.flowLayoutPanelDisplay.Controls.Add(this.chkEventsAllRaces);
        this.flowLayoutPanelDisplay.Controls.Add(this.chkUseHullNumbers);
        this.flowLayoutPanelDisplay.Controls.Add(this.chkActiveSensors);
        this.flowLayoutPanelDisplay.Controls.Add(this.chkFireControlRange);
        this.flowLayoutPanelDisplay.Controls.Add(this.chkFiringRanges);
        this.flowLayoutPanelDisplay.Controls.Add(this.chkMoveTail);
        this.flowLayoutPanelDisplay.Controls.Add(this.chkGeoPoints);
        this.flowLayoutPanelDisplay.Controls.Add(this.chkSBSurvey);
        this.flowLayoutPanelDisplay.Controls.Add(this.chkBearing);
        this.flowLayoutPanelDisplay.Controls.Add(this.chkOrder);
        this.flowLayoutPanelDisplay.Controls.Add(this.chkEscorts);
        this.flowLayoutPanelDisplay.Controls.Add(this.chkHideOrbitFleets);
        this.flowLayoutPanelDisplay.Controls.Add(this.chkSalvoTarget);
        this.flowLayoutPanelDisplay.Controls.Add(this.chkSalvoOrigin);
        this.flowLayoutPanelDisplay.Controls.Add(this.chkMPC);
        this.flowLayoutPanelDisplay.Controls.Add(this.chkCentre);
        this.flowLayoutPanelDisplay.Controls.Add(this.chkTAD);
        this.flowLayoutPanelDisplay.Controls.Add(this.chkCoordinates);
        this.flowLayoutPanelDisplay.Controls.Add(this.chkMinerals);
        this.flowLayoutPanelDisplay.Controls.Add(this.chkHideSL);
        this.flowLayoutPanelDisplay.Controls.Add(this.chkAstMinOnly);
        this.flowLayoutPanelDisplay.Controls.Add(this.chkAstColOnly);
        this.flowLayoutPanelDisplay.Controls.Add(this.chkPassive10);
        this.flowLayoutPanelDisplay.Controls.Add(this.chkPassive100);
        this.flowLayoutPanelDisplay.Controls.Add(this.chkPassive1000);
        this.flowLayoutPanelDisplay.Controls.Add(this.chkPassive10000);
        this.flowLayoutPanelDisplay.Controls.Add(this.chkNoOverlap);
        this.flowLayoutPanelDisplay.Controls.Add(this.chkAllRace);
        this.flowLayoutPanelDisplay.Controls.Add(this.chkDisplayAllForms);
        this.flowLayoutPanelDisplay.Controls.Add(this.chkHideWreckIDs);
        ...
        this.chkEvents.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkEventsAllRaces.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkUseHullNumbers.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkActiveSensors.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkFireControlRange.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkFiringRanges.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkMoveTail.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkGeoPoints.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkSBSurvey.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkBearing.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkOrder.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkEscorts.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkHideOrbitFleets.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkSalvoTarget.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkSalvoOrigin.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkMPC.CheckedChanged += this.chkTracking_Click;
        this.chkCentre.AutoSize = true;
        this.chkCentre.Location = new Point(sbyte.MaxValue, 3);
        ...
        this.chkCentre.CheckedChanged += this.chkTracking_Click;
        this.chkTAD.AutoSize = true;
        this.chkTAD.Location = new Point(sbyte.MaxValue, 26);
        ...
        this.chkTAD.CheckedChanged += this.chkTracking_Click;
        this.chkCoordinates.AutoSize = true;
        this.chkCoordinates.Location = new Point(sbyte.MaxValue, 49);
        ...
        this.chkCoordinates.CheckedChanged += this.chkTracking_Click;
        this.chkMinerals.AutoSize = true;
        this.chkMinerals.Location = new Point(sbyte.MaxValue, 72);
        ...
        this.chkMinerals.CheckedChanged += this.chkTracking_Click;
        this.chkHideSL.AutoSize = true;
        this.chkHideSL.Location = new Point(sbyte.MaxValue, 95);
        ...
        this.chkHideSL.CheckedChanged += this.chkTracking_Click;
        this.chkAstMinOnly.AutoSize = true;
        this.chkAstMinOnly.Location = new Point(sbyte.MaxValue, 118);
        ...
        this.chkAstMinOnly.CheckedChanged += this.chkTracking_Click;
        this.chkAstColOnly.AutoSize = true;
        this.chkAstColOnly.Location = new Point(sbyte.MaxValue, 141);
        ...
        this.chkAstColOnly.CheckedChanged += this.chkTracking_Click;
        this.chkPassive10.AutoSize = true;
        this.chkPassive10.Location = new Point(sbyte.MaxValue, 164);
        ...
        this.chkPassive10.CheckedChanged += this.chkTracking_Click;
        this.chkPassive100.AutoSize = true;
        this.chkPassive100.Location = new Point(sbyte.MaxValue, 187);
        ...
        this.chkPassive100.CheckedChanged += this.chkTracking_Click;
        this.chkPassive1000.AutoSize = true;
        this.chkPassive1000.Location = new Point(sbyte.MaxValue, 210);
        ...
        this.chkPassive1000.CheckedChanged += this.chkTracking_Click;
        this.chkPassive10000.AutoSize = true;
        this.chkPassive10000.Location = new Point(sbyte.MaxValue, 233);
        ...
        this.chkPassive10000.CheckedChanged += this.chkTracking_Click;
        this.chkNoOverlap.AutoSize = true;
        this.chkNoOverlap.Location = new Point(sbyte.MaxValue, 256 /*0x0100*/);
        ...
        this.chkNoOverlap.CheckedChanged += this.chkTracking_Click;
        this.chkAllRace.AutoSize = true;
        this.chkAllRace.Location = new Point(sbyte.MaxValue, 279);
        ...
        this.chkAllRace.CheckedChanged += this.chkTracking_Click;
        this.chkDisplayAllForms.AutoSize = true;
        this.chkDisplayAllForms.Location = new Point(sbyte.MaxValue, 302);
        ...
        this.chkDisplayAllForms.CheckedChanged += this.chkTracking_Click;
        this.chkHideWreckIDs.AutoSize = true;
        this.chkHideWreckIDs.Location = new Point(sbyte.MaxValue, 325);
        ...
        this.chkHideWreckIDs.CheckedChanged += this.chkTracking_Click;
        this.flowLayoutPanel9.BorderStyle = BorderStyle.FixedSingle;
        this.flowLayoutPanel9.Controls.Add(this.chkColonies);
        this.flowLayoutPanel9.Controls.Add(this.chkWP);
        this.flowLayoutPanel9.Controls.Add(this.chkPlanets);
        this.flowLayoutPanel9.Controls.Add(this.chkDwarf);
        this.flowLayoutPanel9.Controls.Add(this.chkMoons);
        this.flowLayoutPanel9.Controls.Add(this.chkAst);
        this.flowLayoutPanel9.Controls.Add(this.chkFleets);
        this.flowLayoutPanel9.Controls.Add(this.chkStarOrbits);
        this.flowLayoutPanel9.Controls.Add(this.chkPlanetOrbits);
        this.flowLayoutPanel9.Controls.Add(this.chkDwarfOrbits);
        this.flowLayoutPanel9.Controls.Add(this.chkCometPath);
        this.flowLayoutPanel9.Controls.Add(this.chkMoonOrbits);
        this.flowLayoutPanel9.Controls.Add(this.chkAsteroidOrbits);
        this.flowLayoutPanel9.Controls.Add(this.chkSelectedOrbit);
        this.flowLayoutPanel9.Controls.Add(this.chkStarNames);
        this.flowLayoutPanel9.Controls.Add(this.chkPlanetNames);
        this.flowLayoutPanel9.Controls.Add(this.chkDwarfNames);
        this.flowLayoutPanel9.Controls.Add(this.chkMoonNames);
        this.flowLayoutPanel9.Controls.Add(this.chkAstNames);
        this.flowLayoutPanel9.Controls.Add(this.chkLifepods);
        this.flowLayoutPanel9.Controls.Add(this.chkWrecks);
        this.flowLayoutPanel9.Controls.Add(this.chkWaypoint);
        this.flowLayoutPanel9.Controls.Add(this.chkSL);
        this.flowLayoutPanel9.Controls.Add(this.chkPackets);
        ...
        this.chkColonies.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkWP.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkPlanets.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkDwarf.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkMoons.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkAst.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkFleets.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkStarOrbits.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkPlanetOrbits.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkDwarfOrbits.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkCometPath.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkMoonOrbits.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkAsteroidOrbits.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkSelectedOrbit.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkStarNames.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkPlanetNames.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkDwarfNames.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkMoonNames.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkAstNames.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkLifepods.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkWrecks.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkWaypoint.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkSL.CheckedChanged += this.chkTracking_Click;
        ...
        this.chkPackets.CheckedChanged += this.chkTracking_Click;
        this.tabContacts.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.tabContacts.Controls.Add(this.flowLayoutPanelContacts);
        ...
        this.flowLayoutPanelContacts.Controls.Add(this.flowLayoutPanel6);
        this.flowLayoutPanelContacts.Controls.Add(this.flowLayoutPanel4);
        this.flowLayoutPanelContacts.Controls.Add(this.flowLayoutPanel5);
        ...
        this.flowLayoutPanel6.Controls.Add(this.chkLostContactsOneDay);
        this.flowLayoutPanel6.Controls.Add(this.chkLostContacts);
        this.flowLayoutPanel6.Controls.Add(this.chkLostContactsOneYear);
        this.flowLayoutPanel6.Controls.Add(this.ckNoSensors);
        ...
        this.chkHostile.Click += this.chkTracking_Click;
        ...
        this.chkNeutral.Click += this.chkTracking_Click;
        ...
        this.chkFriendly.Click += this.chkTracking_Click;
        ...
        this.chkAllied.Click += this.chkTracking_Click;
        ...
        this.chkCivilian.Click += this.chkTracking_Click;
        ...
        this.chkLostContactsOneDay.CheckedChanged += this.chkLostContactsOneYear_CheckedChanged;
        ...
        this.chkLostContacts.CheckedChanged += this.chkLostContactsOneYear_CheckedChanged;
        ...
        this.chkLostContactsOneYear.CheckedChanged += this.chkLostContactsOneYear_CheckedChanged;
        ...
        this.ckNoSensors.CheckedChanged += this.ckNoSensors_CheckedChanged;
        ...
        this.flowLayoutPanel5.Controls.Add(this.chkContactsCurrentSystem);
        this.flowLayoutPanel5.Controls.Add(this.tvContacts);
        this.flowLayoutPanel5.Controls.Add(this.lblLocation);
        ...
        this.chkContactsCurrentSystem.Click += this.chkShowCivilianOOB_Click;
        ...
        this.tvContacts.AfterSelect += this.tvContacts_AfterSelect;
        ...
        this.tabMinerals.Controls.Add(this.flowLayoutPanelMinerals);
        ...
        this.flowLayoutPanelMinerals.Controls.Add(this.tvMinerals);
        ...
        this.tvMinerals.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.tabMineralText.Controls.Add(this.txtMinerals);
        ...
        this.tabJump.Controls.Add(this.flowLayoutPanelJump);
        ...
        this.flowLayoutPanelJump.Controls.Add(this.label2);
        this.flowLayoutPanelJump.Controls.Add(this.lstRuins);
        this.flowLayoutPanelJump.Controls.Add(this.label3);
        this.flowLayoutPanelJump.Controls.Add(this.lstAnomalies);
        this.flowLayoutPanelJump.Controls.Add(this.label4);
        this.flowLayoutPanelJump.Controls.Add(this.lstWrecks);
        ...
        this.lstRuins.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstRuins.Click += this.lstRuins_Click;
        ...
        this.lstAnomalies.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstWrecks.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.tabGroundSurvey.Controls.Add(this.lstvSurveySites);
        ...
        this.tabBodyInfo.Controls.Add(this.flowLayoutPanel7);
        ...
        this.flowLayoutPanel7.Controls.Add(this.lstvBodyInfo);
        this.flowLayoutPanel7.Controls.Add(this.lstvMinerals);
        ...
        this.lstvBodyInfo.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.tabAllBodies.Controls.Add(this.tvSystemBodies);
        ...
        this.tvSystemBodies.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.tvSystemBodies.AfterSelect += this.tvSystemBodies_AfterSelect;
        this.tabMilitary.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.tabMilitary.Controls.Add(this.flowLayoutPanelMilitary);
        ...
        this.flowLayoutPanelMilitary.Controls.Add(this.chkSystemOnly);
        this.flowLayoutPanelMilitary.Controls.Add(this.chkShowCivilianOOB);
        this.flowLayoutPanelMilitary.Controls.Add(this.tvMilitary);
        this.flowLayoutPanelMilitary.Controls.Add(this.cmdCreateFleetWaypoint);
        this.flowLayoutPanelMilitary.Controls.Add(this.cmdSetFleetWaypoint);
        ...
        this.chkSystemOnly.Click += this.chkShowCivilianOOB_Click;
        ...
        this.chkShowCivilianOOB.Click += this.chkShowCivilianOOB_Click;
        this.tvMilitary.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.tvMilitary.BorderStyle = BorderStyle.None;
        this.tvMilitary.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.tvMilitary.AfterSelect += this.tvMilitary_AfterSelect;
        this.tabWaypoints.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.tabWaypoints.Controls.Add(this.lstvWaypoints);
        this.tabWaypoints.Controls.Add(this.flowLayoutPanel8);
        ...
        this.lstvWaypoints.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstvWaypoints.SelectedIndexChanged += this.lstvWaypoints_SelectedIndexChanged;
        this.columnHeader_5.Width = 30;
        this.columnHeader_6.Width = 90;
        this.columnHeader_7.Width = 190;
        this.flowLayoutPanel8.Controls.Add(this.cmdNormalWP);
        this.flowLayoutPanel8.Controls.Add(this.cmdLastClickedWP);
        this.flowLayoutPanel8.Controls.Add(this.cmdRendezvousWP);
        this.flowLayoutPanel8.Controls.Add(this.cmdPOIWP);
        this.flowLayoutPanel8.Controls.Add(this.cmdUrgentPOIWP);
        this.flowLayoutPanel8.Controls.Add(this.cmdMoveWaypoint);
        this.flowLayoutPanel8.Controls.Add(this.cmdTempWaypoint);
        this.flowLayoutPanel8.Controls.Add(this.cmdDeleteWP);
        this.flowLayoutPanel8.Controls.Add(this.cmdDeleteAll);
        ...
        this.cmdNormalWP.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdNormalWP.TabIndex = sbyte.MaxValue;
        this.cmdNormalWP.Tag = "1200";
        this.cmdNormalWP.Text = "Normal Waypoint";
        this.cmdNormalWP.UseVisualStyleBackColor = false;
        this.cmdNormalWP.Click += this.cmdNormalWP_Click;
        this.cmdLastClickedWP.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.cmdLastClickedWP.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdLastClickedWP.Tag = "1200";
        this.cmdLastClickedWP.Text = "Named Waypoint";
        this.cmdLastClickedWP.UseVisualStyleBackColor = false;
        this.cmdLastClickedWP.Click += this.cmdLastClickedWP_Click;
        this.cmdRendezvousWP.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.cmdRendezvousWP.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdRendezvousWP.Tag = "1200";
        this.cmdRendezvousWP.Text = "Rendezvous";
        this.cmdRendezvousWP.UseVisualStyleBackColor = false;
        this.cmdRendezvousWP.Click += this.cmdRendezvousWP_Click;
        this.cmdPOIWP.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.cmdPOIWP.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdPOIWP.Tag = "1200";
        this.cmdPOIWP.Text = "Point of Interest";
        this.cmdPOIWP.UseVisualStyleBackColor = false;
        this.cmdPOIWP.Click += this.cmdPOIWP_Click;
        this.cmdUrgentPOIWP.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.cmdUrgentPOIWP.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdUrgentPOIWP.Tag = "1200";
        this.cmdUrgentPOIWP.Text = "Urgent POI";
        this.cmdUrgentPOIWP.UseVisualStyleBackColor = false;
        this.cmdUrgentPOIWP.Click += this.cmdUrgentPOIWP_Click;
        this.cmdMoveWaypoint.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.cmdMoveWaypoint.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdMoveWaypoint.Tag = "1200";
        this.cmdMoveWaypoint.Text = "Move Waypoint";
        this.cmdMoveWaypoint.UseVisualStyleBackColor = false;
        this.cmdMoveWaypoint.Click += this.cmdMoveWaypoint_Click;
        this.cmdTempWaypoint.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.cmdTempWaypoint.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdTempWaypoint.Tag = "1200";
        this.cmdTempWaypoint.Text = "Temp Waypoint";
        this.cmdTempWaypoint.UseVisualStyleBackColor = false;
        this.cmdTempWaypoint.Click += this.cmdTempWaypoint_Click;
        this.cmdDeleteWP.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.cmdDeleteWP.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdDeleteWP.Tag = "1200";
        this.cmdDeleteWP.Text = "Delete Waypoint";
        this.cmdDeleteWP.UseVisualStyleBackColor = false;
        this.cmdDeleteWP.Click += this.cmdDeleteWP_Click;
        this.cmdDeleteAll.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.cmdDeleteAll.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.tabMisc.Controls.Add(this.cmdEmpire);
        this.tabMisc.Controls.Add(this.panel3);
        this.tabMisc.Controls.Add(this.panel2);
        this.tabMisc.Controls.Add(this.panel1);
        this.tabMisc.Controls.Add(this.lblVersion);
        ...
        this.cmdEmpire.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdEmpire.Tag = "1200";
        this.cmdEmpire.Text = "Create Empire";
        this.cmdEmpire.UseVisualStyleBackColor = false;
        this.cmdEmpire.Click += this.cmdEmpire_Click;
        this.panel3.BorderStyle = BorderStyle.FixedSingle;
        this.panel3.Controls.Add(this.cmdCeaseFireAll);
        ...
        this.cmdCeaseFireAll.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdCeaseFireAll.Tag = "1200";
        this.cmdCeaseFireAll.Text = "Cease Fire All Ships";
        this.cmdCeaseFireAll.UseVisualStyleBackColor = false;
        this.cmdCeaseFireAll.Click += this.cmdCeaseFireAll_Click;
        this.panel2.BorderStyle = BorderStyle.FixedSingle;
        this.panel2.Controls.Add(this.cdmDeepSpaceLocation);
        ...
        this.cdmDeepSpaceLocation.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cdmDeepSpaceLocation.Tag = "1200";
        this.cdmDeepSpaceLocation.Text = "Create Deep Space Population";
        this.cdmDeepSpaceLocation.UseVisualStyleBackColor = false;
        this.cdmDeepSpaceLocation.Click += this.cdmDeepSpaceLocation_Click;
        this.panel1.BorderStyle = BorderStyle.FixedSingle;
        this.panel1.Controls.Add(this.button1);
        this.panel1.Controls.Add(this.label1);
        this.panel1.Controls.Add(this.label5);
        this.panel1.Controls.Add(this.cmdAddNameTheme);
        this.panel1.Controls.Add(this.cmdResetWindows);
        this.panel1.Controls.Add(this.cmdAddCmdrTheme);
        ...
        this.button1.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.label1.Text =
            "Click button, enter theme name, then select first name and surname text files with one name per line";
        ...
        this.cmdAddNameTheme.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdAddNameTheme.Tag = "1200";
        this.cmdAddNameTheme.Text = "Add Name Theme";
        this.cmdAddNameTheme.UseVisualStyleBackColor = false;
        this.cmdAddNameTheme.Click += this.cmdAddNameTheme_Click;
        this.cmdResetWindows.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.cmdResetWindows.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdResetWindows.Tag = "1200";
        this.cmdResetWindows.Text = "Reset Windows";
        this.cmdResetWindows.UseVisualStyleBackColor = false;
        this.cmdResetWindows.Click += this.cmdResetWindows_Click;
        this.cmdAddCmdrTheme.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.cmdAddCmdrTheme.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdAddCmdrTheme.Tag = "1200";
        this.cmdAddCmdrTheme.Text = "Cmdr Theme MF";
        this.cmdAddCmdrTheme.UseVisualStyleBackColor = false;
        this.cmdAddCmdrTheme.Click += this.cmdAddCmdrTheme_Click;
        this.label8.Location = new Point(3, 51);
        this.label8.Name = "label8";
        this.label8.Size = new Size(190, 44);
        this.label8.TabIndex = 131;
        this.label8.Text =
            "Click button, enter theme name, then select male, female and surname text files with one name per line";
        ...
        this.cmdCreateFleetWaypoint.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdSetFleetWaypoint.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.Tag = "Tactical";
        this.Text = "Aurora";
        this.FormClosing += this.TacticalMap_FormClosing;
        this.Load += this.TacticalMap_Load;
        this.Paint += this.TacticalMap_Paint;
        this.KeyDown += this.TacticalMap_KeyDown;
        this.MouseClick += this.TacticalMap_MouseClick;
        this.MouseDoubleClick += this.TacticalMap_MouseDoubleClick;
        this.MouseDown += this.TacticalMap_MouseDown;
        this.MouseMove += this.TacticalMap_MouseMove;
        this.MouseUp += this.TacticalMap_MouseUp;
