...
#nullable disable
[CompilerGenerated]
internal sealed class Class323<T, U, V, W, X>
{
  ...
  public V ThermalStrength => this.gparam_2;
  ...
  [DebuggerHidden]
  public Class323(T gparam_5, U gparam_6, V gparam_7, W gparam_8, X gparam_9)
  {
  ...
  public override bool Equals(object value)
  {
    ...
    Class323<T, U, V, W, X> class323 = value as Class323<T, U, V, W, X>;
    if (this == class323)
      return true;
    // ISSUE: reference to a compiler-generated field
    // ISSUE: reference to a compiler-generated field
    ...
    // ISSUE: reference to a compiler-generated field
    // ISSUE: reference to a compiler-generated field
    return class323 != null && EqualityComparer<T>.Default.Equals(this.gparam_0, class323.gparam_0) && EqualityComparer<U>.Default.Equals(this.gparam_1, class323.gparam_1) && EqualityComparer<V>.Default.Equals(this.gparam_2, class323.gparam_2) && EqualityComparer<W>.Default.Equals(this.gparam_3, class323.gparam_3) && EqualityComparer<X>.Default.Equals(this.gparam_4, class323.gparam_4);
  }
  ...
  public override string ToString()
  {
    ...
    objArray[4] = (object) ((object) local5 != null ? local5.ToString() : (string) null);
    return string.Format((IFormatProvider) null, "{{ SensorRace = {0}, SensorSystem = {1}, ThermalStrength = {2}, Xcor = {3}, Ycor = {4} }}", objArray);
  }
}
