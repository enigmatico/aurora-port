...
public class RankThemeEntry
{
    ...
    public RankThemeEntry method_1()
    {
        try
        {
            return this.gclass21_0.RacialRankDictionary.Values.Where<RankThemeEntry>(gclass61_0 =>
    ...
    public RankThemeEntry method_2(int int_4)
    {
        try
        {
            // ISSUE: reference to a compiler-generated method
            return this.gclass21_0.RacialRankDictionary.Values.FirstOrDefault(
    ...
    public RankThemeEntry method_3()
    {
        try
        {
            return this.gclass21_0.RacialRankDictionary.Values.Where<RankThemeEntry>(gclass61_0 =>
