...
public class SelectRace : Form
{
    ...
    public SelectRace(GameRace gclass21_1, GClass0 gclass0_1, PopulationData gclass146_1)
    {
        ...
        this.gclass0_0.gclass146_0 = null;
    }
    ...
    private void SelectRace_Load(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 3566);
        }
    }
    ...
    private void cmdCancel_Click(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 3567);
        }
    }
    ...
    private void cmdOK_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            this.gclass0_0.gclass146_0 = (PopulationData)this.cboTargetPopulation.SelectedValue;
    ...
    private void InitializeComponent()
    {
        ...
        this.cboTargetPopulation.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.txtInput.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.Controls.Add(this.cboTargetPopulation);
        this.Controls.Add(this.cmdCancel);
        this.Controls.Add(this.cmdOK);
        this.Name = nameof(SelectRace);
        this.Text = "Select Race";
        this.Load += this.SelectRace_Load;
