...
public class GClass92
{
  ...
  {
    this.gclass0_0.int_132 = gclass91_1.int_1 >= 61 ? (gclass91_1.int_1 >= 201 ? (gclass91_1.int_1 >= 401 ? (gclass91_1.int_1 >= 1201 ? (gclass91_1.int_1 >= 3601 ? (gclass91_1.int_1 >= 10801 ? (gclass91_1.int_1 >= 28801 ? (gclass91_1.int_1 >= 86401 ? (gclass91_1.int_1 >= 432001 ? 21600 : 7200) : 1800) : 900) : 360) : 120) : 60) : 20) : 10) : 5;
    gclass91_1.int_1 = (int) Math.Floor((double) gclass91_1.int_1 / (double) this.gclass0_0.int_132) * this.gclass0_0.int_132;
  }
  ...
  {
    this.method_4(genum126_0, string_0, gclass21_0, gclass200_0, (GClass146) null, double_0, double_1, auroraEventCategory_0, false, false, (GClass21) null);
  }
  ...
  public void method_3(
    ...
    AuroraEventCategory auroraEventCategory_0)
  {
    this.method_4(genum126_0, string_0, gclass21_0, gclass200_0, gclass146_0, double_0, double_1, auroraEventCategory_0, false, false, (GClass21) null);
  }
    ...
    GClass21 gclass21_1)
  {
    try
    {
      ...
      if (this.gclass91_0 == null)
        this.gclass91_0 = this.dictionary_0.Values.OrderByDescending<GClass91, Decimal>((Func<GClass91, Decimal>) (gclass91_0 => gclass91_0.decimal_0)).FirstOrDefault<GClass91>();
      if (!this.gclass0_0.dictionary_46.ContainsKey(genum126_0))
        return;
      gclass87.gclass91_0 = this.gclass91_0;
      gclass87.gclass88_0 = this.gclass0_0.dictionary_46[genum126_0];
      ...
      if (gclass21_0.bool_0)
      {
        if (gclass87.gclass88_0.bool_2)
        {
          this.gclass0_0.bool_0 = true;
        }
        else
        {
          if (gclass21_1 == null || !gclass21_1.bool_0)
            return;
          this.gclass0_0.bool_0 = true;
        }
      }
