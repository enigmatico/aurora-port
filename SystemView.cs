...
public class SystemView : Form
{
  ...
  public SystemView(GClass0 gclass0_1, GClass202 gclass202_1)
  {
  ...
  private void SystemView_Load(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        this.cboRaces.SelectedItem = (object) this.gclass202_0.gclass21_0;
        this.gclass21_0 = this.gclass202_0.gclass21_0;
      }
      else
      {
        this.cboRaces.SelectedItem = (object) this.gclass0_0.gclass21_0;
        this.gclass21_0 = this.gclass0_0.gclass21_0;
      }
      ...
      if (this.gclass0_0.bool_18)
        this.method_3();
      foreach (GClass200 gclass200 in this.gclass0_0.dictionary_11.Values.Where<GClass1>((Func<GClass1, bool>) (gclass1_0 => gclass1_0.auroraSystemBodyType_0 == AuroraSystemBodyType.Asteroid && gclass1_0.int_4 == 0)).Select<GClass1, GClass200>((Func<GClass1, GClass200>) (gclass1_0 => gclass1_0.gclass200_0)).Where<GClass200>((Func<GClass200, bool>) (gclass200_0 => !gclass200_0.bool_0)).Distinct<GClass200>().ToList<GClass200>())
        gclass200.method_0();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3078);
    }
  }
  ...
  public void method_1()
  {
    ...
    {
      GClass226.smethod_74(ex, 3462);
    }
  }

  public void method_2(GClass21 gclass21_1)
  {
    try
    {
      this.bool_1 = true;
  ...
  private void cboRaces_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      if (this.gclass21_0.dictionary_0.Keys.Contains<int>(this.gclass202_0.gclass200_0.int_0))
        this.gclass202_0 = this.gclass21_0.dictionary_0[this.gclass202_0.gclass200_0.int_0];
      this.method_5();
      if (!this.bool_1)
  ...
  private void method_5()
  {
    try
    {
      ...
      {
        if (this.gclass21_0.dictionary_0.Keys.Contains<int>(this.gclass202_0.gclass200_0.int_0))
          this.cboSystems.SelectedItem = (object) this.gclass202_0;
        else
          this.gclass202_0 = (GClass202) null;
      }
      if (this.gclass202_0 == null && gclass202List.Count > 0)
        this.cboSystems.SelectedItem = (object) gclass202List[0];
      if (this.bool_0)
        return;
      this.method_6();
    }
  ...
  private void method_6()
  {
    try
    {
      ...
      this.gclass202_0.method_40(this.lblAge, this.lblDiscovered, this.lblJSP, this.lblJPSurvey, this.lblSBSurvey);
  ...
  private void cboSpecies_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      this.gclass194_0.method_0(this.lblGravity, this.lblOxygen, this.lblTemperature, this.lblBreathe, this.lblPressure);
      this.pbSpecies.Image = Image.FromFile($"{Application.StartupPath}\\Races\\{this.gclass194_0.string_0}");
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3084);
    }
  }
  ...
  private void lstvSB_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      if (this.gclass202_0 == null || this.gclass197_0 == null || this.lstvSB.SelectedItems.Count <= 0 || this.lstvSB.SelectedItems[0].Index < 0)
        return;
      this.gclass1_0 = (GClass1) this.lstvSB.SelectedItems[0].Tag;
      this.method_7();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3085);
    }
  }
  ...
  private void method_7()
  {
    try
    {
      ...
      this.gclass1_0.method_71(this.gclass21_0, this.gclass194_0, this.chkMaxCC.CheckState, this.lblRetention, this.lblCCGravity, this.lblCCTemp, this.lblBreathable, this.lblMaxPressure, this.lblDangerous, this.lblWater, this.lblColonyCost, this.lblPerihelionCC, this.lblAphelionCC, 2);
  ...
  private void cmdAddColony_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass202_0 == null || this.gclass1_0 == null || this.gclass1_0.auroraSystemBodyType_0 == AuroraSystemBodyType.GasGiant || this.gclass1_0.auroraSystemBodyType_0 == AuroraSystemBodyType.Superjovian)
        return;
  ...
  private void cmdDeleteSystem_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass202_0 == null || MessageBox.Show($" Are you sure you want to delete the system {this.gclass202_0.Name}?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes || MessageBox.Show(" Are you really sure? This will delete all populations and military forces in the system", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
        return;
      this.gclass0_0.method_545(this.gclass202_0.gclass200_0, false);
      this.gclass202_0 = (GClass202) null;
      this.method_5();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3090);
    }
  }
  ...
  private void cmdAllBodySurvey_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass202_0 == null)
        return;
      this.gclass202_0.gclass21_0.method_258(this.gclass202_0.gclass200_0, false);
      this.gclass202_0.method_40(this.lblAge, this.lblDiscovered, this.lblJSP, this.lblJPSurvey, this.lblSBSurvey);
      this.method_12();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3091);
    }
  }
  ...
  private void cmdNoBodySurvey_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass202_0 == null)
        return;
      this.gclass202_0.gclass21_0.method_259(this.gclass202_0.gclass200_0);
  ...
  private void method_8(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass202_0 == null)
        return;
      this.gclass202_0.gclass200_0.method_13();
      this.method_12();
      if (this.gclass1_0 == null)
        return;
      this.gclass1_0.method_68(this.lstvMinerals, this.gclass21_0);
  ...
  private void cmdAddJumpPoint_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass202_0 == null)
        return;
      this.gclass202_0.gclass200_0.method_14(false);
      this.gclass202_0.method_39(this.lstvJP);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3097);
    }
  }
  ...
  private void lstvJP_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass202_0 == null || this.lstvJP.SelectedItems.Count <= 0 || this.lstvJP.SelectedItems[0].Tag == null)
        return;
      this.gclass120_0 = (GClass120) this.lstvJP.SelectedItems[0].Tag;
      if (this.gclass120_0.method_0(this.gclass202_0.gclass21_0))
      {
        this.cmdExploreJP.Visible = false;
  ...
  private void cmdDeleteJP_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass120_0 == null || MessageBox.Show(" Are you sure you want to delete the selected jump point?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
        return;
      this.gclass202_0.gclass200_0.method_15(this.gclass120_0);
      this.gclass202_0.method_39(this.lstvJP);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3099);
    }
  }
  ...
  private void cmdRandomRuin_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass1_0 == null || this.gclass1_0.auroraSystemBodyType_0 == AuroraSystemBodyType.GasGiant || this.gclass1_0.auroraSystemBodyType_0 == AuroraSystemBodyType.Superjovian)
        return;
      if (this.gclass1_0.gclass174_0 != null)
      {
        int num = (int) MessageBox.Show("A ruin is already in place on this body and will be deleted");
        this.gclass1_0.gclass174_0 = (GClass174) null;
        this.gclass1_0.int_8 = 0;
        this.gclass1_0.int_10 = 0;
        if (this.gclass1_0.genum5_0 == GEnum5.const_0)
          this.gclass1_0.genum5_0 = GEnum5.const_1;
        this.gclass1_0.int_9 = 0;
        this.gclass1_0.gclass171_0 = (GClass171) null;
        if (this.gclass1_0.gclass220_0 != null)
        {
          this.gclass0_0.dictionary_27.Remove(this.gclass1_0.gclass220_0.int_0);
          this.gclass1_0.gclass220_0 = (GClass220) null;
        }
      }
      else
      {
        ...
        foreach (GClass174 gclass174 in this.gclass0_0.dictionary_38.Values)
          this.gclass0_0.list_32.Add(gclass174.string_0);
        int num = (int) new UserSelection(this.gclass0_0).ShowDialog();
        if (this.gclass0_0.bool_21)
          return;
        if (this.gclass0_0.string_4 == "Random Ruin")
          this.gclass0_0.method_676(this.gclass1_0, (GClass174) null, true);
        else
          this.gclass0_0.method_676(this.gclass1_0, this.gclass0_0.dictionary_38.Values.FirstOrDefault<GClass174>((Func<GClass174, bool>) (gclass174_0 => gclass174_0.string_0 == this.gclass0_0.string_4)), true);
      }
      this.method_12();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3100);
    }
  }
  ...
  private void cmdExploreJP_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass120_0 == null)
        return;
      this.gclass202_0 = this.gclass0_0.method_638(this.gclass120_0, this.gclass202_0, (List<GClass200>) null, false, false);
      this.method_5();
  ...
  private void cmdEnterJP_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass120_0 == null || this.gclass21_0 == null || !this.gclass21_0.dictionary_0.ContainsKey(this.gclass120_0.gclass120_0.gclass200_0.int_0))
        return;
      this.cboSystems.SelectedItem = (object) this.gclass21_0.dictionary_0[this.gclass120_0.gclass120_0.gclass200_0.int_0];
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3102);
    }
  }
  ...
  private void cmdCreateSystem_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass21_0 == null)
        return;
      this.gclass0_0.gclass198_0 = (GClass198) null;
      this.gclass0_0.bool_3 = false;
      if (this.gclass0_0.int_99 == 1)
      {
  ...
  private void cmdJG_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass120_0 == null)
        return;
      this.gclass120_0.int_2 = 1000;
      this.gclass202_0.method_39(this.lstvJP);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3104);
    }
  }
  ...
  private void cmdDeleteJG_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass120_0 == null)
        return;
      this.gclass120_0.int_2 = 0;
      this.gclass202_0.method_39(this.lstvJP);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3105);
    }
  }
  ...
  private void cmdChangeJPLocation_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass120_0 == null)
        return;
      string str1 = GClass226.smethod_43(this.gclass120_0.double_0 * GClass226.double_14 / 1000000.0);
      string str2 = GClass226.smethod_37(this.gclass120_0.int_1);
      ...
      if (this.gclass0_0.string_4 != str1)
        this.gclass120_0.double_0 = Convert.ToDouble(this.gclass0_0.string_4) / 150.0;
      if (this.gclass0_0.string_5 != str2)
        this.gclass120_0.int_1 = Convert.ToInt32(this.gclass0_0.string_5);
      double num2 = 40.0 * this.gclass202_0.gclass200_0.method_12();
      if (this.gclass120_0.double_0 > num2)
        this.gclass120_0.double_0 = num2;
      GClass221 gclass221 = this.gclass0_0.method_592(0.0, 0.0, this.gclass120_0.double_0 * GClass226.double_14, (double) this.gclass120_0.int_1);
      this.gclass120_0.double_1 = gclass221.double_0;
      this.gclass120_0.double_2 = gclass221.double_1;
      this.gclass202_0.method_39(this.lstvJP);
      foreach (TacticalMap tacticalMap in Application.OpenForms.OfType<TacticalMap>())
  ...
  private void cmdCreateRace_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      GClass21 gclass21 = this.gclass0_0.method_536(this.gclass1_0, 0, GEnum82.const_0, true, false, false, false, GEnum6.const_0, 0, true, (GClass143) null, 0);
      if (gclass21 == null)
      {
  ...
  private void lstvSB_DrawColumnHeader(object sender, DrawListViewColumnHeaderEventArgs e)
  {
    try
    {
      Brush brush1 = (Brush) new SolidBrush(GClass226.color_19);
      Brush brush2 = (Brush) new SolidBrush(GClass226.color_16);
      e.Graphics.FillRectangle(brush1, e.Bounds);
      e.Graphics.DrawString(e.Header.Text, e.Font, brush2, (RectangleF) e.Bounds);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3109);
    }
  }
  ...
  private void cmdRenameSystemAll_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      if (!(this.gclass0_0.string_4 != this.gclass202_0.Name) || this.gclass0_0.bool_21)
        return;
      foreach (GClass202 gclass202 in this.gclass0_0.dictionary_36.Values.SelectMany<GClass21, GClass202>((Func<GClass21, IEnumerable<GClass202>>) (gclass21_0 => (IEnumerable<GClass202>) gclass21_0.dictionary_0.Values)).Where<GClass202>((Func<GClass202, bool>) (gclass202_1 => gclass202_1.gclass200_0 == this.gclass202_0.gclass200_0)).ToList<GClass202>())
        gclass202.Name = this.gclass0_0.string_4;
      this.method_5();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3112);
    }
  }
  ...
  private void cmdRenameBodyAll_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      if (!(this.gclass0_0.string_4 != str) || this.gclass0_0.bool_21)
        return;
      foreach (GClass21 gclass21_0 in this.gclass0_0.dictionary_36.Values.SelectMany<GClass21, GClass202>((Func<GClass21, IEnumerable<GClass202>>) (gclass21_0 => (IEnumerable<GClass202>) gclass21_0.dictionary_0.Values)).Where<GClass202>((Func<GClass202, bool>) (gclass202_1 => gclass202_1.gclass200_0 == this.gclass202_0.gclass200_0)).Select<GClass202, GClass21>((Func<GClass202, GClass21>) (gclass202_0 => gclass202_0.gclass21_0)).ToList<GClass21>())
        this.gclass1_0.method_80(gclass21_0, this.gclass0_0.string_4);
      this.lstvSB.SelectedItems[0].SubItems[0].Text = this.gclass0_0.string_4;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3113);
    }
  }
  ...
  private void cmdSwarm_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass202_0 == null)
        return;
      GClass1 gclass1_1_1 = this.gclass0_0.dictionary_11.Values.Where<GClass1>((Func<GClass1, bool>) (gclass1_1 => gclass1_1.gclass200_0 == this.gclass202_0.gclass200_0)).Where<GClass1>((Func<GClass1, bool>) (gclass1_0 => gclass1_0.method_17() > 4.0)).Where<GClass1>((Func<GClass1, bool>) (gclass1_0 => gclass1_0.method_16(50, false))).OrderByDescending<GClass1, double>((Func<GClass1, double>) (gclass1_0 => gclass1_0.method_17())).FirstOrDefault<GClass1>() ?? this.gclass0_0.dictionary_11.Values.Where<GClass1>((Func<GClass1, bool>) (gclass1_1 => gclass1_1.gclass200_0 == this.gclass202_0.gclass200_0)).OrderBy<GClass1, int>((Func<GClass1, int>) (gclass1_0 => gclass1_0.int_3)).FirstOrDefault<GClass1>();
      if (gclass1_1_1 == null)
      {
  ...
  private void cmdNameSolBodies_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        foreach (GClass1 gclass1 in this.gclass0_0.dictionary_11.Values.Where<GClass1>((Func<GClass1, bool>) (gclass1_0 => gclass1_0.gclass200_0.bool_0)).ToList<GClass1>())
        {
  ...
  private void cmdPotentialColonies_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      this.gclass1_0 = (GClass1) null;
      this.method_12();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3117);
    }
  }
  ...
  private void cmdChangeStar_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass202_0 == null || this.gclass197_0 == null)
        return;
      int num = (int) new StarSetup(this.gclass0_0, this.gclass197_0, this.gclass202_0.gclass200_0).ShowDialog();
      if (this.gclass0_0.bool_21)
        return;
      this.method_6();
  ...
  private void cmdAddNewStar_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass202_0 == null)
        return;
      int num = (int) new StarSetup(this.gclass0_0, (GClass197) null, this.gclass202_0.gclass200_0).ShowDialog();
      if (this.gclass0_0.bool_21)
        return;
      this.method_6();
      this.gclass0_0.tacticalMap_0.method_10();
  ...
  private void cmdModifyBody_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass202_0 == null || this.gclass197_0 == null || this.gclass1_0 == null)
        return;
      int num = (int) new SystemBodySetup(this.gclass0_0, this.gclass1_0, this.gclass194_0, this.gclass21_0).ShowDialog();
  ...
  private void cmdDeleteSystemBody_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass202_0 == null || this.gclass1_0 == null || MessageBox.Show($" Are you sure you want to delete {this.gclass1_0.method_78(this.gclass21_0)}?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes || MessageBox.Show(" Are you really sure? This will delete all populations on the system body or on any orbiting moons", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
        return;
  ...
  private void cmdAddLGP_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass202_0 == null || this.gclass197_0 == null || this.gclass1_0 == null || this.gclass0_0.dictionary_14.Values.FirstOrDefault<GClass212>((Func<GClass212, bool>) (gclass212_0 => gclass212_0.gclass1_0 == this.gclass1_0)) != null)
        return;
      this.gclass0_0.method_666(this.gclass1_0, false);
      if (this.gclass0_0.bool_21)
        return;
      this.method_12();
      this.gclass0_0.tacticalMap_0.method_10();
  ...
  private void cmdDeleteBelt_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass202_0 == null || this.gclass1_0 == null)
        return;
      if (this.gclass1_0.genum12_0 != GEnum12.const_3)
      {
        int num = (int) MessageBox.Show("Please select an asteroid");
      }
      else
      {
        if (this.gclass1_0.int_3 == 100)
        {
          if (MessageBox.Show($" Are you sure you want to delete {this.gclass1_0.method_78(this.gclass21_0)} and all asteroids in the same belt?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes || MessageBox.Show(" Are you really sure? This will delete all populations in the asteroid belt", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
            return;
          foreach (GClass1 gclass1_1 in this.gclass0_0.dictionary_11.Values.Where<GClass1>((Func<GClass1, bool>) (gclass1_1 => gclass1_1.gclass197_0 == this.gclass1_0.gclass197_0 && gclass1_1.int_3 == 100 && gclass1_1.int_6 == this.gclass1_0.int_6)).ToList<GClass1>())
            this.gclass0_0.method_547(gclass1_1);
        }
        else if (this.gclass1_0.int_3 == 101)
        {
          if (MessageBox.Show($" Are you sure you want to delete {this.gclass1_0.method_78(this.gclass21_0)} and all other trojan asteroids for the same planet?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes || MessageBox.Show(" Are you really sure? This will delete all populations on the trojan asteroids", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
            return;
          foreach (GClass1 gclass1_1 in this.gclass0_0.dictionary_11.Values.Where<GClass1>((Func<GClass1, bool>) (gclass1_1 => gclass1_1.gclass197_0 == this.gclass1_0.gclass197_0 && gclass1_1.int_3 == 101 && gclass1_1.gclass1_0 == this.gclass1_0.gclass1_0)).ToList<GClass1>())
            this.gclass0_0.method_547(gclass1_1);
        }
        this.method_12();
        this.gclass0_0.tacticalMap_0.method_10();
  ...
  private void cmdDeleteLagrange_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass202_0 == null || this.gclass1_0 == null)
        return;
      var cgc212 = this.gclass0_0.dictionary_14.Values.FirstOrDefault<GClass212>((Func<GClass212, bool>) (gclass212_0 => gclass212_0.gclass1_0 == this.gclass1_0));
      if (cgc212 == null)
      {
      ...
      {
        if (MessageBox.Show($" Are you sure you want to delete the Lagrange Point for {this.gclass1_0.method_78(this.gclass21_0)}?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
          return;
        foreach (GClass85 gclass85 in this.gclass0_0.dictionary_1.Values
                   .SelectMany<GClass85, GClass139>((Func<GClass85, IEnumerable<GClass139>>) (gclass85_0 => (IEnumerable<GClass139>) gclass85_0.dictionary_0.Values))
                   .Where<GClass139>(gc139 => gc139.genum13_0 == GEnum13.const_8 && gc139.int_2 == cgc212.int_0)
                   .Select<GClass139, GClass85>((Func<GClass139, GClass85>) (gclass139_0 => gclass139_0.gclass85_0)).ToList<GClass85>())
        {
        ...
        this.gclass202_0.gclass200_0.method_28();
        this.method_12();
        this.gclass0_0.tacticalMap_0.method_10();
      }
    }
  ...
  private void cmdRemoveMinerals_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      this.gclass1_0.auroraGroundMineralSurvey_0 = AuroraGroundMineralSurvey.Completed;
      this.gclass1_0.method_68(this.lstvMinerals, this.gclass21_0);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3132);
    }
  }
  ...
  private void cmdNewMinerals_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass202_0 == null || this.gclass1_0 == null || this.gclass21_0 == null || MessageBox.Show($" Are you sure you want to remove and regenerate the minerals on {this.gclass1_0.method_78(this.gclass21_0)}?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
        return;
      ...
      {
        if (this.gclass1_0.auroraSystemBodyType_0 == AuroraSystemBodyType.Comet)
          this.gclass0_0.method_670(this.gclass1_0);
        else
          this.gclass0_0.method_672(this.gclass1_0, (GClass21) null);
      }
      else
      {
  ...
  private void cmdBanBody_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass202_0 == null || this.gclass1_0 == null || this.gclass21_0 == null || this.lstvSB.SelectedItems.Count == 0)
        return;
      if (this.gclass1_0.genum12_0 == GEnum12.const_1)
      {
        List<GClass1> list = this.gclass0_0.dictionary_11.Values.Where<GClass1>((Func<GClass1, bool>) (gclass1_1 => gclass1_1.gclass1_0 == this.gclass1_0 && gclass1_1.genum12_0 == GEnum12.const_2)).ToList<GClass1>();
        if (list.Count == 0)
          this.method_10();
        else if (!this.gclass21_0.list_9.Contains(this.gclass1_0))
        {
          ...
          {
            if (!this.gclass21_0.list_9.Contains(gclass1))
              this.gclass21_0.list_9.Add(gclass1);
          }
          this.method_12();
        }
        else
        {
          ...
          {
            if (this.gclass21_0.list_9.Contains(gclass1))
              this.gclass21_0.list_9.Remove(gclass1);
          }
          this.method_12();
        }
      }
  ...
  private void method_10()
  {
    try
    {
      if (this.gclass21_0.list_9.Contains(this.gclass1_0))
        this.gclass21_0.list_9.Remove(this.gclass1_0);
      else
        this.gclass21_0.list_9.Add(this.gclass1_0);
      string str = this.gclass1_0.method_78(this.gclass21_0);
      if (this.gclass21_0.list_9.Contains(this.gclass1_0))
        str += " (B)";
  ...
  private void cmdRedoJP_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass202_0 == null || this.gclass1_0 == null || this.gclass21_0 == null || MessageBox.Show($" Are you sure you want to remove and regenerate the jump points in {this.gclass202_0.Name}?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
        return;
      foreach (GClass120 gclass120_1 in this.gclass0_0.dictionary_12.Values.Where<GClass120>((Func<GClass120, bool>) (gclass120_1 => gclass120_1.gclass200_0 == this.gclass202_0.gclass200_0)).ToList<GClass120>())
        this.gclass202_0.gclass200_0.method_15(gclass120_1);
      this.gclass0_0.string_3 = "Min Jump Points";
      this.gclass0_0.string_4 = "0";
      int num = (int) new MessageEntry(this.gclass0_0).ShowDialog();
      int int_136 = (int) Math.Floor(GClass226.smethod_2(this.gclass0_0.string_4, 0M));
      if (int_136 < 0)
        int_136 = 0;
      this.gclass0_0.method_690(this.gclass202_0.gclass200_0, int_136, false, this.gclass202_0.gclass200_0.bool_0);
      this.gclass202_0.method_39(this.lstvJP);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3428);
    }
  }
  ...
  private void cmdRedoAllMinerals_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass202_0 == null || this.gclass21_0 == null || MessageBox.Show($"Are you sure you want to remove and regenerate the minerals on all system bodies in {this.gclass202_0.Name}, except for those with existing colonies?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
        return;
      List<GClass1> list1 = this.gclass0_0.dictionary_22.Values.Where<GClass146>((Func<GClass146, bool>) (gclass146_0 => gclass146_0.gclass202_0.gclass200_0 == this.gclass202_0.gclass200_0)).Select<GClass146, GClass1>((Func<GClass146, GClass1>) (gclass146_0 => gclass146_0.gclass1_0)).ToList<GClass1>();
      List<GClass1> list2 = this.gclass0_0.dictionary_11.Values.Where<GClass1>((Func<GClass1, bool>) (gclass1_1 => gclass1_1.gclass200_0 == this.gclass202_0.gclass200_0)).Except<GClass1>((IEnumerable<GClass1>) list1).ToList<GClass1>();
      foreach (GClass1 gclass1_1 in list2)
      {
        gclass1_1.dictionary_0.Clear();
        gclass1_1.auroraGroundMineralSurvey_0 = AuroraGroundMineralSurvey.Completed;
        if (this.gclass1_0.gclass174_0 != null)
        {
          this.gclass1_0.gclass174_0 = (GClass174) null;
          this.gclass1_0.int_8 = 0;
      ...
      if (this.gclass202_0.gclass200_0.bool_0)
      {
        foreach (GClass1 gclass1_1 in list2)
  ...
  private void cmdNoGravSurvey_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      for (int key = 1; key < 31 /*0x1F*/; ++key)
        this.gclass202_0.gclass200_0.dictionary_0[key].list_0.Remove(this.gclass21_0.RaceID);
      this.gclass202_0.method_40(this.lblAge, this.lblDiscovered, this.lblJSP, this.lblJPSurvey, this.lblSBSurvey);
      this.method_12();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3430);
    }
  }
  ...
  private void cmdRestrictJP_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass21_0 == null || this.gclass202_0 == null || this.gclass197_0 == null || this.gclass120_0 == null)
        return;
      if (this.gclass120_0.dictionary_0[this.gclass21_0.RaceID].int_4 == 1)
      {
        this.gclass120_0.dictionary_0[this.gclass21_0.RaceID].int_4 = 0;
        if (this.gclass120_0.gclass120_0 != null && this.gclass120_0.dictionary_0[this.gclass21_0.RaceID].int_1 == 1)
          this.gclass120_0.gclass120_0.dictionary_0[this.gclass21_0.RaceID].int_4 = 0;
      }
      else if (MessageBox.Show($" Are you sure you want to restrict {this.gclass120_0.method_7(this.gclass202_0)} to military traffic? Any civilian freighters scheduled to enter this jump point will abandon their cargo and seek new trade runs. Colony ships will be diverted.", "Confirmation Required", MessageBoxButtons.YesNo) == DialogResult.Yes)
      {
        this.gclass120_0.dictionary_0[this.gclass21_0.RaceID].int_4 = 1;
        this.gclass21_0.method_97(this.gclass120_0);
        if (this.gclass120_0.gclass120_0 != null && this.gclass120_0.dictionary_0[this.gclass21_0.RaceID].int_1 == 1)
        {
          this.gclass120_0.gclass120_0.dictionary_0[this.gclass21_0.RaceID].int_4 = 1;
          this.gclass21_0.method_97(this.gclass120_0.gclass120_0);
        }
      }
      this.gclass202_0.method_39(this.lstvJP);
    }
  ...
  private void method_12()
  {
    try
    {
      if (this.gclass202_0 == null || this.lstvStars.SelectedItems.Count <= 0)
        return;
      this.gclass197_0 = (GClass197) this.lstvStars.SelectedItems[0].Tag;
      if (this.gclass197_0 == null)
        return;
      this.genum1_0 = !this.rdoAllMoons.Checked ? (!this.rdoHideMoons.Checked ? GEnum1.const_1 : GEnum1.const_2) : GEnum1.const_0;
      this.genum1_1 = !this.rdoAllAsteroids.Checked ? (!this.rdoHideAsteroids.Checked ? GEnum1.const_1 : GEnum1.const_2) : GEnum1.const_0;
      this.genum1_2 = !this.rdoAllComets.Checked ? (!this.rdoHideComets.Checked ? GEnum1.const_1 : GEnum1.const_2) : GEnum1.const_0;
      int index = -1;
      ...
      GClass208 gclass208_1 = GClass226.smethod_4(this.txtMaxColonyCost.Text);
      if (gclass208_1.bool_0)
        decimal_29 = gclass208_1.decimal_0;
      GClass208 gclass208_2 = GClass226.smethod_4(this.txtMinPopCapacity.Text);
      if (gclass208_2.bool_0)
        decimal_30 = gclass208_2.decimal_0;
      this.lstvSB.Visible = false;
      this.gclass1_0 = this.gclass21_0.method_110(this.lstvSB, this.gclass197_0, this.genum1_0, this.genum1_1, this.genum1_2, this.chkMinDep.CheckState, this.chkUnsurveyed.CheckState, this.chkTeamSurvey.CheckState, this.chkMaxCC.CheckState, this.chkOrbital.CheckState, this.gclass194_0, this.bool_2, this.chkAlien.CheckState, this.chkAcceptableGravity.CheckState, this.chkExcludeGasGiants.CheckState, this.chkOxygenPresent.CheckState, this.chkWaterPresent.CheckState, this.chkHydroAbove20.CheckState, this.chkBelowMaxCC.CheckState, this.chkAboveMinPop.CheckState, this.chkMineralsPresent.CheckState, decimal_29, decimal_30, (GEnum59) this.cboSort1.SelectedIndex, (GEnum59) this.cboSort2.SelectedIndex);
      if (this.gclass1_0 == null)
      {
        this.lstvMinerals.Items.Clear();
        this.lstvAtmosphere.Items.Clear();
  ...
  private void InitializeComponent()
  {
    ...
    this.lstvStars.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvStars.SelectedIndexChanged += new EventHandler(this.chkMaxCC_CheckedChanged);
    ...
    this.lstvSB.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.rdoAllMoons.CheckedChanged += new EventHandler(this.chkMaxCC_CheckedChanged);
    ...
    this.rdoMineralMoons.CheckedChanged += new EventHandler(this.chkMaxCC_CheckedChanged);
    ...
    this.rdoHideMoons.CheckedChanged += new EventHandler(this.chkMaxCC_CheckedChanged);
    ...
    this.rdoAllAsteroids.CheckedChanged += new EventHandler(this.chkMaxCC_CheckedChanged);
    ...
    this.rdoMineralAsteroids.CheckedChanged += new EventHandler(this.chkMaxCC_CheckedChanged);
    ...
    this.rdoHideAsteroids.CheckedChanged += new EventHandler(this.chkMaxCC_CheckedChanged);
    ...
    this.rdoAllComets.CheckedChanged += new EventHandler(this.chkMaxCC_CheckedChanged);
    ...
    this.rdoCometMinerals.CheckedChanged += new EventHandler(this.chkMaxCC_CheckedChanged);
    ...
    this.rdoHideComets.CheckedChanged += new EventHandler(this.chkMaxCC_CheckedChanged);
    this.lblAge.AutoSize = true;
    this.lblAge.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.lblDiscovered.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.label9.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.lblJSP.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.lblJPSurvey.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.lblSBSurvey.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.flpColonyCosts.Controls.Add((Control) this.flowLayoutPanel11);
    this.flpColonyCosts.Controls.Add((Control) this.flowLayoutPanel12);
    ...
    this.flowLayoutPanel11.Controls.Add((Control) this.label32);
    this.flowLayoutPanel11.Controls.Add((Control) this.label33);
    ...
    this.label30.Location = new Point(3, (int) sbyte.MaxValue);
    ...
    this.flowLayoutPanel12.Controls.Add((Control) this.lblPerihelionCC);
    this.flowLayoutPanel12.Controls.Add((Control) this.lblAphelionCC);
    ...
    this.lblDangerous.Click += new EventHandler(this.lblDangerous_Click);
    ...
    this.cmdRenameSystem.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvJP.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdRenameBody.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdAddColony.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDeleteSystem.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.flpSM.Controls.Add((Control) this.cmdCreateHabitableSystem);
    ...
    this.cmdCreateRace.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdSwarm.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdCreateSystem.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdCreateHabitableSystem.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdCreateHabitableSystem.Tag = (object) "1200";
    this.cmdCreateHabitableSystem.Text = "Create Habitable";
    this.cmdCreateHabitableSystem.UseVisualStyleBackColor = false;
    this.cmdCreateHabitableSystem.Click += new EventHandler(this.cmdCreateHabitableSystem_Click);
    this.cmdAddNewStar.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdAddNewStar.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdChangeStar.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdAddPlanet.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdModifyBody.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdAddMoons.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdAddLGP.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDeleteStar.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDeleteSystemBody.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDeleteBelt.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDeleteBelt.Click += new EventHandler(this.cmdDeleteBelt_Click);
    this.cmdDeleteLagrange.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdDeleteLagrange.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdJPSurvey.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdAllBodySurvey.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdNoBodySurvey.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdBodySurvey.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdHWMinerals.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdAddJumpPoint.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDeleteJP.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdRandomRuin.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.chkMinDep.CheckedChanged += new EventHandler(this.chkMaxCC_CheckedChanged);
    ...
    this.chkUnsurveyed.CheckedChanged += new EventHandler(this.chkMaxCC_CheckedChanged);
    ...
    this.chkTeamSurvey.CheckedChanged += new EventHandler(this.chkMaxCC_CheckedChanged);
    ...
    this.chkOrbital.CheckedChanged += new EventHandler(this.chkMaxCC_CheckedChanged);
    ...
    this.chkMaxCC.CheckedChanged += new EventHandler(this.chkMaxCC_CheckedChanged);
    this.cmdExploreJP.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdExploreJP.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.flpButtonRow.Controls.Add((Control) this.cmdRenameSystem);
    this.flpButtonRow.Controls.Add((Control) this.cmdSelectName);
    this.flpButtonRow.Controls.Add((Control) this.cmdRenameBody);
    this.flpButtonRow.Controls.Add((Control) this.cmdRenameSystemAll);
    this.flpButtonRow.Controls.Add((Control) this.cmdRenameBodyAll);
    this.flpButtonRow.Controls.Add((Control) this.cmdAddColony);
    this.flpButtonRow.Controls.Add((Control) this.cmdBanBody);
    this.flpButtonRow.Controls.Add((Control) this.cmdPotentialColonies);
    this.flpButtonRow.Controls.Add((Control) this.cmdRestrictJP);
    this.flpButtonRow.Controls.Add((Control) this.cmdWideView);
    ...
    this.cmdRenameSystemAll.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdRenameSystemAll.Click += new EventHandler(this.cmdRenameSystemAll_Click);
    this.cmdRenameBodyAll.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdRenameBodyAll.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdBanBody.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdPotentialColonies.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdRestrictJP.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdRestrictJP.Tag = (object) "1200";
    this.cmdRestrictJP.Text = "Restrict JP";
    this.cmdRestrictJP.UseVisualStyleBackColor = false;
    this.cmdRestrictJP.Click += new EventHandler(this.cmdRestrictJP_Click);
    this.cmdWideView.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdWideView.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdWideView.Tag = (object) "1200";
    this.cmdWideView.Text = "Wide View";
    this.cmdWideView.UseVisualStyleBackColor = false;
    this.cmdWideView.Click += new EventHandler(this.cmdWideView_Click);
    this.cmdNameSolBodies.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdNameSolBodies.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdEnterJP.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdMinText.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdJG.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.flpDisplaySection.Controls.Add((Control) this.lstvJP);
    this.flpDisplaySection.Controls.Add((Control) this.flpJPs);
    this.flpDisplaySection.Controls.Add((Control) this.flowLayoutPanel15);
    this.flpDisplaySection.Controls.Add((Control) this.flpMinButtons);
    this.flpDisplaySection.Controls.Add((Control) this.flpColonyCosts);
    this.flpDisplaySection.Controls.Add((Control) this.lstvAtmosphere);
    this.flpDisplaySection.Controls.Add((Control) this.flpSM);
    this.flpDisplaySection.Controls.Add((Control) this.lstvColonyCosts);
    ...
    this.flpDisplaySection.Paint += new PaintEventHandler(this.flpDisplaySection_Paint);
    this.flpJPs.BorderStyle = BorderStyle.FixedSingle;
    this.flpJPs.Controls.Add((Control) this.cmdEnterJP);
    ...
    this.cmdChangeJPLocation.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDeleteJG.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdNewMinerals.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdSpecify.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdRemoveMinerals.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvColonyCosts.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvColonyCosts.SelectedIndexChanged += new EventHandler(this.lstvColonyCosts_SelectedIndexChanged);
    ...
    this.txtAmount1.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtAmount2.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtAmount3.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtAmount4.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtAmount5.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtAmount6.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtAmount7.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtAmount8.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtAmount9.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtAmount10.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtAmount11.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtAcc1.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtAcc2.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtAcc3.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtAcc4.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtAcc5.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtAcc6.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtAcc7.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtAcc8.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtAcc9.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtAcc10.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtAcc11.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.chkAlien.CheckedChanged += new EventHandler(this.chkMineralsPresent_CheckedChanged);
    this.txtMaxColonyCost.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.txtMaxColonyCost.BorderStyle = BorderStyle.None;
    this.txtMaxColonyCost.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.chkWaterPresent.CheckedChanged += new EventHandler(this.chkMineralsPresent_CheckedChanged);
    ...
    this.chkHydroAbove20.CheckedChanged += new EventHandler(this.chkMineralsPresent_CheckedChanged);
    ...
    this.chkOxygenPresent.CheckedChanged += new EventHandler(this.chkMineralsPresent_CheckedChanged);
    this.txtMinPopCapacity.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.txtMinPopCapacity.BorderStyle = BorderStyle.None;
    this.txtMinPopCapacity.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtMinPopCapacity.TextChanged += new EventHandler(this.txtMinPopCapacity_TextChanged);
    ...
    this.chkAcceptableGravity.CheckedChanged += new EventHandler(this.chkMineralsPresent_CheckedChanged);
    ...
    this.chkExcludeGasGiants.CheckedChanged += new EventHandler(this.chkMineralsPresent_CheckedChanged);
    ...
    this.chkBelowMaxCC.CheckedChanged += new EventHandler(this.chkMineralsPresent_CheckedChanged);
    ...
    this.chkAboveMinPop.CheckedChanged += new EventHandler(this.chkMineralsPresent_CheckedChanged);
    ...
    this.chkMineralsPresent.CheckedChanged += new EventHandler(this.chkMineralsPresent_CheckedChanged);
    ...
    this.cboSort1.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboSort1.SelectedIndexChanged += new EventHandler(this.cboSort2_SelectedIndexChanged);
    this.cboSort2.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cboSort2.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboSort2.SelectedIndexChanged += new EventHandler(this.cboSort2_SelectedIndexChanged);
    this.cmdRedoJP.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdRedoJP.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdRedoJP.Tag = (object) "1200";
    this.cmdRedoJP.Text = "Regen JP";
    this.cmdRedoJP.UseVisualStyleBackColor = false;
    this.cmdRedoJP.Click += new EventHandler(this.cmdRedoJP_Click);
    this.cmdRedoAllMinerals.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdRedoAllMinerals.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdRedoAllMinerals.Tag = (object) "1200";
    this.cmdRedoAllMinerals.Text = "Regen Min";
    this.cmdRedoAllMinerals.UseVisualStyleBackColor = false;
    this.cmdRedoAllMinerals.Click += new EventHandler(this.cmdRedoAllMinerals_Click);
    this.flpSMButtons.Controls.Add((Control) this.cmdJPSurvey);
    this.flpSMButtons.Controls.Add((Control) this.cmdNoGravSurvey);
    this.flpSMButtons.Controls.Add((Control) this.cmdAllBodySurvey);
    this.flpSMButtons.Controls.Add((Control) this.cmdNoBodySurvey);
    this.flpSMButtons.Controls.Add((Control) this.cmdRedoJP);
    this.flpSMButtons.Controls.Add((Control) this.cmdRedoAllMinerals);
    this.flpSMButtons.Controls.Add((Control) this.cmdNameSolBodies);
    this.flpSMButtons.Controls.Add((Control) this.cmdDeleteSystem);
    ...
    this.cmdNoGravSurvey.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdNoGravSurvey.Tag = (object) "1200";
    this.cmdNoGravSurvey.Text = "No Grav Survey";
    this.cmdNoGravSurvey.UseVisualStyleBackColor = false;
    this.cmdNoGravSurvey.Click += new EventHandler(this.cmdNoGravSurvey_Click);
    ...
    this.Controls.Add((Control) this.pbSpecies);
    this.Controls.Add((Control) this.flpSMButtons);
    this.Controls.Add((Control) this.flpSpecify);
    this.Controls.Add((Control) this.flpAllSystemOptions);
    this.Controls.Add((Control) this.flpDisplaySection);
    this.Controls.Add((Control) this.flpButtonRow);
    ...
    this.KeyDown += new KeyEventHandler(this.SystemView_KeyDown);
