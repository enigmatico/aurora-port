...
public class GClass210
{
    ...
    GClass202 gclass202_0)
  {
    try
    {
      ...
      double num = (double) graphics_0.MeasureString("Aether Gate", font_0).Width / 2.0;
      gclass221.double_0 = gclass222_0.double_2 - num;
      gclass221.double_1 = gclass222_0.double_3 + (double) (GClass226.int_61 + 2);
      graphics_0.DrawString("Aether Gate", font_0, (Brush) solidBrush, (float) gclass221.double_0, (float) gclass221.double_1);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3406);
    }
  }
}
