...
public class RuinRaceData
{
    ...
    public ShipComponent method_0()
    {
        try
        {
            TechData164 gclass164_1 = this.gclass0_0.method_493(TechType.LaserFocalSize, this.Level);
            TechData164 gclass164_2 = this.gclass0_0.method_493(TechType.LaserWavelength, this.Level);
            TechData164 gclass164_3 = this.gclass0_0.method_493(TechType.CapacitorRechargeRate, this.Level);
            TechData164 gclass164_4 = this.gclass0_0.TechDataDictionary[26596];
            TechData164 gclass164_5_1 = this.gclass0_0.TechDataDictionary[55406];
            ...
            TechData164 gclass164_5_2 = this.gclass0_0.method_493(TechType.EnergyWeaponMount, this.Level);
    ...
    public ShipComponent method_1()
    {
        try
        {
            TechData164 gclass164_1 = this.gclass0_0.method_493(TechType.RailgunType, this.Level);
            TechData164 gclass164_2 = this.gclass0_0.method_493(TechType.RailgunVelocity, this.Level);
            TechData164 gclass164_3 = this.gclass0_0.method_493(TechType.CapacitorRechargeRate, this.Level);
    ...
    public ShipComponent method_2()
    {
        try
        {
            TechData164 gclass164_1 = this.gclass0_0.method_493(TechType.ParticleBeamStrength, this.Level);
            TechData164 gclass164_2 = this.gclass0_0.method_493(TechType.MaximumParticleBeamRange, this.Level);
            TechData164 gclass164_4 = this.gclass0_0.method_493(TechType.ParticleLance, this.Level);
            TechData164 gclass164_3 = this.gclass0_0.method_493(TechType.CapacitorRechargeRate, this.Level);
            TechData164 gclass164_5 = this.gclass0_0.TechDataDictionary[55406];
    ...
    public ShipComponent method_3()
    {
        try
        {
            TechData164 gclass164_1 = this.gclass0_0.method_493(TechType.MesonFocalSize, this.Level);
            TechData164 gclass164_2 = this.gclass0_0.method_493(TechType.MesonFocusing, this.Level);
            TechData164 gclass164_3 = this.gclass0_0.method_493(TechType.CapacitorRechargeRate, this.Level);
            TechData164 gclass164_4 = this.gclass0_0.method_493(TechType.MesonArmourRetardation, this.Level);
    ...
    public ShipComponent method_4()
    {
        try
        {
            TechData164 gclass164_1 = this.gclass0_0.method_493(TechType.CarronadeCalibre, this.Level);
            TechData164 gclass164_2 = this.gclass0_0.method_493(TechType.CapacitorRechargeRate, this.Level);
            TechData164 gclass164_3 = this.gclass0_0.TechDataDictionary[55406];
            ShipComponent gclass230 =
    ...
    public ShipComponent method_5()
    {
        try
        {
            TechData164 gclass164_1_1 = this.gclass0_0.method_493(TechType.GaussCannonRateofFire, this.Level);
            TechData164 gclass164_2 = this.gclass0_0.method_493(TechType.GaussCannonVelocity, this.Level);
            TechData164 gclass164_1_2 = this.gclass0_0.method_493(TechType.TurretRotationGear, this.Level);
            TechData164 gclass164_1 = this.gclass0_0.method_493(TechType.BeamFireControlDistanceRating, this.Level);
            TechData164 gclass164_3 = this.gclass0_0.TechDataDictionary[26645];
            TechData164 gclass164_4 = this.gclass0_0.TechDataDictionary[24375];
    ...
    public ShipComponent method_6()
    {
        try
        {
            TechData164 gclass164_1 = this.gclass0_0.method_493(TechType.ShieldType, this.Level);
            TechData164 gclass164_2 = this.gclass0_0.method_493(TechType.ShieldRegenerationRate, this.Level);
            TechData164 gclass164 = this.gclass0_0.method_493(TechType.MaximumShieldGeneratorSize, this.Level);
            ShipComponent gclass230 =
    ...
    public ShipComponent method_7()
    {
        try
        {
            TechData164 gclass164_1 = this.gclass0_0.method_493(TechType.EngineTechnology, this.Level);
            TechData164 gclass164_2 = this.gclass0_0.method_493(TechType.FuelConsumption, this.Level);
            TechData164 gclass164_3 = this.gclass0_0.TechDataDictionary[26091];
    ...
    public ShipComponent method_8()
    {
        try
        {
            TechData164 gclass164_1 = this.gclass0_0.method_493(TechType.EngineTechnology, this.Level);
            TechData164 gclass164_2 = this.gclass0_0.method_493(TechType.FuelConsumption, this.Level);
            TechData164 gclass164_3 = this.gclass0_0.method_493(TechType.MinEngineThrustModifier, this.Level);
            TechData164 gclass164_4 = this.gclass0_0.method_493(TechType.MaximumEngineSize, this.Level);
    ...
    public ShipComponent method_9()
    {
        try
        {
            TechData164 gclass164_1 = this.gclass0_0.method_493(TechType.GaussCannonRateofFire, this.Level);
            TechData164 gclass164_5 = this.gclass0_0.method_493(TechType.TurretRotationGear, this.Level);
            TechData164 gclass164_3 = this.gclass0_0.method_493(TechType.FireControlSpeedRating, this.Level);
            TechData164 gclass164_2 = this.gclass0_0.method_493(TechType.BeamFireControlDistanceRating, this.Level);
            TechData164 gclass164_4 = this.gclass0_0.method_493(TechType.MissileWarheadStrength, this.Level);
            TechData164 gclass164_6 = this.gclass0_0.method_493(TechType.ECCM, this.Level);
    ...
    public ShipComponent method_10()
    {
        try
        {
            TechData164 gclass164_1 = this.gclass0_0.method_493(TechType.JumpDriveEfficiency, this.Level);
            TechData164 gclass164_2 = this.gclass0_0.method_493(TechType.MaxJumpSquadronSize, this.Level);
            TechData164 gclass164_3 = this.gclass0_0.method_493(TechType.MaxSquadronJumpRadius, this.Level);
