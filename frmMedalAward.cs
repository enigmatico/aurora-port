...
public class frmMedalAward : Form
{
    ...
    private void frmMedalAward_FormClosing(object sender, FormClosingEventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 1060);
        }
    }
    ...
    private void frmMedalAward_Load(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 1061);
        }
    }
    ...
    private void cmdAwardMedal_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                this.gclass0_0.gclass42_0 = (FCTRaceMedalRecord)this.lstvMedals.SelectedItems[0].Tag;
                this.Close();
            }
        }
        catch (Exception ex)
    ...
    private void InitializeComponent()
    {
        ...
        this.flpCommandType.Controls.Add(this.chkNavalAdmin);
        this.flpCommandType.Controls.Add(this.chkFleetCommander);
        this.flpCommandType.Controls.Add(this.chkCommander);
        this.flpCommandType.Controls.Add(this.chkExecutiveOfficer);
        this.flpCommandType.Controls.Add(this.chkCAG);
        this.flpCommandType.Controls.Add(this.chkChiefEngineer);
        this.flpCommandType.Controls.Add(this.chkTacticalOfficer);
        this.flpCommandType.Controls.Add(this.chkScienceOfficer);
        this.flpCommandType.Controls.Add(this.chkGround);
        this.flpCommandType.Controls.Add(this.chkSector);
        this.flpCommandType.Controls.Add(this.chkGovenor);
        this.flpCommandType.Controls.Add(this.chkResearch);
        this.flpCommandType.Controls.Add(this.chkAcademy);
        ...
        this.chkExecutiveOfficer.Tag = "8";
        ...
        this.chkTacticalOfficer.Tag = "11";
        ...
        this.lstvMedals.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.Controls.Add(this.lstvMedals);
        this.Controls.Add(this.flpCommandType);
        this.Controls.Add(this.cmdCancel);
        this.Controls.Add(this.cmdAwardMedal);
        ...
        this.FormClosing += this.frmMedalAward_FormClosing;
        this.Load += this.frmMedalAward_Load;
