...
public class GClass211
{
    ...
    GClass202 gclass202_0)
  {
    try
    {
      ...
      float num1 = (float) (GClass226.int_61 * 2);
      float num2 = (float) (this.double_2 / gclass202_0.double_2);
      ...
      graphics_0.FillEllipse((Brush) solidBrush1, (float) x, (float) y, num1, num1);
      float num3 = num1 * 0.1f;
      if ((double) num3 < 2.0)
        num3 = 2f;
      float num4 = num3 / 2f;
      SolidBrush solidBrush2 = new SolidBrush(Color.Black);
      graphics_0.FillEllipse((Brush) solidBrush2, (float) x + num4, (float) y + num4, num1 - num3, num1 - num3);
      solidBrush2.Color = Color.LimeGreen;
      double num5 = (double) graphics_0.MeasureString("Aether Rift", font_0).Width / 2.0;
      gclass221.double_0 = gclass222_0.double_2 - num5;
      gclass221.double_1 = gclass222_0.double_3 + (double) GClass226.int_61;
      graphics_0.DrawString("Aether Rift", font_0, (Brush) solidBrush2, (float) gclass221.double_0, (float) gclass221.double_1);
    }
    catch (Exception ex)
    {
