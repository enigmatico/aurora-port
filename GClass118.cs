...
public class GClass118
{
  ...
  public bool method_0(double double_2, double double_3)
  {
    ...
    try
    {
      ...
      if (this.list_0.Where<GClass221>(new Func<GClass221, bool>(class1071.method_0)).FirstOrDefault<GClass221>() != null)
        return false;
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
  ...
  public bool method_1(double double_2, int int_2)
  {
    ...
    {
      GClass226.smethod_74(ex, 3959);
      return false;
    }
  }

  public GClass118 method_2(GClass21 gclass21_2)
  {
    try
    {
    ...
    {
      GClass226.smethod_74(ex, 1923);
      return (GClass118) null;
    }
  }
  ...
  public string method_3()
  {
    try
    {
      if (this.double_1 <= 100.0)
        return $"{this.string_0}: GPS {GClass226.smethod_38(this.decimal_1 * (Decimal) this.int_1)}";
      return $"{this.string_0}: {GClass226.smethod_44(this.gclass230_0.double_0 / 1000000.0, 0)}m km  RES {GClass226.smethod_37(this.int_1)}";
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 1924);
      return "Unknown";
    }
  }
}
