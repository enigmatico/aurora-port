...
public class FleetWindow : Form
{
  ...
  private sealed class Class1015
  {
    ...
    {
      return this.list_0.Contains(gclass103_0.gclass40_0);
    }
  ...
  private sealed class Class1018
  {
    ...
    internal bool method_0(GClass84 gclass84_0)
    {
      return gclass84_0.gclass85_0 == this.gclass85_0 && gclass84_0.gclass85_1 != null;
    }
  }
  ...
  private sealed class Class1020
  {
    ...
    {
      return gclass85_1.gclass85_1 == this.gclass85_0 && gclass85_1.gclass202_0 == this.gclass85_0.gclass202_0;
    }
  }
  ...
  private sealed class Class1021
  {
    ...
    {
      return gclass40_1.gclass22_0.gclass76_0 == this.gclass40_0.gclass22_0.gclass76_0 && gclass40_1.int_20 == this.int_0;
    }
  }
  ...
  private sealed class Class1022
  {
    ...
    internal bool method_0(GClass84 gclass84_0)
    {
      return gclass84_0.string_0 == this.gclass40_0.gclass70_0.SquadronName;
    }
  }
  ...
  private sealed class Class1029
  {
    ...
    internal bool method_0(GClass83 gclass83_1)
    {
  ...
  private GClass40 gclass40_1;
  private GClass187 gclass187_0;
  ...
  private void FleetWindow_Load(object sender, EventArgs e)
  {
    try
    {
      ...
      this.cboSortType.DataSource = (object) Enum.GetValues(typeof (AuroraLogisticsSortType)).Cast<Enum>().Select<Enum, Class327<string, Enum>>((Func<Enum, Class327<string, Enum>>) (enum_0 => new Class327<string, Enum>((Attribute.GetCustomAttribute((MemberInfo) enum_0.GetType().GetField(enum_0.ToString()), typeof (DescriptionAttribute)) as DescriptionAttribute).Description, enum_0))).OrderBy<Class327<string, Enum>, Enum>((Func<Class327<string, Enum>, Enum>) (class327_0 => class327_0.value)).ToList<Class327<string, Enum>>();
      this.bool_2 = true;
      this.gclass0_0.method_577(this.cboRaces);
      this.gclass0_0.method_532(this.lstvNACTypes);
      this.method_3();
      this.method_2();
      this.chkOrders.CheckState = GClass226.smethod_28(this.gclass0_0.bool_4);
      this.chkOverhauls.CheckState = GClass226.smethod_28(this.gclass0_0.bool_5);
      this.chkShowJD.CheckState = GClass226.smethod_28(this.gclass0_0.bool_6);
      this.gclass0_0.bool_9 = false;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 923);
    }
  }
  ...
  private void method_3()
  {
    ...
    toolTip.SetToolTip((Control) this.cmdCreateSquadron, "Create a squadron below the selected ship");
    ...
    toolTip.SetToolTip((Control) this.cmdActive2, "Activate / Deactivate all active sensors on the selected ship or fleet");
    toolTip.SetToolTip((Control) this.cmdFleetShields, "Raise or lower shields on the selected ship or fleet");
    toolTip.SetToolTip((Control) this.cmdSyncFire, "When synchronous fire is active, the selected ship will not fire unless other ships in the same fleet are ready to fire");
    ...
    toolTip.SetToolTip((Control) this.cmdLaunchAll, "Launch all parasites from the selected fleet, sub-fleet or ship. Any squadrons will appear as sub-fleets");
  }
  ...
  private void method_5()
  {
    try
    {
      ...
      this.gclass0_0.bool_9 = false;
      this.gclass21_0.method_355(this.tvFleetList, (GClass202) null, false, GClass226.smethod_27(this.chkIncludeCivilians.CheckState), this.txtSystemOOB);
      this.gclass21_0.method_350(this.lstvFuel, this.chkExcTanker.CheckState, this.chkExcludeFighter.CheckState, this.chkExcludeFAC.CheckState, this.chkExcludeSY.CheckState, this.chkNonArmed.CheckState, this.chkSupplyShip.CheckState);
      this.gclass21_0.method_352(this.lstvLogisticsReport, selectedIndex, this.chkLogExcTanker.CheckState, this.chkLogExcludeFighter.CheckState, this.chkLogExcludeFAC.CheckState, this.chkLogExcludeSY.CheckState, this.chkLogNonArmed.CheckState, this.chkLogSupplyShip.CheckState);
      this.gclass21_0.method_353(this.lstvCombatRating, this.chkIncludeSG.CheckState, this.rdoMilitary.Checked, this.rdoCommercial.Checked, this.rdoGround.Checked, this.rdoMissiles.Checked, this.rdoSize.Checked, this.rdoDistance.Checked);
      this.gclass21_0.method_351(this.lstvRepair, this.chkExcludeFighterRepair.CheckState, this.chkExcludeFACRepair.CheckState, this.chkExcludeSYRepair.CheckState, this.chkNonArmedRepair.CheckState);
  ...
  private void tvFleetList_DragDrop(object sender, DragEventArgs e)
  {
    try
    {
      ...
      if (data.Equals((object) nodeAt) || nodeAt == null)
        return;
      if (data.Tag is GClass84)
      {
        if (nodeAt.Tag is GClass84)
        {
          // ISSUE: object of a compiler-generated type is created
          // ISSUE: variable of a compiler-generated type
          FleetWindow.Class1025 class1025 = new FleetWindow.Class1025();
          // ISSUE: reference to a compiler-generated field
          class1025.gclass84_0 = (GClass84) data.Tag;
          GClass84 tag = (GClass84) nodeAt.Tag;
          // ISSUE: reference to a compiler-generated field
          if (class1025.gclass84_0.gclass85_0 == tag.gclass85_0)
          {
            // ISSUE: reference to a compiler-generated field
            class1025.gclass84_0.gclass84_0 = tag;
          }
          else
          {
            // ISSUE: reference to a compiler-generated field
            ...
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            if (this.gclass0_0.method_520(class1025.gclass84_0.gclass85_0.double_2, tag.gclass85_0.double_2, class1025.gclass84_0.gclass85_0.double_3, tag.gclass85_0.double_3) && class1025.gclass84_0.gclass85_0.gclass202_0 == tag.gclass85_0.gclass202_0 && class1025.gclass84_0.gclass21_0 == tag.gclass21_0)
            {
              // ISSUE: reference to a compiler-generated method
              List<GClass40> list = this.gclass0_0.dictionary_4.Values.Where<GClass40>(new Func<GClass40, bool>(class1025.method_0)).ToList<GClass40>();
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              class1025.gclass84_0.gclass21_0.method_270(list, class1025.gclass84_0.gclass85_0, tag.gclass85_0, false, false);
              // ISSUE: reference to a compiler-generated field
              class1025.gclass84_0.gclass84_0 = tag;
              // ISSUE: reference to a compiler-generated field
              class1025.gclass84_0.gclass85_0 = tag.gclass85_0;
            }
            else
            {
        ...
        if (nodeAt.Tag is GClass85)
        {
          // ISSUE: object of a compiler-generated type is created
          // ISSUE: variable of a compiler-generated type
          FleetWindow.Class1026 class1026 = new FleetWindow.Class1026();
          // ISSUE: reference to a compiler-generated field
          class1026.gclass84_0 = (GClass84) data.Tag;
          GClass85 tag = (GClass85) nodeAt.Tag;
          // ISSUE: reference to a compiler-generated field
          if (class1026.gclass84_0.gclass85_0 == tag)
          {
            // ISSUE: reference to a compiler-generated field
            class1026.gclass84_0.gclass84_0 = (GClass84) null;
          }
          else
          {
            // ISSUE: reference to a compiler-generated field
            ...
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            if (this.gclass0_0.method_520(class1026.gclass84_0.gclass85_0.double_2, tag.double_2, class1026.gclass84_0.gclass85_0.double_3, tag.double_3) && class1026.gclass84_0.gclass85_0.gclass202_0 == tag.gclass202_0 && class1026.gclass84_0.gclass21_0 == tag.gclass21_0)
            {
              // ISSUE: reference to a compiler-generated method
              List<GClass40> list = this.gclass0_0.dictionary_4.Values.Where<GClass40>(new Func<GClass40, bool>(class1026.method_0)).ToList<GClass40>();
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              class1026.gclass84_0.gclass21_0.method_270(list, class1026.gclass84_0.gclass85_0, tag, false, false);
              // ISSUE: reference to a compiler-generated field
              class1026.gclass84_0.gclass84_0 = (GClass84) null;
              // ISSUE: reference to a compiler-generated field
              class1026.gclass84_0.gclass85_0 = tag;
            }
            else
            {
              int num = (int) MessageBox.Show("Sub-fleets may only be moved within their current fleet (including sub-fleets) or to a fleet or sub-fleet of the same race in the same location as their parent fleet");
        ...
        if (nodeAt.Tag is GClass83 || nodeAt.Tag is GClass40)
        {
          int num = (int) MessageBox.Show("Sub-fleets may only be moved within their current fleet (including sub-fleets) or to a fleet or sub-fleet of the same race in the same location as their parent fleet");
          return;
        }
      }
      if (data.Tag is GClass40)
      {
        if (nodeAt.Tag is GClass84)
        {
          // ISSUE: object of a compiler-generated type is created
          ...
          // ISSUE: reference to a compiler-generated field
          class1027.gclass40_0 = (GClass40) data.Tag;
          GClass84 tag = (GClass84) nodeAt.Tag;
          // ISSUE: reference to a compiler-generated field
          if (class1027.gclass40_0.gclass85_0 == tag.gclass85_0)
          {
            // ISSUE: reference to a compiler-generated field
            class1027.gclass40_0.gclass84_0 = tag;
            // ISSUE: reference to a compiler-generated field
            class1027.gclass40_0.gclass70_0 = (GClass70) null;
            // ISSUE: reference to a compiler-generated field
            class1027.gclass40_0.gclass40_0 = (GClass40) null;
            // ISSUE: reference to a compiler-generated method
            foreach (GClass40 gclass40 in this.gclass0_0.dictionary_4.Values.Where<GClass40>(new Func<GClass40, bool>(class1027.method_0)).ToList<GClass40>())
            {
              // ISSUE: reference to a compiler-generated field
          ...
          else
          {
            ...
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            if (this.gclass0_0.method_520(class1027.gclass40_0.gclass85_0.double_2, tag.gclass85_0.double_2, class1027.gclass40_0.gclass85_0.double_3, tag.gclass85_0.double_3) && class1027.gclass40_0.gclass85_0.gclass202_0 == tag.gclass85_0.gclass202_0 && class1027.gclass40_0.gclass21_0 == tag.gclass21_0)
            {
              // ISSUE: reference to a compiler-generated field
              class1027.gclass40_0.gclass84_0 = tag;
              // ISSUE: reference to a compiler-generated field
              class1027.gclass40_0.gclass40_0 = (GClass40) null;
              // ISSUE: reference to a compiler-generated field
              class1027.gclass40_0.method_185(tag.gclass85_0, true, false, false, true);
            }
            else
            {
        ...
        if (nodeAt.Tag is GClass70)
        {
          GClass40 tag1 = (GClass40) data.Tag;
          GClass70 tag2 = (GClass70) nodeAt.Tag;
          if (this.gclass0_0.method_520(tag1.gclass85_0.double_2, tag2.gclass40_0.gclass85_0.double_2, tag1.gclass85_0.double_3, tag2.gclass40_0.gclass85_0.double_3) && tag1.gclass85_0.gclass202_0 == tag2.gclass40_0.gclass85_0.gclass202_0)
          {
            if (tag1.gclass40_0 != tag2.gclass40_0)
            {
              if (tag2.gclass40_0.method_125() >= tag1.gclass22_0.decimal_14)
              {
                tag1.gclass40_0 = tag2.gclass40_0;
                tag1.gclass40_1 = tag2.gclass40_0;
                tag1.method_185(tag2.gclass40_0.gclass85_0, true, true, false, true);
                tag1.gclass84_0 = tag2.gclass40_0.gclass84_0;
                tag1.method_117(tag1.gclass40_1);
              }
              else
              {
                int num = (int) MessageBox.Show("Ships can only be moved into a squadron if the parent ship has sufficient hangar space");
                return;
              }
            }
            tag1.gclass70_0 = tag2;
            tag1.int_22 = tag1.gclass70_0.int_0;
          }
          else
          {
            int num = (int) MessageBox.Show("Ships can only be moved into a squadron in the same location as their parent fleet");
            return;
          }
        }
        if (nodeAt.Tag is GClass85)
        {
          ...
          // ISSUE: reference to a compiler-generated field
          class1028.gclass40_0 = (GClass40) data.Tag;
          GClass85 tag = (GClass85) nodeAt.Tag;
          // ISSUE: reference to a compiler-generated field
          if (class1028.gclass40_0.gclass85_0 == tag)
          {
            // ISSUE: reference to a compiler-generated field
            class1028.gclass40_0.gclass84_0 = (GClass84) null;
            // ISSUE: reference to a compiler-generated field
            class1028.gclass40_0.gclass40_0 = (GClass40) null;
            // ISSUE: reference to a compiler-generated method
            foreach (GClass40 gclass40 in this.gclass0_0.dictionary_4.Values.Where<GClass40>(new Func<GClass40, bool>(class1028.method_0)).ToList<GClass40>())
          ...
          else
          {
            ...
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            if (class1028.gclass40_0.gclass85_0.method_52(tag.double_2, tag.double_3) && class1028.gclass40_0.gclass85_0.gclass202_0 == tag.gclass202_0 && class1028.gclass40_0.gclass21_0 == tag.gclass21_0)
            {
              // ISSUE: reference to a compiler-generated field
              class1028.gclass40_0.gclass84_0 = (GClass84) null;
              // ISSUE: reference to a compiler-generated field
      ...
      if (data.Tag is GClass70 && nodeAt.Tag is GClass40)
      {
        GClass70 tag3 = (GClass70) data.Tag;
        GClass40 tag4 = (GClass40) nodeAt.Tag;
        if (this.gclass0_0.method_520(tag3.gclass40_0.gclass85_0.double_2, tag4.gclass85_0.double_2, tag3.gclass40_0.gclass85_0.double_3, tag4.gclass85_0.double_3) && tag3.gclass40_0.gclass85_0.gclass202_0 == tag4.gclass85_0.gclass202_0)
        {
          List<GClass40> source = tag3.method_0();
          if (tag4.method_125() >= source.Sum<GClass40>((Func<GClass40, Decimal>) (gclass40_0 => gclass40_0.gclass22_0.decimal_14)))
          {
            ...
            tag3.gclass40_0 = tag4;
          }
          else
          {
            int num = (int) MessageBox.Show("A squadron can only be moved to a ship with sufficient hangar space");
            return;
          }
        }
        else
        {
          int num = (int) MessageBox.Show("Squadrons can only be moved to a ship in the same location as their parent fleet");
          return;
        }
      }
      if (data.Tag is GClass85)
      {
        if (nodeAt.Tag is GClass83)
        {
          GClass85 tag5 = (GClass85) data.Tag;
          GClass83 tag6 = (GClass83) nodeAt.Tag;
          if (tag5.gclass21_0 == tag6.gclass21_0)
          {
            tag5.gclass83_0 = tag6;
            tag6.bool_0 = true;
          }
          else
          {
        ...
        else if (nodeAt.Tag is GClass85)
        {
          GClass85 tag7 = (GClass85) data.Tag;
          GClass85 tag8 = (GClass85) nodeAt.Tag;
          if (tag7.method_53(tag8.double_2, tag8.double_3, tag8.gclass202_0) && tag7.gclass21_0 == tag8.gclass21_0)
          {
            ...
            if (this.lstvShips.SelectedItems.Count > 1)
            {
              ...
              {
                GClass40 tag9 = (GClass40) selectedItem.Tag;
            ...
            else
            {
              ...
              tag7.gclass21_0.genum42_0 = GEnum42.const_2;
              tag7.gclass21_0.int_43 = tag8.int_3;
              tag8.bool_16 = true;
            }
          }
          else
        ...
        else if (nodeAt.Tag is GClass70)
        {
          GClass85 tag10 = (GClass85) data.Tag;
          GClass70 tag11 = (GClass70) nodeAt.Tag;
          if (this.gclass0_0.method_520(tag11.gclass40_0.gclass85_0.double_2, tag10.double_2, tag11.gclass40_0.gclass85_0.double_3, tag10.double_3) && tag11.gclass40_0.gclass85_0.gclass202_0 == tag10.gclass202_0)
          {
            List<GClass40> source = tag10.method_177();
            if (tag11.gclass40_0.method_125() >= source.Sum<GClass40>((Func<GClass40, Decimal>) (gclass40_0 => gclass40_0.gclass22_0.decimal_14)))
            {
              foreach (GClass40 gclass40 in source)
              {
                gclass40.gclass40_0 = tag11.gclass40_0;
                gclass40.gclass40_1 = tag11.gclass40_0;
                gclass40.gclass70_0 = tag11;
                if (gclass40.gclass85_0 != tag11.gclass40_0.gclass85_0)
                  gclass40.method_185(tag11.gclass40_0.gclass85_0, true, true, false, false);
                gclass40.gclass84_0 = tag11.gclass40_0.gclass84_0;
              }
              tag11.gclass40_0.gclass21_0.genum42_0 = GEnum42.const_2;
              tag11.gclass40_0.gclass21_0.int_43 = tag11.int_0;
              tag11.bool_0 = true;
            }
            else
            {
              int num = (int) MessageBox.Show("A fleet can only be moved to a squadron on board a ship with sufficient hangar space");
              return;
            }
          }
          else
        ...
        else if (nodeAt.Tag is GClass84)
        {
          GClass85 tag12 = (GClass85) data.Tag;
          GClass84 tag13 = (GClass84) nodeAt.Tag;
          if (tag13.gclass85_0 == tag12)
          {
            int num = (int) MessageBox.Show("Fleets cannot be moved under their own sub-fleet");
            return;
          }
          if (tag12.method_53(tag13.gclass85_0.double_2, tag13.gclass85_0.double_3, tag13.gclass85_0.gclass202_0) && tag12.gclass21_0 == tag13.gclass85_0.gclass21_0)
          {
            tag13.gclass85_0.method_73(tag12, tag13);
            tag12.gclass21_0.genum42_0 = GEnum42.const_2;
            tag12.gclass21_0.int_43 = tag13.gclass85_0.int_3;
            tag13.gclass85_0.bool_16 = true;
          }
          else
          {
            int num = (int) MessageBox.Show("Fleets may only be moved to a fleet or sub-fleet of the same race in the same location");
      ...
      if (data.Tag is GClass83)
      {
        GClass83 tag = (GClass83) data.Tag;
        if (tag.gclass83_0 == null)
        {
        ...
        if (nodeAt.Tag is GClass83)
        {
          ...
          // ISSUE: reference to a compiler-generated field
          class1029.gclass83_0 = (GClass83) nodeAt.Tag;
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated method
          if (class1029.gclass83_0.gclass40_0 != null && this.gclass0_0.dictionary_0.Values.FirstOrDefault<GClass83>(new Func<GClass83, bool>(class1029.method_0)) != null)
          {
            int num = (int) MessageBox.Show("Ship-based admin commands cannot have subordinate commands");
            return;
          }
          // ISSUE: reference to a compiler-generated field
          if (class1029.gclass83_0.gclass21_0 == tag.gclass21_0)
          {
            // ISSUE: reference to a compiler-generated field
            if (class1029.gclass83_0.gclass83_0 == tag)
            {
              // ISSUE: reference to a compiler-generated field
              class1029.gclass83_0.gclass83_0 = tag.gclass83_0;
              // ISSUE: reference to a compiler-generated field
              tag.gclass83_0 = class1029.gclass83_0;
              nodeAt.Remove();
  ...
  private void cmdCreateAdmin_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else if (this.tvFleetList.SelectedNode.Tag is GClass83)
      {
        GClass83 tag = (GClass83) this.tvFleetList.SelectedNode.Tag;
        if (tag.gclass40_0 != null)
        {
          int num3 = (int) MessageBox.Show("Admin commands located on a flag bridge cannot have subordinate commands");
        }
        else
        {
          GClass146 gclass1460 = tag.gclass146_0;
          ...
          GEnum37 genum37_0 = GEnum37.const_0;
          if (this.gclass79_0 != null)
            genum37_0 = this.gclass79_0.genum37_0;
          ...
          if (this.gclass0_0.bool_21)
            return;
          GClass83 gclass83 = this.gclass21_0.method_248(tag, gclass1460, gclass40_1, this.gclass0_0.string_4, genum37_0);
          this.tvFleetList.SelectedNode.Nodes.Add(new TreeNode()
          {
            Text = gclass83.method_6(),
            Tag = (object) gclass83,
            ForeColor = GClass226.color_2
          });
        }
      }
      else
  ...
  private void cmdUpdateAdmin_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else if (this.tvFleetList.SelectedNode.Tag is GClass83)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        class1030.gclass83_0 = (GClass83) this.tvFleetList.SelectedNode.Tag;
        if (this.gclass79_0 != null)
        {
          // ISSUE: reference to a compiler-generated field
          class1030.gclass83_0.gclass79_0 = this.gclass0_0.dictionary_65[this.gclass79_0.genum37_0];
        }
        if (this.gclass146_0 != null || this.gclass40_1 != null)
        {
          if (this.gclass146_0 != null)
          {
            ...
            // ISSUE: reference to a compiler-generated field
            class1030.gclass83_0.gclass40_0 = (GClass40) null;
          }
          else
          {
            // ISSUE: reference to a compiler-generated method
            if (this.gclass0_0.dictionary_0.Values.FirstOrDefault<GClass83>(new Func<GClass83, bool>(class1030.method_0)) != null)
            {
              int num2 = (int) MessageBox.Show("Admin commands with subordinate commands cannot be assigned to a ship");
              return;
            }
            // ISSUE: reference to a compiler-generated field
            class1030.gclass83_0.gclass146_0 = (GClass146) null;
            // ISSUE: reference to a compiler-generated field
    ...
    try
    {
      ...
      else if (this.tvFleetList.SelectedNode.Tag is GClass83)
      {
        ...
        if (tag.gclass146_0 != null)
          this.gclass21_0.method_307(string4, tag, tag.gclass146_0.gclass1_0, GEnum105.const_0);
        else if (tag.gclass40_0 != null)
          this.gclass21_0.method_307(string4, tag, tag.gclass40_0.gclass85_0.gclass1_0, GEnum105.const_0);
        this.gclass21_0.method_355(this.tvFleetList, (GClass202) null, false, GClass226.smethod_27(this.chkIncludeCivilians.CheckState), this.txtSystemOOB);
      }
      else
      {
  ...
  private void cmdCreateSubFleet_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else if (this.tvFleetList.SelectedNode.Tag is GClass85)
      {
        GClass85 tag = (GClass85) this.tvFleetList.SelectedNode.Tag;
        if (this.lstvShips.SelectedItems.Count > 0)
        {
          GClass84 gclass84 = this.gclass21_0.method_341(tag, (GClass84) null);
          if (gclass84 == null)
            return;
          gclass84.bool_0 = true;
          foreach (ListViewItem selectedItem in this.lstvShips.SelectedItems)
            ((GClass40) selectedItem.Tag).gclass84_0 = gclass84;
          this.gclass21_0.genum42_0 = GEnum42.const_3;
          this.gclass21_0.int_43 = gclass84.int_0;
          this.gclass21_0.method_355(this.tvFleetList, (GClass202) null, false, GClass226.smethod_27(this.chkIncludeCivilians.CheckState), this.txtSystemOOB);
        }
        else if (this.gclass21_0.method_341(tag, (GClass84) null) == null)
          return;
        this.gclass21_0.method_355(this.tvFleetList, (GClass202) null, false, GClass226.smethod_27(this.chkIncludeCivilians.CheckState), this.txtSystemOOB);
      }
      else if (this.tvFleetList.SelectedNode.Tag is GClass84)
      {
        GClass84 tag = (GClass84) this.tvFleetList.SelectedNode.Tag;
        if (this.gclass21_0.method_341(tag.gclass85_0, tag) == null)
          return;
        this.gclass21_0.method_355(this.tvFleetList, (GClass202) null, false, GClass226.smethod_27(this.chkIncludeCivilians.CheckState), this.txtSystemOOB);
      }
      else
    ...
    {
      GClass226.smethod_74(ex, 931);
    }
  }

  private void method_6(GClass85 gclass85_0)
  {
    try
    {
      if (this.rdoSL.Checked)
        gclass85_0.method_281(this.lstvSystemLocations, this.chkMoon, this.chkComets, this.chkAst, this.chkExcSurveyed, this.chkWaypoint, this.chkLocation, this.chkFleets, this.chkContacts, this.chkCivilian, this.chkWrecks, this.chkLifepods, this.chkExcludeTP, this.chkPlanet, this.chkDwarf);
      ...
      else
      {
        ...
        if (this.gclass21_0 == null)
        {
          ...
          this.gclass21_0.method_117(this.lstvSystemLocations, gclass85_0.gclass202_0);
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 932);
    }
  }
  ...
  public void method_7()
  {
    try
    {
      ...
      else
      {
        ...
        if (this.tvFleetList.SelectedNode == null || this.tvFleetList.SelectedNode.Tag == null)
          return;
        if (this.tvFleetList.SelectedNode.Tag is GClass85)
          this.method_8((GClass85) this.tvFleetList.SelectedNode.Tag, (GClass84) null, (GClass70) null);
        else if (this.tvFleetList.SelectedNode.Tag is GClass84)
        {
          GClass84 tag = (GClass84) this.tvFleetList.SelectedNode.Tag;
          ...
          this.gclass21_0.genum42_0 = GEnum42.const_3;
          this.gclass21_0.int_43 = tag.int_0;
          this.method_8(tag.gclass85_0, tag, (GClass70) null);
          tag.method_17(this.lstvFormation);
        }
        else if (this.tvFleetList.SelectedNode.Tag is GClass70)
        {
          GClass70 tag = (GClass70) this.tvFleetList.SelectedNode.Tag;
          this.cmdDetach.Visible = true;
          this.tabNaval.SelectTab(this.tabFleet);
          this.gclass21_0.genum42_0 = GEnum42.const_3;
          this.gclass21_0.int_43 = tag.int_0;
          this.method_8(tag.gclass40_0.gclass85_0, (GClass84) null, tag);
        }
        else if (this.tvFleetList.SelectedNode.Tag is GClass83)
        {
          this.gclass83_0 = (GClass83) this.tvFleetList.SelectedNode.Tag;
          ...
          this.chkAutoAssign.CheckState = GClass226.smethod_28(this.gclass83_0.bool_1);
          this.cboBonusOne.SelectedItem = (object) this.gclass0_0.dictionary_62[this.gclass83_0.genum121_0];
          this.cboBonusTwo.SelectedItem = (object) this.gclass0_0.dictionary_62[this.gclass83_0.genum121_1];
          this.cboBonusThree.SelectedItem = (object) this.gclass0_0.dictionary_62[this.gclass83_0.genum121_2];
          GClass50 selectedItem = (GClass50) this.cboBonusOne.SelectedItem;
          this.cboNavalRanks.SelectedItem = (object) (this.gclass21_0.dictionary_1.Values.FirstOrDefault<GClass61>((Func<GClass61, bool>) (gclass61_0 => gclass61_0.int_1 == this.gclass83_0.int_3)) ?? this.gclass21_0.dictionary_1.Values.OrderByDescending<GClass61, int>((Func<GClass61, int>) (gclass61_0 => gclass61_0.int_1)).FirstOrDefault<GClass61>());
        ...
        else if (this.tvFleetList.SelectedNode.Tag is GClass40)
        {
          this.gclass40_0 = (GClass40) this.tvFleetList.SelectedNode.Tag;
          this.cmdDetach.Visible = true;
          this.cmdSelectName.Visible = true;
          this.cmdCreateSquadron.Visible = true;
          if (this.gclass40_0.gclass85_0.method_176().Count<GClass40>((Func<GClass40, bool>) (gclass40_2 => gclass40_2.gclass40_0 == this.gclass40_0)) > 0)
            this.cmdLaunchAll.Visible = true;
          this.method_9();
        }
        else if (this.tvFleetList.SelectedNode.Tag is GClass187)
        {
          this.gclass187_0 = (GClass187) this.tvFleetList.SelectedNode.Tag;
    ...
    {
      GClass226.smethod_74(ex, 3255);
    }
  }

  public void method_8(GClass85 gclass85_0, GClass84 gclass84_0, GClass70 gclass70_0)
  {
    try
    {
      gclass85_0.method_167(this.lstvShips, gclass84_0, gclass70_0, this.lblLocation, this.lblCommander, this.lblFleetData, this.lblCapacity, this.lblDefault, this.lblClassSummary, this.lstvHistory, this.chkCycle, this.txtSurveyRadius);
      ...
      if (gclass84_0 == null && gclass70_0 == null)
      {
        ...
        this.gclass21_0.method_383(this.tvThreat, this.tvAnchor, gclass85_0, this.chkCurrentContact.CheckState, this.chkCurrentSystem.CheckState);
        ...
        List<GClass40> list1 = gclass85_0.method_176().ToList<GClass40>();
        if (list1.Count<GClass40>((Func<GClass40, bool>) (gclass40_0 => gclass40_0.list_17.Count > 0)) > 0 && gclass85_0.method_125(AuroraComponentType.SalvageModule) > 0M)
        {
          this.cmdScrap.Visible = true;
          this.cmdScrapAll.Visible = true;
          this.tvFleetCargo.Height = 611;
        }
        if (list1.Count<GClass40>((Func<GClass40, bool>) (gclass40_0 => gclass40_0.gclass40_0 != null)) > 0)
          this.cmdLaunchAll.Visible = true;
        if (list1.Count<GClass40>((Func<GClass40, bool>) (gclass40_0 => gclass40_0.genum29_0 == GEnum29.const_1)) > 0)
        ...
        if (list2.Count<GClass40>((Func<GClass40, bool>) (gclass40_0 => gclass40_0.bool_8)) > 0)
          this.cmdActive2.Text = "Active Off";
        else
          this.cmdActive2.Text = "Active On";
        int num = list2.Count<GClass40>((Func<GClass40, bool>) (gclass40_0 => gclass40_0.gclass22_0.int_42 > 0));
        if (num > 0)
        {
          this.cmdFleetShields.Visible = true;
          if (list2.Count<GClass40>((Func<GClass40, bool>) (gclass40_0 => gclass40_0.bool_10)) == num)
        ...
        this.chkDanger.CheckState = GClass226.smethod_28(gclass85_0.bool_5);
        this.chkExcludeAlien.CheckState = GClass226.smethod_28(gclass85_0.bool_6);
        this.chkAssumeJumpCapable.CheckState = GClass226.smethod_28(gclass85_0.bool_10);
        this.chkSensorDisplay.CheckState = GClass226.smethod_28(gclass85_0.bool_7);
        this.chkWeaponDisplay.CheckState = GClass226.smethod_28(gclass85_0.bool_8);
        this.chkMaxSpeed.CheckState = GClass226.smethod_28(gclass85_0.bool_9);
        this.chkDetachedStanding.CheckState = GClass226.smethod_28(gclass85_0.bool_11);
        this.chkDetachedConditional.CheckState = GClass226.smethod_28(gclass85_0.bool_12);
        this.chkIncludeSquadrons.CheckState = GClass226.smethod_28(gclass85_0.bool_13);
        this.chkIgnoreSO.CheckState = GClass226.smethod_28(gclass85_0.bool_14);
        this.chkIgnoreCO.CheckState = GClass226.smethod_28(gclass85_0.bool_15);
        this.gclass21_0.genum42_0 = GEnum42.const_2;
        this.gclass21_0.int_43 = gclass85_0.int_3;
        if (gclass85_0.gclass187_0 != null && !this.gclass0_0.bool_10)
        {
      ...
      else
      {
        ...
        if (gclass84_0 == null || gclass84_0.method_0().Count<GClass40>((Func<GClass40, bool>) (gclass40_0 => gclass40_0.gclass40_0 != null)) <= 0)
          return;
        this.cmdLaunchAll.Visible = true;
      }
    }
  ...
  private void method_9()
  {
    try
    {
      this.txtShipSummary.Text = this.gclass40_0.method_164(GClass226.smethod_67(this.txtTargetSpeed.Text), GClass226.smethod_67(this.txtRangeBand.Text), this.cboRefuelActive, this.cboResupplyActive, this.cboTransferActive, this.cboHangar, this.flpEnergyWeaponData, this.lstvMeasurement, this.lstvLogistics, this.lstvCrew, this.lstvOrdnance, this.lstvOfficers, this.lstvDAC, this.lstvDamageControlQueue, this.lstvMeasurement, this.lstvShipHistory, GClass226.smethod_67(this.txtRepairChanceTime.Text));
      this.gclass40_0.gclass22_0.method_85(0, 0, "");
      this.txtClassDisplay.Text = this.gclass40_0.gclass22_0.string_0;
      this.txtFuelPriority.Text = GClass226.smethod_37(this.gclass40_0.int_18);
      this.txtSupplyPriority.Text = GClass226.smethod_37(this.gclass40_0.int_19);
      this.chkAutoDC.CheckState = GClass226.smethod_28(this.gclass40_0.bool_14);
      this.chkRetainData.CheckState = GClass226.smethod_26(this.gclass40_0.int_14);
      this.ckhTarget.CheckState = GClass226.smethod_26(this.gclass40_0.int_24);
      ...
      if (this.gclass40_0.method_177() > 0M)
      {
        ...
        else
        {
          ...
          if (this.gclass40_0.list_4.Where<GClass36>((Func<GClass36, bool>) (gclass36_0 => gclass36_0.bool_0)).FirstOrDefault<GClass36>() == null)
  ...
  private void cmdDelete_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        GClass40 tag = (GClass40) this.tvFleetList.SelectedNode.Tag;
      ...
      {
        GClass84 tag = (GClass84) this.tvFleetList.SelectedNode.Tag;
        if (MessageBox.Show($" Are you sure you want to delete the sub fleet '{tag.string_0}'?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
          return;
        tag.gclass85_0.method_163(tag);
        this.gclass21_0.method_355(this.tvFleetList, (GClass202) null, false, GClass226.smethod_27(this.chkIncludeCivilians.CheckState), this.txtSystemOOB);
      }
      else if (this.tvFleetList.SelectedNode.Tag is GClass70)
      {
        GClass70 tag = (GClass70) this.tvFleetList.SelectedNode.Tag;
        if (MessageBox.Show($" Are you sure you want to delete '{tag.SquadronName}'?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
          return;
        tag.gclass40_0.method_54(tag);
        this.gclass21_0.method_355(this.tvFleetList, (GClass202) null, false, GClass226.smethod_27(this.chkIncludeCivilians.CheckState), this.txtSystemOOB);
      }
      else if (this.tvFleetList.SelectedNode.Tag is GClass83)
      {
      ...
      {
        if (!(this.tvFleetList.SelectedNode.Tag is GClass187))
          return;
        GClass187 tag = (GClass187) this.tvFleetList.SelectedNode.Tag;
        if (MessageBox.Show($" Are you sure you want to delete the Shipping Line '{tag.string_0}'?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
          return;
  ...
  private void cmdRename_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        GClass84 tag = (GClass84) this.tvFleetList.SelectedNode.Tag;
        string str = this.gclass0_0.method_562("Enter New Sub Fleet Name", tag.string_0);
        if (str != "")
          tag.string_0 = str;
  ...
  private void tvFleetList_AfterExpand(object sender, TreeViewEventArgs e)
  {
    try
    {
      ...
      if (e.Node.Tag is GClass85)
        ((GClass85) e.Node.Tag).bool_16 = true;
      else if (e.Node.Tag is GClass40)
        ((GClass40) e.Node.Tag).bool_12 = true;
      else if (e.Node.Tag is GClass70)
        ((GClass70) e.Node.Tag).bool_0 = true;
      else if (e.Node.Tag is GClass84)
      {
        ((GClass84) e.Node.Tag).bool_0 = true;
      }
      else
      {
        if (!(e.Node.Tag is GClass83))
          return;
        ((GClass83) e.Node.Tag).bool_0 = true;
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 937);
    }
  }
  ...
  private void tvFleetList_AfterCollapse(object sender, TreeViewEventArgs e)
  {
    try
    {
      if (this.gclass0_0.bool_9)
        return;
      if (e.Node.Tag is GClass85)
        ((GClass85) e.Node.Tag).bool_16 = false;
      else if (e.Node.Tag is GClass40)
        ((GClass40) e.Node.Tag).bool_12 = false;
      else if (e.Node.Tag is GClass70)
        ((GClass70) e.Node.Tag).bool_0 = false;
      else if (e.Node.Tag is GClass84)
      {
        ((GClass84) e.Node.Tag).bool_0 = false;
      }
      else
      {
        if (!(e.Node.Tag is GClass83))
          return;
        ((GClass83) e.Node.Tag).bool_0 = false;
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 938);
    }
  }
    ...
    try
    {
      ...
      else
      {
        if (!(this.tvFleetList.SelectedNode.Tag is GClass85))
          return;
        GClass85 tag = (GClass85) this.tvFleetList.SelectedNode.Tag;
        string str = this.gclass0_0.method_562("Enter New Fleet Speed", tag.int_6.ToString());
        if (!(str != ""))
          return;
  ...
  private void chkFilterOrders_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        if (!(this.tvFleetList.SelectedNode.Tag is GClass85))
          return;
        ((GClass85) this.tvFleetList.SelectedNode.Tag).method_281(this.lstvSystemLocations, this.chkMoon, this.chkComets, this.chkAst, this.chkExcSurveyed, this.chkWaypoint, this.chkLocation, this.chkFleets, this.chkContacts, this.chkCivilian, this.chkWrecks, this.chkLifepods, this.chkExcludeTP, this.chkPlanet, this.chkDwarf);
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 940);
    }
  }

  private void method_10(ListView listView_0, GClass136 gclass136_0)
  {
    try
    {
      foreach (ListViewItem listViewItem in listView_0.Items)
      {
        ...
        if ((GClass136) listViewItem.Tag == gclass136_0)
          listViewItem.Selected = true;
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 943);
    }
  }

  private void method_11(ListView listView_0, GClass137 gclass137_0)
  {
    try
    {
      foreach (ListViewItem listViewItem in listView_0.Items)
      {
        listViewItem.Selected = false;
        if ((GClass137) listViewItem.Tag == gclass137_0)
          listViewItem.Selected = true;
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 944);
    }
  }
  ...
  private void lstvActions_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        if (!(this.tvFleetList.SelectedNode.Tag is GClass85))
          return;
        GClass85 tag1 = (GClass85) this.tvFleetList.SelectedNode.Tag;
        GClass134 tag2 = (GClass134) this.lstvSystemLocations.SelectedItems[0].Tag;
        GClass133 tag3 = (GClass133) this.lstvActions.SelectedItems[0].Tag;
        this.lstvLoadItems.Items.Clear();
        if (tag3.genum125_0 != GEnum125.const_0)
        {
          this.lstvLoadItems.Visible = true;
          tag1.method_283(tag3.genum125_0, tag2, this.lstvLoadItems);
        }
        else
          this.lstvLoadItems.Visible = false;
        if (tag3.bool_18)
        ...
        if (tag3.genum123_0 == GEnum123.const_50)
        {
  ...
  private void method_12(CheckState checkState_0)
  {
    try
    {
      ...
      else
      {
        ...
        if (tag1.method_46())
        {
          int num4 = (int) MessageBox.Show("Orders cannot be assigned to a fleet which contains ships in a shipyard");
        }
        else if (tag1.method_47())
        {
          int num5 = (int) MessageBox.Show("Orders cannot be assigned to a fleet that contains an active mobile shipyard");
        }
        else if (tag1.genum106_0 != GEnum106.const_0)
        {
          int num6 = (int) MessageBox.Show("Orders cannot be assigned to a civilian or computer-controlled fleet");
        }
        else if (tag1.method_9())
        {
          int num7 = (int) MessageBox.Show("Fleet cannot receive further orders if already ordered to transit an unexplored jump point");
        }
        else
        {
          bool flag = true;
          if (this.rdoSL.Checked)
          {
            GClass133 gclass133 = new GClass133();
            GClass134 tag2 = (GClass134) this.lstvSystemLocations.SelectedItems[0].Tag;
            GClass133 tag3;
            if (this.lstvActions.SelectedItems.Count == 0)
            {
              ...
              {
                if (tag2.genum13_0 == GEnum13.const_0)
                  tag3 = this.gclass0_0.dictionary_19[GEnum123.const_0];
                else if (tag2.genum13_0 == GEnum13.const_10)
                  tag3 = this.gclass0_0.dictionary_19[GEnum123.const_1];
                else if (tag2.gclass146_0 != null)
                  tag3 = this.gclass0_0.dictionary_19[GEnum123.const_96];
                else if (tag2.genum13_0 == GEnum13.const_4)
                  tag3 = this.gclass0_0.dictionary_19[GEnum123.const_15];
                else if (tag2.genum13_0 == GEnum13.const_7)
                  tag3 = this.gclass0_0.dictionary_19[GEnum123.const_2];
                else if (tag2.genum13_0 == GEnum13.const_1)
                  tag3 = this.gclass0_0.dictionary_19[GEnum123.const_8];
                else if (tag2.genum13_0 == GEnum13.const_2)
                  tag3 = this.gclass0_0.dictionary_19[GEnum123.const_10];
                else if (tag2.genum13_0 == GEnum13.const_6)
                {
                  tag3 = this.gclass0_0.dictionary_19[GEnum123.const_39];
                  flag = false;
                }
                else if (tag2.genum13_0 == GEnum13.const_3)
                  tag3 = this.gclass0_0.dictionary_19[GEnum123.const_1];
                else if (tag2.genum13_0 == GEnum13.const_5)
                {
                  tag3 = this.gclass0_0.dictionary_19[GEnum123.const_32];
                }
                else
                {
              ...
              tag3 = (GClass133) this.lstvActions.SelectedItems[0].Tag;
            ...
            {
              GClass208 gclass208 = GClass226.smethod_4(this.txtMaxItems.Text);
              if (gclass208.bool_0)
                decimal_9 = gclass208.decimal_0;
            }
            ...
            if (this.chkLoadSubUnits.Visible)
              bool_25 = GClass226.smethod_27(this.chkLoadSubUnits.CheckState);
            tag1.method_264(tag2, tag3, object_0, decimal_9, double_11, int32, int_13, int_14, bool_25, this.chkAutoLP.CheckState);
            tag1.method_258(this.lstvOrders);
            if (flag)
              tag1.method_281(this.lstvSystemLocations, this.chkMoon, this.chkComets, this.chkAst, this.chkExcSurveyed, this.chkWaypoint, this.chkLocation, this.chkFleets, this.chkContacts, this.chkCivilian, this.chkWrecks, this.chkLifepods, this.chkExcludeTP, this.chkPlanet, this.chkDwarf);
          ...
          {
            GClass202 tag5 = (GClass202) this.lstvSystemLocations.SelectedItems[0].Tag;
            bool bool_25 = false;
            if (this.chkAssumeJumpCapable.CheckState == CheckState.Checked)
              bool_25 = true;
            GClass202 gclass202_1 = tag1.method_261();
            tag1.method_237(gclass202_1, GEnum109.const_41, "Move to Target System", bool_25, tag5.gclass200_0.int_0, false, false, true);
            tag1.method_258(this.lstvOrders);
            this.rdoSL.Checked = true;
          }
          else if (this.rdoOrderTemplates.Checked)
          {
            ((GClass144) this.lstvSystemLocations.SelectedItems[0].Tag).method_0(tag1);
            tag1.method_258(this.lstvOrders);
            this.rdoSL.Checked = true;
          }
  ...
  private void cmdRemoveLastOrder_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        tag.method_281(this.lstvSystemLocations, this.chkMoon, this.chkComets, this.chkAst, this.chkExcSurveyed, this.chkWaypoint, this.chkLocation, this.chkFleets, this.chkContacts, this.chkCivilian, this.chkWrecks, this.chkLifepods, this.chkExcludeTP, this.chkPlanet, this.chkDwarf);
  ...
  private void cmdRemoveAll_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        GClass85 tag = (GClass85) this.tvFleetList.SelectedNode.Tag;
        tag.method_263();
        if (tag.gclass21_0.bool_0)
        {
          tag.gclass4_0.bool_1 = false;
          tag.gclass4_0.gclass202_0 = (GClass202) null;
        }
        tag.method_258(this.lstvOrders);
        tag.method_281(this.lstvSystemLocations, this.chkMoon, this.chkComets, this.chkAst, this.chkExcSurveyed, this.chkWaypoint, this.chkLocation, this.chkFleets, this.chkContacts, this.chkCivilian, this.chkWrecks, this.chkLifepods, this.chkExcludeTP, this.chkPlanet, this.chkDwarf);
      }
  ...
  private void tvCombatAssignment_AfterSelect(object sender, TreeViewEventArgs e)
  {
    try
    {
      ...
      else if (this.tvCombatAssignment.SelectedNode.Tag is GClass36)
      {
        if (((GClass36) this.tvCombatAssignment.SelectedNode.Tag).bool_0)
          this.cmdOpenFire.Text = "Cease Fire FC";
        else
          this.cmdOpenFire.Text = "Open Fire FC";
      }
      else if (this.tvCombatAssignment.SelectedNode.Tag is GClass31)
      {
        GClass31 tag1 = (GClass31) this.tvCombatAssignment.SelectedNode.Tag;
      }
  ...
  private void tvCombatAssignment_DragDrop(object sender, DragEventArgs e)
  {
    try
    {
      if (!(this.tvFleetList.SelectedNode.Tag is GClass40))
        return;
      GClass40 tag1 = (GClass40) this.tvFleetList.SelectedNode.Tag;
      ...
      if (this.chkDragNum.CheckState == CheckState.Checked)
        int_40 = GClass226.smethod_67(this.txtAssignNum.Text);
      if (data.Equals((object) nodeAt) || nodeAt == null)
        return;
      if (data.Tag is GClass31)
      {
        GClass31 tag2 = (GClass31) data.Tag;
        if (nodeAt.Tag is GClass36)
        {
          GClass36 tag3 = (GClass36) nodeAt.Tag;
          if (tag3.gclass230_0.gclass231_0.auroraComponentType_0 == AuroraComponentType.BeamFireControl && !tag2.gclass230_0.bool_4)
          {
            int num = (int) MessageBox.Show("Missile weapons cannot be assigned to beam fire controls");
            return;
          }
          if (tag3.gclass230_0.gclass231_0.auroraComponentType_0 == AuroraComponentType.MissileFireControl && tag2.gclass230_0.bool_4)
          {
      ...
      else if (data.Tag is GClass32)
      {
        GClass32 tag4 = (GClass32) data.Tag;
        if (nodeAt.Tag is string && (string) nodeAt.Tag == "Unassigned")
        {
      ...
      else if (data.Tag is GClass35)
      {
        ...
        if (nodeAt.Tag is GClass36)
        {
          ...
          // ISSUE: reference to a compiler-generated field
          class1031.gclass36_0 = (GClass36) nodeAt.Tag;
          // ISSUE: reference to a compiler-generated field
          if (class1031.gclass36_0.gclass230_0.gclass231_0.auroraComponentType_0 == AuroraComponentType.BeamFireControl && !tag5.gclass230_0.bool_4)
          {
            int num = (int) MessageBox.Show("Missile weapons cannot be assigned to beam fire controls");
            return;
          }
          // ISSUE: reference to a compiler-generated field
          if (class1031.gclass36_0.gclass230_0.gclass231_0.auroraComponentType_0 == AuroraComponentType.MissileFireControl && tag5.gclass230_0.bool_4)
          {
            int num = (int) MessageBox.Show("Energy weapons cannot be assigned to missile fire controls");
            return;
          }
          if (tag5.gclass230_0.gclass231_0.auroraComponentType_0 == AuroraComponentType.DecoyMissileLauncher)
          {
          ...
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated method
          if (class1031.gclass36_0.gclass230_0.genum87_0 == GEnum87.const_6 && tag1.list_2.Count<GClass31>(new Func<GClass31, bool>(class1031.method_0)) > 0)
          {
            int num = (int) MessageBox.Show("Only a single weapon can be assigned to this fire control");
            return;
          }
          // ISSUE: reference to a compiler-generated field
          tag1.method_33(class1031.gclass36_0, tag5, this.chkDragAll.CheckState, this.chkDragNum.CheckState, int_40);
          flag = true;
        }
      ...
      else if (data.Tag is GClass130)
      {
        ...
        if (nodeAt.Tag is GClass31)
        {
          GClass31 tag7 = (GClass31) nodeAt.Tag;
          if (tag6.gclass129_0.int_14 == 1 && tag7.gclass230_0.gclass231_0.auroraComponentType_0 != AuroraComponentType.DecoyMissileLauncher)
          {
            int num = (int) MessageBox.Show("Decoy Missiles can only be assigned to Decoy Launchers");
            return;
          }
          if (tag6.gclass129_0.int_14 == 0 && tag7.gclass230_0.gclass231_0.auroraComponentType_0 == AuroraComponentType.DecoyMissileLauncher)
          {
        ...
        else if (nodeAt.Tag is GClass32)
        {
          GClass32 tag8 = (GClass32) nodeAt.Tag;
      ...
      else if (data.Tag is AuroraPointDefenceMode)
      {
        ...
        if (nodeAt.Tag is GClass36)
        {
          GClass36 tag10 = (GClass36) nodeAt.Tag;
          if (tag10.gclass230_0.gclass231_0.auroraComponentType_0 == AuroraComponentType.BeamFireControl && tag9 > AuroraPointDefenceMode.PointBlankDefensiveFire)
          {
            int num = (int) MessageBox.Show("Missile-based point defence modes cannot be assigned to beam fire controls");
            return;
          }
          if (tag10.gclass230_0.gclass231_0.auroraComponentType_0 == AuroraComponentType.MissileFireControl && tag9 < AuroraPointDefenceMode.PointBlankDefensiveFireSelf && tag9 != AuroraPointDefenceMode.None)
          {
      ...
      else if (data.Tag is AuroraPointDefencePriority)
      {
        ...
        if (nodeAt.Tag is GClass36)
        {
          GClass36 tag12 = (GClass36) nodeAt.Tag;
          if (tag12.gclass230_0.gclass231_0.auroraComponentType_0 == AuroraComponentType.MissileFireControl)
          {
            int num = (int) MessageBox.Show("Beam fire control priorities cannot be assigned to missile fire controls");
            return;
          }
          tag12.auroraPointDefencePriority_0 = tag11;
          flag = true;
        }
      }
      else if (data.Tag is AuroraPointDefenceConcentration)
      {
        ...
        if (nodeAt.Tag is GClass36)
        {
          GClass36 tag14 = (GClass36) nodeAt.Tag;
          if (tag14.gclass230_0.gclass231_0.auroraComponentType_0 == AuroraComponentType.MissileFireControl)
          {
            int num = (int) MessageBox.Show("Beam fire control concentration cannot be assigned to missile fire controls");
            return;
          }
          tag14.auroraPointDefenceConcentration_0 = tag13;
          flag = true;
        }
      }
      else if (data.Tag is GClass65)
      {
        ...
        if (nodeAt.Tag is GClass36)
        {
          ...
          {
            GClass36 tag16 = (GClass36) nodeAt.Tag;
            tag1.method_26(tag16, tag15);
            flag = true;
          }
          else
          {
            foreach (GClass36 gclass36_0 in tag1.list_4)
      ...
      else if (data.Tag is GClass214)
      {
        ...
        if (nodeAt.Tag is GClass36)
        {
          GClass36 tag18 = (GClass36) nodeAt.Tag;
          if (tag18.gclass230_0.gclass231_0.auroraComponentType_0 != AuroraComponentType.MissileFireControl)
          {
  ...
  private void tvCombatAssignment_AfterExpand(object sender, TreeViewEventArgs e)
  {
    try
    {
      ...
      {
        if (!(e.Node.Tag is GClass36))
          return;
        ((GClass36) e.Node.Tag).bool_2 = true;
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 951);
    }
  }
  ...
  private void tvCombatAssignment_AfterCollapse(object sender, TreeViewEventArgs e)
  {
    try
    {
      ...
      else
      {
        if (!(e.Node.Tag is GClass36))
          return;
        ((GClass36) e.Node.Tag).bool_2 = false;
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 952);
    }
  }
  ...
  private void cmdOpenFire_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        GClass36 tag1 = (GClass36) this.tvCombatAssignment.SelectedNode.Tag;
        if (tag1.bool_0)
        {
          tag1.bool_0 = false;
          this.cmdOpenFire.Text = "Open Fire FC";
          this.tvCombatAssignment.SelectedNode.ForeColor = GClass226.color_2;
        }
        else
        {
          tag1.bool_0 = true;
        ...
        if (this.gclass0_0.int_87 != 1 || !this.method_18() || !(this.tvFleetList.SelectedNode.Tag is GClass40))
          return;
        GClass40 tag2 = (GClass40) this.tvFleetList.SelectedNode.Tag;
        if (tag2.bool_15)
          return;
  ...
  private void cmdOpenFireAll_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.tvFleetList.SelectedNode == null || !(this.tvFleetList.SelectedNode.Tag is GClass40))
        return;
      GClass40 tag = (GClass40) this.tvFleetList.SelectedNode.Tag;
      ...
      if (this.gclass0_0.int_87 == 1 && !tag.bool_15)
      {
  ...
  private void cmdAssignFleet_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.tvFleetList.SelectedNode == null || !(this.tvFleetList.SelectedNode.Tag is GClass40))
        return;
      ((GClass40) this.tvFleetList.SelectedNode.Tag).method_24(GEnum35.const_0);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 957);
    }
  }
  ...
  private void cmdAssignSubFleet_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.tvFleetList.SelectedNode == null || !(this.tvFleetList.SelectedNode.Tag is GClass40))
        return;
      ((GClass40) this.tvFleetList.SelectedNode.Tag).method_24(GEnum35.const_1);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 958);
    }
  }
  ...
  private void cmdAssignSystem_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.tvFleetList.SelectedNode == null || !(this.tvFleetList.SelectedNode.Tag is GClass40))
        return;
      ((GClass40) this.tvFleetList.SelectedNode.Tag).method_24(GEnum35.const_2);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 959);
    }
  }
  ...
  private void cmdAssignAll_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.tvFleetList.SelectedNode == null || !(this.tvFleetList.SelectedNode.Tag is GClass40))
        return;
      ((GClass40) this.tvFleetList.SelectedNode.Tag).method_24(GEnum35.const_3);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 960);
    }
  }
  ...
  private void cmdFleetSync_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.tvFleetList.SelectedNode == null || !(this.tvFleetList.SelectedNode.Tag is GClass40))
        return;
      ((GClass40) this.tvFleetList.SelectedNode.Tag).gclass85_0.method_65(1, this.tvFleetList.SelectedNode.Parent);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 962);
    }
  }
  ...
  private void cmdFleetSyncOff_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.tvFleetList.SelectedNode == null || !(this.tvFleetList.SelectedNode.Tag is GClass40))
        return;
      ((GClass40) this.tvFleetList.SelectedNode.Tag).gclass85_0.method_65(0, this.tvFleetList.SelectedNode.Parent);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 963);
    }
  }
  ...
  private void tvTargets_AfterCollapse(object sender, TreeViewEventArgs e)
  {
    try
    {
      ...
      else if (e.Node.Tag is GClass110)
      {
        ((GClass110) e.Node.Tag).bool_6 = false;
      }
      else
      {
  ...
  private void tvTargets_AfterExpand(object sender, TreeViewEventArgs e)
  {
    try
    {
      ...
      {
        ((GClass110) e.Node.Tag).bool_6 = true;
      }
      else
      {
        if (!(e.Node.Tag is string) || !((string) e.Node.Tag == "PD"))
  ...
  private void lstvNACTypes_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      if (this.lstvNACTypes.SelectedItems.Count == 0)
        return;
      this.gclass79_0 = (GClass79) this.lstvNACTypes.SelectedItems[0].Tag;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 967);
    }
  }
  ...
  private void lstvPopulation_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      if (this.lstvPopulation.SelectedItems[0].Tag is GClass146)
      {
        this.gclass146_0 = (GClass146) this.lstvPopulation.SelectedItems[0].Tag;
      }
      else
      {
        if (!(this.lstvPopulation.SelectedItems[0].Tag is GClass40))
          return;
        this.gclass40_1 = (GClass40) this.lstvPopulation.SelectedItems[0].Tag;
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 968);
    }
  }
  ...
  private void cmdDetach_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        GClass40 tag = (GClass40) this.tvFleetList.SelectedNode.Tag;
        tag.gclass40_0 = (GClass40) null;
        tag.gclass85_0.method_75(tag, GEnum105.const_0, false);
        tag.gclass84_0 = (GClass84) null;
        if (tag.gclass70_0 != null)
        {
          tag.int_22 = tag.gclass70_0.int_0;
          tag.gclass70_0 = (GClass70) null;
        }
        this.gclass21_0.genum42_0 = GEnum42.const_2;
        this.gclass21_0.int_43 = tag.gclass85_0.int_3;
        this.gclass21_0.method_355(this.tvFleetList, (GClass202) null, false, GClass226.smethod_27(this.chkIncludeCivilians.CheckState), this.txtSystemOOB);
      }
      else if (this.lstvShips.SelectedItems.Count > 0)
      {
        ...
        GClass85 gclass85 = new GClass85(this.gclass0_0);
        string string_10;
        GClass85 gclass85_5;
        if (this.tvFleetList.SelectedNode.Tag is GClass85)
        {
        ...
        {
          GClass84 tag = (GClass84) this.tvFleetList.SelectedNode.Tag;
          string_10 = tag.string_0;
          gclass85_5 = tag.gclass85_0;
        }
        else
        {
          if (!(this.tvFleetList.SelectedNode.Tag is GClass70))
            return;
          GClass70 tag = (GClass70) this.tvFleetList.SelectedNode.Tag;
          string_10 = tag.SquadronName;
          gclass85_5 = tag.gclass40_0.gclass85_0;
        }
        if (this.lstvShips.SelectedItems.Count == 1)
        {
          GClass40 tag = (GClass40) this.lstvShips.SelectedItems[0].Tag;
          if (tag != null)
        ...
        // ISSUE: reference to a compiler-generated field
        class1032.gclass85_0 = gclass85_5.gclass9_0 == null ? this.gclass21_0.method_308(string_10, gclass85_5.gclass83_0, gclass85_5.gclass202_0, gclass85_5.double_2, gclass85_5.double_3, gclass85_5.gclass1_0, GEnum105.const_0) : this.gclass21_0.method_308(string_10, gclass85_5.gclass83_0, gclass85_5.gclass202_0, gclass85_5.double_2, gclass85_5.double_3, gclass85_5.gclass1_0, gclass85_5.gclass9_0.genum105_0);
        if ((gclass85_5.bool_11 || gclass85_5.bool_12) && (gclass85_5.bool_13 || !(this.tvFleetList.SelectedNode.Tag is GClass70)))
        {
          // ISSUE: reference to a compiler-generated field
          class1032.gclass85_0.method_2(gclass85_5, gclass85_5.bool_11, gclass85_5.bool_12);
        }
        foreach (ListViewItem selectedItem in this.lstvShips.SelectedItems)
        {
          GClass40 tag = (GClass40) selectedItem.Tag;
          if (tag != null)
          {
            if (tag.gclass70_0 != null)
            {
        ...
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated method
        foreach (GClass40 gclass40 in class1032.gclass85_0.method_176().Where<GClass40>((Func<GClass40, bool>) (gclass40_0 => gclass40_0.gclass40_0 != null)).Where<GClass40>(new Func<GClass40, bool>(class1032.method_0)).ToList<GClass40>())
          gclass40.gclass40_0 = (GClass40) null;
        this.gclass21_0.genum42_0 = GEnum42.const_2;
        // ISSUE: reference to a compiler-generated field
        this.gclass21_0.int_43 = class1032.gclass85_0.int_3;
        this.gclass21_0.method_355(this.tvFleetList, (GClass202) null, false, GClass226.smethod_27(this.chkIncludeCivilians.CheckState), this.txtSystemOOB);
      }
      else if (this.tvFleetList.SelectedNode.Tag is GClass85)
      {
      ...
      else if (this.tvFleetList.SelectedNode.Tag is GClass84)
      {
        ...
        GClass84 tag = (GClass84) this.tvFleetList.SelectedNode.Tag;
        // ISSUE: reference to a compiler-generated field
        class1033.gclass85_0 = tag.gclass85_0.method_70(tag, false);
        this.gclass21_0.genum42_0 = GEnum42.const_2;
        // ISSUE: reference to a compiler-generated field
        this.gclass21_0.int_43 = class1033.gclass85_0.int_3;
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated method
        foreach (GClass40 gclass40 in class1033.gclass85_0.method_176().Where<GClass40>((Func<GClass40, bool>) (gclass40_0 => gclass40_0.gclass40_0 != null)).Where<GClass40>(new Func<GClass40, bool>(class1033.method_0)).ToList<GClass40>())
          gclass40.gclass40_0 = (GClass40) null;
        this.gclass21_0.method_355(this.tvFleetList, (GClass202) null, false, GClass226.smethod_27(this.chkIncludeCivilians.CheckState), this.txtSystemOOB);
      }
      else
      {
        ...
        GClass70 tag = (GClass70) this.tvFleetList.SelectedNode.Tag;
        // ISSUE: reference to a compiler-generated field
        class1034.gclass85_0 = tag.gclass40_0.gclass85_0.method_71(tag, GEnum105.const_0);
        this.gclass21_0.genum42_0 = GEnum42.const_2;
        // ISSUE: reference to a compiler-generated field
        this.gclass21_0.int_43 = class1034.gclass85_0.int_3;
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated method
        foreach (GClass40 gclass40 in class1034.gclass85_0.method_176().Where<GClass40>((Func<GClass40, bool>) (gclass40_0 => gclass40_0.gclass40_0 != null)).Where<GClass40>(new Func<GClass40, bool>(class1034.method_0)).ToList<GClass40>())
          gclass40.gclass40_0 = (GClass40) null;
        this.gclass21_0.method_355(this.tvFleetList, (GClass202) null, false, GClass226.smethod_27(this.chkIncludeCivilians.CheckState), this.txtSystemOOB);
      }
    }
  ...
  private void cboRefuelActive_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        if (!(this.tvFleetList.SelectedNode.Tag is GClass40))
          return;
        ((GClass40) this.tvFleetList.SelectedNode.Tag).auroraRefuelStatus_0 = (AuroraRefuelStatus) this.cboRefuelActive.SelectedIndex;
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 971);
    }
  }
  ...
  private void cboTransferActive_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        if (!(this.tvFleetList.SelectedNode.Tag is GClass40))
          return;
        ((GClass40) this.tvFleetList.SelectedNode.Tag).auroraOrdnanceTransferStatus_0 = (AuroraOrdnanceTransferStatus) this.cboTransferActive.SelectedIndex;
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 972);
    }
  }
  ...
  private void rdoOrderTemplates_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      if (this.tvFleetList.SelectedNode.Tag is GClass85)
      {
        this.method_6((GClass85) this.tvFleetList.SelectedNode.Tag);
      }
      else
      {
  ...
  private void chkExcludeAlien_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      if (this.tvFleetList.SelectedNode.Tag is GClass85)
      {
        ...
        if (tag.genum106_0 != GEnum106.const_0)
          return;
        tag.bool_6 = GClass226.smethod_27(this.chkExcludeAlien.CheckState);
        this.method_6(tag);
      }
      else
      {
  ...
  private void cmdAutoFleetFC_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      if (this.tvFleetList.SelectedNode.Tag is GClass85)
      {
        ((GClass85) this.tvFleetList.SelectedNode.Tag).method_43();
      }
      else
      {
        int num = (int) MessageBox.Show("Please select a fleet");
  ...
  private void cboHangar_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      if (!this.method_18() || !(this.tvFleetList.SelectedNode.Tag is GClass40))
        return;
      ((GClass40) this.tvFleetList.SelectedNode.Tag).genum43_0 = (GEnum43) this.cboHangar.SelectedIndex;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 987);
    }
  }
  ...
  private void cmdRepair_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else if (this.lstvDAC.SelectedItems[0].Tag is GClass228)
      {
        ...
        GClass40 tag = (GClass40) this.tvFleetList.SelectedNode.Tag;
        // ISSUE: reference to a compiler-generated method
        int num2 = tag.list_12.Where<GClass178>(new Func<GClass178, bool>(class1035.method_0)).Select<GClass178, int>((Func<GClass178, int>) (gclass178_0 => gclass178_0.int_0)).FirstOrDefault<int>();
        if (num2 == 0)
        {
        ...
        {
          // ISSUE: reference to a compiler-generated method
          if (tag.list_13.Where<GClass26>(new Func<GClass26, bool>(class1035.method_1)).Count<GClass26>() >= num2)
          {
          ...
          else
          {
            ...
            tag.list_13.Add(new GClass26()
            {
              ...
              gclass40_0 = tag,
              int_0 = tag.list_13.Count <= 0 ? 1 : tag.list_13.Max<GClass26>((Func<GClass26, int>) (gclass26_0 => gclass26_0.int_0)) + 1
            });
            int int_40 = GClass226.smethod_67(this.txtRepairChanceTime.Text);
  ...
  private void cmdRemove_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else if (this.lstvDamageControlQueue.SelectedItems[0].Tag is GClass26)
      {
        ...
        tag2.method_91();
        tag2.method_89(this.lstvDamageControlQueue, GClass226.smethod_67(this.txtRepairChanceTime.Text));
      }
      else
      {
  ...
  private void cmdUp_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else if (this.lstvDamageControlQueue.SelectedItems[0].Tag is GClass26)
      {
        ...
        GClass40 tag = (GClass40) this.tvFleetList.SelectedNode.Tag;
        // ISSUE: reference to a compiler-generated method
        GClass26 gclass26 = tag.list_13.FirstOrDefault<GClass26>(new Func<GClass26, bool>(class1036.method_0));
        if (gclass26 == null)
          return;
        // ISSUE: reference to a compiler-generated field
  ...
  private void cmdDown_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else if (this.lstvDamageControlQueue.SelectedItems[0].Tag is GClass26)
      {
        ...
        GClass40 tag = (GClass40) this.tvFleetList.SelectedNode.Tag;
        // ISSUE: reference to a compiler-generated method
        GClass26 gclass26 = tag.list_13.FirstOrDefault<GClass26>(new Func<GClass26, bool>(class1037.method_0));
        if (gclass26 == null)
          return;
        // ISSUE: reference to a compiler-generated field
  ...
  private void method_17(bool bool_3)
  {
    try
    {
      if (!this.method_18())
        return;
      GClass40 tag1 = (GClass40) this.tvFleetList.SelectedNode.Tag;
      int num1 = GClass226.smethod_67(this.txtManualDamage.Text);
      if (num1 < 1)
        return;
      Decimal decimal_42 = 0M;
      GClass230 gclass230_0 = (GClass230) null;
      if (this.lstvWeapons.SelectedItems[0].Tag is GClass129)
        decimal_42 = ((GClass129) this.lstvWeapons.SelectedItems[0].Tag).decimal_0;
      else if (this.lstvWeapons.SelectedItems[0].Tag is GClass230)
      {
        GClass230 tag2 = (GClass230) this.lstvWeapons.SelectedItems[0].Tag;
        decimal_42 = (Decimal) tag2.method_5(1);
        gclass230_0 = tag2;
        if (tag2.int_7 > 1)
          num1 *= tag2.int_7;
      }
      ...
      {
        int num2 = (int) tag1.method_0(gclass230_0, (GClass129) null, decimal_42, bool_3, (GClass117) null, false, false, (GClass37) null);
      }
      this.method_9();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 995);
    }
  }
  ...
  private void cboResupplyActive_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      if (!this.method_18() || !(this.tvFleetList.SelectedNode.Tag is GClass40))
        return;
      ((GClass40) this.tvFleetList.SelectedNode.Tag).auroraResupplyStatus_0 = (AuroraResupplyStatus) this.cboResupplyActive.SelectedIndex;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 998);
    }
  }
  ...
  private void chkAutoDC_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      if (!this.method_18() || !(this.tvFleetList.SelectedNode.Tag is GClass40))
        return;
      ((GClass40) this.tvFleetList.SelectedNode.Tag).bool_14 = GClass226.smethod_27(this.chkAutoDC.CheckState);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 999);
    }
  }
  ...
  private void cmdAutoQueue_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      GClass40 tag = (GClass40) this.tvFleetList.SelectedNode.Tag;
      tag.method_87();
      tag.method_89(this.lstvDamageControlQueue, GClass226.smethod_67(this.txtRepairChanceTime.Text));
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 1003);
    }
  }
  ...
  private void chkSensorDisplay_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        GClass85 tag = (GClass85) this.tvFleetList.SelectedNode.Tag;
        tag.bool_7 = GClass226.smethod_27(this.chkSensorDisplay.CheckState);
        this.method_6(tag);
      }
      else
      {
  ...
  private void chkWeaponDisplay_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        GClass85 tag = (GClass85) this.tvFleetList.SelectedNode.Tag;
        tag.bool_8 = GClass226.smethod_27(this.chkWeaponDisplay.CheckState);
        this.method_6(tag);
      }
      else
      {
    ...
    try
    {
      ...
      else
      {
        ...
        if (!this.rdoSL.Checked)
          return;
        GClass134 tag2 = (GClass134) this.lstvSystemLocations.SelectedItems[0].Tag;
        if (tag2.genum13_0 != GEnum13.const_1 || tag2.gclass146_0 != null)
          return;
        GClass1 gclass1_0 = this.gclass0_0.dictionary_11[tag2.int_0];
        ...
        else
        {
          ...
          if (this.gclass0_0.bool_21)
            return;
          GClass194 gclass194_1 = source.FirstOrDefault<GClass194>((Func<GClass194, bool>) (gclass194_0 => gclass194_0.SpeciesName == this.gclass0_0.string_4));
          if (gclass194_1 != null)
  ...
  private void cmdRepeat_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        if (tag.genum106_0 != GEnum106.const_0)
        {
          int num3 = (int) MessageBox.Show("Orders cannot be assigned to a civilian or computer-controlled fleet");
        }
        else
        {
          int int_12 = 1;
  ...
  private void cmdEndOverhaul_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else if (this.tvFleetList.SelectedNode == null)
      {
        ...
        ((GClass40) this.tvFleetList.SelectedNode.Tag).method_83();
      else if (this.tvFleetList.SelectedNode.Tag is GClass85)
      {
        GClass85 tag = (GClass85) this.tvFleetList.SelectedNode.Tag;
        foreach (GClass40 gclass40 in tag.method_176())
          gclass40.method_83();
        tag.method_167(this.lstvShips, (GClass84) null, (GClass70) null, this.lblLocation, this.lblCommander, this.lblFleetData, this.lblCapacity, this.lblDefault, this.lblClassSummary, this.lstvHistory, this.chkCycle, this.txtSurveyRadius);
      }
      else
      {
  ...
  private void chkMaxSpeed_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      if (this.tvFleetList.SelectedNode.Tag is GClass85)
      {
        ((GClass85) this.tvFleetList.SelectedNode.Tag).bool_9 = GClass226.smethod_27(this.chkMaxSpeed.CheckState);
      }
      else
      {
        int num = (int) MessageBox.Show("Please select a fleet");
  ...
  private void cmdSMRefuel_Click(object sender, EventArgs e)
  {
    try
    {
      if (!this.method_18() || !(this.tvFleetList.SelectedNode.Tag is GClass40))
        return;
      GClass40 tag = (GClass40) this.tvFleetList.SelectedNode.Tag;
      tag.decimal_14 = (Decimal) tag.gclass22_0.int_63;
      this.method_9();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 1010);
    }
  }
  ...
  private void cmdPartialRefuel_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      tag.decimal_14 = !(num2 < (Decimal) int32) ? (Decimal) int32 : num2;
      this.method_9();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 1011);
    }
  }
  ...
  private void cmdSaveTemplate_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else if (this.tvFleetList.SelectedNode.Tag is GClass85)
      {
        ...
        if (this.gclass0_0.bool_21)
          return;
        GClass144 gclass144 = new GClass144(this.gclass0_0);
        gclass144.int_0 = this.gclass0_0.method_26(GEnum0.const_45);
        gclass144.gclass21_0 = tag.gclass21_0;
        gclass144.gclass202_0 = tag.gclass202_0;
        gclass144.string_0 = this.gclass0_0.string_4;
        this.gclass0_0.dictionary_33.Add(gclass144.int_0, gclass144);
  ...
  private void cmdDeleteTemplate_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else if (this.tvFleetList.SelectedNode.Tag is GClass85)
      {
        ...
        {
          GClass144 tag2 = (GClass144) this.lstvSystemLocations.SelectedItems[0].Tag;
          if (MessageBox.Show($" Are you sure you want to delete {tag2.string_0}?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes || !this.gclass0_0.dictionary_33.ContainsKey(tag2.int_0))
            return;
          this.gclass0_0.dictionary_33.Remove(tag2.int_0);
          this.gclass21_0.method_117(this.lstvSystemLocations, tag1.gclass202_0);
        }
      }
      else
      {
  ...
  private void cmdMoveFleetToPop_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else if (this.tvFleetList.SelectedNode.Tag is GClass85)
      {
        ...
        {
          GClass146 selectedValue = (GClass146) this.lstMoveFleet.SelectedValue;
          ...
          {
            tag.gclass1_0 = selectedValue.gclass1_0;
            tag.gclass202_0 = selectedValue.gclass202_0;
            tag.gclass146_0 = selectedValue;
            tag.double_2 = selectedValue.gclass1_0.double_0;
            tag.double_3 = selectedValue.gclass1_0.double_1;
            tag.method_167(this.lstvShips, (GClass84) null, (GClass70) null, this.lblLocation, this.lblCommander, this.lblFleetData, this.lblCapacity, this.lblDefault, this.lblClassSummary, this.lstvHistory, this.chkCycle, this.txtSurveyRadius);
          }
        }
      }
  ...
  private void cmdAwardMedal_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      // ISSUE: reference to a compiler-generated field
      class1015.list_0 = new List<GClass40>();
      string str = "";
      GClass55 gclass55 = (GClass55) null;
      if (this.tvFleetList.SelectedNode.Tag is GClass40)
      {
        this.gclass40_0 = (GClass40) this.tvFleetList.SelectedNode.Tag;
        // ISSUE: reference to a compiler-generated field
      ...
      else if (this.tvFleetList.SelectedNode.Tag is GClass84)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        class1016.gclass84_0 = (GClass84) this.tvFleetList.SelectedNode.Tag;
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated method
        class1015.list_0 = this.gclass0_0.dictionary_4.Values.Where<GClass40>(new Func<GClass40, bool>(class1016.method_0)).ToList<GClass40>();
        // ISSUE: reference to a compiler-generated field
        str = class1016.gclass84_0.string_0;
      }
      else if (this.tvFleetList.SelectedNode.Tag is GClass70)
      {
        // ISSUE: object of a compiler-generated type is created
        ...
        // ISSUE: reference to a compiler-generated field
        class1017.gclass70_0 = (GClass70) this.tvFleetList.SelectedNode.Tag;
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated method
        class1015.list_0 = this.gclass0_0.dictionary_4.Values.Where<GClass40>(new Func<GClass40, bool>(class1017.method_0)).ToList<GClass40>();
        // ISSUE: reference to a compiler-generated field
      ...
      if (this.gclass0_0.gclass42_0 == null)
        return;
      if (MessageBox.Show($" Are you sure you want to award the {this.gclass0_0.gclass42_0.string_0} to all officers of {str} with the selected command types?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
        return;
      // ISSUE: reference to a compiler-generated method
      List<GClass55> list = this.gclass0_0.dictionary_42.Values.Where<GClass55>(new Func<GClass55, bool>(class1015.method_0)).ToList<GClass55>();
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated method
      class1015.list_1 = this.gclass0_0.dictionary_71.Values.Where<GClass103>((Func<GClass103, bool>) (gclass103_0 => gclass103_0.gclass40_0 != null)).Where<GClass103>(new Func<GClass103, bool>(class1015.method_1)).ToList<GClass103>();
      // ISSUE: reference to a compiler-generated method
      list.AddRange((IEnumerable<GClass55>) this.gclass0_0.dictionary_42.Values.Where<GClass55>((Func<GClass55, bool>) (gclass55_0 => gclass55_0.gclass103_0 != null)).Where<GClass55>(new Func<GClass55, bool>(class1015.method_2)).ToList<GClass55>());
      if (gclass55 != null)
        list.Add(gclass55);
  ...
  private void chkLogNonArmed_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass21_0 == null)
        return;
      this.gclass21_0.method_352(this.lstvLogisticsReport, (AuroraLogisticsSortType) this.cboSortType.SelectedIndex, this.chkLogExcTanker.CheckState, this.chkLogExcludeFighter.CheckState, this.chkLogExcludeFAC.CheckState, this.chkLogExcludeSY.CheckState, this.chkLogNonArmed.CheckState, this.chkLogSupplyShip.CheckState);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 1017);
    }
  }
  ...
  private void lstvOrdnanceTemplate_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      if (this.lstvOrdnanceTemplate.SelectedItems.Count <= 0)
        return;
      this.gclass129_0 = (GClass129) this.lstvOrdnanceTemplate.SelectedItems[0].Tag;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 1019);
    }
  }
  ...
  public int method_19()
  {
    ...
    {
      GClass226.smethod_74(ex, 1023 /*0x03FF*/);
      return 0;
    }
  }
  ...
  private void cmdCopyClassLoadout_Click(object sender, EventArgs e)
  {
    ...
    {
      GClass226.smethod_74(ex, 1024 /*0x0400*/);
    }
  }
  ...
  private void cmdSMFillClass_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass40_0 == null)
        return;
      foreach (GClass40 gclass40 in this.gclass0_0.dictionary_4.Values.Where<GClass40>((Func<GClass40, bool>) (gclass40_2 => gclass40_2.gclass22_0 == this.gclass40_0.gclass22_0)).ToList<GClass40>())
        gclass40.method_62(false);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 1026);
    }
  }
  ...
  private void method_20(GEnum61 genum61_0)
  {
    try
    {
      GClass85 gclass85 = (GClass85) null;
      GClass40 gclass40_1 = (GClass40) null;
      if (this.tvFleetList.SelectedNode == null)
        return;
      if (this.tvFleetList.SelectedNode.Tag is GClass40)
      {
        gclass40_1 = (GClass40) this.tvFleetList.SelectedNode.Tag;
        if (gclass40_1 != null)
          gclass85 = gclass40_1.gclass85_0;
      }
      else if (this.tvFleetList.SelectedNode.Tag is GClass85)
        gclass85 = (GClass85) this.tvFleetList.SelectedNode.Tag;
      if (gclass85 == null)
        return;
      List<GClass40> gclass40List = new List<GClass40>();
      foreach (GClass40 gclass40_2 in genum61_0 != GEnum61.const_2 ? gclass85.method_177() : gclass85.method_176())
      {
        gclass40_2.method_31(genum61_0);
        if (this.gclass0_0.int_87 == 1 && !gclass40_2.bool_15 && (genum61_0 == GEnum61.const_1 || genum61_0 == GEnum61.const_3 || genum61_0 == GEnum61.const_4))
        {
  ...
  private void method_21()
  {
    try
    {
      ...
      if (gclass85 == null)
        return;
      foreach (GClass40 gclass40_2 in gclass85.method_177())
      {
        gclass40_2.method_32((GClass36) null);
        if (this.gclass0_0.int_87 == 1)
        {
  ...
  private void method_22(AuroraComponentType auroraComponentType_0, CheckState checkState_0)
  {
    try
    {
      ...
      if (this.tvFleetList.SelectedNode.Tag is GClass40)
      {
        gclass40 = (GClass40) this.tvFleetList.SelectedNode.Tag;
        if (gclass40 != null)
  ...
  private void cmdFleetText_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        GClass85 gclass85_1 = (GClass85) null;
        if (this.tvFleetList.SelectedNode == null)
          return;
        if (this.tvFleetList.SelectedNode.Tag is GClass85)
          gclass85_1 = (GClass85) this.tvFleetList.SelectedNode.Tag;
        if (gclass85_1 == null)
          return;
        int num2 = (int) new PopulationText(gclass85_1, this.gclass0_0, this.chkIncFAC.CheckState, this.chkIncFighter.CheckState).ShowDialog();
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 1038);
    }
  }
  ...
  private void chkRetainData_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      if (tag == null)
        return;
      tag.int_14 = GClass226.smethod_29(this.chkRetainData.CheckState);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 1039);
    }
  }
  ...
  private void cmdClearTarget_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.tvFleetList.SelectedNode.Tag is GClass40)
      {
        ...
        {
          if (!(this.tvCombatAssignment.SelectedNode.Tag is GClass36))
            return;
          GClass36 tag2 = (GClass36) this.tvCombatAssignment.SelectedNode.Tag;
          tag2.int_1 = 0;
          tag2.auroraContactType_0 = AuroraContactType.None;
          if (this.gclass40_0 == null)
            return;
          this.gclass40_0.method_37(this.tvCombatAssignment, this.tvTargets, this.bool_1);
        }
  ...
  private void cmdClearAllTargets_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        GClass40 tag = (GClass40) this.tvFleetList.SelectedNode.Tag;
        foreach (GClass36 gclass36 in this.gclass40_0.list_4)
        {
          gclass36.int_1 = 0;
    ...
    try
    {
      ...
      else if (this.tvFleetList.SelectedNode.Tag is GClass85)
      {
        ...
        else
        {
          ...
          {
            tag.gclass1_0 = selectedValue.gclass1_0;
            tag.gclass202_0 = tag.gclass21_0.method_128(selectedValue.gclass200_0);
            tag.method_6();
            tag.double_2 = selectedValue.double_0;
            tag.double_3 = selectedValue.double_1;
            tag.method_167(this.lstvShips, (GClass84) null, (GClass70) null, this.lblLocation, this.lblCommander, this.lblFleetData, this.lblCapacity, this.lblDefault, this.lblClassSummary, this.lstvHistory, this.chkCycle, this.txtSurveyRadius);
          }
        }
      }
  ...
  private void chkCurrentSystem_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      if (this.tvFleetList.SelectedNode.Tag is GClass85)
      {
        this.gclass21_0.method_383(this.tvThreat, this.tvAnchor, (GClass85) this.tvFleetList.SelectedNode.Tag, this.chkCurrentContact.CheckState, this.chkCurrentSystem.CheckState);
      }
      else
      {
        int num = (int) MessageBox.Show("Please select a fleet");
  ...
  private void cmdClearAnchor_Click(object sender, EventArgs e)
  {
    ...
    {
      GClass226.smethod_74(ex, 3327 /*0x0CFF*/);
    }
  }
  ...
  private void cmdClearThreat_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        GClass85 tag = (GClass85) this.tvFleetList.SelectedNode.Tag;
        tag.gclass117_0 = (GClass117) null;
        tag.method_259(this.lstvFormation);
      }
      else
      {
    ...
    {
      GClass226.smethod_74(ex, 3328 /*0x0D00*/);
    }
  }
  ...
  private void cmdSetDistance_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      if (this.tvFleetList.SelectedNode.Tag is GClass85)
      {
        ...
        if (this.gclass0_0.bool_21)
          return;
        tag.double_0 = Convert.ToDouble(this.gclass0_0.string_4);
        tag.method_259(this.lstvFormation);
      }
      else
      {
  ...
  private void cmdSetOffset_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      if (this.tvFleetList.SelectedNode.Tag is GClass85)
      {
        ...
        if (this.gclass0_0.bool_21)
          return;
        tag.int_2 = Convert.ToInt32(this.gclass0_0.string_4);
        tag.method_259(this.lstvFormation);
      }
      else
      {
  ...
  private void cmdSetAnchor_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        GClass85 tag1 = (GClass85) this.tvFleetList.SelectedNode.Tag;
        if (this.tvAnchor.SelectedNode.Tag is GClass85)
        {
          GClass85 tag2 = (GClass85) this.tvAnchor.SelectedNode.Tag;
          tag1.gclass85_1 = tag2;
  ...
  private void cmdDetachEscorts_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        // ISSUE: object of a compiler-generated type is created
        // ISSUE: reference to a compiler-generated method
        foreach (GClass84 gclass84_0 in this.gclass0_0.dictionary_2.Values.Where<GClass84>(new Func<GClass84, bool>(new FleetWindow.Class1018()
        {
          gclass85_0 = (GClass85) this.tvFleetList.SelectedNode.Tag
        }.method_0)).ToList<GClass84>())
        {
          // ISSUE: object of a compiler-generated type is created
          // ISSUE: variable of a compiler-generated type
          FleetWindow.Class1019 class1019 = new FleetWindow.Class1019();
          // ISSUE: reference to a compiler-generated field
          class1019.gclass85_0 = gclass84_0.gclass85_0.method_70(gclass84_0, false);
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated method
          foreach (GClass40 gclass40 in class1019.gclass85_0.method_176().Where<GClass40>((Func<GClass40, bool>) (gclass40_0 => gclass40_0.gclass40_0 != null)).Where<GClass40>(new Func<GClass40, bool>(class1019.method_0)).ToList<GClass40>())
            gclass40.gclass40_0 = (GClass40) null;
        }
        this.gclass21_0.method_355(this.tvFleetList, (GClass202) null, false, GClass226.smethod_27(this.chkIncludeCivilians.CheckState), this.txtSystemOOB);
      }
  ...
  private void cmdRecallEscorts_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        // ISSUE: reference to a compiler-generated field
        class1020.gclass85_0 = (GClass85) this.tvFleetList.SelectedNode.Tag;
        // ISSUE: reference to a compiler-generated method
        foreach (GClass85 gclass85 in this.gclass0_0.dictionary_1.Values.Where<GClass85>(new Func<GClass85, bool>(class1020.method_0)).ToList<GClass85>())
        {
          gclass85.method_263();
          // ISSUE: reference to a compiler-generated field
          gclass85.method_222(class1020.gclass85_0, GEnum123.const_76);
        }
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3339);
    }
  }
  ...
  private void method_24(GClass55 gclass55_0)
  {
    try
    {
      if (gclass55_0 == null)
        return;
      CommandersWindow commandersWindow = Application.OpenForms.OfType<CommandersWindow>().FirstOrDefault<CommandersWindow>();
      ...
      else
      {
        ...
        this.gclass0_0.object_0 = (object) commandersWindow;
      }
      commandersWindow.method_5(gclass55_0);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3390);
    }
  }
  ...
  private void lblCommander_DoubleClick(object sender, EventArgs e)
  {
    try
    {
      if (this.tvFleetList.SelectedNode == null || this.tvFleetList.SelectedNode.Tag == null || !(this.tvFleetList.SelectedNode.Tag is GClass85))
        return;
      this.method_24(((GClass85) this.tvFleetList.SelectedNode.Tag).method_162());
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3389);
    }
  }
  ...
  private void lstvShips_MouseDoubleClick(object sender, MouseEventArgs e)
  {
    try
    {
      if (this.tvFleetList.SelectedNode == null || this.tvFleetList.SelectedNode.Tag == null || !(this.tvFleetList.SelectedNode.Tag is GClass85) || this.lstvShips.SelectedItems.Count == 0)
        return;
      GClass40 tag1 = (GClass40) this.lstvShips.SelectedItems[0].Tag;
      if (tag1 == null)
        return;
      if (Control.ModifierKeys == Keys.Control)
      {
        GClass40 tag2 = (GClass40) this.lstvShips.HitTest(e.X, e.Y).Item.Tag;
        if (tag2 == null)
          return;
  ...
  private void cmdTransfer_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        GClass85 tag = (GClass85) this.tvFleetList.SelectedNode.Tag;
        GClass110 selectedValue = (GClass110) this.cboTransferRace.SelectedValue;
        if (selectedValue == null)
          return;
        GClass21 gclass210 = selectedValue.gclass21_0;
        if (gclass210 == tag.gclass21_0)
        {
        ...
        else
        {
          ...
          this.gclass0_0.dictionary_1.Remove(tag.int_3);
    ...
    try
    {
      ...
      else
      {
        if (!(this.tvFleetList.SelectedNode.Tag is GClass85))
          return;
        GClass85 tag = (GClass85) this.tvFleetList.SelectedNode.Tag;
        List<GClass40> gclass40List = tag.method_177();
        if (this.cmdActive2.Text == "Active On")
        {
  ...
  private void chkSelectOnMap_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      if (this.chkSelectOnMap.CheckState == CheckState.Unchecked || this.tvFleetList.SelectedNode == null || this.tvFleetList.SelectedNode.Tag == null || !(this.tvFleetList.SelectedNode.Tag is GClass85))
        return;
      this.gclass0_0.method_522((GClass85) this.tvFleetList.SelectedNode.Tag);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3403);
    }
  }
  ...
  private void chkAssumeJumpCapable_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        GClass85 tag = (GClass85) this.tvFleetList.SelectedNode.Tag;
        tag.bool_10 = GClass226.smethod_27(this.chkAssumeJumpCapable.CheckState);
        this.method_6(tag);
      }
      else
      {
  ...
  private void chkAutoAssign_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      else if (this.gclass83_0 == null)
      {
        ...
        this.gclass83_0.bool_1 = GClass226.smethod_27(this.chkAutoAssign.CheckState);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3486);
    }
  }
  ...
  private void cboBonusOne_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      else if (this.gclass83_0 == null)
      {
        ...
        this.gclass83_0.genum121_0 = ((GClass50) this.cboBonusOne.SelectedItem).genum121_0;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3488);
    }
  }
  ...
  private void cboBonusThree_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      else if (this.gclass83_0 == null)
      {
        ...
        this.gclass83_0.genum121_2 = ((GClass50) this.cboBonusThree.SelectedItem).genum121_0;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3489);
    }
  }
  ...
  private void cboBonusTwo_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      else if (this.gclass83_0 == null)
      {
        ...
        this.gclass83_0.genum121_1 = ((GClass50) this.cboBonusTwo.SelectedItem).genum121_0;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3490);
    }
  }
  ...
  private void cboNavalRanks_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        this.gclass83_0.int_3 = ((GClass61) this.cboNavalRanks.SelectedItem).int_1;
  ...
  private void cmdSetHullNumber_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else if (this.tvFleetList.SelectedNode.Tag is GClass40)
      {
        ...
        {
          gclass40_0 = (GClass40) this.tvFleetList.SelectedNode.Tag
        };
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        class1021.int_0 = Convert.ToInt32(this.gclass0_0.method_562("Enter New Hull Number", class1021.gclass40_0.int_20.ToString()));
        // ISSUE: reference to a compiler-generated field
        ...
        {
          // ISSUE: reference to a compiler-generated field
          if (!this.gclass21_0.dictionary_15.ContainsKey(class1021.gclass40_0.gclass22_0.gclass76_0))
          {
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            ...
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            this.gclass21_0.dictionary_15.Add(class1021.gclass40_0.gclass22_0.gclass76_0, class1021.int_0);
            // ISSUE: reference to a compiler-generated field
          ...
          {
            // ISSUE: reference to a compiler-generated method
            GClass40 gclass40 = this.gclass0_0.dictionary_4.Values.FirstOrDefault<GClass40>(new Func<GClass40, bool>(class1021.method_0));
            if (gclass40 != null)
            {
              // ISSUE: reference to a compiler-generated field
              int num4 = (int) MessageBox.Show($"Hull number {class1021.int_0.ToString()} is already assigned to {gclass40.method_187()}");
              return;
            }
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            ...
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            if (class1021.int_0 > this.gclass21_0.dictionary_15[class1021.gclass40_0.gclass22_0.gclass76_0])
            {
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              this.gclass21_0.dictionary_15[class1021.gclass40_0.gclass22_0.gclass76_0] = class1021.int_0;
            }
            // ISSUE: reference to a compiler-generated field
            this.tvFleetList.SelectedNode.Text = class1021.gclass40_0.method_187();
          }
          int int_40 = GClass226.smethod_67(this.txtTargetSpeed.Text);
          int int_41 = GClass226.smethod_67(this.txtRangeBand.Text);
          int int_42 = GClass226.smethod_67(this.txtRepairChanceTime.Text);
          // ISSUE: reference to a compiler-generated field
          this.txtShipSummary.Text = class1021.gclass40_0.method_164(int_40, int_41, this.cboRefuelActive, this.cboResupplyActive, this.cboTransferActive, this.cboHangar, this.flpEnergyWeaponData, this.lstvMeasurement, this.lstvLogistics, this.lstvCrew, this.lstvOrdnance, this.lstvOfficers, this.lstvDAC, this.lstvDamageControlQueue, this.lstvMeasurement, this.lstvShipHistory, int_42);
        }
      }
      else
      {
  ...
  private void cmdCreateSquadron_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        GClass40 tag = (GClass40) this.tvFleetList.SelectedNode.Tag;
        GClass70 gclass70 = this.gclass21_0.method_342(tag);
        if (gclass70 == null)
          return;
  ...
  private void cmdLaunchAll_Click(object sender, EventArgs e)
  {
    try
    {
      List<GClass40> source1 = new List<GClass40>();
      GClass85 gclass85_1 = new GClass85(this.gclass0_0);
      if (this.gclass21_0 == null)
      {
        int num1 = (int) MessageBox.Show("Please select a race");
      }
      ...
      else
      {
        ...
        {
          GClass85 tag = (GClass85) this.tvFleetList.SelectedNode.Tag;
          source1 = tag.method_176().Where<GClass40>((Func<GClass40, bool>) (gclass40_0 => gclass40_0.gclass40_0 != null)).Where<GClass40>((Func<GClass40, bool>) (gclass40_0 => gclass40_0.gclass40_0.gclass40_0 == null)).ToList<GClass40>();
          gclass85_1 = this.gclass21_0.method_308(tag.FleetName + " Strikegroup", tag.gclass83_0, tag.gclass202_0, tag.double_2, tag.double_3, tag.gclass1_0, GEnum105.const_0);
        }
        else if (this.tvFleetList.SelectedNode.Tag is GClass84)
        {
          GClass84 tag = (GClass84) this.tvFleetList.SelectedNode.Tag;
          source1 = tag.method_0().Where<GClass40>((Func<GClass40, bool>) (gclass40_0 => gclass40_0.gclass40_0 != null)).Where<GClass40>((Func<GClass40, bool>) (gclass40_0 => gclass40_0.gclass40_0.gclass40_0 == null)).ToList<GClass40>();
          gclass85_1 = this.gclass21_0.method_308(tag.string_0 + " Strikegroup", tag.gclass85_0.gclass83_0, tag.gclass85_0.gclass202_0, tag.gclass85_0.double_2, tag.gclass85_0.double_3, tag.gclass85_0.gclass1_0, GEnum105.const_0);
        }
        else if (this.tvFleetList.SelectedNode.Tag is GClass40)
        {
          GClass40 tag = (GClass40) this.tvFleetList.SelectedNode.Tag;
          source1 = tag.method_205();
          gclass85_1 = this.gclass21_0.method_308(tag.ShipName + " Strikegroup", tag.gclass85_0.gclass83_0, tag.gclass85_0.gclass202_0, tag.gclass85_0.double_2, tag.gclass85_0.double_3, tag.gclass85_0.gclass1_0, GEnum105.const_0);
        }
        List<GClass70> list = source1.Where<GClass40>((Func<GClass40, bool>) (gclass40_0 => gclass40_0.gclass70_0 != null)).Select<GClass40, GClass70>((Func<GClass40, GClass70>) (gclass40_0 => gclass40_0.gclass70_0)).Distinct<GClass70>().ToList<GClass70>();
        List<GClass84> source2 = new List<GClass84>();
        foreach (GClass70 gclass70 in list)
        {
          GClass84 gclass84 = gclass85_1.method_89(gclass70.SquadronName);
          source2.Add(gclass84);
        }
        foreach (GClass40 gclass40 in source1)
        {
          // ISSUE: object of a compiler-generated type is created
          // ISSUE: variable of a compiler-generated type
          ...
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated method
          class1022.gclass40_0.gclass84_0 = class1022.gclass40_0.gclass70_0 == null ? (GClass84) null : source2.FirstOrDefault<GClass84>(new Func<GClass84, bool>(class1022.method_0));
          // ISSUE: reference to a compiler-generated field
          class1022.gclass40_0.gclass40_0 = (GClass40) null;
          // ISSUE: reference to a compiler-generated field
          class1022.gclass40_0.gclass70_0 = (GClass70) null;
          // ISSUE: reference to a compiler-generated field
          class1022.gclass40_0.method_185(gclass85_1, true, false, false, true);
        }
        this.gclass21_0.genum42_0 = GEnum42.const_2;
        this.gclass21_0.int_43 = gclass85_1.int_3;
        this.gclass21_0.method_355(this.tvFleetList, (GClass202) null, false, GClass226.smethod_27(this.chkIncludeCivilians.CheckState), this.txtSystemOOB);
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3541);
    }
  }
  ...
  private void cmdMinAMMRange_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        GClass36 tag = (GClass36) this.tvCombatAssignment.SelectedNode.Tag;
        if (tag.gclass230_0.gclass231_0.auroraComponentType_0 != AuroraComponentType.MissileFireControl)
        {
        ...
        else
        {
          ...
          this.gclass0_0.string_4 = tag.double_0.ToString();
          int num3 = (int) new MessageEntry(this.gclass0_0).ShowDialog();
          if (!this.gclass0_0.bool_21)
            tag.double_0 = GClass226.smethod_3(this.gclass0_0.string_4, 0.0);
          this.gclass40_0.method_37(this.tvCombatAssignment, this.tvTargets, this.bool_1);
        }
      }
      else
  ...
  private void cmdDecoyThreshold_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        int num2 = (int) new MessageEntry(this.gclass0_0).ShowDialog();
        if (!this.gclass0_0.bool_21)
          this.gclass40_0.int_23 = GClass226.smethod_67(this.gclass0_0.string_4);
        this.gclass40_0.method_37(this.tvCombatAssignment, this.tvTargets, this.bool_1);
      }
    }
    catch (Exception ex)
  ...
  private void ckhTarget_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      if (tag == null)
        return;
      tag.int_24 = GClass226.smethod_29(this.ckhTarget.CheckState);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3741);
    }
  }
  ...
  private void cmdDeleteSalvo_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        if (MessageBox.Show($" Are you sure you want to delete {this.gclass132_0.string_0}?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
          return;
  ...
  private void txtSurveyRadius_TextChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        if (tag == null)
          return;
        GClass208 gclass208 = GClass226.smethod_4(this.txtSurveyRadius.Text);
        if (gclass208.bool_0)
        {
          tag.long_0 = (long) gclass208.decimal_0;
          if (tag.long_0 >= 0L)
            return;
          tag.long_0 = 0L;
  ...
  private void cmdTemp_Click(object sender, EventArgs e)
  {
    try
    {
      foreach (GClass187 gclass187 in this.gclass0_0.dictionary_8.Values.Where<GClass187>((Func<GClass187, bool>) (gclass187_0 => gclass187_0.decimal_0 == 0M)).ToList<GClass187>())
      {
        // ISSUE: object of a compiler-generated type is created
        // ISSUE: variable of a compiler-generated type
        ...
        // ISSUE: reference to a compiler-generated method
        foreach (GClass22 gclass22 in this.gclass0_0.dictionary_3.Values.Where<GClass22>(new Func<GClass22, bool>(class1023.method_0)).ToList<GClass22>())
        {
          // ISSUE: object of a compiler-generated type is created
          // ISSUE: reference to a compiler-generated method
          List<GClass40> list = this.gclass0_0.dictionary_4.Values.Where<GClass40>(new Func<GClass40, bool>(new FleetWindow.Class1024()
          {
            gclass22_0 = gclass22
          }.method_0)).ToList<GClass40>();
          if (list.Count > 15)
          {
  ...
  private void cmdScrap_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else if (this.tvFleetList.SelectedNode != null)
      {
        if (this.tvFleetList.SelectedNode.Tag is GClass85)
        {
          ...
          else if (this.tvFleetCargo.SelectedNode.Tag is GClass230)
          {
            GClass230 tag2 = (GClass230) this.tvFleetCargo.SelectedNode.Tag;
            foreach (GClass40 gclass40 in tag1.method_176())
              gclass40.method_47(tag2);
            this.gclass21_0.method_101(this.tvFleetCargo, tag1, (GClass84) null, (GClass70) null);
    ...
    {
      GClass226.smethod_74(ex, 3840 /*0x0F00*/);
    }
  }
  ...
  private void cmdScrapAll_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else if (this.tvFleetList.SelectedNode != null)
      {
        ...
        {
          GClass85 tag = (GClass85) this.tvFleetList.SelectedNode.Tag;
          if (MessageBox.Show($"Are you sure you want to scrap all components in {tag.FleetName}, except for researched non-obsolete components or those that can be disassembled?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
            return;
          List<GClass40> source = tag.method_176();
          List<GClass73> list1 = source.SelectMany<GClass40, GClass73>((Func<GClass40, IEnumerable<GClass73>>) (gclass40_0 => (IEnumerable<GClass73>) gclass40_0.list_17)).ToList<GClass73>();
          ...
          List<GClass230> list2 = list1.Where<GClass73>((Func<GClass73, bool>) (gclass73_0 => gclass73_0.bool_0)).Select<GClass73, GClass230>((Func<GClass73, GClass230>) (gclass73_0 => gclass73_0.gclass230_0)).Distinct<GClass230>().ToList<GClass230>();
          foreach (GClass40 gclass40 in source)
          {
            foreach (GClass230 gclass230_0 in list2)
              gclass40.method_47(gclass230_0);
          }
          this.gclass21_0.method_101(this.tvFleetCargo, tag, (GClass84) null, (GClass70) null);
          foreach (global::Events events in Application.OpenForms.OfType<global::Events>())
            events.method_0();
          if (this.gclass21_0.chkEvents != CheckState.Checked)
            return;
  ...
  private void cmdCollapseAll_Click(object sender, EventArgs e)
  {
    try
    {
      foreach (GClass85 gclass85 in this.gclass0_0.dictionary_1.Values)
        gclass85.bool_16 = false;
      foreach (GClass84 gclass84 in this.gclass0_0.dictionary_2.Values)
        gclass84.bool_0 = false;
      foreach (GClass40 gclass40 in this.gclass0_0.dictionary_4.Values)
      {
        gclass40.bool_12 = false;
        foreach (GClass70 gclass70 in gclass40.dictionary_0.Values)
          gclass70.bool_0 = false;
      }
      foreach (GClass83 gclass83 in this.gclass0_0.dictionary_0.Values)
        gclass83.bool_0 = false;
      this.gclass21_0.method_355(this.tvFleetList, (GClass202) null, false, GClass226.smethod_27(this.chkIncludeCivilians.CheckState), this.txtSystemOOB);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3856);
    }
  }
  ...
  private void method_25(bool bool_3)
  {
    try
    {
      ...
      else if (this.tvFleetList.SelectedNode.Tag is GClass85)
      {
        ...
        else if (this.tvStandingOrders.SelectedNode.Tag is GClass136)
        {
          GClass136 tag2 = (GClass136) this.tvStandingOrders.SelectedNode.Tag;
          if (tag1 == null)
            return;
          int key = 1;
          if (tag1.dictionary_1.Count > 0)
            key = tag1.dictionary_1.Max<KeyValuePair<int, GClass136>>((Func<KeyValuePair<int, GClass136>, int>) (keyValuePair_0 => keyValuePair_0.Key)) + 1;
          if (!bool_3)
          {
            tag1.dictionary_1.Add(key, tag2);
          }
          else
          {
            ...
            GClass137 tag3 = (GClass137) this.lstvConditionOne.SelectedItems[0].Tag;
            if (tag1.dictionary_2.Count > 0)
              key = tag1.dictionary_2.Max<KeyValuePair<int, GClass138>>((Func<KeyValuePair<int, GClass138>, int>) (keyValuePair_0 => keyValuePair_0.Key)) + 1;
            int num5 = 0;
            if (this.chkSetFWP.CheckState == CheckState.Checked)
              num5 = 1;
            tag1.dictionary_2.Add(key, new GClass138()
            {
              auroraStandingOrder_0 = tag2.auroraStandingOrder_0,
              auroraFleetCondition_0 = tag3.auroraFleetCondition_0,
              int_0 = num5
            });
          }
    ...
    try
    {
      ...
      else if (this.tvFleetList.SelectedNode.Tag is GClass85)
      {
        ...
        else
        {
          ...
          if (this.lstvStandingOrdersList.SelectedItems[0].Tag is GClass136)
          {
            tag.dictionary_1.Remove(int32);
            tag.method_198(0);
          }
          else if (this.lstvStandingOrdersList.SelectedItems[0].Tag is GClass138)
          {
            tag.dictionary_2.Remove(int32);
            tag.method_199(0);
          }
    ...
    try
    {
      ...
      else if (this.tvFleetList.SelectedNode.Tag is GClass85)
      {
        ...
        else
        {
          ...
          if (this.lstvStandingOrdersList.SelectedItems[0].Tag is GClass136)
          {
            int num5 = tag1.dictionary_1.Max<KeyValuePair<int, GClass136>>((Func<KeyValuePair<int, GClass136>, int>) (keyValuePair_0 => keyValuePair_0.Key));
            if (int32 == num5 && !bool_3)
              return;
            GClass136 tag2 = (GClass136) this.lstvStandingOrdersList.SelectedItems[0].Tag;
            tag1.dictionary_1.Remove(int32);
            int num6 = int32 + 1;
            if (bool_3)
              num6 = int32 - 1;
            tag1.method_198(num6);
            tag1.dictionary_1.Add(num6, tag2);
          }
          else if (this.lstvStandingOrdersList.SelectedItems[0].Tag is GClass138)
          {
            int num7 = tag1.dictionary_2.Max<KeyValuePair<int, GClass138>>((Func<KeyValuePair<int, GClass138>, int>) (keyValuePair_0 => keyValuePair_0.Key));
            if (int32 == num7 && !bool_3)
              return;
            GClass138 tag3 = (GClass138) this.lstvStandingOrdersList.SelectedItems[0].Tag;
            tag1.dictionary_2.Remove(int32);
            int num8 = int32 + 1;
            if (bool_3)
              num8 = int32 - 1;
            tag1.method_199(num8);
            tag1.dictionary_2.Add(num8, tag3);
          }
          this.lblDefault.Text = tag1.method_173();
          tag1.method_197(this.lstvStandingOrdersList);
          if (bool_3)
  ...
  private void cmdCreateTemplate_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else if (this.tvFleetList.SelectedNode.Tag is GClass85)
      {
        ...
        if (tag == null)
          return;
        if (tag.dictionary_1.Count == 0 && tag.dictionary_2.Count == 0)
        {
          int num3 = (int) MessageBox.Show("Please select a fleet with one or more standing or conditional orders");
        }
        else
        {
          ...
          foreach (KeyValuePair<int, GClass136> keyValuePair in tag.dictionary_1)
            gclass135.dictionary_0.Add(keyValuePair.Key, keyValuePair.Value);
          foreach (KeyValuePair<int, GClass138> keyValuePair in tag.dictionary_2)
  ...
  private void cmdDeleteSOTemplate_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        if (MessageBox.Show($" Are you sure you want to delete {tag.string_0}?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
          return;
    ...
    try
    {
      ...
      else if (this.tvFleetList.SelectedNode.Tag is GClass85)
      {
        ...
        else
        {
          ...
          if ((tag1.dictionary_1.Count > 0 || tag1.dictionary_2.Count > 0) && MessageBox.Show($" Are you sure you want to replace the existing standing and conditional orders with {tag2.string_0}?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
            return;
          tag1.dictionary_1.Clear();
          tag1.dictionary_2.Clear();
          foreach (KeyValuePair<int, GClass136> keyValuePair in tag2.dictionary_0)
            tag1.dictionary_1.Add(keyValuePair.Key, keyValuePair.Value);
          foreach (KeyValuePair<int, GClass138> keyValuePair in tag2.dictionary_1)
            tag1.dictionary_2.Add(keyValuePair.Key, keyValuePair.Value);
          this.lblDefault.Text = tag1.method_173();
          tag1.method_197(this.lstvStandingOrdersList);
        }
      }
  ...
  private void cmdDeleteAll_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else if (this.tvFleetList.SelectedNode.Tag is GClass85)
      {
        ...
        if (tag == null)
          return;
        tag.dictionary_1.Clear();
        tag.dictionary_2.Clear();
        this.lblDefault.Text = tag.method_173();
        tag.method_197(this.lstvStandingOrdersList);
      }
      else
  ...
  private void cmdCreateFleetWaypoint_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        ((GClass85) this.tvFleetList.SelectedNode.Tag)?.method_0(true, (GClass200) null, (GClass1) null, 0.0, 0.0);
      }
      else
      {
        int num3 = (int) MessageBox.Show("Please select a fleet");
  ...
  private void chkDetachedStanding_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      if (this.tvFleetList.SelectedNode.Tag is GClass85)
      {
        ((GClass85) this.tvFleetList.SelectedNode.Tag).bool_11 = GClass226.smethod_27(this.chkDetachedStanding.CheckState);
      }
      else
      {
        int num = (int) MessageBox.Show("Please select a fleet");
  ...
  private void chkDetachedConditional_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      if (this.tvFleetList.SelectedNode.Tag is GClass85)
      {
        ((GClass85) this.tvFleetList.SelectedNode.Tag).bool_12 = GClass226.smethod_27(this.chkDetachedConditional.CheckState);
      }
      else
      {
        int num = (int) MessageBox.Show("Please select a fleet");
  ...
  private void chkIncludeSquadrons_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      if (this.tvFleetList.SelectedNode.Tag is GClass85)
      {
        ((GClass85) this.tvFleetList.SelectedNode.Tag).bool_13 = GClass226.smethod_27(this.chkIncludeSquadrons.CheckState);
      }
      else
      {
        int num = (int) MessageBox.Show("Please select a fleet");
  ...
  private void chkIgnoreSO_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      if (this.tvFleetList.SelectedNode.Tag is GClass85)
      {
        ((GClass85) this.tvFleetList.SelectedNode.Tag).bool_14 = GClass226.smethod_27(this.chkIgnoreSO.CheckState);
      }
      else
      {
        int num = (int) MessageBox.Show("Please select a fleet");
  ...
  private void chkIgnoreCO_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      if (this.tvFleetList.SelectedNode.Tag is GClass85)
      {
        ((GClass85) this.tvFleetList.SelectedNode.Tag).bool_15 = GClass226.smethod_27(this.chkIgnoreCO.CheckState);
      }
      else
      {
        int num = (int) MessageBox.Show("Please select a fleet");
  ...
  private void cmdClearFleetTargets_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      foreach (GClass40 gclass40 in gclass85.list_3)
      {
  ...
  private void chkOrders_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      this.gclass0_0.bool_4 = GClass226.smethod_27(this.chkOrders.CheckState);
      this.gclass21_0.method_355(this.tvFleetList, (GClass202) null, false, GClass226.smethod_27(this.chkIncludeCivilians.CheckState), this.txtSystemOOB);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3966);
    }
  }
  ...
  private void chkOverhauls_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      this.gclass0_0.bool_5 = GClass226.smethod_27(this.chkOverhauls.CheckState);
      this.gclass21_0.method_355(this.tvFleetList, (GClass202) null, false, GClass226.smethod_27(this.chkIncludeCivilians.CheckState), this.txtSystemOOB);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3967);
    }
  }
  ...
  private void chkShowJD_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      this.gclass0_0.bool_6 = GClass226.smethod_27(this.chkShowJD.CheckState);
      this.gclass21_0.method_355(this.tvFleetList, (GClass202) null, false, GClass226.smethod_27(this.chkIncludeCivilians.CheckState), this.txtSystemOOB);
    }
    catch (Exception ex)
    {
  ...
  private void InitializeComponent()
  {
    ...
    this.tvFleetList.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdRefresh.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdCreateSubFleet.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvShips.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvShips.SelectedIndexChanged += new EventHandler(this.lstvShips_SelectedIndexChanged);
    this.lstvShips.DoubleClick += new EventHandler(this.lstvShips_DoubleClick);
    this.lstvShips.MouseDoubleClick += new MouseEventHandler(this.lstvShips_MouseDoubleClick);
    ...
    this.tabNaval.Controls.Add((Control) this.tabPage3);
    this.tabNaval.Controls.Add((Control) this.tabPage4);
    ...
    this.tabFleetPages.Controls.Add((Control) this.tabFormation);
    ...
    this.txtMinDistance.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtOrderDelay.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtMaxItems.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtOrbDistance.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtMinAvailable.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.flpFleetOrderButtons.Controls.Add((Control) this.txtRepeatMultiple);
    ...
    this.flpFleetOrderButtons.Controls.Add((Control) this.cmdCreateFleetWaypoint);
    this.flpFleetOrderButtons.Controls.Add((Control) this.chkDefaultActions);
    ...
    this.cmdAddMove.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdCreatePop.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdRemoveLastOrder.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdRemoveAll.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdRepeat.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.txtRepeatMultiple.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.cmdSaveTemplate.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDeleteTemplate.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvLoadItems.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvLoadItems.DoubleClick += new EventHandler(this.lstvLoadItems_DoubleClick);
    ...
    this.lstvOrders.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvActions.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvActions.DoubleClick += new EventHandler(this.lstvActions_DoubleClick);
    ...
    this.lstvSystemLocations.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvSystemLocations.DoubleClick += new EventHandler(this.lstvSystemLocations_DoubleClick);
    ...
    this.chkAssumeJumpCapable.CheckedChanged += new EventHandler(this.chkAssumeJumpCapable_CheckedChanged);
    ...
    this.rdoSL.CheckedChanged += new EventHandler(this.rdoOrderTemplates_CheckedChanged);
    ...
    this.rdoARSystem.CheckedChanged += new EventHandler(this.rdoOrderTemplates_CheckedChanged);
    ...
    this.rdoOrderTemplates.CheckedChanged += new EventHandler(this.rdoOrderTemplates_CheckedChanged);
    ...
    this.chkPlanet.CheckedChanged += new EventHandler(this.chkFilterOrders_CheckedChanged);
    ...
    this.chkDwarf.CheckedChanged += new EventHandler(this.chkFilterOrders_CheckedChanged);
    ...
    this.chkMoon.CheckedChanged += new EventHandler(this.chkFilterOrders_CheckedChanged);
    ...
    this.chkComets.CheckedChanged += new EventHandler(this.chkFilterOrders_CheckedChanged);
    ...
    this.chkAst.CheckedChanged += new EventHandler(this.chkFilterOrders_CheckedChanged);
    ...
    this.chkFleets.CheckedChanged += new EventHandler(this.chkFilterOrders_CheckedChanged);
    ...
    this.chkContacts.CheckedChanged += new EventHandler(this.chkFilterOrders_CheckedChanged);
    ...
    this.chkExcludeTP.CheckedChanged += new EventHandler(this.chkFilterOrders_CheckedChanged);
    ...
    this.chkCivilian.CheckedChanged += new EventHandler(this.chkFilterOrders_CheckedChanged);
    ...
    this.chkLifepods.CheckedChanged += new EventHandler(this.chkFilterOrders_CheckedChanged);
    ...
    this.chkWrecks.CheckedChanged += new EventHandler(this.chkFilterOrders_CheckedChanged);
    ...
    this.chkWaypoint.CheckedChanged += new EventHandler(this.chkFilterOrders_CheckedChanged);
    ...
    this.chkLocation.CheckedChanged += new EventHandler(this.chkFilterOrders_CheckedChanged);
    ...
    this.chkExcSurveyed.CheckedChanged += new EventHandler(this.chkFilterOrders_CheckedChanged);
    ...
    this.chkFilterOrders.CheckedChanged += new EventHandler(this.chkFilterOrders_CheckedChanged);
    this.tabStandingOrders.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.tabStandingOrders.Controls.Add((Control) this.flowLayoutPanel29);
    this.tabStandingOrders.Controls.Add((Control) this.chkSetFWP);
    this.tabStandingOrders.Controls.Add((Control) this.cmdDeleteAll);
    this.tabStandingOrders.Controls.Add((Control) this.cmdDeleteSOTemplate);
    this.tabStandingOrders.Controls.Add((Control) this.cmdLoadTemplate);
    this.tabStandingOrders.Controls.Add((Control) this.cmdCreateTemplate);
    this.tabStandingOrders.Controls.Add((Control) this.lstvStandingOrderTemplates);
    this.tabStandingOrders.Controls.Add((Control) this.tvStandingOrders);
    this.tabStandingOrders.Controls.Add((Control) this.cmdAddCO);
    this.tabStandingOrders.Controls.Add((Control) this.cmdOrderDown);
    this.tabStandingOrders.Controls.Add((Control) this.cmdOrderUp);
    this.tabStandingOrders.Controls.Add((Control) this.cmdDeleteSO);
    this.tabStandingOrders.Controls.Add((Control) this.cmdAddSO);
    this.tabStandingOrders.Controls.Add((Control) this.lstvStandingOrdersList);
    ...
    this.flowLayoutPanel29.Controls.Add((Control) this.chkDetachedStanding);
    this.flowLayoutPanel29.Controls.Add((Control) this.chkDetachedConditional);
    this.flowLayoutPanel29.Controls.Add((Control) this.chkIncludeSquadrons);
    this.flowLayoutPanel29.Controls.Add((Control) this.chkIgnoreSO);
    this.flowLayoutPanel29.Controls.Add((Control) this.chkIgnoreCO);
    ...
    this.chkDetachedStanding.CheckedChanged += new EventHandler(this.chkDetachedStanding_CheckedChanged);
    ...
    this.chkDetachedConditional.CheckedChanged += new EventHandler(this.chkDetachedConditional_CheckedChanged);
    ...
    this.chkIncludeSquadrons.CheckedChanged += new EventHandler(this.chkIncludeSquadrons_CheckedChanged);
    ...
    this.chkIgnoreSO.CheckedChanged += new EventHandler(this.chkIgnoreSO_CheckedChanged);
    ...
    this.chkIgnoreCO.CheckedChanged += new EventHandler(this.chkIgnoreCO_CheckedChanged);
    ...
    this.cmdDeleteSOTemplate.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDeleteSOTemplate.Tag = (object) "1200";
    this.cmdDeleteSOTemplate.Text = "Delete Template";
    this.cmdDeleteSOTemplate.UseVisualStyleBackColor = false;
    this.cmdDeleteSOTemplate.Click += new EventHandler(this.cmdDeleteSOTemplate_Click);
    this.cmdLoadTemplate.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdLoadTemplate.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdLoadTemplate.Tag = (object) "1200";
    this.cmdLoadTemplate.Text = "Load Template";
    this.cmdLoadTemplate.UseVisualStyleBackColor = false;
    this.cmdLoadTemplate.Click += new EventHandler(this.cmdLoadTemplate_Click);
    this.cmdCreateTemplate.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdCreateTemplate.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdCreateTemplate.Tag = (object) "1200";
    this.cmdCreateTemplate.Text = "Create Template";
    this.cmdCreateTemplate.UseVisualStyleBackColor = false;
    this.cmdCreateTemplate.Click += new EventHandler(this.cmdCreateTemplate_Click);
    ...
    this.lstvStandingOrderTemplates.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tvStandingOrders.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdAddCO.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdAddCO.Tag = (object) "1200";
    this.cmdAddCO.Text = "Add Conditional";
    this.cmdAddCO.UseVisualStyleBackColor = false;
    this.cmdAddCO.Click += new EventHandler(this.cmdAddCO_Click);
    this.cmdOrderDown.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdOrderDown.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdOrderDown.Tag = (object) "1200";
    this.cmdOrderDown.Text = "Move Down";
    this.cmdOrderDown.UseVisualStyleBackColor = false;
    this.cmdOrderDown.Click += new EventHandler(this.cmdOrderDown_Click);
    this.cmdOrderUp.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdOrderUp.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdOrderUp.Tag = (object) "1200";
    this.cmdOrderUp.Text = "Move Up";
    this.cmdOrderUp.UseVisualStyleBackColor = false;
    this.cmdOrderUp.Click += new EventHandler(this.cmdOrderUp_Click);
    this.cmdDeleteSO.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdDeleteSO.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDeleteSO.Tag = (object) "1200";
    this.cmdDeleteSO.Text = "Delete Order";
    this.cmdDeleteSO.UseVisualStyleBackColor = false;
    this.cmdDeleteSO.Click += new EventHandler(this.cmdDeleteSO_Click);
    this.cmdAddSO.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdAddSO.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdAddSO.Tag = (object) "1200";
    this.cmdAddSO.Text = "Add Standing";
    this.cmdAddSO.UseVisualStyleBackColor = false;
    this.cmdAddSO.Click += new EventHandler(this.cmdAddSO_Click);
    ...
    this.lstvStandingOrdersList.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvConditionOne.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tabFormation.Controls.Add((Control) this.flowLayoutPanel20);
    this.tabFormation.Controls.Add((Control) this.tvAnchor);
    this.tabFormation.Controls.Add((Control) this.flowLayoutPanel23);
    this.tabFormation.Controls.Add((Control) this.lstvFormation);
    this.tabFormation.Controls.Add((Control) this.tvThreat);
    ...
    this.flowLayoutPanel20.Controls.Add((Control) this.chkCurrentContact);
    this.flowLayoutPanel20.Controls.Add((Control) this.chkCurrentSystem);
    ...
    this.chkCurrentContact.CheckedChanged += new EventHandler(this.chkCurrentSystem_CheckedChanged);
    ...
    this.chkCurrentSystem.CheckedChanged += new EventHandler(this.chkCurrentSystem_CheckedChanged);
    this.tvAnchor.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.tvAnchor.BorderStyle = BorderStyle.FixedSingle;
    this.tvAnchor.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.flowLayoutPanel23.Controls.Add((Control) this.cmdSetAnchor);
    this.flowLayoutPanel23.Controls.Add((Control) this.cmdSetThreat);
    this.flowLayoutPanel23.Controls.Add((Control) this.cmdClearAnchor);
    this.flowLayoutPanel23.Controls.Add((Control) this.cmdClearThreat);
    this.flowLayoutPanel23.Controls.Add((Control) this.cmdSetDistance);
    this.flowLayoutPanel23.Controls.Add((Control) this.cmdSetOffset);
    this.flowLayoutPanel23.Controls.Add((Control) this.cmdToggleWarship);
    this.flowLayoutPanel23.Controls.Add((Control) this.cmdToggleContact);
    this.flowLayoutPanel23.Controls.Add((Control) this.button1);
    ...
    this.cmdSetAnchor.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdSetAnchor.Tag = (object) "1200";
    this.cmdSetAnchor.Text = "Set Anchor Fleet";
    this.cmdSetAnchor.UseVisualStyleBackColor = false;
    this.cmdSetAnchor.Click += new EventHandler(this.cmdSetAnchor_Click);
    this.cmdSetThreat.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdSetThreat.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdSetThreat.Tag = (object) "1200";
    this.cmdSetThreat.Text = "Set Specific Threat";
    this.cmdSetThreat.UseVisualStyleBackColor = false;
    this.cmdSetThreat.Click += new EventHandler(this.cmdSetThreat_Click);
    this.cmdClearAnchor.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdClearAnchor.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdClearAnchor.Tag = (object) "1200";
    this.cmdClearAnchor.Text = "Clear Anchor Fleet";
    this.cmdClearAnchor.UseVisualStyleBackColor = false;
    this.cmdClearAnchor.Click += new EventHandler(this.cmdClearAnchor_Click);
    this.cmdClearThreat.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdClearThreat.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdClearThreat.Tag = (object) "1200";
    this.cmdClearThreat.Text = "Clear Specific Threat";
    this.cmdClearThreat.UseVisualStyleBackColor = false;
    this.cmdClearThreat.Click += new EventHandler(this.cmdClearThreat_Click);
    this.cmdSetDistance.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdSetDistance.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdSetDistance.Tag = (object) "1200";
    this.cmdSetDistance.Text = "Set Distance to Anchor";
    this.cmdSetDistance.UseVisualStyleBackColor = false;
    this.cmdSetDistance.Click += new EventHandler(this.cmdSetDistance_Click);
    this.cmdSetOffset.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdSetOffset.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdSetOffset.Tag = (object) "1200";
    this.cmdSetOffset.Text = "Set Bearing Offset";
    this.cmdSetOffset.UseVisualStyleBackColor = false;
    this.cmdSetOffset.Click += new EventHandler(this.cmdSetOffset_Click);
    this.cmdToggleWarship.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdToggleWarship.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdToggleWarship.Tag = (object) "1200";
    this.cmdToggleWarship.Text = "Toggle Hostile Warship";
    this.cmdToggleWarship.UseVisualStyleBackColor = false;
    this.cmdToggleWarship.Click += new EventHandler(this.cmdToggleWarship_Click);
    this.cmdToggleContact.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdToggleContact.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdToggleContact.Tag = (object) "1200";
    this.cmdToggleContact.Text = "Toggle Hostile Contact";
    this.cmdToggleContact.UseVisualStyleBackColor = false;
    this.cmdToggleContact.Click += new EventHandler(this.cmdToggleContact_Click);
    ...
    this.lstvFormation.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvFormation.DragDrop += new DragEventHandler(this.lstvFormation_DragDrop);
    ...
    this.tvThreat.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tabCargo.Controls.Add((Control) this.cmdScrapAll);
    this.tabCargo.Controls.Add((Control) this.cmdScrap);
    ...
    this.cmdScrapAll.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdScrapAll.Tag = (object) "1200";
    this.cmdScrapAll.Text = "Scrap All";
    this.cmdScrapAll.UseVisualStyleBackColor = false;
    this.cmdScrapAll.Visible = false;
    this.cmdScrapAll.Click += new EventHandler(this.cmdScrapAll_Click);
    this.cmdScrap.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdScrap.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdScrap.Visible = false;
    this.cmdScrap.Click += new EventHandler(this.cmdScrap_Click);
    ...
    this.tvFleetCargo.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvHistory.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tabFleetMisc.Controls.Add((Control) this.panel2);
    this.tabFleetMisc.Controls.Add((Control) this.panel1);
    this.tabFleetMisc.Controls.Add((Control) this.cmdMoveFleettoWP);
    this.tabFleetMisc.Controls.Add((Control) this.lstMoveWP);
    ...
    this.panel2.Controls.Add((Control) this.cboTransferRace);
    this.panel2.Controls.Add((Control) this.cmdTransfer);
    ...
    this.cboTransferRace.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdTransfer.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdTransfer.Tag = (object) "1200";
    this.cmdTransfer.Text = "Transfer Fleet";
    this.cmdTransfer.UseVisualStyleBackColor = false;
    this.cmdTransfer.Click += new EventHandler(this.cmdTransfer_Click);
    this.panel1.BorderStyle = BorderStyle.FixedSingle;
    this.panel1.Controls.Add((Control) this.chkIncFighter);
    this.panel1.Controls.Add((Control) this.chkIncFAC);
    this.panel1.Controls.Add((Control) this.cmdFleetText);
    ...
    this.cmdFleetText.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdMoveFleettoWP.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdMoveFleettoWP.Tag = (object) "1200";
    this.cmdMoveFleettoWP.Text = "Move Fleet";
    this.cmdMoveFleettoWP.UseVisualStyleBackColor = false;
    this.cmdMoveFleettoWP.Click += new EventHandler(this.cmdMoveFleettoWP_Click);
    this.lstMoveWP.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.lstMoveWP.BorderStyle = BorderStyle.FixedSingle;
    this.lstMoveWP.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdMoveFleetToPop.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstMoveFleet.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.flowLayoutPanel15.Controls.Add((Control) this.label11);
    this.flowLayoutPanel15.Controls.Add((Control) this.txtSurveyRadius);
    ...
    this.txtSurveyRadius.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtSurveyRadius.TextChanged += new EventHandler(this.txtSurveyRadius_TextChanged);
    ...
    this.lblCommander.Click += new EventHandler(this.lblCommander_Click);
    this.lblCommander.DoubleClick += new EventHandler(this.lblCommander_DoubleClick);
    ...
    this.lstvOfficers.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvOfficers.DoubleClick += new EventHandler(this.lstvOfficers_DoubleClick);
    ...
    this.lstvCrew.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvLogistics.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvOrdnance.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvMeasurement.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboRefuelActive.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboResupplyActive.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboResupplyActive.SelectedIndexChanged += new EventHandler(this.cboResupplyActive_SelectedIndexChanged);
    this.cboTransferActive.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cboTransferActive.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboHangar.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.txtTargetSpeed.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtRangeBand.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtShipSummary.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.txtClassDisplay.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvClassTemplate.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvShipTemplate.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvShipLoadout.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.chkObsoleteMissiles.CheckedChanged += new EventHandler(this.checkBox1_CheckedChanged);
    ...
    this.cmdRenameMissile.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdObsoleteMissile.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdCopyClassLoadout.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdCopyToClass.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdCopyToFleet.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdFillShip.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdSMFillClass.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvOrdnanceTemplate.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tvShipCargo.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdRepair.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdSMRepair.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdAutoQueue.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.txtRepairChanceTime.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.cmdTop.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdRemove.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDown.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdUp.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvDamageControlQueue.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvDAC.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tabPage8.Controls.Add((Control) this.lstvShipHistory);
    ...
    this.lstvShipHistory.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tabMiscellaneous.Controls.Add((Control) this.flowLayoutPanel6);
    ...
    this.flowLayoutPanel6.Controls.Add((Control) this.cmdSMRefuel);
    this.flowLayoutPanel6.Controls.Add((Control) this.cmdPartialRefuel);
    this.flowLayoutPanel6.Controls.Add((Control) this.cmdAbandonShip);
    this.flowLayoutPanel6.Controls.Add((Control) this.cmdSetHullNumber);
    ...
    this.cmdSMRefuel.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdPartialRefuel.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdAbandonShip.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdSetHullNumber.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdSetHullNumber.Tag = (object) "1200";
    this.cmdSetHullNumber.Text = "Select Hull Num";
    this.cmdSetHullNumber.UseVisualStyleBackColor = false;
    this.cmdSetHullNumber.Click += new EventHandler(this.cmdSetHullNumber_Click);
    ...
    this.flowLayoutPanel13.Controls.Add((Control) this.label14);
    this.flowLayoutPanel13.Controls.Add((Control) this.chkRetainData);
    this.flowLayoutPanel13.Controls.Add((Control) this.ckhTarget);
    ...
    this.txtFuelPriority.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtSupplyPriority.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.ckhTarget.Size = new Size((int) sbyte.MaxValue, 17);
    ...
    this.ckhTarget.CheckedChanged += new EventHandler(this.ckhTarget_CheckedChanged);
    ...
    this.lstvWeapons.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.txtManualDamage.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.cmdInternalDamage.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDamage.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tabCombat.Controls.Add((Control) this.flowLayoutPanel25);
    this.tabCombat.Controls.Add((Control) this.flowLayoutPanel32);
    ...
    this.flowLayoutPanel25.Controls.Add((Control) this.chkHostileOnly);
    this.flowLayoutPanel25.Controls.Add((Control) this.chkDragAll);
    this.flowLayoutPanel25.Controls.Add((Control) this.chkDragNum);
    this.flowLayoutPanel25.Controls.Add((Control) this.txtAssignNum);
    this.flowLayoutPanel25.Controls.Add((Control) this.cmdOpenFireAll);
    this.flowLayoutPanel25.Controls.Add((Control) this.cmdOpenFire);
    this.flowLayoutPanel25.Controls.Add((Control) this.cmdFleetAtWill);
    this.flowLayoutPanel25.Controls.Add((Control) this.cmdFireAtWillFC);
    this.flowLayoutPanel25.Controls.Add((Control) this.cmdAssignFleet);
    this.flowLayoutPanel25.Controls.Add((Control) this.cmdAssignSubFleet);
    this.flowLayoutPanel25.Controls.Add((Control) this.cmdAssignSystem);
    this.flowLayoutPanel25.Controls.Add((Control) this.cmdAssignAll);
    this.flowLayoutPanel25.Controls.Add((Control) this.cmOpenFireFleet);
    this.flowLayoutPanel25.Controls.Add((Control) this.cmdFleetFireAtWill);
    this.flowLayoutPanel25.Controls.Add((Control) this.cmOpenFireFleetMFC);
    this.flowLayoutPanel25.Controls.Add((Control) this.cmOpenFireFleetBFC);
    this.flowLayoutPanel25.Controls.Add((Control) this.cmdCeaseFireFleet);
    this.flowLayoutPanel25.Controls.Add((Control) this.cmdClearTarget);
    this.flowLayoutPanel25.Controls.Add((Control) this.cmdClearAllTargets);
    this.flowLayoutPanel25.Controls.Add((Control) this.cmdClearFleetTargets);
    this.flowLayoutPanel25.Controls.Add((Control) this.cmdAutoAssign);
    this.flowLayoutPanel25.Controls.Add((Control) this.cmdAutoTargetMFC);
    this.flowLayoutPanel25.Controls.Add((Control) this.cmdAutoTargetBFC);
    this.flowLayoutPanel25.Controls.Add((Control) this.chkDoubleRange);
    ...
    this.txtAssignNum.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.cmdOpenFireAll.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdOpenFire.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdFleetAtWill.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdFleetAtWill.Tag = (object) "1200";
    this.cmdFleetAtWill.Text = "Fire at Will";
    this.cmdFleetAtWill.UseVisualStyleBackColor = false;
    this.cmdFleetAtWill.Click += new EventHandler(this.cmdFleetAtWill_Click);
    this.cmdFireAtWillFC.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdFireAtWillFC.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdFireAtWillFC.Tag = (object) "1200";
    this.cmdFireAtWillFC.Text = "Fire at Will FC";
    this.cmdFireAtWillFC.UseVisualStyleBackColor = false;
    this.cmdFireAtWillFC.Click += new EventHandler(this.cmdFireAtWillFC_Click);
    this.cmdAssignFleet.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdAssignFleet.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdAssignSubFleet.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdAssignSystem.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdAssignAll.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmOpenFireFleet.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdFleetFireAtWill.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdFleetFireAtWill.Tag = (object) "1200";
    this.cmdFleetFireAtWill.Text = "Fleet Fire at Will";
    this.cmdFleetFireAtWill.UseVisualStyleBackColor = false;
    this.cmdFleetFireAtWill.Click += new EventHandler(this.cmdFleetFireAtWill_Click);
    this.cmOpenFireFleetMFC.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmOpenFireFleetMFC.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmOpenFireFleetBFC.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdCeaseFireFleet.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdClearTarget.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdClearTarget.Tag = (object) "1200";
    this.cmdClearTarget.Text = "Clear Target";
    this.cmdClearTarget.UseVisualStyleBackColor = false;
    this.cmdClearTarget.Click += new EventHandler(this.cmdClearTarget_Click);
    this.cmdClearAllTargets.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdClearAllTargets.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdClearAllTargets.Tag = (object) "1200";
    this.cmdClearAllTargets.Text = "Clear All Targets";
    this.cmdClearAllTargets.UseVisualStyleBackColor = false;
    this.cmdClearAllTargets.Click += new EventHandler(this.cmdClearAllTargets_Click);
    this.cmdClearFleetTargets.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdClearFleetTargets.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdClearFleetTargets.Tag = (object) "1200";
    this.cmdClearFleetTargets.Text = "Clear Fleet Tgts";
    this.cmdClearFleetTargets.UseVisualStyleBackColor = false;
    this.cmdClearFleetTargets.Click += new EventHandler(this.cmdClearFleetTargets_Click);
    this.cmdAutoAssign.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdAutoAssign.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdAutoTargetMFC.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdAutoTargetBFC.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.flowLayoutPanel32.Controls.Add((Control) this.cmdSyncFire);
    this.flowLayoutPanel32.Controls.Add((Control) this.cmdFleetSync);
    this.flowLayoutPanel32.Controls.Add((Control) this.cmdFleetSyncOff);
    this.flowLayoutPanel32.Controls.Add((Control) this.cmdMinAMMRange);
    this.flowLayoutPanel32.Controls.Add((Control) this.cmdDecoyThreshold);
    ...
    this.cmdSyncFire.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdFleetSync.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdFleetSyncOff.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdMinAMMRange.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdMinAMMRange.Tag = (object) "1200";
    this.cmdMinAMMRange.Text = "Min AMM Range";
    this.cmdMinAMMRange.UseVisualStyleBackColor = false;
    this.cmdMinAMMRange.Click += new EventHandler(this.cmdMinAMMRange_Click);
    this.cmdDecoyThreshold.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdDecoyThreshold.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDecoyThreshold.Tag = (object) "1200";
    this.cmdDecoyThreshold.Text = "Decoy Threshold";
    this.cmdDecoyThreshold.UseVisualStyleBackColor = false;
    this.cmdDecoyThreshold.Click += new EventHandler(this.cmdDecoyThreshold_Click);
    ...
    this.tvTargets.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tvCombatAssignment.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tabAdminCommand.Controls.Add((Control) this.panel3);
    ...
    this.panel3.Controls.Add((Control) this.cmdReassignAllGovernors);
    this.panel3.Controls.Add((Control) this.cmdAssignGovernors);
    this.panel3.Controls.Add((Control) this.cmdSelectGovernor);
    this.panel3.Controls.Add((Control) this.flowLayoutPanel27);
    this.panel3.Controls.Add((Control) this.label37);
    this.panel3.Controls.Add((Control) this.txtImportance);
    this.panel3.Controls.Add((Control) this.chkAutoAssign);
    ...
    this.cmdReassignAllGovernors.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdReassignAllGovernors.Tag = (object) "1200";
    this.cmdReassignAllGovernors.Text = "Reassign All Admin Commands";
    this.cmdReassignAllGovernors.UseVisualStyleBackColor = false;
    this.cmdReassignAllGovernors.Click += new EventHandler(this.cmdReassignAllGovernors_Click);
    this.cmdAssignGovernors.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdAssignGovernors.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdAssignGovernors.Tag = (object) "1200";
    this.cmdAssignGovernors.Text = "Assign Admin Vacancies";
    this.cmdAssignGovernors.UseVisualStyleBackColor = false;
    this.cmdAssignGovernors.Click += new EventHandler(this.cmdAssignGovernors_Click);
    this.cmdSelectGovernor.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdSelectGovernor.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdSelectGovernor.Tag = (object) "1200";
    this.cmdSelectGovernor.Text = "Assign Admin Commander";
    this.cmdSelectGovernor.UseVisualStyleBackColor = false;
    this.cmdSelectGovernor.Click += new EventHandler(this.cmdSelectGovernor_Click);
    this.flowLayoutPanel27.Controls.Add((Control) this.flowLayoutPanel24);
    this.flowLayoutPanel27.Controls.Add((Control) this.flowLayoutPanel26);
    ...
    this.flowLayoutPanel24.Controls.Add((Control) this.label39);
    this.flowLayoutPanel24.Controls.Add((Control) this.label36);
    this.flowLayoutPanel24.Controls.Add((Control) this.label40);
    this.flowLayoutPanel24.Controls.Add((Control) this.label9);
    ...
    this.label36.TabIndex = (int) sbyte.MaxValue;
    ...
    this.flowLayoutPanel26.Controls.Add((Control) this.cboBonusOne);
    this.flowLayoutPanel26.Controls.Add((Control) this.cboBonusTwo);
    this.flowLayoutPanel26.Controls.Add((Control) this.cboBonusThree);
    this.flowLayoutPanel26.Controls.Add((Control) this.cboNavalRanks);
    ...
    this.cboBonusOne.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboBonusOne.SelectedIndexChanged += new EventHandler(this.cboBonusOne_SelectedIndexChanged);
    this.cboBonusTwo.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cboBonusTwo.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboBonusTwo.SelectedIndexChanged += new EventHandler(this.cboBonusTwo_SelectedIndexChanged);
    this.cboBonusThree.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cboBonusThree.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboBonusThree.SelectedIndexChanged += new EventHandler(this.cboBonusThree_SelectedIndexChanged);
    this.cboNavalRanks.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cboNavalRanks.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboNavalRanks.SelectedIndexChanged += new EventHandler(this.cboNavalRanks_SelectedIndexChanged);
    ...
    this.txtImportance.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtImportance.TextChanged += new EventHandler(this.txtImportance_TextChanged);
    ...
    this.textBox1.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdUpdateAdmin.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdCreateAdmin.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvPopulation.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvNACTypes.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvAdminCommandSystems.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboSortType.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvLogisticsReport.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.chkExcTanker.CheckedChanged += new EventHandler(this.chkNonArmed_CheckedChanged);
    ...
    this.chkExcludeFighter.CheckedChanged += new EventHandler(this.chkNonArmed_CheckedChanged);
    ...
    this.chkExcludeFAC.CheckedChanged += new EventHandler(this.chkNonArmed_CheckedChanged);
    ...
    this.chkExcludeSY.CheckedChanged += new EventHandler(this.chkNonArmed_CheckedChanged);
    ...
    this.chkNonArmed.CheckedChanged += new EventHandler(this.chkNonArmed_CheckedChanged);
    ...
    this.lstvFuel.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvRepair.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvWealth.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvSL.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.txtSystemOOB.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tabPage3.Controls.Add((Control) this.flowLayoutPanel28);
    this.tabPage3.Controls.Add((Control) this.chkIncludeSG);
    this.tabPage3.Controls.Add((Control) this.lstvCombatRating);
    ...
    this.flowLayoutPanel28.Controls.Add((Control) this.rdoMilitary);
    this.flowLayoutPanel28.Controls.Add((Control) this.rdoCommercial);
    this.flowLayoutPanel28.Controls.Add((Control) this.rdoGround);
    this.flowLayoutPanel28.Controls.Add((Control) this.rdoMissiles);
    this.flowLayoutPanel28.Controls.Add((Control) this.rdoSize);
    this.flowLayoutPanel28.Controls.Add((Control) this.rdoDistance);
    ...
    this.rdoMilitary.CheckedChanged += new EventHandler(this.rdoDistance_CheckedChanged);
    ...
    this.rdoCommercial.CheckedChanged += new EventHandler(this.rdoDistance_CheckedChanged);
    ...
    this.rdoGround.CheckedChanged += new EventHandler(this.rdoDistance_CheckedChanged);
    ...
    this.rdoMissiles.CheckedChanged += new EventHandler(this.rdoDistance_CheckedChanged);
    ...
    this.rdoSize.CheckedChanged += new EventHandler(this.rdoDistance_CheckedChanged);
    ...
    this.rdoDistance.CheckedChanged += new EventHandler(this.rdoDistance_CheckedChanged);
    ...
    this.chkIncludeSG.CheckedChanged += new EventHandler(this.chkIncludeSG_CheckedChanged);
    ...
    this.lstvCombatRating.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tabPage4.Controls.Add((Control) this.cmdDeleteSalvo);
    this.tabPage4.Controls.Add((Control) this.lstvSalvos);
    ...
    this.cmdDeleteSalvo.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDeleteSalvo.Tag = (object) "1200";
    this.cmdDeleteSalvo.Text = "Delete Salvo";
    this.cmdDeleteSalvo.UseVisualStyleBackColor = false;
    this.cmdDeleteSalvo.Click += new EventHandler(this.cmdDeleteSalvo_Click);
    ...
    this.lstvSalvos.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvSalvos.SelectedIndexChanged += new EventHandler(this.lstvSalvos_SelectedIndexChanged);
    ...
    this.cmdCreateFleet.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdSetSpeed.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.chkSelectOnMap.CheckedChanged += new EventHandler(this.chkSelectOnMap_CheckedChanged);
    this.cmdDetach.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdDetach.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.flowLayoutPanel9.Controls.Add((Control) this.cmdCreateSquadron);
    ...
    this.flowLayoutPanel9.Controls.Add((Control) this.cmdFleetShields);
    this.flowLayoutPanel9.Controls.Add((Control) this.cmdEndOverhaul);
    this.flowLayoutPanel9.Controls.Add((Control) this.cmdDetach);
    this.flowLayoutPanel9.Controls.Add((Control) this.cmdLaunchAll);
    this.flowLayoutPanel9.Controls.Add((Control) this.cmdDetachEscorts);
    this.flowLayoutPanel9.Controls.Add((Control) this.cmdRecallEscorts);
    ...
    this.flowLayoutPanel9.Controls.Add((Control) this.cmdTemp);
    this.flowLayoutPanel9.Controls.Add((Control) this.cmdCollapseAll);
    ...
    this.cmdCreateSquadron.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdCreateSquadron.Tag = (object) "1200";
    this.cmdCreateSquadron.Text = "Create Squadron";
    this.cmdCreateSquadron.UseVisualStyleBackColor = false;
    this.cmdCreateSquadron.Visible = false;
    this.cmdCreateSquadron.Click += new EventHandler(this.cmdCreateSquadron_Click);
    this.cmdAutoFleetFC.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdAutoFleetFC.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdActive2.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdActive2.Visible = false;
    this.cmdActive2.Click += new EventHandler(this.cmdActive2_Click);
    this.cmdFleetShields.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdFleetShields.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdFleetShields.Tag = (object) "1200";
    this.cmdFleetShields.Text = "Raise Shields";
    this.cmdFleetShields.UseVisualStyleBackColor = false;
    this.cmdFleetShields.Visible = false;
    this.cmdFleetShields.Click += new EventHandler(this.cmdFleetShields_Click);
    this.cmdEndOverhaul.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdEndOverhaul.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdLaunchAll.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdLaunchAll.Tag = (object) "1200";
    this.cmdLaunchAll.Text = "Launch All";
    this.cmdLaunchAll.UseVisualStyleBackColor = false;
    this.cmdLaunchAll.Visible = false;
    this.cmdLaunchAll.Click += new EventHandler(this.cmdLaunchAll_Click);
    this.cmdDetachEscorts.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdDetachEscorts.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDetachEscorts.Tag = (object) "1200";
    this.cmdDetachEscorts.Text = "Detach Escorts";
    this.cmdDetachEscorts.UseVisualStyleBackColor = false;
    this.cmdDetachEscorts.Click += new EventHandler(this.cmdDetachEscorts_Click);
    this.cmdRecallEscorts.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdRecallEscorts.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdRecallEscorts.Tag = (object) "1200";
    this.cmdRecallEscorts.Text = "Recall Escorts";
    this.cmdRecallEscorts.UseVisualStyleBackColor = false;
    this.cmdRecallEscorts.Click += new EventHandler(this.cmdRecallEscorts_Click);
    ...
    this.cmdTemp.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdTemp.Tag = (object) "1200";
    this.cmdTemp.Text = "Fix SL";
    this.cmdTemp.UseVisualStyleBackColor = false;
    this.cmdTemp.Visible = false;
    this.cmdTemp.Click += new EventHandler(this.cmdTemp_Click);
    this.cmdCollapseAll.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdCollapseAll.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdCollapseAll.Tag = (object) "1200";
    this.cmdCollapseAll.Text = "Collapse All";
    this.cmdCollapseAll.UseVisualStyleBackColor = false;
    this.cmdCollapseAll.Click += new EventHandler(this.cmdCollapseAll_Click);
    ...
    this.chkIncludeCivilians.CheckedChanged += new EventHandler(this.chkIncludeCivilians_CheckedChanged);
    this.flowLayoutPanel30.BorderStyle = BorderStyle.FixedSingle;
    this.flowLayoutPanel30.Controls.Add((Control) this.chkOrders);
    this.flowLayoutPanel30.Controls.Add((Control) this.chkOverhauls);
    this.flowLayoutPanel30.Controls.Add((Control) this.chkShowJD);
    this.flowLayoutPanel30.Controls.Add((Control) this.chkSelectOnMap);
    ...
    this.chkShowJD.CheckedChanged += new EventHandler(this.chkShowJD_CheckedChanged);
    ...
    this.chkOverhauls.CheckedChanged += new EventHandler(this.chkOverhauls_CheckedChanged);
    ...
    this.chkOrders.CheckedChanged += new EventHandler(this.chkOrders_CheckedChanged);
    this.AutoScaleDimensions = new SizeF(6f, 13f);
    this.AutoScaleMode = AutoScaleMode.Font;
    this.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.ClientSize = new Size(1424, 886);
    this.Controls.Add((Control) this.flowLayoutPanel30);
    ...
    this.KeyDown += new KeyEventHandler(this.FleetWindow_KeyDown);
