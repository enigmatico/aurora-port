...
public class FleetWindow : Form
{
    ...
    private void FleetWindow_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            this.method_3();
            this.method_2();
            this.chkOrders.CheckState = AuroraUtils.smethod_28(this.gclass0_0.bool_4);
            this.chkOverhauls.CheckState = AuroraUtils.smethod_28(this.gclass0_0.bool_5);
            this.chkShowJD.CheckState = AuroraUtils.smethod_28(this.gclass0_0.bool_6);
        ...
        try
        {
            ...
            else if (this.tvFleetList.SelectedNode.Tag is NavalAdminCommand)
            {
                ...
                if (tag.gclass146_0 != null)
                    this.gclass21_0.method_307(string4, tag, tag.gclass146_0.SystemBodyData, OperationalGroup.None);
                else if (tag.gclass40_0 != null)
                    this.gclass21_0.method_307(string4, tag, tag.gclass40_0.gclass85_0.OrbitingBody, OperationalGroup.None);
                this.gclass21_0.method_355(this.tvFleetList, null, false,
                    AuroraUtils.smethod_27(this.chkIncludeCivilians.CheckState), this.txtSystemOOB);
            }
            else
    ...
    private void cmdOpenFire_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else if (this.tvCombatAssignment.SelectedNode.Tag is FireControlAssignment)
            {
                ...
                if (this.gclass0_0.int_87 != 1 || !this.method_18() ||
    ...
    private void cmdDetach_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else if (this.tvFleetList.SelectedNode.Tag is FCTShipData40)
            {
                FCTShipData40 tag = (FCTShipData40)this.tvFleetList.SelectedNode.Tag;
                tag.gclass40_0 = null;
                tag.gclass85_0.method_75(tag, OperationalGroup.None, false);
                tag.gclass84_0 = null;
            ...
            else if (this.lstvShips.SelectedItems.Count > 0)
            {
                ...
                class1032.gclass85_0 = gclass85_5.NPROperationGroup == null
                    ? this.gclass21_0.method_308(string_10, gclass85_5.ParentNavalCommand, gclass85_5.System,
                        gclass85_5.XCoord, gclass85_5.YCoord, gclass85_5.OrbitingBody, OperationalGroup.None)
                    : this.gclass21_0.method_308(string_10, gclass85_5.ParentNavalCommand, gclass85_5.System,
                        gclass85_5.XCoord, gclass85_5.YCoord, gclass85_5.OrbitingBody,
                        gclass85_5.NPROperationGroup.genum105_0);
            ...
            else
            {
                ...
                FCTSquadronData70 tag = (FCTSquadronData70)this.tvFleetList.SelectedNode.Tag;
                // ISSUE: reference to a compiler-generated field
                class1034.gclass85_0 = tag.ParentShipData.gclass85_0.method_71(tag, OperationalGroup.None);
                this.gclass21_0.genum42_0 = GEnum42.const_2;
                // ISSUE: reference to a compiler-generated field
    ...
    private void method_20(GEnum61 genum61_0)
    {
        try
        {
                         ...
                         : gclass85.method_176())
            {
                ...
                if (this.gclass0_0.int_87 == 1 && !gclass40_2.bool_15 && (genum61_0 == GEnum61.const_1 ||
    ...
    private void chkRetainData_CheckedChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            if (tag == null)
                return;
            tag.int_14 = AuroraUtils.smethod_29(this.chkRetainData.CheckState);
        }
        catch (Exception ex)
        {
    ...
    private void cmdTransfer_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else if (this.tvFleetList.SelectedNode.Tag is FleetData)
            {
                ...
                if (selectedValue == null)
                    return;
                FCTRaceRecordC21 gclass210 = selectedValue.ActualAlienRace;
            ...
            else
            {
                if (this.tvFleetList.SelectedNode.Tag is FleetData)
                {
                    ...
                    gclass85_1 = this.gclass21_0.method_308(tag.FleetName + " Strikegroup", tag.ParentNavalCommand,
                        tag.System, tag.XCoord, tag.YCoord, tag.OrbitingBody, OperationalGroup.None);
                }
                else if (this.tvFleetList.SelectedNode.Tag is SubFleet)
                {
                    SubFleet tag = (SubFleet)this.tvFleetList.SelectedNode.Tag;
                    ...
                    gclass85_1 = this.gclass21_0.method_308(tag.SubFleetName + " Strikegroup", tag.ParentFleet.ParentNavalCommand,
                        ...
                        tag.ParentFleet.OrbitingBody, OperationalGroup.None);
                }
                else if (this.tvFleetList.SelectedNode.Tag is FCTShipData40)
                {
                    FCTShipData40 tag = (FCTShipData40)this.tvFleetList.SelectedNode.Tag;
                    ...
                    gclass85_1 = this.gclass21_0.method_308(tag.ShipName + " Strikegroup", tag.gclass85_0.ParentNavalCommand,
                        ...
                        tag.gclass85_0.OrbitingBody, OperationalGroup.None);
                }
    ...
    private void ckhTarget_CheckedChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            if (tag == null)
                return;
            tag.int_24 = AuroraUtils.smethod_29(this.ckhTarget.CheckState);
        }
        catch (Exception ex)
        {
    ...
    private void chkOrders_CheckedChanged(object sender, EventArgs e)
    {
        try
        {
            this.gclass0_0.bool_4 = AuroraUtils.smethod_27(this.chkOrders.CheckState);
            this.gclass21_0.method_355(this.tvFleetList, null, false,
                AuroraUtils.smethod_27(this.chkIncludeCivilians.CheckState), this.txtSystemOOB);
        }
        catch (Exception ex)
    ...
    private void chkOverhauls_CheckedChanged(object sender, EventArgs e)
    {
        try
        {
            this.gclass0_0.bool_5 = AuroraUtils.smethod_27(this.chkOverhauls.CheckState);
            this.gclass21_0.method_355(this.tvFleetList, null, false,
                AuroraUtils.smethod_27(this.chkIncludeCivilians.CheckState), this.txtSystemOOB);
        }
        catch (Exception ex)
    ...
    private void chkShowJD_CheckedChanged(object sender, EventArgs e)
    {
        try
        {
            this.gclass0_0.bool_6 = AuroraUtils.smethod_27(this.chkShowJD.CheckState);
            this.gclass21_0.method_355(this.tvFleetList, null, false,
                AuroraUtils.smethod_27(this.chkIncludeCivilians.CheckState), this.txtSystemOOB);
        }
        catch (Exception ex)
    ...
    private void InitializeComponent()
    {
        ...
        this.cmdDelete.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdCreateSubFleet.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdCreateSubFleet.TabIndex = sbyte.MaxValue;
        ...
        this.lstvShips.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.txtMinDistance.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.txtOrderDelay.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.txtMaxItems.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.txtOrbDistance.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.txtMinAvailable.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.cmdAddMove.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdCreatePop.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdRemoveLastOrder.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdRemoveAll.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdRepeat.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.txtRepeatMultiple.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.cmdSaveTemplate.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdDeleteTemplate.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstvLoadItems.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstvOrders.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstvActions.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstvSystemLocations.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdDeleteSOTemplate.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdLoadTemplate.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdCreateTemplate.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstvStandingOrderTemplates.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.tvStandingOrders.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdAddCO.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdOrderDown.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdOrderUp.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdDeleteSO.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdAddSO.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstvStandingOrdersList.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstvConditionOne.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.tvAnchor.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdSetAnchor.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdSetThreat.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdClearAnchor.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdClearThreat.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdSetDistance.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdSetOffset.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdToggleWarship.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdToggleContact.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstvFormation.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.tvThreat.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdScrap.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.tvFleetCargo.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstvHistory.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdTransfer.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdFleetText.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdMoveFleettoWP.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstMoveWP.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdMoveFleetToPop.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstMoveFleet.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.txtSurveyRadius.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.lstvOfficers.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstvCrew.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstvLogistics.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstvOrdnance.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstvMeasurement.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cboRefuelActive.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cboResupplyActive.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cboTransferActive.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cboHangar.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.txtTargetSpeed.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.txtRangeBand.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.txtShipSummary.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.txtClassDisplay.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstvClassTemplate.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstvShipTemplate.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstvShipLoadout.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdRenameMissile.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdObsoleteMissile.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdCopyClassLoadout.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdCopyToClass.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdCopyToFleet.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdFillShip.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdSMFillClass.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstvOrdnanceTemplate.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.tvShipCargo.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdRepair.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdRepair.TabIndex = sbyte.MaxValue;
        ...
        this.cmdSMRepair.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdAutoQueue.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.txtRepairChanceTime.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.cmdTop.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdRemove.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdDown.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdUp.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstvDamageControlQueue.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstvDAC.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstvShipHistory.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdSMRefuel.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdPartialRefuel.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdAbandonShip.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdSetHullNumber.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.txtFuelPriority.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.txtSupplyPriority.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.ckhTarget.Size = new Size(sbyte.MaxValue, 17);
        ...
        this.txtManualDamage.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.cmdInternalDamage.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdDamage.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        this.cmdDamage.Location = new Point(byte.MaxValue, 3);
        ...
        this.txtAssignNum.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.cmdOpenFireAll.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdOpenFire.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdFleetAtWill.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdFireAtWillFC.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdAssignFleet.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdAssignSubFleet.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdAssignSystem.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdAssignAll.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmOpenFireFleet.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdFleetFireAtWill.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmOpenFireFleetMFC.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmOpenFireFleetBFC.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdCeaseFireFleet.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdClearTarget.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdClearAllTargets.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdClearFleetTargets.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdAutoAssign.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdAutoTargetMFC.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdAutoTargetBFC.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdSyncFire.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdFleetSync.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdFleetSyncOff.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdMinAMMRange.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdDecoyThreshold.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.tvTargets.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.tvCombatAssignment.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cboNavalRanks.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.textBox1.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdUpdateAdmin.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdCreateAdmin.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstvNACTypes.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstvAdminCommandSystems.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cboSortType.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstvLogisticsReport.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstvFuel.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstvRepair.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstvWealth.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstvSL.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.txtSystemOOB.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstvCombatRating.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdDeleteSalvo.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstvSalvos.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdCreateFleet.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdSetSpeed.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdDetach.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdCreateSquadron.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdAutoFleetFC.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdActive2.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdFleetShields.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdEndOverhaul.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdLaunchAll.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdDetachEscorts.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdRecallEscorts.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdTemp.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdCollapseAll.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
