...
public class RaceCreation : Form
{
    ...
    private void RaceCreation_FormClosing(object sender, FormClosingEventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 2571);
        }
    }
    ...
    private void RaceCreation_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            this.cboCommanderTheme.SelectedItem = this.gclass21_0.RaceNameThemeList[0].CommanderNameThemeData;
            this.cboRankTheme.SelectedItem = this.gclass21_0.gclass60_0;
            this.txtPopulation.Text = AuroraUtils.FormatNumberToDigits(this.gclass146_0.decimal_30, 1);
            this.method_0();
        }
        catch (Exception ex)
        {
            AuroraUtils.ShowExceptionPopup(ex, 2572);
        }
    }
    ...
    private void method_0()
    {
        try
        {
            this.txtRL.Text = AuroraUtils.smethod_37(this.gclass146_0.method_73(AuroraInstallationType.ResearchLab));
            this.txtCF.Text =
                AuroraUtils.smethod_37(this.gclass146_0.method_73(AuroraInstallationType.ConventionalIndustry));
            this.txtSY.Text = AuroraUtils.smethod_37(this.gclass21_0.int_41);
            this.txtTP.Text = AuroraUtils.smethod_37(this.gclass21_0.StartTechPoints);
            this.txtSBP.Text = AuroraUtils.smethod_38(this.gclass21_0.StartBuildPoints);
            this.txtConst.Text =
                AuroraUtils.smethod_37(this.gclass146_0.method_73(AuroraInstallationType.ConstructionFactory));
            this.txtOF.Text =
                AuroraUtils.smethod_37(this.gclass146_0.method_73(AuroraInstallationType.OrdnanceFactory));
            this.txtFF.Text = AuroraUtils.smethod_37(this.gclass146_0.method_73(AuroraInstallationType.FighterFactory));
            this.txtFC.Text =
                AuroraUtils.smethod_37(this.gclass146_0.method_73(AuroraInstallationType.FinancialCentre));
            this.txtFR.Text = AuroraUtils.smethod_37(this.gclass146_0.method_73(AuroraInstallationType.FuelRefinery));
            this.txtAM.Text = AuroraUtils.smethod_37(this.gclass146_0.method_73(AuroraInstallationType.AutomatedMine));
            this.txtMines.Text = AuroraUtils.smethod_37(this.gclass146_0.method_73(AuroraInstallationType.Mine));
            this.txtMF.Text =
                AuroraUtils.smethod_37(this.gclass146_0.method_73(AuroraInstallationType.MaintenanceFacility));
            this.txtGF.Text = AuroraUtils.smethod_37(this.gclass146_0.method_73(AuroraInstallationType.GFCC));
            this.txtDSTS.Text =
                AuroraUtils.smethod_37(this.gclass146_0.method_73(AuroraInstallationType.TrackingStation));
            this.txtMA.Text =
                AuroraUtils.smethod_37(this.gclass146_0.method_73(AuroraInstallationType.MilitaryAcademy));
            this.txtFuel.Text = AuroraUtils.smethod_39(this.gclass146_0.FuelStockpile);
            this.txtMSP.Text = AuroraUtils.smethod_38(this.gclass146_0.MaintenanceStockpile);
        }
        catch (Exception ex)
        {
            AuroraUtils.ShowExceptionPopup(ex, 2573);
        }
    }
    ...
    private void cmdCreate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            this.gclass21_0.RaceStartingLevel = GEnum82.const_0;
            if (this.chkConv.Checked && !this.chkNPR.Checked)
                this.gclass21_0.RaceStartingLevel = GEnum82.const_1;
            else if (this.chkConv.Checked && this.chkNPR.Checked)
                this.gclass21_0.RaceStartingLevel = GEnum82.const_2;
            ...
            this.gclass21_0.gclass60_0 = (RankTheme)this.cboRankTheme.SelectedValue;
            CommanderNameThemeData selectedValue = (CommanderNameThemeData)this.cboCommanderTheme.SelectedValue;
            if (this.gclass21_0.RaceNameThemeList[0].CommanderNameThemeData != selectedValue)
            {
                this.gclass21_0.RaceNameThemeList.Clear();
            ...
            if (gclass208_2.Succeed)
                this.gclass146_0.method_25(gclass208_2.Value);
            ParsedDecimal gclass208_3 = AuroraUtils.ParseDecimalString(this.txtFuel.Text);
            if (gclass208_3.Succeed)
                this.gclass146_0.FuelStockpile = gclass208_3.Value;
            ...
            ParsedDecimal gclass208_6 = AuroraUtils.ParseDecimalString(this.txtConst.Text);
            if (gclass208_6.Succeed)
                this.gclass146_0.method_64(AuroraInstallationType.ConstructionFactory, gclass208_6.Value);
            ParsedDecimal gclass208_7 = AuroraUtils.ParseDecimalString(this.txtOF.Text);
            if (gclass208_7.Succeed)
                this.gclass146_0.method_64(AuroraInstallationType.OrdnanceFactory, gclass208_7.Value);
            ParsedDecimal gclass208_8 = AuroraUtils.ParseDecimalString(this.txtFF.Text);
            if (gclass208_8.Succeed)
                this.gclass146_0.method_64(AuroraInstallationType.FighterFactory, gclass208_8.Value);
            ParsedDecimal gclass208_9 = AuroraUtils.ParseDecimalString(this.txtCF.Text);
            if (gclass208_9.Succeed)
                this.gclass146_0.method_64(AuroraInstallationType.ConventionalIndustry, gclass208_9.Value);
            ParsedDecimal gclass208_10 = AuroraUtils.ParseDecimalString(this.txtFR.Text);
            if (gclass208_10.Succeed)
                this.gclass146_0.method_64(AuroraInstallationType.FuelRefinery, gclass208_10.Value);
            ParsedDecimal gclass208_11 = AuroraUtils.ParseDecimalString(this.txtAM.Text);
            if (gclass208_11.Succeed)
                this.gclass146_0.method_64(AuroraInstallationType.AutomatedMine, gclass208_11.Value);
            ParsedDecimal gclass208_12 = AuroraUtils.ParseDecimalString(this.txtMines.Text);
            if (gclass208_12.Succeed)
                this.gclass146_0.method_64(AuroraInstallationType.Mine, gclass208_12.Value);
            ParsedDecimal gclass208_13 = AuroraUtils.ParseDecimalString(this.txtMF.Text);
            if (gclass208_13.Succeed)
                this.gclass146_0.method_64(AuroraInstallationType.MaintenanceFacility, gclass208_13.Value);
            ParsedDecimal gclass208_14 = AuroraUtils.ParseDecimalString(this.txtGF.Text);
            if (gclass208_14.Succeed)
                this.gclass146_0.method_64(AuroraInstallationType.GFCC, gclass208_14.Value);
            ParsedDecimal gclass208_15 = AuroraUtils.ParseDecimalString(this.txtDSTS.Text);
            if (gclass208_15.Succeed)
                this.gclass146_0.method_64(AuroraInstallationType.TrackingStation, gclass208_15.Value);
            ParsedDecimal gclass208_16 = AuroraUtils.ParseDecimalString(this.txtMA.Text);
            if (gclass208_16.Succeed)
                this.gclass146_0.method_64(AuroraInstallationType.MilitaryAcademy, gclass208_16.Value);
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 2574);
        }
    }
    ...
    private void method_1(ComboBox comboBox_0)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 2575);
        }
    }
    ...
    private void cboSpecies_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 2576);
        }
    }
    ...
    private void cmdSpeciesImage_Click(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 2577);
        }
    }
    ...
    private void cmdRaceFlag_Click(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 2578);
        }
    }
    ...
    private void cmdRandomName_Click(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 2579);
        }
    }
    ...
    private void chkNeutral_CheckedChanged(object sender, EventArgs e)
    {
        try
        {
            this.gclass21_0.RaceStartingLevel = !this.chkConv.Checked || this.chkNPR.Checked
                ? (!this.chkConv.Checked || !this.chkNPR.Checked ? GEnum82.const_0 : GEnum82.const_2)
                : GEnum82.const_1;
            this.gclass146_0.method_59(this.chkNeutral.CheckState, null, 0);
            if (this.chkConv.CheckState == CheckState.Checked)
            {
                this.gclass21_0.StartBuildPoints = 0M;
            ...
            else
            {
                ...
                this.gclass21_0.StartBuildPoints = 3M * this.gclass146_0.method_181();
            }
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 2580);
        }
    }
    ...
    private void txtPopulation_TextChanged(object sender, EventArgs e)
    {
        try
        {
            if (this.txtPopulation.Text == "")
                return;
            ParsedDecimal gclass208 = AuroraUtils.ParseDecimalString(this.txtPopulation.Text);
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 2581);
        }
    }
    ...
    private void cmdHull_Click(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 2582);
        }
    }
    ...
    private void cmdStation_Click(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 2583);
        }
    }
    ...
    private void chkNPR_CheckedChanged(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 2584);
        }
    }
    ...
    private void txtTP_Leave(object sender, EventArgs e)
    {
        try
        {
            if (this.chkNPR.CheckState != CheckState.Checked)
                return;
            ParsedDecimal gclass208 = AuroraUtils.ParseDecimalString(this.txtTP.Text);
            if (!gclass208.Succeed || !(gclass208.Value < 100000M))
                return;
    ...
    private void chkAutoDesignGround_CheckedChanged(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 3226);
        }
    }
    ...
    private void chkAutoAssign_CheckedChanged(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 3227);
        }
    }
    ...
    private void chkAutoCreate_CheckedChanged(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 3228);
        }
    }
    ...
    private void InitializeComponent()
    {
        ...
        this.chkNPR.CheckedChanged += this.chkNPR_CheckedChanged;
        ...
        this.chkConv.CheckedChanged += this.chkNeutral_CheckedChanged;
        ...
        this.chkNeutral.CheckedChanged += this.chkNeutral_CheckedChanged;
        ...
        this.cboSpecies.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.panel14.Controls.Add(this.txtSpeciesName);
        ...
        this.txtSpeciesName.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.txtGravity.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.txtTemp.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.txtOxygen.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.txtPressure.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.txtGravityDev.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.txtTempDev.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.txtOxygenDev.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.txtDensity.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.panel36.Location = new Point(3, byte.MaxValue);
        ...
        this.panel18.Controls.Add(this.txtPopulation);
        ...
        this.txtPopulation.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.txtPopulation.TextChanged += this.txtPopulation_TextChanged;
        ...
        this.panel22.Controls.Add(this.txtSY);
        ...
        this.txtSY.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.panel23.Controls.Add(this.txtRL);
        ...
        this.txtRL.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.panel24.Controls.Add(this.txtCF);
        ...
        this.txtCF.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.panel29.Controls.Add(this.txtConst);
        ...
        this.txtConst.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.panel31.Controls.Add(this.txtFF);
        ...
        this.txtFF.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.panel25.Controls.Add(this.txtMines);
        ...
        this.txtMines.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.panel32.Controls.Add(this.txtAM);
        ...
        this.txtAM.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.panel33.Controls.Add(this.txtFR);
        ...
        this.txtFR.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.panel20.Controls.Add(this.txtFC);
        ...
        this.txtFC.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.panel34.Controls.Add(this.txtMF);
        ...
        this.txtMF.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.panel35.Controls.Add(this.txtGF);
        this.panel35.Controls.Add(this.label35);
        this.panel35.Location = new Point(3, byte.MaxValue);
        ...
        this.txtGF.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.panel45.Controls.Add(this.txtDSTS);
        ...
        this.txtDSTS.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.panel46.Controls.Add(this.txtMA);
        ...
        this.txtMA.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.panel43.Controls.Add(this.txtFuel);
        ...
        this.txtFuel.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.panel44.Controls.Add(this.txtMSP);
        ...
        this.txtMSP.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.txtTP.Leave += this.txtTP_Leave;
        ...
        this.panel47.Controls.Add(this.txtSBP);
        ...
        this.txtSBP.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.flowLayoutPanel2.Controls.Add(this.chkNPR);
        this.flowLayoutPanel2.Controls.Add(this.chkConv);
        this.flowLayoutPanel2.Controls.Add(this.chkNeutral);
        this.flowLayoutPanel2.Controls.Add(this.chkAutoAssign);
        this.flowLayoutPanel2.Controls.Add(this.chkAutoDesignGround);
        this.flowLayoutPanel2.Controls.Add(this.chkAutoCreate);
        this.flowLayoutPanel2.Controls.Add(this.chkSurveyGeo);
        this.flowLayoutPanel2.Controls.Add(this.chkSurveyGrav);
        ...
        this.chkAutoDesignGround.CheckedChanged += this.chkAutoDesignGround_CheckedChanged;
        ...
        this.chkAutoCreate.CheckedChanged += this.chkAutoCreate_CheckedChanged;
        ...
        this.chkSurveyGeo.CheckedChanged += this.chkSurveyGeo_CheckedChanged;
        ...
        this.flowLayoutPanel3.Controls.Add(this.pbFlag);
        ...
        this.flowLayoutPanel5.Controls.Add(this.pbRace);
        ...
        this.flowLayoutPanel7.Controls.Add(this.pbShip);
        this.flowLayoutPanel7.Controls.Add(this.pbStation);
        ...
        this.cmdRandomName.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.panel21.Controls.Add(this.txtGraduationAge);
        ...
        this.txtGraduationAge.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.Controls.Add(this.cmdHull);
        this.Controls.Add(this.cmdRandomName);
        this.Controls.Add(this.cmdRaceFlag);
        this.Controls.Add(this.cmdSpeciesImage);
        ...
        this.FormClosing += this.RaceCreation_FormClosing;
        this.Load += this.RaceCreation_Load;
