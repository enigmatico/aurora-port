...
public class Sector
{
    ...
    public Commander SectorCommander;
    public Color Colour;
    ...
    public Sector(GClass0 gclass0_1) => this.gclass0_0 = gclass0_1;
    ...
    public void method_0(ListView listView_0)
    {
        try
        {
            ...
            int num = this.Race.RacialSystemDictionary.Values.Count<RacialSystemSurvey>(
            ...
            this.gclass0_0.method_594(listView_0, "");
            if (this.SectorCommander == null)
            {
                this.gclass0_0.method_594(listView_0, "No Governor Assigned");
            }
            else
            {
                this.gclass0_0.method_601(listView_0, "Sector Governor", this.SectorCommander.Name, null);
                this.SectorCommander.method_30(listView_0, false);
            }
        }
        catch (Exception ex)
        {
    ...
    public void method_1()
    {
        try
        {
            if (this.gclass146_0 == null)
                ...
                this.dictionary_0 =
                    this.gclass0_0.method_32(this.Race, this.gclass146_0.gclass202_0, this.method_2());
        }
        catch (Exception ex)
        {
