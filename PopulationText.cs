...
public class PopulationText : Form
{
  ...
  public PopulationText(GClass146 gclass146_1, TreeView treeView_1, GClass0 gclass0_1)
  {
  ...
  public PopulationText(GClass110 gclass110_1, GClass0 gclass0_1)
  {
    this.InitializeComponent();
  ...
  public PopulationText(GClass102 gclass102_1, GClass0 gclass0_1)
  {
    this.InitializeComponent();
  ...
  public PopulationText(GClass21 gclass21_1, GEnum127 genum127_1, GClass0 gclass0_1)
  {
    this.InitializeComponent();
  ...
  private void method_0()
  {
    try
    {
      ...
      else if (this.gclass110_0 != null)
      {
        ...
        this.txtDetails.Text = this.gclass110_0.gclass21_1.method_21(this.gclass110_0);
      }
  ...
  private string method_1(TreeNode treeNode_0)
  {
    ...
    {
      string str = "";
      if (treeNode_0.Tag is GClass146)
      {
        GClass146 tag = (GClass146) treeNode_0.Tag;
