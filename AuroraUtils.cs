...
public static class AuroraUtils
{
    ...
    public static Color color_2 = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
    public static Color color_3 = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
    ...
    public static Color color_10 = Color.FromArgb(byte.MaxValue, 140, 0);
    public static Color color_11 = Color.FromArgb(byte.MaxValue, 215, 0);
    public static Color color_12 = Color.FromArgb(0, byte.MaxValue, byte.MaxValue);
    public static Color color_13 = Color.FromArgb(0, byte.MaxValue, byte.MaxValue);
    ...
    public static Color color_16 = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
    public static Color color_17 = Color.FromArgb(0, byte.MaxValue, byte.MaxValue);
    public static Color color_18 = Color.FromArgb(0, 50, byte.MaxValue);
    public static Color color_19 = Color.FromArgb(0, 0, 64 /*0x40*/);
    public static Color color_20 = Color.FromArgb(0, byte.MaxValue, 160 /*0xA0*/);
    public static Color color_21 = Color.FromArgb(0, byte.MaxValue, 160 /*0xA0*/);
