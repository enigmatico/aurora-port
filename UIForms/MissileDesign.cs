...
public class MissileDesign : Form
{
    ...
    private void method_9(string string_0)
    {
        try
        {
            int num = this.gclass0_0.TechSystems.Values.Max<TechSystem>(gclass164_0 => gclass164_0.TechSystemID) + 1;
            ...
            this.gclass0_0.TechSystems.Add(this.gclass230_0.gclass164_0.TechSystemID, this.gclass230_0.gclass164_0);
        ...
        try
        {
            ...
            else
            {
                this.gclass0_0.gclass164_0.Name = !(this.txtCompanyName.Text == "")
                    ? string.Format("{0} {1}", this.txtCompanyName.Text, this.txtMissileName.Text)
                    : this.txtMissileName.Text;
                if (this.chkNoEngine.CheckState == CheckState.Unchecked)
                    this.method_9(string.Format("{0} Engine", this.gclass0_0.gclass164_0.Name));
                int num2 = this.gclass0_0.TechSystems.Values.Max<TechSystem>(gclass164_0 => gclass164_0.TechSystemID) +
                           1;
    ...
    private void cmdCreate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (this.chkNoEngine.CheckState == CheckState.Unchecked)
                this.method_9(string.Format("{0} Engine", this.gclass0_0.gclass164_0.Name));
            int num1 = this.gclass0_0.TechSystems.Values.Max<TechSystem>(gclass164_0 => gclass164_0.TechSystemID) + 1;
    ...
    private void InitializeComponent()
    {
        ...
        this.txtWHSize.ForeColor = Color.FromArgb(128 /*0x80*/, 255, 128 /*0x80*/);
        ...
        this.txtFCSize.ForeColor = Color.FromArgb(128 /*0x80*/, 255, 128 /*0x80*/);
        ...
        this.txtReactorSize.ForeColor = Color.FromArgb(255, 255, 192 /*0xC0*/);
        ...
        this.txtSensorSize.ForeColor = Color.FromArgb(128 /*0x80*/, 255, 128 /*0x80*/);
        ...
        this.txtThermalSize.ForeColor = Color.FromArgb(128 /*0x80*/, 255, 128 /*0x80*/);
        ...
        this.txtEMSize.ForeColor = Color.FromArgb(128 /*0x80*/, 255, 128 /*0x80*/);
        ...
        this.txtGeoSize.ForeColor = Color.FromArgb(128 /*0x80*/, 255, 128 /*0x80*/);
        ...
        this.txtNumDecoys.ForeColor = Color.FromArgb(128 /*0x80*/, 255, 128 /*0x80*/);
        ...
        this.txtMultipleWarheads.ForeColor = Color.FromArgb(128 /*0x80*/, 255, 128 /*0x80*/);
        ...
        this.txtResolution.ForeColor = Color.FromArgb(128 /*0x80*/, 255, 128 /*0x80*/);
        ...
        this.txtMinDetonationRange.ForeColor = Color.FromArgb(128 /*0x80*/, 255, 128 /*0x80*/);
        ...
        this.cboEnginePower.ForeColor = Color.FromArgb(255, 255, 192 /*0xC0*/);
        ...
        this.cboEngineSize.ForeColor = Color.FromArgb(255, 255, 192 /*0xC0*/);
        ...
        this.cboSecond.ForeColor = Color.FromArgb(255, 255, 192 /*0xC0*/);
        ...
        this.txtNumSS.ForeColor = Color.FromArgb(128 /*0x80*/, 255, 128 /*0x80*/);
        ...
        this.txtSeparationRange.ForeColor = Color.FromArgb(128 /*0x80*/, 255, 128 /*0x80*/);
        ...
        this.lstvMissileTech.ForeColor = Color.FromArgb(255, 255, 192 /*0xC0*/);
        ...
        this.txtMissileSummary.ForeColor = Color.FromArgb(255, 255, 192 /*0xC0*/);
        ...
        this.txtMissileName.ForeColor = Color.FromArgb(128 /*0x80*/, 255, 128 /*0x80*/);
        ...
        this.cboPreviousDesigns.ForeColor = Color.FromArgb(255, 255, 192 /*0xC0*/);
        ...
        this.txtMaxDetonationRange.ForeColor = Color.FromArgb(128 /*0x80*/, 255, 128 /*0x80*/);
