...
public class TechnologyView : Form
{
    ...
    private void InitializeComponent()
    {
        ...
        this.chkObsolete.ForeColor = Color.FromArgb(255, 255, 192 /*0xC0*/);
        ...
        this.chkShowCivilian.ForeColor = Color.FromArgb(255, 255, 192 /*0xC0*/);
        ...
        this.chkTons.ForeColor = Color.FromArgb(255, 255, 192 /*0xC0*/);
        ...
        this.lstvDisplayTech.ForeColor = Color.FromArgb(255, 255, 192 /*0xC0*/);
