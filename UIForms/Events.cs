...
public class Events : Form
{
            ...
            else
            {
                ...
                if (tag.gclass21_0.EventColourSettings.ContainsKey(tag.gclass88_0.EventTypeId))
                    ...
                    tag.gclass21_0.EventColourSettings.Add(tag.gclass88_0.EventTypeId, new EventColourSetting()
                    {
                        ...
                        AlertColour = Color.FromArgb(255, 255, 192 /*0xC0*/),
                    ...
                    while (!streamReader.EndOfStream)
                    {
                        ...
                        if (!(source[0] == "") && source.Count<string>() >= 3)
                        {
                            ...
                            if (this.gclass0_0.DIMEventTypeDictionary.ContainsKey(int32_1))
                            {
                                ...
                                gclass90.TextColour = Color.FromArgb(255, Color.FromArgb(int32_2));
                                gclass90.AlertColour = Color.FromArgb(255, Color.FromArgb(int32_3));
    ...
    private void InitializeComponent()
    {
        ...
        this.lstvEvents.ForeColor = Color.FromArgb(255, 255, 192 /*0xC0*/);
        ...
        this.txtDays.ForeColor = Color.FromArgb(128 /*0x80*/, 255, 128 /*0x80*/);
        ...
        this.cmdBackColour.ForeColor = Color.FromArgb(255, 255, 192 /*0xC0*/);
        ...
        this.cmdTextColour.ForeColor = Color.FromArgb(255, 255, 192 /*0xC0*/);
        ...
        this.cmdHideEvent.ForeColor = Color.FromArgb(255, 255, 192 /*0xC0*/);
        ...
        this.cmdTextFile.ForeColor = Color.FromArgb(255, 255, 192 /*0xC0*/);
        ...
        this.cboCategory.ForeColor = Color.FromArgb(255, 255, 192 /*0xC0*/);
        ...
        this.cmdCopyColour.ForeColor = Color.FromArgb(255, 255, 192 /*0xC0*/);
        ...
        this.cmdHeight.ForeColor = Color.FromArgb(255, 255, 192 /*0xC0*/);
        ...
        this.cmdImportColours.ForeColor = Color.FromArgb(255, 255, 192 /*0xC0*/);
        ...
        this.cmdExportColours.ForeColor = Color.FromArgb(255, 255, 192 /*0xC0*/);
        ...
        this.txtNumEvents.ForeColor = Color.FromArgb(128 /*0x80*/, 255, 128 /*0x80*/);
