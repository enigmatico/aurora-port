...
public class StarSetup : Form
{
    ...
    private void InitializeComponent()
    {
        ...
        this.cboStellarType.ForeColor = Color.FromArgb(255, 255, 192 /*0xC0*/);
        ...
        this.lstvStellarType.ForeColor = Color.FromArgb(255, 255, 192 /*0xC0*/);
        ...
        this.txtOrbit.ForeColor = Color.FromArgb(128 /*0x80*/, 255, 128 /*0x80*/);
        ...
        this.rdoA.ForeColor = Color.FromArgb(255, 255, 192 /*0xC0*/);
        ...
        this.rdoB.ForeColor = Color.FromArgb(255, 255, 192 /*0xC0*/);
        ...
        this.rdoC.ForeColor = Color.FromArgb(255, 255, 192 /*0xC0*/);
        ...
        this.txtEccDirection.ForeColor = Color.FromArgb(128 /*0x80*/, 255, 128 /*0x80*/);
