...
public class frmSectors : Form
{
    ...
    private void InitializeComponent()
    {
        ...
        this.tvSectors.ForeColor = Color.FromArgb(255, 255, 192 /*0xC0*/);
        ...
        this.lstAvailable.ForeColor = Color.FromArgb(255, 255, 192 /*0xC0*/);
        ...
        this.lstvSectorDetail.ForeColor = Color.FromArgb(255, 255, 192 /*0xC0*/);
