...
public class GClass214
{
  ...
  public int method_0()
  {
    try
    {
      return this.gclass120_0 == null ? 0 : this.gclass120_0.int_0;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3000);
      return 0;
    }
  }
  ...
  public bool method_1(double double_2, List<GClass214> list_0)
  {
    try
    {
      ...
      {
        if (gclass214 != this && this.gclass0_0.method_30(this.gclass200_0, gclass214.double_0, gclass214.double_1, this.double_0, this.double_1) < double_2)
          return true;
      }
      return false;
    }
    ...
    int int_4)
  {
    try
    {
      if (gclass202_0.gclass21_0.chkWaypoint == CheckState.Unchecked)
        return;
      SolidBrush solidBrush = new SolidBrush(Color.Violet);
      string s = this.method_2(false);
      double x = gclass222_0.double_2 - (double) GClass226.int_60 / 2.0;
      double y = gclass222_0.double_3 - (double) GClass226.int_60 / 2.0;
      if (int_4 == 0)
        graphics_0.FillEllipse((Brush) solidBrush, (float) x, (float) y, (float) GClass226.int_60, (float) GClass226.int_60);
      GClass221 gclass221 = new GClass221();
      gclass221.double_0 = x + (double) GClass226.int_60 + 5.0;
      gclass221.double_1 = y - 3.0 - (double) (int_4 * 15);
      graphics_0.DrawString(s, font_0, (Brush) solidBrush, (float) gclass221.double_0, (float) gclass221.double_1);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3003);
    }
  }
}
