...
public class AlienShipIntel
{
    ...
    public AlienShipIntel(GClass0 gclass0_1) => this.gclass0_0 = gclass0_1;
    ...
    public AlienShipIntel method_2(GameRace gclass21_2, List<AlienRaceIntel> list_0, List<AlienShipClassIntel> list_1)
    {
        try
        {
            AlienShipIntel gclass117_1 = new AlienShipIntel(this.gclass0_0);
            AlienShipIntel gclass117_2 = (AlienShipIntel)this.MemberwiseClone();
            gclass117_2.gclass21_1 = gclass21_2;
            gclass117_2.gclass110_0 =
                list_0.FirstOrDefault<AlienRaceIntel>(gclass110_1 => gclass110_1.ActualAlienRace == this.gclass21_0);
            gclass117_2.gclass115_0 =
                list_1.FirstOrDefault<AlienShipClassIntel>(gclass115_1 => gclass115_1.gclass22_0 == this.gclass115_0.gclass22_0);
            return gclass117_2;
        }
        catch (Exception ex)
        {
    ...
    public void method_4(List<GClass116> list_0)
    {
        try
        {
            ...
            if (gclass116 == null)
            {
                ...
                gclass116.int_1 = this.gclass40_0.Class.MaxSpeed;
                list_0.Add(gclass116);
            }
            else if (this.gclass40_0.Class.MaxSpeed > gclass116.int_1 && this.gclass40_0.gclass40_0 == null)
                gclass116.int_1 = this.gclass40_0.Class.MaxSpeed;
    ...
    public void method_5()
    {
        try
        {
            ...
            this.decimal_4 = this.gclass115_0.gclass22_0.Size +
                             this.gclass115_0.list_1.Sum<AlienShipWeaponIntel>(gclass119_0 =>
                                 gclass119_0.gclass230_0.decimal_2 * gclass119_0.int_1) +
                             this.gclass115_0.list_0.Sum<AlienSensorIntel>(gclass118_0 => gclass118_0.ActualSensor.decimal_2);
        }
        catch (Exception ex)
        {
    ...
    public void method_10(ShipData gclass40_1)
    {
        try
        {
            ...
            if (this.gclass110_0.SystemIntels.ContainsKey(this.gclass200_0.SystemID))
                return;
            ...
            if (gclass202.AutoSystemProtectionStatus != AuroraSystemProtectionStatus.NoProtection)
            {
                ...
                str =
                    string.Format(
                        " As per the system-level auto-protection setting, the protection status for {0} has been set to '{1}.",
                        this.gclass110_0.AlienRaceName, AuroraUtils.smethod_82(gclass202.AutoSystemProtectionStatus));
            }
            else
            {
                ...
                if (enum_0 != AuroraSystemProtectionStatus.NoProtection)
                    str =
                        string.Format(" This system has a protection status set to '{0}' for a different race.",
                            AuroraUtils.smethod_82(enum_0));
            }

            this.gclass110_0.SystemIntels.Add(this.gclass200_0.SystemID, this.gclass200_0);
            this.gclass0_0.gclass92_0.method_2(EventType.const_66,
                string.Format("The {0} has been detected in {1} for the first time.{2}", this.gclass110_0.AlienRaceName,
                    gclass202.Name, str),
    ...
    public string method_11()
    {
        try
        {
            return string.Format("{0} {1}", this.gclass115_0.gclass76_0.Abbreviation, this.string_0);
        }
        catch (Exception ex)
        {
