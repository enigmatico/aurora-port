...
internal sealed class Class328<T, U, V, W, X>
{
  ...
  public override bool Equals(object value)
  {
    ...
    // ISSUE: reference to a compiler-generated field
    // ISSUE: reference to a compiler-generated field
    return class328 != null && EqualityComparer<T>.Default.Equals(this.gparam_0, class328.gparam_0) && EqualityComparer<U>.Default.Equals(this.gparam_1, class328.gparam_1) && EqualityComparer<V>.Default.Equals(this.gparam_2, class328.gparam_2) && EqualityComparer<W>.Default.Equals(this.gparam_3, class328.gparam_3) && EqualityComparer<X>.Default.Equals(this.gparam_4, class328.gparam_4);
  }
  ...
  public override string ToString()
  {
    ...
    return string.Format((IFormatProvider) null, "{{ MineralID = {0}, MineralRace = {1}, MineralPopulation = {2}, DataType = {3}, Time = {4} }}", objArray);
  }
}
