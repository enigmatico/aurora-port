...
public class TurretDesign : Form
{
  ...
  private void TurretDesign_Load(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        this.gclass230_0 = (GClass230) this.cboBeamType.SelectedValue;
        ...
        this.gclass0_0.gclass164_0 = (GClass164) null;
        this.method_1();
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3166);
    }
  }
  ...
  private void method_1()
  {
    try
    {
      ...
      {
        int int_137 = (int) GClass226.smethod_3(this.txtTrackingSpeed.Text, 0.0);
        int int_138 = (int) GClass226.smethod_3(this.txtArmourStrength.Text, 0.0);
        GClass164 gclass164_1 = this.gclass21_0.method_388(this.gclass0_0.dictionary_49[GEnum122.const_44]);
        this.gclass21_0.method_388(this.gclass0_0.dictionary_49[GEnum122.const_5]);
        this.gclass0_0.method_450(this.gclass21_0, gclass164_1, this.gclass230_0, this.int_0, int_137, int_138, this.txtTurretSummary, this.txtTurretName, this.txtWeaponSize, this.txtWeaponCost, this.txtTotalWeaponSize, this.txtTotalWeaponCost, this.txtRotationGear, this.txtGearSize, this.txtArmourCost, this.txtArmourSize, false);
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3171);
    }
  }
  ...
  private void cmdCreate_Click(object sender, EventArgs e)
  {
    try
    {
      this.gclass0_0.gclass164_0.Name = !(this.txtCompanyName.Text == "") ? $"{this.txtCompanyName.Text} {this.txtTurretName.Text}" : this.txtTurretName.Text;
      if (this.gclass230_0.genum86_0 != GEnum86.const_0)
      {
        int num1 = (int) MessageBox.Show("You cannot create a research project for a turret that includes a prototype weapon");
      }
      else
      {
        ...
        this.gclass0_0.dictionary_54.Add(this.gclass0_0.gclass230_1.int_0, this.gclass0_0.gclass230_1);
        int num2 = (int) MessageBox.Show("Turret Design Created. Research the new turret on the Research tab of the economics window");
        this.method_1();
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3178);
    }
  }
  ...
  private void cmdInstant_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        if (this.gclass230_0.genum86_0 != GEnum86.const_0)
        {
          int num2 = (int) MessageBox.Show("You cannot create a research project for a turret that includes a prototype weapon");
        }
        else
        {
          this.gclass0_0.dictionary_50.Add(this.gclass0_0.gclass164_0.int_0, this.gclass0_0.gclass164_0);
  ...
  private void InitializeComponent()
  {
    ...
    this.txtWeaponSize.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.txtWeaponCost.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.txtTotalWeaponSize.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.txtTotalWeaponCost.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.txtRotationGear.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.txtGearSize.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.txtArmourCost.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.txtArmourSize.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.txtTrackingSpeed.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtArmourStrength.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.cboBeamType.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.txtTech.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.txtFireControl.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.txtTurretName.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtTurretSummary.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.KeyDown += new KeyEventHandler(this.TurretDesign_KeyDown);
