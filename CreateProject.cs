...
public class CreateProject : Form
{
    ...
    private void CreateProject_FormClosing(object sender, FormClosingEventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 1041);
        }
    }
    ...
    private void CreateProject_Load(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 1042);
        }
    }
    ...
    public void method_0(GameRace gclass21_1)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 1043);
        }
    }
    ...
    private void cboRaces_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 1044);
        }
    }
    ...
    public void method_1(ComboBox comboBox_0)
    {
        try
        {
            List<ResearchCategoryData> list = this.gclass0_0.ResearchCategoryDictionary.Values
                .Where<ResearchCategoryData>(gclass169_0 => gclass169_0.bPlayerDefined)
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 1045);
        }
    }
    ...
    private void cboRC_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 1046);
        }
    }
    ...
    private void method_2()
    {
        try
        {
            this.bool_1 = true;
            int int_136 = 0;
            ResearchCategoryData selectedItem = (ResearchCategoryData)this.cboRC.SelectedItem;
            if (selectedItem == null)
                return;
            if (selectedItem.ResearchCategoryType == ResearchCategoryType.NewSpecies)
                this.cmdPrototype.Visible = false;
            else
                this.cmdPrototype.Visible = true;
            if (selectedItem.RadioNumber > 0)
            {
                int_136 = selectedItem.RadioNumber;
                this.flpSizeOptions.Visible = true;
                if (selectedItem.RadioNumber == 10)
                    this.rdo10.Checked = true;
                else if (selectedItem.RadioNumber == 100)
                    this.rdo100.Checked = true;
                else if (selectedItem.RadioNumber == 1000)
                    this.rdo1000.Checked = true;
                else if (selectedItem.RadioNumber == 10000)
            ...
            if (selectedItem != null)
            {
                this.gclass0_0.method_477(this.gclass21_0, selectedItem, this.cboTech0, this.cboTech1, this.cboTech2,
                    this.cboTech3, this.cboTech4, this.cboTech5, this.cboTech6, this.cboTech7, this.lblNotes,
                    this.chkNextTech.CheckState, int_136);
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 1047);
        }
    }

    private void method_3(ResearchCategoryData gclass169_1)
    {
        try
        {
            if (gclass169_1.SourceTechType0 != TechType.None && this.cboTech0.Items.Count == 0)
                this.cmdCreate.Enabled = false;
            if (gclass169_1.SourceTechType1 != TechType.None && this.cboTech1.Items.Count == 0)
                this.cmdCreate.Enabled = false;
            if (gclass169_1.SourceTechType2 != TechType.None && this.cboTech2.Items.Count == 0)
                this.cmdCreate.Enabled = false;
            if (gclass169_1.SourceTechType3 != TechType.None && this.cboTech3.Items.Count == 0)
                this.cmdCreate.Enabled = false;
            if (gclass169_1.SourceTechType4 != TechType.None && this.cboTech4.Items.Count == 0)
                this.cmdCreate.Enabled = false;
            if (gclass169_1.SourceTechType5 != TechType.None && this.cboTech5.Items.Count == 0)
                this.cmdCreate.Enabled = false;
            if (gclass169_1.SourceTechType6 != TechType.None && this.cboTech6.Items.Count == 0)
                this.cmdCreate.Enabled = false;
            if (gclass169_1.SourceTechType7 == TechType.None || this.cboTech7.Items.Count != 0)
                return;
            this.cmdCreate.Enabled = false;
        }
        catch (Exception ex)
        {
            AuroraUtils.ShowExceptionPopup(ex, 3768);
        }
    }
    ...
    private void cboTech7_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 1048);
        }
    }
    ...
    private void method_4()
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 1049);
        }
    }
    ...
    private void method_5()
    {
        try
        {
            if (!this.method_6())
                return;
            this.gclass169_0 = (ResearchCategoryData)this.cboRC.SelectedValue;
            this.gclass0_0.gclass194_0 = null;
            string text = this.txtProjectName.Text;
            if (this.gclass169_0.ResearchCategoryType == ResearchCategoryType.FighterPodBay)
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 1050);
        }
    }
    ...
    private void cmdCreate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (this.gclass0_0.gclass194_0 != null)
            {
                ...
                this.gclass0_0.SpeciesDictionary.Add(this.gclass0_0.gclass194_0.int_0, this.gclass0_0.gclass194_0);
            }
            else
            {
                this.gclass0_0.gclass230_0.Name = this.gclass0_0.gclass164_0.Name;
                this.gclass0_0.ComponentDataDictionary.Add(this.gclass0_0.gclass230_0.int_0, this.gclass0_0.gclass230_0);
            }
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 1051);
        }
    }
    ...
    private bool method_6()
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 1052);
            return false;
        }
    }
    ...
    private void cmdCompanyName_Click(object sender, EventArgs e)
    {
        try
        {
            if (this.gclass21_0 == null || this.gclass169_0 == null)
                return;
            this.txtCompanyName.Text = this.gclass0_0.method_479(this.gclass21_0, this.gclass169_0.CompanyNameType);
        }
        catch (Exception ex)
        {
            AuroraUtils.ShowExceptionPopup(ex, 1053);
        }
    }
    ...
    private void cmdMissileDesign_Click(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 1054);
        }
    }
    ...
    private void cmdInstant_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                {
                    this.gclass0_0.gclass230_0.Name = this.gclass0_0.gclass164_0.Name;
                    this.gclass0_0.ComponentDataDictionary.Add(this.gclass0_0.gclass230_0.int_0,
                        this.gclass0_0.gclass230_0);
                }
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 1055);
        }
    }
    ...
    private void cmdTurretDesign_Click(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 1056);
        }
    }
    ...
    private void cmdGU_Click(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 1057);
        }
    }
    ...
    private void cmdPrototype_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                {
                    this.gclass0_0.gclass230_0.Name = this.gclass0_0.gclass164_0.Name;
                    this.gclass0_0.gclass230_0.genum86_0 = this.chkNextTech.CheckState != CheckState.Checked
                        ? GEnum86.const_1
                        : GEnum86.const_2;
                    this.gclass0_0.ComponentDataDictionary.Add(this.gclass0_0.gclass230_0.int_0,
                        this.gclass0_0.gclass230_0);
                ...
                if (this.chkNextTech.CheckState == CheckState.Checked)
                {
                    int num2 = (int)MessageBox.Show(
                        "The future prototype component has been created and is available for class design. A shipyard cannot be retooled for a class design that contains any type of prototype component");
                }
                else
                {
                    int num3 = (int)MessageBox.Show(
                        "The prototype component has been created and is available for class design. A shipyard cannot be retooled for a class design that contains a prototype component");
                }
            }
        }
        catch (Exception ex)
        {
            AuroraUtils.ShowExceptionPopup(ex, 1058);
        }
    }
    ...
    private void chkNextTech_CheckedChanged(object sender, EventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 1059);
        }
    }
    ...
    private void CreateProject_KeyDown(object sender, KeyEventArgs e)
    {
        ...
        {
            AuroraUtils.ShowExceptionPopup(ex, 3276);
        }
    }
    ...
    private void InitializeComponent()
    {
        ...
        this.flowLayoutPanel1.Controls.Add(this.cboTech0);
        this.flowLayoutPanel1.Controls.Add(this.cboTech1);
        this.flowLayoutPanel1.Controls.Add(this.cboTech2);
        this.flowLayoutPanel1.Controls.Add(this.cboTech3);
        this.flowLayoutPanel1.Controls.Add(this.cboTech4);
        this.flowLayoutPanel1.Controls.Add(this.cboTech5);
        this.flowLayoutPanel1.Controls.Add(this.cboTech6);
        this.flowLayoutPanel1.Controls.Add(this.cboTech7);
        this.flowLayoutPanel1.Controls.Add(this.flpSizeOptions);
        ...
        this.cboTech0.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cboTech0.SelectedIndexChanged += this.cboTech7_SelectedIndexChanged;
        this.cboTech1.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.cboTech1.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cboTech1.SelectedIndexChanged += this.cboTech7_SelectedIndexChanged;
        this.cboTech2.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.cboTech2.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cboTech2.SelectedIndexChanged += this.cboTech7_SelectedIndexChanged;
        this.cboTech3.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.cboTech3.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cboTech3.SelectedIndexChanged += this.cboTech7_SelectedIndexChanged;
        this.cboTech4.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.cboTech4.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cboTech4.SelectedIndexChanged += this.cboTech7_SelectedIndexChanged;
        this.cboTech5.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.cboTech5.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cboTech5.SelectedIndexChanged += this.cboTech7_SelectedIndexChanged;
        this.cboTech6.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.cboTech6.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cboTech6.SelectedIndexChanged += this.cboTech7_SelectedIndexChanged;
        this.cboTech7.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.cboTech7.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cboTech7.SelectedIndexChanged += this.cboTech7_SelectedIndexChanged;
        this.cboRC.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.cboRC.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cboRC.SelectedIndexChanged += this.cboRC_SelectedIndexChanged;
        ...
        this.txtCompanyName.Leave += this.txtProjectName_Leave;
        this.txtProjectName.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.txtProjectName.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.txtProjectName.TextChanged += this.txtProjectName_TextChanged;
        this.txtProjectName.Leave += this.txtProjectName_Leave;
        this.cmdMissileDesign.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.cmdMissileDesign.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdMissileDesign.Tag = "1200";
        this.cmdMissileDesign.Text = "Missile Design";
        this.cmdMissileDesign.UseVisualStyleBackColor = false;
        this.cmdMissileDesign.Click += this.cmdMissileDesign_Click;
        this.cmdTurretDesign.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.cmdTurretDesign.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdTurretDesign.Tag = "1200";
        this.cmdTurretDesign.Text = "Turret Design";
        this.cmdTurretDesign.UseVisualStyleBackColor = false;
        this.cmdTurretDesign.Click += this.cmdTurretDesign_Click;
        this.txtDetails.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
        this.txtDetails.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdGU.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.cmdGU.Click += this.cmdGU_Click;
        ...
        this.flpEntry1.Controls.Add(this.lblEntry1);
        this.flpEntry1.Controls.Add(this.txtEntry1);
        ...
        this.txtEntry1.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.flpEntry2.Controls.Add(this.lblEntry2);
        this.flpEntry2.Controls.Add(this.txtEntry2);
        ...
        this.txtEntry2.ForeColor = Color.FromArgb(128 /*0x80*/, byte.MaxValue, 128 /*0x80*/);
        ...
        this.cmdPrototype.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.flowLayoutPanel2.Controls.Add(this.cmdCreate);
        this.flowLayoutPanel2.Controls.Add(this.cmdInstant);
        this.flowLayoutPanel2.Controls.Add(this.cmdPrototype);
        this.flowLayoutPanel2.Controls.Add(this.cmdCompanyName);
        this.flowLayoutPanel2.Controls.Add(this.cmdMissileDesign);
        this.flowLayoutPanel2.Controls.Add(this.cmdTurretDesign);
        this.flowLayoutPanel2.Controls.Add(this.cmdGU);
        ...
        this.chkNextTech.CheckedChanged += this.chkNextTech_CheckedChanged;
        this.flpSizeOptions.Anchor = AnchorStyles.None;
        this.flpSizeOptions.AutoSize = true;
        this.flpSizeOptions.Controls.Add(this.lblRadioInfo);
        this.flpSizeOptions.Controls.Add(this.rdo10);
        this.flpSizeOptions.Controls.Add(this.rdo100);
        this.flpSizeOptions.Controls.Add(this.rdo1000);
        this.flpSizeOptions.Controls.Add(this.rdo10000);
        ...
        this.rdo10.CheckedChanged += this.rdo10000_CheckedChanged;
        ...
        this.rdo100.CheckedChanged += this.rdo10000_CheckedChanged;
        ...
        this.rdo1000.CheckedChanged += this.rdo10000_CheckedChanged;
        ...
        this.rdo10000.CheckedChanged += this.rdo10000_CheckedChanged;
        ...
        this.Controls.Add(this.chkNextTech);
        this.Controls.Add(this.flowLayoutPanel2);
        this.Controls.Add(this.chkNoNameUpdate);
        this.Controls.Add(this.txtDetails);
        this.Controls.Add(this.txtProjectName);
        this.Controls.Add(this.txtCompanyName);
        this.Controls.Add(this.flpEntry1);
        this.Controls.Add(this.flpEntry2);
        this.Controls.Add(this.cboRC);
        ...
        this.Activated += this.CreateProject_Activated;
        this.FormClosing += this.CreateProject_FormClosing;
        this.Load += this.CreateProject_Load;
        this.KeyDown += this.CreateProject_KeyDown;
