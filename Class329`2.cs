...
internal sealed class Class329<T, U>
{
    ...
    public override bool Equals(object value)
    {
        ...
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        return class329 != null && EqualityComparer<T>.Default.Equals(this.gparam_0, class329.gparam_0) &&
               EqualityComparer<U>.Default.Equals(this.gparam_1, class329.gparam_1);
    }
    ...
    public override int GetHashCode()
    {
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        return (EqualityComparer<T>.Default.GetHashCode(this.gparam_0) - 1558636025) * -1521134295 +
    ...
    public override string ToString()
    {
        ...
        return string.Format(null, "{{ MineralID = {0}, DataType = {1} }}", objArray);
    }
}