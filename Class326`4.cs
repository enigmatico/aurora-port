...
internal sealed class Class326<T, U, V, W>
{
    ...
    public override bool Equals(object value)
    {
        ...
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        return class326 != null && EqualityComparer<T>.Default.Equals(this.gparam_0, class326.gparam_0) &&
               EqualityComparer<U>.Default.Equals(this.gparam_1, class326.gparam_1) &&
               EqualityComparer<V>.Default.Equals(this.gparam_2, class326.gparam_2) &&
               EqualityComparer<W>.Default.Equals(this.gparam_3, class326.gparam_3);
    }
    ...
    public override int GetHashCode()
    {
        ...
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        return (((EqualityComparer<T>.Default.GetHashCode(this.gparam_0) - 1657138387) * -1521134295 +
               ...
               EqualityComparer<W>.Default.GetHashCode(this.gparam_3);
    }
    ...
    public override string ToString()
    {
        ...
        return string.Format(null, "{{ SensorRace = {0}, SensorSystem = {1}, Xcor = {2}, Ycor = {3} }}", objArray);
    }
}