...
public class cmdSelect : Form
{
    ...
    private void InitializeComponent()
    {
        ...
        this.lstThemes.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
        ...
        this.lstNames.ForeColor = Color.FromArgb(byte.MaxValue, byte.MaxValue, 192 /*0xC0*/);
