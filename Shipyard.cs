...
public class Shipyard
{
    private sealed class Class1162
    {
        ...
        internal bool method_0(ShipClass gclass22_0)
        {
            if (gclass22_0.gclass187_0 != null || gclass22_0.Obsolete != 0 && !this.bool_0 ||
                !(gclass22_0.Size <= this.gclass193_0.Capacity / 50M) || !gclass22_0.Commercial ||
                gclass22_0.Race != this.gclass193_0.Race)
                return false;
            if (!this.bool_1)
                return true;
            return gclass22_0.Size >= this.gclass193_0.BuildShipClass.Size * 0.8M &&
                   gclass22_0.Size <= this.gclass193_0.BuildShipClass.Size * 1.2M;
        }
        ...
        {
            return gclass40_0.Race == this.gclass193_0.Race;
        }

        internal bool method_3(ShipClass gclass22_0)
        {
            return gclass22_0.Size <= this.gclass193_0.Capacity / 50M && gclass22_0.Commercial &&
                   gclass22_0.Race == this.gclass193_0.Race && gclass22_0.gclass187_0 == null;
        }

        internal bool method_4(ShipClass gclass22_0)
        {
            return gclass22_0.Size <= this.gclass193_0.Capacity / 50M &&
                   gclass22_0.Race == this.gclass193_0.Race && gclass22_0.gclass187_0 == null;
        }
        ...
        internal bool method_6(ShipData gclass40_0)
        {
            return this.gclass193_0.gclass0_0.method_520(gclass40_0.gclass85_0.XCoord,
                this.gclass193_0.Population.method_87(), gclass40_0.gclass85_0.YCoord,
                this.gclass193_0.Population.method_88());
        }
    }
    ...
    public ShipData TractorParentShip;
    public ShipData ParentShip;
    public ShipClass BuildShipClass;
    public ShipClass RetoolClassID;
    public FleetData DefaultFleet;
    public NavalAdminCommand DefaultNavalAdmin;
    ...
    public Shipyard(GClass0 gclass0_1) => this.gclass0_0 = gclass0_1;

    public List<ShipyardTask> method_0()
    {
        try
        {
            return this.gclass0_0.dictionary_32.Values.Where<ShipyardTask>(gclass192_0 => gclass192_0.gclass193_0 == this)
                .ToList<ShipyardTask>();
        }
        catch (Exception ex)
        {
    ...
    public int method_1()
    {
        try
        {
            return this.gclass0_0.dictionary_32.Values.Count<ShipyardTask>(gclass192_0 => gclass192_0.gclass193_0 == this);
        }
        catch (Exception ex)
        {
    ...
    public void method_2()
    {
        try
        {
            ...
            gclass192.gclass21_0 = this.Race;
            gclass192.gclass146_0 = this.Population;
            gclass192.gclass193_0 = this;
            gclass192.gclass40_0 = null;
            gclass192.gclass22_0 = this.BuildShipClass;
            gclass192.gclass22_1 = null;
            gclass192.gclass85_0 = null;
            gclass192.gclass123_0 = this.BuildShipClass.ClassMaterials.method_25();
            gclass192.auroraSYTaskType_0 = AuroraSYTaskType.Construction;
            gclass192.decimal_0 = this.BuildShipClass.Cost;
            gclass192.decimal_1 = 0M;
            gclass192.bool_0 = this.BuildShipClass.Commercial;
            gclass192.string_0 = "";
            gclass192.bool_2 = false;
            gclass192.bool_1 = this.Race.NPR;
        ...
        ComboBox comboBox_2)
    {
        try
        {
            if (this.auroraSYTaskType_0 == AuroraSYTaskType.Construction)
            {
                ...
                if (!this.gclass22_2.method_29(this.Population))
                {
                ...
                ShipData gclass40 = this.gclass0_0.Ships.Values.FirstOrDefault<ShipData>(
                    gclass40_3 => gclass40_3.Race == this.Race && gclass40_3.ShipName == this.string_1);
                if (gclass40 != null)
                {
                    int num = (int)MessageBox.Show(
                        string.Format("That name is already in use for a unit of the {0} class",
                            gclass40.Class.ClassName));
                    return false;
                }
            ...
            {
                if (!this.gclass22_3.method_30(this.gclass22_2, this.Population))
                {
                    int num = (int)MessageBox.Show(
            ...
            gclass192_0.gclass146_0 = this.Population;
            ...
            if (this.auroraSYTaskType_0 == AuroraSYTaskType.Construction)
            {
                this.Population.method_33(gclass192_0, checkState_0);
            ...
            if (this.auroraSYTaskType_0 == AuroraSYTaskType.Refit ||
                this.auroraSYTaskType_0 == AuroraSYTaskType.AutoRefit)
            {
                this.Population.method_34(gclass192_0, checkState_0);
                gclass192_0.bool_3 = true;
            }
        ...
        try
        {
            ...
            switch (comboBox_0.Text)
            {
                case "Construction":
                    ...
                    this.gclass22_2.ClassMaterials.method_31(listView_0, this.Population.CurrentMinerals);
                ...
                case "Scrap":
                    ...
                    this.gclass22_2.ClassMaterials.method_32(listView_0, this.Population.CurrentMinerals,
                ...
                case "Refit":
                    ...
                    gclass123_1_1.method_31(listView_0, this.Population.CurrentMinerals);
                ...
                case "Auto Refit":
                    ...
                    gclass123_1_2.method_31(listView_0, this.Population.CurrentMinerals);
    ...
    public void method_6()
    {
        ...
        {
            this.decimal_3 =
                (1M + ((this.SYType != AuroraShipyardType.Naval
                    ? this.Capacity * AuroraUtils.decimal_67 / (AuroraUtils.int_20 * 50)
                    : this.Capacity / (AuroraUtils.int_20 * 50)) - 1M) / 2M) * this.Population.decimal_65;
        }
        catch (Exception ex)
        {
    ...
    public void method_7(ShipClass gclass22_4)
    {
        try
        {
            ...
            this.decimal_4 = (1M + (decimal14 / AuroraUtils.int_20 - 1M) / 2M) * this.Population.decimal_65;
        }
        catch (Exception ex)
        {
    ...
    public List<ShipClass> method_8()
    {
        try
        {
            ...
            if (this.BuildShipClass == null)
                return gclass22List;
            gclass22List.Add(this.BuildShipClass);
            foreach (ShipClass gclass22_0 in this.SYType != AuroraShipyardType.Commercial
                         ? this.gclass0_0.ShipClasses.Values.Where<ShipClass>(gclass22_4 =>
                                 ...
                                 gclass22_4.Size <= this.Capacity / 50M && gclass22_4 != this.BuildShipClass &&
                                 gclass22_4.Race == this.Race)
                             .OrderBy<ShipClass, string>(gclass22_0 => gclass22_0.ClassName).ToList<ShipClass>()
                         : this.gclass0_0.ShipClasses.Values.Where<ShipClass>(gclass22_4 =>
                                 gclass22_4.gclass187_0 == null && gclass22_4.Obsolete == 0 && gclass22_4.OtherRaceClassID == 0 &&
                                 gclass22_4.Size <= this.Capacity / 50M && gclass22_4 != this.BuildShipClass &&
                                 gclass22_4.Commercial && gclass22_4.Race == this.Race)
                             .OrderBy<ShipClass, string>(gclass22_0 => gclass22_0.ClassName).ToList<ShipClass>())
            {
                if (!(gclass22_0.Size < this.BuildShipClass.Size * 0.8M) &&
                    !(gclass22_0.Size > this.BuildShipClass.Size * 1.2M) &&
                    this.BuildShipClass.method_40(gclass22_0, null, null) <= this.BuildShipClass.Cost / 5M)
    ...
    public List<ShipClass> method_9(bool bool_2, bool bool_3, bool bool_4)
    {
        ...
        Shipyard.Class1162 class1162 = new Shipyard.Class1162();
        ...
        {
            // ISSUE: reference to a compiler-generated field
            if (this.BuildShipClass == null && class1162.bool_1)
            ...
            if (class1162.bool_1)
            {
                ...
                // ISSUE: reference to a compiler-generated method
                // ISSUE: reference to a compiler-generated method
                first = (this.SYType != AuroraShipyardType.Commercial
