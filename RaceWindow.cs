...
public class RaceWindow : Form
{
  ...
  public void method_0()
  {
    try
    {
      ...
      this.pbFlagImage.Image = this.gclass21_0.image_0;
      this.pbShipImage.Image = this.gclass21_0.image_1;
      this.pbStationImage.Image = this.gclass21_0.image_2;
      ...
      List<GClass146> list = this.gclass0_0.dictionary_22.Values.Where<GClass146>((Func<GClass146, bool>) (gclass146_0 => gclass146_0.gclass21_0 == this.gclass21_0)).ToList<GClass146>();
  ...
  private void cboSpecies_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      Decimal num1 = this.gclass0_0.dictionary_22.Values.Where<GClass146>((Func<GClass146, bool>) (gclass146_0 => gclass146_0.gclass21_0 == this.gclass21_0)).Sum<GClass146>((Func<GClass146, Decimal>) (gclass146_0 => gclass146_0.decimal_4));
      Decimal num2 = this.gclass0_0.dictionary_22.Values.Where<GClass146>(v=>
        v.gclass21_0 == capturedthis.gclass21_0 && v.gclass194_0 == capturedSboSpeciesSelectedValue
        ).Sum<GClass146>((Func<GClass146, Decimal>) (gclass146_0 => gclass146_0.decimal_4));
      Decimal num3 = num1 + (Decimal) this.gclass0_0.dictionary_4.Values.Where<GClass40>((Func<GClass40, bool>) (gclass40_0 => gclass40_0.gclass21_0 == this.gclass21_0)).SelectMany<GClass40, GClass181>((Func<GClass40, IEnumerable<GClass181>>) (gclass40_0 => (IEnumerable<GClass181>) gclass40_0.list_18)).Sum<GClass181>((Func<GClass181, int>) (gclass181_0 => gclass181_0.int_0)) / 1000000M;
      Decimal decimal_73 = num2 + (Decimal) this.gclass0_0.dictionary_4.Values.Where<GClass40>((Func<GClass40, bool>) (gclass40_0 => gclass40_0.gclass21_0 == this.gclass21_0)).SelectMany<GClass40, GClass181>((Func<GClass40, IEnumerable<GClass181>>) (gclass40_0 => (IEnumerable<GClass181>) gclass40_0.list_18)).Where<GClass181>(v181=>v181.gclass194_0 == capturedSboSpeciesSelectedValue).Sum<GClass181>((Func<GClass181, int>) (gclass181_0 => gclass181_0.int_0)) / 1000000M;
      this.txtSpeciesTotalPop.Text = GClass226.smethod_39(decimal_73);
      if (num3 > 0M)
        this.txtPercentPop.Text = GClass226.smethod_42(decimal_73 / num3 * 100M, 1) + "%";
      else
        this.txtPercentPop.Text = "N/A";
      this.pbSpecies.Image = Image.FromFile($"{Application.StartupPath}\\Races\\{capturedSboSpeciesSelectedValue.string_0}");
      this.txtSpeciesName.Text = capturedSboSpeciesSelectedValue.SpeciesName;
      this.txtGravity.Text = GClass226.smethod_46(capturedSboSpeciesSelectedValue.double_5, 2);
      this.txtGravityDev.Text = GClass226.smethod_46(capturedSboSpeciesSelectedValue.double_6, 2);
      this.txtTemp.Text = GClass226.smethod_46(capturedSboSpeciesSelectedValue.double_3 - (double) GClass226.int_17, 2);
      this.txtTempDev.Text = GClass226.smethod_46(capturedSboSpeciesSelectedValue.double_4, 2);
      this.txtOxygen.Text = GClass226.smethod_46(capturedSboSpeciesSelectedValue.double_0, 2);
      this.txtOxygenDev.Text = GClass226.smethod_46(capturedSboSpeciesSelectedValue.double_1, 2);
      this.txtPressure.Text = GClass226.smethod_46(capturedSboSpeciesSelectedValue.double_2, 2);
      this.txtDensity.Text = GClass226.smethod_45(capturedSboSpeciesSelectedValue.decimal_0, 2);
      this.txtGrowth.Text = GClass226.smethod_45(capturedSboSpeciesSelectedValue.decimal_1, 2);
      this.txtResearch.Text = GClass226.smethod_45(capturedSboSpeciesSelectedValue.decimal_2, 2);
      this.txtProduction.Text = GClass226.smethod_45(capturedSboSpeciesSelectedValue.decimal_3, 2);
      this.txtDet.Text = GClass226.smethod_37(capturedSboSpeciesSelectedValue.int_7);
      this.txtDip.Text = GClass226.smethod_37(capturedSboSpeciesSelectedValue.int_3);
      this.txtExp.Text = GClass226.smethod_37(capturedSboSpeciesSelectedValue.int_6);
      this.txtMil.Text = GClass226.smethod_37(capturedSboSpeciesSelectedValue.int_5);
      this.txtTrade.Text = GClass226.smethod_37(capturedSboSpeciesSelectedValue.int_8);
      this.txtTrans.Text = GClass226.smethod_37(capturedSboSpeciesSelectedValue.int_4);
      this.txtXen.Text = GClass226.smethod_37(capturedSboSpeciesSelectedValue.int_2);
      this.txtGraduationAge.Text = GClass226.smethod_37(capturedSboSpeciesSelectedValue.int_11);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 2590);
    }
  }
  ...
  private void cmdSaveSpecies_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      GClass208 gclass208_1 = GClass226.smethod_4(this.txtDensity.Text);
      if (gclass208_1.bool_0)
        selectedValue.decimal_0 = gclass208_1.decimal_0;
      GClass208 gclass208_2 = GClass226.smethod_4(this.txtGrowth.Text);
      if (gclass208_2.bool_0)
        selectedValue.decimal_1 = gclass208_2.decimal_0;
      GClass208 gclass208_3 = GClass226.smethod_4(this.txtProduction.Text);
      if (gclass208_3.bool_0)
        selectedValue.decimal_3 = gclass208_3.decimal_0;
      GClass208 gclass208_4 = GClass226.smethod_4(this.txtResearch.Text);
      if (gclass208_4.bool_0)
        selectedValue.decimal_2 = gclass208_4.decimal_0;
      ...
      selectedValue.double_3 = Convert.ToDouble(this.txtTemp.Text) + (double) GClass226.int_17;
  ...
  private void cmdAddTheme_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass0_0.bool_9 || this.gclass21_0 == null)
        return;
      this.gclass21_0.method_111((GClass58) this.cboSelectNamingTheme.SelectedValue, Convert.ToInt32(this.txtChance.Text));
      this.gclass21_0.method_119(this.lstvNameThemes, this.txtPrimaryNameTheme);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 2600);
    }
  }
  ...
  private void cmdDeleteNameTheme_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        this.gclass21_0.method_112((GClass45) this.lstvNameThemes.SelectedItems[0].Tag);
        this.gclass21_0.method_119(this.lstvNameThemes, this.txtPrimaryNameTheme);
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 2601);
    }
  }
  ...
  private void cmdEditTheme_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        GClass45 tag = (GClass45) this.lstvNameThemes.SelectedItems[0].Tag;
        ...
        if (this.gclass0_0.bool_21)
          return;
        tag.int_0 = Convert.ToInt32(this.gclass0_0.string_4);
        this.gclass21_0.method_119(this.lstvNameThemes, this.txtPrimaryNameTheme);
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 2602);
    }
  }
  ...
  private void cmdDeleteRace_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass0_0.bool_9 || this.gclass21_0 == null || MessageBox.Show(" Are you sure you want to delete this race?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes || MessageBox.Show(" Are you really sure?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
        return;
  ...
  private void cboTrainingLevel_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      if (this.gclass21_0 == null)
        return;
      Decimal num = this.gclass21_0.decimal_8 * (Decimal) this.gclass21_0.int_30;
      this.gclass21_0.int_30 = Convert.ToInt32((string) this.cboTrainingLevel.SelectedItem);
      this.gclass21_0.decimal_8 = num / (Decimal) this.gclass21_0.int_30;
      this.gclass21_0.method_120(this.lstvAcademies, this.gclass0_0.dictionary_22.Values.Where<GClass146>((Func<GClass146, bool>) (gclass146_0 => gclass146_0.gclass21_0 == this.gclass21_0)).ToList<GClass146>(), (ComboBox) null);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3199);
    }
  }
  ...
  private void InitializeComponent()
  {
    ...
    this.flowLayoutPanel1.Controls.Add((Control) this.pbRaceImage);
    this.flowLayoutPanel1.Controls.Add((Control) this.flowLayoutPanel2);
    this.flowLayoutPanel1.Controls.Add((Control) this.flowLayoutPanel5);
    this.flowLayoutPanel1.Controls.Add((Control) this.pbFlagImage);
    ...
    this.flowLayoutPanel2.Controls.Add((Control) this.pbShipImage);
    ...
    this.flowLayoutPanel5.Controls.Add((Control) this.pbStationImage);
    ...
    this.flowLayoutPanel4.Controls.Add((Control) this.panel6);
    this.flowLayoutPanel4.Controls.Add((Control) this.panel15);
    ...
    this.panel4.Controls.Add((Control) this.cboRaces);
    ...
    this.cboSystemTheme.SelectedIndexChanged += new EventHandler(this.cboSystemTheme_SelectedIndexChanged);
    ...
    this.cboClassTheme.SelectedIndexChanged += new EventHandler(this.cboClassTheme_SelectedIndexChanged);
    ...
    this.panel5.Controls.Add((Control) this.txtPrimaryNameTheme);
    ...
    this.txtPrimaryNameTheme.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.flowLayoutPanel6.Controls.Add((Control) this.panel2);
    this.flowLayoutPanel6.Controls.Add((Control) this.panel14);
    this.flowLayoutPanel6.Controls.Add((Control) this.panel49);
    this.flowLayoutPanel6.Controls.Add((Control) this.panel16);
    this.flowLayoutPanel6.Controls.Add((Control) this.panel48);
    ...
    this.flowLayoutPanel6.Controls.Add((Control) this.panel20);
    ...
    this.panel14.Controls.Add((Control) this.pbSpecies);
    ...
    this.panel49.Controls.Add((Control) this.txtSpeciesName);
    this.panel49.Controls.Add((Control) this.label48);
    ...
    this.panel16.Controls.Add((Control) this.txtSpeciesTotalPop);
    ...
    this.txtSpeciesTotalPop.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.panel48.Controls.Add((Control) this.txtPercentPop);
    this.panel48.Controls.Add((Control) this.label32);
    ...
    this.txtPercentPop.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtXen.TextChanged += new EventHandler(this.txtXen_TextChanged);
    ...
    this.cmdSaveSpecies.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdSaveSpecies.Tag = (object) "1200";
    this.cmdSaveSpecies.Text = "Save Species";
    this.cmdSaveSpecies.UseVisualStyleBackColor = false;
    this.cmdSaveSpecies.Click += new EventHandler(this.cmdSaveSpecies_Click);
    this.flowLayoutPanel3.Controls.Add((Control) this.cmdSaveSpecies);
    this.flowLayoutPanel3.Controls.Add((Control) this.cmdTotalForceText);
    this.flowLayoutPanel3.Controls.Add((Control) this.cmdSpeciesImage);
    this.flowLayoutPanel3.Controls.Add((Control) this.cmdStation);
    this.flowLayoutPanel3.Controls.Add((Control) this.cmdHull);
    this.flowLayoutPanel3.Controls.Add((Control) this.cmdRaceFlag);
    this.flowLayoutPanel3.Controls.Add((Control) this.cmdDeleteRace);
    ...
    this.cmdDeleteRace.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDeleteRace.Click += new EventHandler(this.cmdDeleteRace_Click);
    ...
    this.lstvSupplies.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tabPage1.Controls.Add((Control) this.flowLayoutPanel6);
    ...
    this.tabPage2.Controls.Add((Control) this.lstvNameThemes);
    this.tabPage2.Controls.Add((Control) this.flowLayoutPanel7);
    this.tabPage2.Controls.Add((Control) this.panel19);
    this.tabPage2.Controls.Add((Control) this.panel18);
    ...
    this.lstvNameThemes.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.flowLayoutPanel7.Controls.Add((Control) this.cmdAddTheme);
    this.flowLayoutPanel7.Controls.Add((Control) this.cmdEditTheme);
    this.flowLayoutPanel7.Controls.Add((Control) this.cmdDeleteNameTheme);
    ...
    this.cmdAddTheme.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdAddTheme.Tag = (object) "1200";
    this.cmdAddTheme.Text = "Add Theme";
    this.cmdAddTheme.UseVisualStyleBackColor = false;
    this.cmdAddTheme.Click += new EventHandler(this.cmdAddTheme_Click);
    this.cmdEditTheme.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdEditTheme.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdEditTheme.Tag = (object) "1200";
    this.cmdEditTheme.Text = "Edit Weight";
    this.cmdEditTheme.UseVisualStyleBackColor = false;
    this.cmdEditTheme.Click += new EventHandler(this.cmdEditTheme_Click);
    this.cmdDeleteNameTheme.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdDeleteNameTheme.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDeleteNameTheme.Tag = (object) "1200";
    this.cmdDeleteNameTheme.Text = "Delete Theme";
    this.cmdDeleteNameTheme.UseVisualStyleBackColor = false;
    this.cmdDeleteNameTheme.Click += new EventHandler(this.cmdDeleteNameTheme_Click);
    this.panel19.Controls.Add((Control) this.txtChance);
    ...
    this.panel18.Controls.Add((Control) this.cboSelectNamingTheme);
    ...
    this.cboSelectNamingTheme.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboSelectNamingTheme.SelectedIndexChanged += new EventHandler(this.cboSelectNamingTheme_SelectedIndexChanged);
    ...
    this.tabPage3.Controls.Add((Control) this.cboTrainingLevel);
    this.tabPage3.Controls.Add((Control) this.lstvAcademies);
    ...
    this.cboTrainingLevel.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboTrainingLevel.SelectedIndexChanged += new EventHandler(this.cboTrainingLevel_SelectedIndexChanged);
    ...
    this.lstvAcademies.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.panel20.Controls.Add((Control) this.txtGraduationAge);
    this.panel20.Controls.Add((Control) this.label5);
    ...
    this.Controls.Add((Control) this.lstvSupplies);
    this.Controls.Add((Control) this.lstvTechnology);
    this.Controls.Add((Control) this.lstvPopSummary);
    ...
    this.Name = nameof (RaceWindow);
    this.Text = "Race Information";
    this.FormClosing += new FormClosingEventHandler(this.RaceWindow_FormClosing);
    this.Load += new EventHandler(this.RaceWindow_Load);
    this.KeyDown += new KeyEventHandler(this.RaceWindow_KeyDown);
