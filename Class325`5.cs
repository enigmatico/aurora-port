...
internal sealed class Class325<T, U, V, W, X>
{
  ...
  public override bool Equals(object value)
  {
    ...
    // ISSUE: reference to a compiler-generated field
    // ISSUE: reference to a compiler-generated field
    return class325 != null && EqualityComparer<T>.Default.Equals(this.gparam_0, class325.gparam_0) && EqualityComparer<U>.Default.Equals(this.gparam_1, class325.gparam_1) && EqualityComparer<V>.Default.Equals(this.gparam_2, class325.gparam_2) && EqualityComparer<W>.Default.Equals(this.gparam_3, class325.gparam_3) && EqualityComparer<X>.Default.Equals(this.gparam_4, class325.gparam_4);
  }
  ...
  public override string ToString()
  {
    ...
    return string.Format((IFormatProvider) null, "{{ SensorRace = {0}, SensorSystem = {1}, ELINTStrength = {2}, Xcor = {3}, Ycor = {4} }}", objArray);
  }
}
