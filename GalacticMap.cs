...
{
  private Dictionary<AuroraSystemProtectionStatus, string> dictionary_0 = new Dictionary<AuroraSystemProtectionStatus, string>();
  ...
  public GalacticMap(GClass0 gclass0_1)
  {
    ...
    this.MouseWheel += new MouseEventHandler(this.GalacticMap_MouseWheel);
  }
  ...
  private void GalacticMap_Load(object sender, EventArgs e)
  {
    try
    {
      ...
      this.gclass0_0.double_2 = (double) this.Width;
      this.gclass0_0.double_3 = (double) this.Height;
      ...
      this.bool_3 = true;
      foreach (AuroraSystemProtectionStatus protectionStatus in Enum.GetValues(typeof (AuroraSystemProtectionStatus)))
        this.dictionary_0.Add(protectionStatus, GClass226.smethod_82((Enum) protectionStatus));
      this.cboStatus.DataSource = (object) this.dictionary_0.Values.ToList<string>();
  ...
  public void method_0()
  {
    try
    {
      ...
      double num1 = this.gclass21_0.dictionary_0.Values.Min<GClass202>((Func<GClass202, double>) (gclass202_0 => gclass202_0.double_5));
      double num2 = this.gclass21_0.dictionary_0.Values.Min<GClass202>((Func<GClass202, double>) (gclass202_0 => gclass202_0.double_6));
      double num3 = this.gclass21_0.dictionary_0.Values.Max<GClass202>((Func<GClass202, double>) (gclass202_0 => gclass202_0.double_5));
      double num4 = this.gclass21_0.dictionary_0.Values.Max<GClass202>((Func<GClass202, double>) (gclass202_0 => gclass202_0.double_6));
  ...
  public void method_2(bool bool_6)
  {
    try
    {
      ...
      this.gclass21_0.method_183(this.chkAllied.CheckState, this.chkFriendly.CheckState, this.chkNeutral.CheckState, this.chkHostile.CheckState, this.chkCivilian.CheckState, (GClass110) this.cboContactRaceFilter.SelectedItem);
      this.gclass21_0.method_182(this.chkUseMaxCCDisplay.CheckState);
      GClass1 gclass1 = this.gclass21_0.method_189();
      this.gclass0_0.bool_9 = true;
      ...
      this.txtMinFontSize.Text = this.gclass21_0.double_4.ToString();
      this.gclass21_0.method_335(this.lstvSurveySites);
      this.gclass0_0.bool_9 = false;
      if (gclass1 != null && bool_6)
        this.method_4(this.gclass21_0.dictionary_0[gclass1.int_1]);
      if (!this.bool_3)
    ...
    {
      GClass226.smethod_74(ex, 1088);
    }
  }

  private void method_3(GClass122 gclass122_2)
  {
    try
    {
      this.gclass122_0 = gclass122_2;
      this.txtLabel.Text = this.gclass122_0.string_0;
      this.txtLabel.ForeColor = this.gclass122_0.color_0;
      this.txtLabel.Font = this.gclass122_0.font_0;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 1089);
    }
  }

  private void method_4(GClass202 gclass202_2)
  {
    try
    {
      if (gclass202_2 == null)
      ...
      this.gclass0_0.bool_9 = true;
      this.cboAlienRace.SelectedItem = this.gclass202_0.gclass110_0 == null ? (object) this.gclass110_0 : (object) this.gclass202_0.gclass110_0;
      this.cboStatus.SelectedItem = (object) GClass226.smethod_82((Enum) gclass202_2.auroraSystemProtectionStatus_0);
      this.cboNamingTheme.SelectedItem = this.gclass202_0.gclass140_0 == null ? (object) this.gclass140_0 : (object) this.gclass202_0.gclass140_0;
      this.chkNoAutoRoute.CheckState = !this.gclass202_0.bool_3 ? CheckState.Unchecked : CheckState.Checked;
      this.chkRestricted.CheckState = !this.gclass202_0.bool_4 ? CheckState.Unchecked : CheckState.Checked;
      this.chkMineralSearchFlag.CheckState = !this.gclass202_0.bool_5 ? CheckState.Unchecked : CheckState.Checked;
      GClass62 gclass62 = this.gclass21_0.method_186(this.cboSector, this.gclass202_0);
      this.cboSector.SelectedItem = this.gclass202_0.gclass62_0 == null ? (object) gclass62 : (object) this.gclass202_0.gclass62_0;
      this.gclass0_0.bool_9 = false;
      ...
      this.method_10();
      this.panJP.Refresh();
      if (this.chkDistanceFromSelected.CheckState == CheckState.Checked || this.chkDistanceFromSelectedMR.CheckState == CheckState.Checked || this.chkDistanceRealSpace.CheckState == CheckState.Checked)
        this.gclass0_0.method_37(this.gclass202_0.gclass200_0, this.gclass21_0, this.chkDistanceFromSelectedMR.CheckState, this.chkDistanceRealSpace.CheckState);
  ...
  private void panJP_Paint(object sender, PaintEventArgs e)
  {
    try
    {
      if (this.gclass21_0 == null || this.gclass202_0 == null)
        return;
      this.gclass202_0.method_32(e.Graphics, this.Font, (double) this.panJP.Width);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 1092);
    }
  }
  ...
  private void method_7()
  {
    try
    {
      ...
      toolTip.SetToolTip((Control) this.chkHabRangeWorlds, "System Bodies with a colony cost less than 2.00 that have gravity within the species range");
      toolTip.SetToolTip((Control) this.chkHabRangeWorldsLowG, "System Bodies with a colony cost less than 2.00");
      ...
      toolTip.SetToolTip((Control) this.chkDistanceFromSelectedMR, "Show distance in billions of km between centre of selected system and centre of this system, without using military restricted jump points");
      toolTip.SetToolTip((Control) this.chkDistanceRealSpace, "Show real space distance in light years between centre of selected system and centre of others system");
      ...
      toolTip.SetToolTip((Control) this.chkAetherRift, "Highlight systems with one or more Aether Rifts");
      toolTip.SetToolTip((Control) this.chkNumWrecks, "Display number of wrecks in each system");
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 1098);
    }
  }
  ...
  private void chkAdminIcon_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass0_0.bool_9)
        return;
      CheckBox checkBox = (CheckBox) sender;
      if ((this.chkDistanceFromSelected.CheckState == CheckState.Checked || this.chkDistanceFromSelectedMR.CheckState == CheckState.Checked) && checkBox.Name == "chkDistanceRealSpace")
      {
      ...
      else if (this.chkDistanceRealSpace.CheckState == CheckState.Checked && (checkBox.Name == "chkDistanceFromSelected" || checkBox.Name == "chkDistanceFromSelectedMR") && (this.chkDistanceFromSelected.CheckState == CheckState.Checked || this.chkDistanceFromSelectedMR.CheckState == CheckState.Checked))
      {
        this.gclass0_0.bool_9 = true;
      ...
      if (checkBox.Name == "chkUseMaxCCDisplay")
        this.method_2(false);
      if ((checkBox.Name == "chkDistanceFromSelected" || checkBox.Name == "chkDistanceFromSelectedMR" || checkBox.Name == "chkDistanceRealSpace") && this.gclass202_0 != null)
        this.gclass0_0.method_37(this.gclass202_0.gclass200_0, this.gclass21_0, this.chkDistanceFromSelectedMR.CheckState, this.chkDistanceRealSpace.CheckState);
      this.Refresh();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 1099);
    }
  }
  ...
  public void method_9()
  {
    try
    {
      ...
      if (this.chkSystemOnly.CheckState == CheckState.Checked)
        this.gclass21_0.method_355(this.tvFleetList, this.gclass202_0, true, bool_25, (TextBox) null);
      else
        this.gclass21_0.method_355(this.tvFleetList, (GClass202) null, false, bool_25, (TextBox) null);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 1101);
    }
  }
  ...
  public void method_10()
  {
    try
    {
      if (this.gclass21_0 == null || this.gclass202_0 == null)
        return;
      List<GClass132> list = this.gclass0_0.dictionary_6.Values.Where<GClass132>((Func<GClass132, bool>) (gclass132_0 => gclass132_0.gclass21_0 == this.gclass21_0 && gclass132_0.gclass200_0 == this.gclass202_0.gclass200_0)).OrderBy<GClass132, int>((Func<GClass132, int>) (gclass132_0 => gclass132_0.int_1)).ToList<GClass132>();
      ...
      foreach (GClass132 gclass132 in list)
        this.lstvMissiles.Items.Add(new ListViewItem($"{gclass132.dictionary_2.Count.ToString()}x {gclass132.gclass129_0.Name}")
        {
          SubItems = {
            gclass132.method_1()
          },
          Tag = (object) gclass132
        });
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3780);
    }
  }
  ...
  private void cboAlienRace_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass0_0.bool_9 || this.gclass202_0 == null)
        return;
      this.gclass202_0.gclass110_0 = (GClass110) this.cboAlienRace.SelectedValue;
      this.Refresh();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 1103);
    }
  }
  ...
  private void cboNamingTheme_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass0_0.bool_9)
        return;
      this.gclass202_0.gclass140_0 = (GClass140) this.cboNamingTheme.SelectedValue;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 1104);
    }
  }
  ...
  private void cmdNewLabel_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass21_0 == null)
        return;
      GClass122 gclass122_2 = new GClass122(this.gclass0_0)
      {
        gclass21_0 = this.gclass21_0,
        font_0 = new Font("MicroSoft Sans Serif", 12f),
        color_0 = GClass226.color_16,
        string_0 = "New Label",
        double_6 = 350.0,
        double_7 = 125.0
      };
      gclass122_2.double_2 = (double) (int) gclass122_2.double_6 - this.gclass21_0.double_2;
      gclass122_2.double_3 = (double) (int) gclass122_2.double_7 - this.gclass21_0.double_3;
      this.gclass21_0.list_8.Add(gclass122_2);
      this.method_3(gclass122_2);
      this.Refresh();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 1105);
    }
  }
  ...
  private void cmdDeleteLabel_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass122_0 == null)
        return;
      this.gclass21_0.list_8.Remove(this.gclass122_0);
      this.txtLabel.Text = "";
      this.gclass122_0 = (GClass122) null;
      this.Refresh();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 1106);
    }
  }
  ...
  private void cmdUpdateText_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass122_0 == null)
        return;
      this.gclass122_0.string_0 = this.txtLabel.Text;
      this.Refresh();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 1107);
    }
  }
  ...
  private void cmdCopyLabel_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        gclass21_0 = this.gclass21_0,
        font_0 = this.gclass122_0.font_0,
        color_0 = this.gclass122_0.color_0,
        string_0 = this.gclass122_0.string_0,
    ...
    try
    {
      ...
      else
      {
        ...
        if (this.gclass0_0.gclass42_0 == null)
          return;
        if (MessageBox.Show($" Are you sure you want to award the {this.gclass0_0.gclass42_0.string_0} to all officers with the selected command types in {this.gclass202_0.Name}?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
          return;

        var localList_0 = this.gclass0_0.dictionary_4.Values.Where<GClass40>(gclass40_0 => gclass40_0.gclass85_0.gclass202_0 == this.gclass202_0).ToList<GClass40>();
        var localList_1 = this.gclass0_0.dictionary_71.Values.Where<GClass103>(gclass103_0 => gclass103_0.gclass146_0 != null).Where<GClass103>(gclass103_0 => gclass103_0.gclass146_0.gclass202_0 == this.gclass202_0).ToList<GClass103>();
  ...
  private void cmdLabelFont_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      fontDialog.Color = this.gclass122_0.color_0;
      fontDialog.Font = this.gclass122_0.font_0;
      if (fontDialog.ShowDialog() == DialogResult.Cancel)
        return;
      this.txtLabel.Font = fontDialog.Font;
      this.gclass122_0.font_0 = fontDialog.Font;
      this.txtLabel.ForeColor = fontDialog.Color;
      this.gclass122_0.color_0 = fontDialog.Color;
      this.Refresh();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 1110);
    }
  }
  ...
  private void chkNoAutoRoute_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass0_0.bool_9 || this.gclass21_0 == null || this.gclass202_0 == null)
        return;
      this.gclass202_0.bool_3 = ((CheckBox) sender).CheckState == CheckState.Checked;
      this.Refresh();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 1111);
    }
  }
  ...
  private void chkRestricted_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        if (MessageBox.Show($" Are you sure you want to restrict the {this.gclass202_0.Name} system to military traffic? Any civilian freighters scheduled to enter this system will abandon their cargo and seek new trade runs. Colony ships will be diverted.", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
        {
          this.chkRestricted.CheckState = CheckState.Unchecked;
          return;
        }
        this.gclass202_0.bool_4 = true;
        this.gclass21_0.method_96(this.gclass202_0);
      }
      else
        this.gclass202_0.bool_4 = false;
      this.Refresh();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 1112);
    }
  }
  ...
  private void chkMineralSearchFlag_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass0_0.bool_9 || this.gclass21_0 == null || this.gclass202_0 == null)
        return;
      this.gclass202_0.bool_5 = ((CheckBox) sender).CheckState == CheckState.Checked;
      this.Refresh();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 1113);
    }
  }
  ...
  private void cboStatus_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass0_0.bool_9 || this.gclass21_0 == null || this.gclass202_0 == null)
        return;
      this.gclass202_0.auroraSystemProtectionStatus_0 = GClass226.smethod_83<AuroraSystemProtectionStatus>((string) this.cboStatus.SelectedValue);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 1114);
    }
  }
  ...
  private void cmdSupernova_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        if (MessageBox.Show($" Are you sure you want to trigger a supernova in {this.gclass202_0.Name}? This will cause massive radiation damage to many systems and potentially destroy shipping.", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
          return;
        this.gclass202_0.gclass200_0.method_1(1.0);
        this.method_2(false);
        this.Refresh();
      }
    }
  ...
  private void cmdSystemSearch_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      if (this.gclass0_0.string_4 == "")
        return;
      GClass202 gclass202 = this.gclass21_0.dictionary_0.Values.FirstOrDefault<GClass202>((Func<GClass202, bool>) (gclass202_2 => gclass202_2.Name == this.gclass0_0.string_4));
      if (gclass202 == null)
        return;
      this.gclass21_0.method_177((int) (this.gclass0_0.double_6 - gclass202.double_5), (int) (this.gclass0_0.double_7 - gclass202.double_6));
      this.Refresh();
    }
    catch (Exception ex)
    {
  ...
  public void method_13(GClass202 gclass202_2)
  {
    try
    {
      this.gclass21_0.method_177((int) (this.gclass0_0.double_6 - gclass202_2.double_5), (int) (this.gclass0_0.double_7 - gclass202_2.double_6));
      this.Refresh();
    }
    catch (Exception ex)
    {
  ...
  private void rdoCurrent_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      if (this.rdoCurrent.Checked)
        ...
        this.gclass21_0.int_47 = (int) GClass226.decimal_31;
      this.Refresh();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3806);
    }
  }
  ...
  private void tvContacts_AfterExpand(object sender, TreeViewEventArgs e)
  {
    try
    {
      ...
      if (this.tvContacts.SelectedNode == null || this.tvContacts.SelectedNode.Tag == null || !(this.tvContacts.SelectedNode.Tag is GClass110))
        return;
      ((GClass110) this.tvContacts.SelectedNode.Tag).bool_5 = this.tvContacts.SelectedNode.IsExpanded;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3807);
    }
  }
  ...
  private void cboAdminIcon_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass0_0.bool_9)
        return;
      this.gclass21_0.gclass83_0 = (GClass83) this.cboAdminIcon.SelectedValue;
      this.Refresh();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3882);
    }
  }
  ...
  private void txtMinFontSize_TextChanged(object sender, EventArgs e)
  {
    try
    {
      if (this.txtMinFontSize.Text == "")
        return;
      GClass209 gclass209 = GClass226.smethod_5(this.txtMinFontSize.Text);
      if (!gclass209.bool_0 || gclass209.double_0 <= 0.0 || gclass209.double_0 == this.gclass21_0.double_4)
        return;
      this.gclass21_0.double_4 = gclass209.double_0;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3893);
    }
  }
  ...
  private void cboSector_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      this.gclass202_0.int_2 = this.gclass202_0.gclass62_0.int_0;
      if (this.gclass202_0.int_2 == 0)
        this.gclass202_0.gclass62_0 = (GClass62) null;
      this.Refresh();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 1115);
    }
  }
  ...
  private void GalacticMap_MouseUp(object sender, MouseEventArgs e)
  {
    try
    {
      ...
      this.gclass202_1 = (GClass202) null;
      this.gclass122_1 = (GClass122) null;
      this.bool_2 = false;
      if (!this.bool_1)
        return;
      this.bool_1 = false;
  ...
  private void GalacticMap_MouseDown(object sender, MouseEventArgs e)
  {
    try
    {
      ...
      if (e.Button == MouseButtons.Left)
      {
        ...
        {
          GClass202 gclass202 = this.gclass21_0.method_178(e.X, e.Y);
          if (gclass202 != null)
          {
      ...
      else
      {
        ...
        MenuItem menuItem1 = new MenuItem("Open Tactical Map", new EventHandler(this.method_16));
        
        menuItem1.Tag = (object) local202;
        contextMenu.MenuItems.Add(menuItem1);
        var localGClass1List = this.gclass0_0.dictionary_11.Values.Where<GClass1>(gc1=>gc1.gclass200_0 == local202.gclass200_0).ToList<GClass1>();
        List<GClass85> list = this.gclass0_0.dictionary_1.Values.Where<GClass85>(gc85=>gc85.gclass21_0 == this.gclass21_0 && gc85.gclass202_0 == local202 && gc85.gclass187_0 == null).ToList<GClass85>();
        
        foreach (GClass146 gclass146 in this.gclass0_0.dictionary_22.Values.Where<GClass146>(v =>
                   localGClass1List.Contains(v.gclass1_0) && v.gclass21_0 == this.gclass21_0
                 ).ToList<GClass146>())
        {
          MenuItem menuItem2 = new MenuItem(gclass146.PopName, new EventHandler(this.method_16));
          menuItem2.Tag = (object) gclass146;
          contextMenu.MenuItems.Add(menuItem2);
        }
        foreach (GClass85 gclass85 in list)
        {
          MenuItem menuItem3 = new MenuItem(gclass85.FleetName, new EventHandler(this.method_16));
          menuItem3.Tag = (object) gclass85;
          contextMenu.MenuItems.Add(menuItem3);
        }
        foreach (GClass85 gclass85_1 in list)
        {
          GClass69 gclass69 = new GClass69(local202, gclass85_1);
          MenuItem menuItem4 = new MenuItem(gclass85_1.FleetName + " - Tactical", new EventHandler(this.method_16));
          menuItem4.Tag = (object) gclass69;
  ...
  public void method_16(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        this.gclass0_0.tacticalMap_0.method_14((GClass202) menuItem.Tag);
        this.gclass0_0.tacticalMap_0.BringToFront();
        this.gclass0_0.object_0 = (object) this.gclass0_0.tacticalMap_0;
      }
      menuItem.Parent.MenuItems.Clear();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 1125);
    }
  }
  ...
  private void InitializeComponent()
  {
    ...
    this.tabSidebar.Controls.Add((Control) this.tabMissiles);
    this.tabSidebar.Controls.Add((Control) this.tabPage2);
    this.tabSidebar.Controls.Add((Control) this.tabPage3);
    ...
    this.cboAlienRace.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboSector.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvSystemInfo.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tabDisplay.Controls.Add((Control) this.flowLayoutPanel16);
    this.tabDisplay.Controls.Add((Control) this.flowLayoutPanel11);
    ...
    this.tabDisplay.Click += new EventHandler(this.tabDisplay_Click);
    this.flowLayoutPanel16.BorderStyle = BorderStyle.FixedSingle;
    this.flowLayoutPanel16.Controls.Add((Control) this.label9);
    this.flowLayoutPanel16.Controls.Add((Control) this.txtMinFontSize);
    ...
    this.txtMinFontSize.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtMinFontSize.TextChanged += new EventHandler(this.txtMinFontSize_TextChanged);
    this.flowLayoutPanel11.BorderStyle = BorderStyle.FixedSingle;
    this.flowLayoutPanel11.Controls.Add((Control) this.chkDistanceFromSelected);
    this.flowLayoutPanel11.Controls.Add((Control) this.chkDistanceFromSelectedMR);
    this.flowLayoutPanel11.Controls.Add((Control) this.chkDistanceRealSpace);
    ...
    this.chkDistanceFromSelected.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkDistanceFromSelectedMR.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkDistanceRealSpace.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    this.flowLayoutPanel9.BorderStyle = BorderStyle.FixedSingle;
    this.flowLayoutPanel9.Controls.Add((Control) this.chkUnexJP);
    this.flowLayoutPanel9.Controls.Add((Control) this.chkJPSurveyStatus);
    this.flowLayoutPanel9.Controls.Add((Control) this.chkSurveyedSystemBodies);
    this.flowLayoutPanel9.Controls.Add((Control) this.chkSurveyLocationPoints);
    this.flowLayoutPanel9.Controls.Add((Control) this.chkWarshipLocation);
    this.flowLayoutPanel9.Controls.Add((Control) this.chkAllFleetLocations);
    this.flowLayoutPanel9.Controls.Add((Control) this.chkPopulatedSystem);
    this.flowLayoutPanel9.Controls.Add((Control) this.chkKnownAlienForces);
    this.flowLayoutPanel9.Controls.Add((Control) this.chkShipyardComplexes);
    this.flowLayoutPanel9.Controls.Add((Control) this.chkNavalHeadquarters);
    this.flowLayoutPanel9.Controls.Add((Control) this.chkSectors);
    this.flowLayoutPanel9.Controls.Add((Control) this.chkML);
    this.flowLayoutPanel9.Controls.Add((Control) this.chkGroundSurveyLocations);
    this.flowLayoutPanel9.Controls.Add((Control) this.chkAlienControlledSystems);
    this.flowLayoutPanel9.Controls.Add((Control) this.chkNumWrecks);
    this.flowLayoutPanel9.Controls.Add((Control) this.chkAetherRift);
    this.flowLayoutPanel9.Controls.Add((Control) this.chkMilitaryRestricted);
    this.flowLayoutPanel9.Controls.Add((Control) this.chkMilitaryRestrictedJP);
    this.flowLayoutPanel9.Controls.Add((Control) this.chkPossibleDormantJP);
    this.flowLayoutPanel9.Controls.Add((Control) this.chkSecurityStatus);
    ...
    this.chkUnexJP.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkJPSurveyStatus.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkSurveyedSystemBodies.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkSurveyLocationPoints.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkWarshipLocation.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkAllFleetLocations.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkPopulatedSystem.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkKnownAlienForces.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkShipyardComplexes.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkNavalHeadquarters.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkSectors.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkML.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkGroundSurveyLocations.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkAlienControlledSystems.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkNumWrecks.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkAetherRift.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkMilitaryRestricted.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkMilitaryRestrictedJP.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkPossibleDormantJP.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkSecurityStatus.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.flowLayoutPanelDisplay.Controls.Add((Control) this.chkHabRangeWorldsLowG);
    ...
    this.flowLayoutPanelDisplay.Controls.Add((Control) this.chkUseMaxCCDisplay);
    ...
    this.flowLayoutPanelDisplay.Controls.Add((Control) this.chkSupernovaImpactTime);
    ...
    this.flowLayoutPanelDisplay.Controls.Add((Control) this.chkSystemIconOnly);
    ...
    this.chkHabRangeWorlds.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkHabRangeWorldsLowG.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkLowCCNormalG.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkLowCCLowG.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkMediumCCNormalG.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkMediumCCLowG.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkUseMaxCCDisplay.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkNumCometsPlanetlessSystem.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkBlocked.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkSupernovaImpactTime.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkDisplayMineralSearch.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkDiscoveryDate.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkSystemIconOnly.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    ...
    this.chkSystemOnly.Click += new EventHandler(this.chkContactsCurrentSystem_Click);
    ...
    this.chkShowCivilianOOB.Click += new EventHandler(this.chkContactsCurrentSystem_Click);
    ...
    this.chkHostile.CheckedChanged += new EventHandler(this.chkTracking_Click);
    ...
    this.chkNeutral.CheckedChanged += new EventHandler(this.chkTracking_Click);
    ...
    this.chkFriendly.CheckedChanged += new EventHandler(this.chkTracking_Click);
    ...
    this.chkAllied.CheckedChanged += new EventHandler(this.chkTracking_Click);
    ...
    this.chkCivilian.CheckedChanged += new EventHandler(this.chkTracking_Click);
    ...
    this.chkContactsCurrentSystem.Click += new EventHandler(this.chkContactsCurrentSystem_Click);
    ...
    this.tvContacts.AfterCollapse += new TreeViewEventHandler(this.tvContacts_AfterExpand);
    this.tvContacts.AfterExpand += new TreeViewEventHandler(this.tvContacts_AfterExpand);
    ...
    this.cmdCopyLabel.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdUpdateText.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdLabelFont.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdNewLabel.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDeleteLabel.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.txtLabel.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tabMissiles.Controls.Add((Control) this.lstvMissiles);
    ...
    this.lstvMissiles.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tabPage2.Controls.Add((Control) this.cmdScreenshotNoUI);
    this.tabPage2.Controls.Add((Control) this.cmdScreenshot);
    this.tabPage2.Controls.Add((Control) this.cmdSystemSearch);
    this.tabPage2.Controls.Add((Control) this.cmdSupernova);
    ...
    this.cmdScreenshotNoUI.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdScreenshotNoUI.Tag = (object) "1200";
    this.cmdScreenshotNoUI.Text = "Screenshot - No UI";
    this.cmdScreenshotNoUI.UseVisualStyleBackColor = false;
    this.cmdScreenshotNoUI.Click += new EventHandler(this.cmdScreenshotNoUI_Click);
    this.cmdScreenshot.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdScreenshot.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdScreenshot.Tag = (object) "1200";
    this.cmdScreenshot.Text = "Full Map Screenshot";
    this.cmdScreenshot.UseVisualStyleBackColor = false;
    this.cmdScreenshot.Click += new EventHandler(this.cmdScreenshot_Click);
    this.cmdSystemSearch.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdSystemSearch.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdSystemSearch.Tag = (object) "1200";
    this.cmdSystemSearch.Text = "System Search";
    this.cmdSystemSearch.UseVisualStyleBackColor = false;
    this.cmdSystemSearch.Click += new EventHandler(this.cmdSystemSearch_Click);
    this.cmdSupernova.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdSupernova.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdSupernova.Tag = (object) "1200";
    this.cmdSupernova.Text = "Trigger Supernova";
    this.cmdSupernova.UseVisualStyleBackColor = false;
    this.cmdSupernova.Click += new EventHandler(this.cmdSupernova_Click);
    ...
    this.cboStatus.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tabPage3.Controls.Add((Control) this.flowLayoutPanel13);
    ...
    this.flowLayoutPanel13.Controls.Add((Control) this.flowLayoutPanel14);
    this.flowLayoutPanel13.Controls.Add((Control) this.flowLayoutPanel15);
    ...
    this.flowLayoutPanel14.Controls.Add((Control) this.label4);
    this.flowLayoutPanel14.Controls.Add((Control) this.choFlagStatus);
    this.flowLayoutPanel14.Controls.Add((Control) this.label8);
    this.flowLayoutPanel14.Controls.Add((Control) this.rdoMonth);
    this.flowLayoutPanel14.Controls.Add((Control) this.rdoWeek);
    this.flowLayoutPanel14.Controls.Add((Control) this.rdoDay);
    this.flowLayoutPanel14.Controls.Add((Control) this.rdoCurrent);
    ...
    this.choFlagStatus.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.choFlagStatus.SelectedIndexChanged += new EventHandler(this.choFlagStatus_SelectedIndexChanged);
    ...
    this.rdoMonth.CheckedChanged += new EventHandler(this.rdoCurrent_CheckedChanged);
    ...
    this.rdoWeek.CheckedChanged += new EventHandler(this.rdoCurrent_CheckedChanged);
    ...
    this.rdoDay.CheckedChanged += new EventHandler(this.rdoCurrent_CheckedChanged);
    ...
    this.rdoCurrent.CheckedChanged += new EventHandler(this.rdoCurrent_CheckedChanged);
    this.flowLayoutPanel15.BorderStyle = BorderStyle.FixedSingle;
    this.flowLayoutPanel15.Controls.Add((Control) this.chkClassIcon);
    this.flowLayoutPanel15.Controls.Add((Control) this.cboClassIcon);
    this.flowLayoutPanel15.Controls.Add((Control) this.chkAdminIcon);
    this.flowLayoutPanel15.Controls.Add((Control) this.cboAdminIcon);
    ...
    this.chkClassIcon.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    this.cboClassIcon.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cboClassIcon.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboClassIcon.SelectedIndexChanged += new EventHandler(this.cboClassIcon_SelectedIndexChanged);
    ...
    this.chkAdminIcon.CheckedChanged += new EventHandler(this.chkAdminIcon_CheckedChanged);
    this.cboAdminIcon.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cboAdminIcon.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboAdminIcon.SelectedIndexChanged += new EventHandler(this.cboAdminIcon_SelectedIndexChanged);
    ...
    this.cmdToolbarColony.Click += new EventHandler(this.cmdToolbarAuto_Click);
    ...
    this.cmdToolbarIndustry.Click += new EventHandler(this.cmdToolbarAuto_Click);
    ...
    this.cmdToolbarMining.Click += new EventHandler(this.cmdToolbarAuto_Click);
    ...
    this.cmdToolbarResearch.Click += new EventHandler(this.cmdToolbarAuto_Click);
    ...
    this.cmdToolbarWealth.Click += new EventHandler(this.cmdToolbarAuto_Click);
    ...
    this.cmdToolbarClass.Click += new EventHandler(this.cmdToolbarAuto_Click);
    ...
    this.cmdToolbarProject.Click += new EventHandler(this.cmdToolbarAuto_Click);
    ...
    this.cmdToolbarFleet.Click += new EventHandler(this.cmdToolbarAuto_Click);
    ...
    this.cmdToolbarMissileDesign.Click += new EventHandler(this.cmdToolbarAuto_Click);
    ...
    this.cmdToolbarTurret.Click += new EventHandler(this.cmdToolbarAuto_Click);
    ...
    this.cmdToolbarGroundForces.Click += new EventHandler(this.cmdToolbarAuto_Click);
    ...
    this.cmdToolbarCommanders.Click += new EventHandler(this.cmdToolbarAuto_Click);
    ...
    this.cmdToolbarRace.Click += new EventHandler(this.cmdToolbarAuto_Click);
    ...
    this.cmdToolbarSystem.Click += new EventHandler(this.cmdToolbarAuto_Click);
    ...
    this.cmdToolbarHabitable.Click += new EventHandler(this.cmdToolbarAuto_Click);
    ...
    this.cmdToolbarIntelligence.Click += new EventHandler(this.cmdToolbarAuto_Click);
    ...
    this.cmdToolbarTechnology.Click += new EventHandler(this.cmdToolbarAuto_Click);
    ...
    this.cmdToolbarSurvey.Click += new EventHandler(this.cmdToolbarAuto_Click);
    ...
    this.cmdToolbarSector.Click += new EventHandler(this.cmdToolbarAuto_Click);
    ...
    this.cmdToolbarEvents.Click += new EventHandler(this.cmdToolbarAuto_Click);
    ...
    this.cmdToolbarRefreshGalactic.Click += new EventHandler(this.cmdToolbarAuto_Click);
    ...
    this.cmdToolbarGrid.Click += new EventHandler(this.cmdToolbarAuto_Click);
    ...
    this.cmdToolbarUndo.Click += new EventHandler(this.cmdToolbarAuto_Click);
    ...
    this.cmdToolbarSavePositions.Click += new EventHandler(this.cmdToolbarAuto_Click);
    ...
    this.cmdSM.Click += new EventHandler(this.cmdToolbarAuto_Click);
    ...
    this.cmdToolbarAuto.Click += new EventHandler(this.cmdToolbarAuto_Click);
    ...
    this.KeyDown += new KeyEventHandler(this.GalacticMap_KeyDown);
