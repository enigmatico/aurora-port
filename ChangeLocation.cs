...
public class ChangeLocation : Form
{
  ...
  private void InitializeComponent()
  {
    ...
    this.txtInputB.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
