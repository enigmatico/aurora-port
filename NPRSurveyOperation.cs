...
public partial class NPRSurveyOperation
{
    ...
    private RacialSystemSurvey SystemSurvey;
    public NPRSystemValue genum95_0 = NPRSystemValue.const_1;
    ...
    /// <summary>
    /// NPR Survey Operation 
    /// </summary>
    /// <param name="gclass0_1"></param>
    /// <param name="gclass202_1"></param>
    public NPRSurveyOperation(GClass0 gclass0_1, RacialSystemSurvey gclass202_1)
    {
        this.Game = gclass0_1;
        this.SystemSurvey = gclass202_1;
    }
    ...
    public void method_0(List<FleetData> list_0, List<Contact> list_1, List<Contact> list_2)
    {
        try
        {
            ...
            NPRSurveyOperation.Class417 lambdaCaptures = new NPRSurveyOperation.Class417();
            // ISSUE: reference to a compiler-generated field
            lambdaCaptures.thisRef = this;
            List<FleetData> list1 = list_0.Where<FleetData>(gclass85_0 => gclass85_0.System == this.SystemSurvey)
                .ToList<FleetData>();
            if (list1.Count == 0)
                return;
            List<ShipData> list2 = list1.SelectMany<FleetData, ShipData>(gclass85_0 => gclass85_0.method_176())
                .Where<ShipData>(gclass40_0 => gclass40_0.Class.ShieldStrength > 0).ToList<ShipData>();
            if (list2.Count == 0)
                return;
            int num1 = this.SystemSurvey.Race.method_166(GEnum41.const_0);
            // ISSUE: reference to a compiler-generated field
            lambdaCaptures.double_0 = num1 * 2000000;
            list2.Select<ShipData, FleetData>(gclass40_0 => gclass40_0.gclass85_0).Distinct<FleetData>()
                .Count<FleetData>();
            List<Contact> list3 = list_1
                .Where<Contact>(gclass65_0 => gclass65_0.System == this.SystemSurvey.ActualSystem)
                .ToList<Contact>();
            List<Contact> list4 = list_2
                .Where<Contact>(gclass65_0 => gclass65_0.System == this.SystemSurvey.ActualSystem)
                .ToList<Contact>();
            Func<Contact, bool> predicate = gclass65_0 => gclass65_0.LastUpdate == this.Game.GameTime;
            List<Contact> list5 = list3.Where<Contact>(predicate).ToList<Contact>();
            List<Contact> list6 = list4.Where<Contact>(gclass65_0 => gclass65_0.LastUpdate == this.Game.GameTime)
                .ToList<Contact>();
            List<JumpPoint> list7 = this.Game.JumpPointDictionary.Values
                .Where<JumpPoint>(gclass120_0 => gclass120_0.SystemData == this.SystemSurvey.ActualSystem)
                .ToList<JumpPoint>();
            foreach (FleetData gclass85 in list1)
            {
                // ISSUE: object of a compiler-generated type is created
                // ISSUE: variable of a compiler-generated type
                NPRSurveyOperation.Class418 lambdaCap418 = new NPRSurveyOperation.Class418();
                // ISSUE: reference to a compiler-generated field
                lambdaCap418.class417_0 = lambdaCaptures;
                // ISSUE: reference to a compiler-generated field
                lambdaCap418.Fleet = gclass85;
                // ISSUE: reference to a compiler-generated method
                List<ShipData> list8 = list2.Where<ShipData>(lambdaCap418.method_0).ToList<ShipData>();
                if (list8.Count != 0)
                {
                    bool flag = false;
                    if (list8.Count<ShipData>(gclass40_0 =>
                            this.Game.GameTime - gclass40_0.decimal_18 < 86400M) > 0)
                    {
                        flag = true;
                    }
                    else
                    {
                        // ISSUE: reference to a compiler-generated method
                        if (list7.Count<JumpPoint>(lambdaCap418.method_1) > 0)
                        {
                            flag = true;
                        }
                        else
                        {
                            // ISSUE: reference to a compiler-generated method
                            int num2 = list5.Count<Contact>(lambdaCap418.method_2);
                            // ISSUE: reference to a compiler-generated method
                            int num3 = list6.Count<Contact>(lambdaCap418.method_3);
                            if (num2 > 0)
                                flag = true;
                            else if (num3 > 0 && this.genum95_0 >= NPRSystemValue.const_4)
                                flag = true;
    ...
    public void method_1(List<FleetData> list_0, List<Contact> list_1, List<Contact> list_2)
    {
        try
        {
            ...
            if (list1.Count == 0)
                return;
            List<ShipData> list2 = list1.SelectMany<FleetData, ShipData>(gclass85_0 => gclass85_0.method_176())
                .Where<ShipData>(gclass40_0 => gclass40_0.Class.ActiveSensorStrength > 0).ToList<ShipData>();
            if (list2.Count == 0)
                return;
            list2.Select<ShipData, FleetData>(gclass40_0 => gclass40_0.gclass85_0).Distinct<FleetData>()
                .Count<FleetData>();
            ...
            foreach (FleetData gclass85 in list1)
            {
                // ISSUE: object of a compiler-generated type is created
                // ISSUE: variable of a compiler-generated type
                NPRSurveyOperation.Class419 class419 = new NPRSurveyOperation.Class419();
                // ISSUE: reference to a compiler-generated field
                ...
                // ISSUE: object of a compiler-generated type is created
                // ISSUE: variable of a compiler-generated type
                NPRSurveyOperation.Class420 class420 = new NPRSurveyOperation.Class420();
                // ISSUE: reference to a compiler-generated field
                ...
                if (list7.Count != 0)
                {
                    ...
                    class420.double_0 = list7
                        ...
                        .Max<ClassComponent>(gclass228_0 => gclass228_0.Component.double_0);
                    // ISSUE: reference to a compiler-generated method
                    ...
                    if (list7.Count<ShipData>(gclass40_0 =>
                            gclass40_0.Class.AutomatedClassDesign.StealthDesign > StealthDesignType.const_0) == 0)
                    {
                        num3 = num1 <= 0
                            ? (num2 <= 0 || this.genum95_0 < NPRSystemValue.const_4
                    ...
                    else
                    {
                        ...
                        int num8 = list7.Count<ShipData>(gclass40_0 =>
                            this.Game.GameTime - gclass40_0.decimal_18 < 120M);
                        if (num8 == 0)
                        {
                            // ISSUE: object of a compiler-generated type is created
                            // ISSUE: variable of a compiler-generated type
                            NPRSurveyOperation.Class421 class421 = new NPRSurveyOperation.Class421()
                            {
                                class420_0 = class420
                            };
                            // ISSUE: reference to a compiler-generated field
                            ...
                            if (num4 == 0)
                            {
                                // ISSUE: object of a compiler-generated type is created
                                // ISSUE: variable of a compiler-generated type
                                NPRSurveyOperation.Class422 class422 = new NPRSurveyOperation.Class422()
                                {
                                    class421_0 = class421
                                };
                                // ISSUE: reference to a compiler-generated field
                        ...
                        num3 = num4 > 0 || num6 > 0 || num5 > 0 || num8 > 0
                            ? 1000.0
                            : (num7 <= 0 || this.genum95_0 < NPRSystemValue.const_4 ? (list5.Count <= 0 ? 5.0 : 25.0) : 100.0);
                    }
    ...
    public void method_2(List<FleetData> list_0, List<GroundUnitFormationData> list_1, List<Contact> list_2)
    {
        try
        {
            // ISSUE: object of a compiler-generated type is created
            // ISSUE: variable of a compiler-generated type
            NPRSurveyOperation.Class423 class423 = new NPRSurveyOperation.Class423();
            // ISSUE: reference to a compiler-generated field
            ...
            if (list1.Count == 0)
                return;
            // ISSUE: reference to a compiler-generated field
            class423.list_0 = this.Game.FleetDictionary.Values
            ...
            List<GroundUnitFormationElement> list4 = list_1.Where<GroundUnitFormationData>(gclass103_0 => gclass103_0.PopulationData != null)
                .Where<GroundUnitFormationData>(gclass103_0 => gclass103_0.PopulationData.gclass202_0 == this.SystemSurvey)
                .SelectMany<GroundUnitFormationData, GroundUnitFormationElement>(gclass103_0 => gclass103_0.ElementList).Where<GroundUnitFormationElement>(gclass39_0 =>
                    gclass39_0.GroundUnitClass.SurfaceToOrbitWeapon != null && gclass39_0.list_0.Count < gclass39_0.UnitCount)
                .ToList<GroundUnitFormationElement>();
            List<FleetData> list5 = list_0.Where<FleetData>(gclass85_0 => gclass85_0.System == this.SystemSurvey)
                .ToList<FleetData>();
            if (list5.Count == 0 && list4.Count == 0)
                return;
            List<ShipData> list6 = list5.SelectMany<FleetData, ShipData>(gclass85_0 => gclass85_0.method_176())
                .Where<ShipData>(gclass40_0 => gclass40_0.Class.ProtectionValue > 0M && gclass40_0.int_13 == 0)
                .OrderBy<ShipData, int>(gclass40_0 => gclass40_0.gclass85_0.FleetID)
                .ThenByDescending<ShipData, Decimal>(gclass40_0 => gclass40_0.Class.Size)
                .ToList<ShipData>();
            ...
            if (class423.list_1.Count == 0 && list7.Count == 0 && list8.Count == 0)
                return;
            // ISSUE: reference to a compiler-generated field
            class423.gclass194_0 = this.SystemSurvey.Race.method_164();
            // ISSUE: reference to a compiler-generated field
            if (this.SystemSurvey.Race.SpecialNPRID == SpecialNPRIDs.const_0 && class423.gclass194_0.int_2 < 50)
                list8 = list8.Where<Contact>(gclass65_0 =>
                    gclass65_0.ContactType == AuroraContactType.STOGroundUnit ||
                    gclass65_0.ContactType == AuroraContactType.Shipyard ||
                    gclass65_0.TargetPopulation.Population == 0M).ToList<Contact>();
            else if (this.SystemSurvey.Race.SpecialNPRID == SpecialNPRIDs.Eldar ||
                     this.SystemSurvey.Race.SpecialNPRID == SpecialNPRIDs.StarSwarm)
                list8 = list8.Where<Contact>(gclass65_0 =>
                    gclass65_0.ContactType == AuroraContactType.STOGroundUnit ||
            ...
            foreach (Contact gclass65 in list8)
            {
                // ISSUE: object of a compiler-generated type is created
                // ISSUE: variable of a compiler-generated type
                NPRSurveyOperation.Class424 class424 = new NPRSurveyOperation.Class424();
                // ISSUE: reference to a compiler-generated field
                class424.gclass65_0 = gclass65;
                // ISSUE: object of a compiler-generated type is created
                // ISSUE: variable of a compiler-generated type
                NPRSurveyOperation.Class434 class434 = new NPRSurveyOperation.Class434();
                // ISSUE: reference to a compiler-generated field
                // ISSUE: reference to a compiler-generated method
                ...
                {
                    // ISSUE: reference to a compiler-generated field
                    class434.gclass13_0 = new GClass13(this.Game);
                    // ISSUE: reference to a compiler-generated field
                    // ISSUE: reference to a compiler-generated field
                    ...
                    class434.gclass13_0.gclass113_0 =
                        class424.gclass65_0.DetectRace.AlienPopulationIntels.Values
                            .FirstOrDefault<AlienPopulationIntel>(class434.method_0);
                    // ISSUE: reference to a compiler-generated field
            ...
            foreach (GClass13 gclass13 in source1)
            {
                // ISSUE: object of a compiler-generated type is created
                // ISSUE: variable of a compiler-generated type
                NPRSurveyOperation.Class435 class435 = new NPRSurveyOperation.Class435();
                // ISSUE: reference to a compiler-generated field
                class435.class423_0 = class423;
                // ISSUE: reference to a compiler-generated field
                class435.gclass13_0 = gclass13;
                // ISSUE: reference to a compiler-generated method
                if (this.Game.Populations.Values.Where<PopulationData>(class435.method_0)
            ...
            List<FleetData> list10 = list5.SelectMany<FleetData, ShipData>(gclass85_0 => gclass85_0.method_176())
                .Where<ShipData>(gclass40_0 => this.Game.GameTime - gclass40_0.decimal_21 < 300M)
            ...
            if (list10.Count > 0)
            {
                foreach (FleetData gclass85 in list10)
                {
                    // ISSUE: object of a compiler-generated type is created
                    // ISSUE: reference to a compiler-generated method
                    source2.AddRange(list5.Where<FleetData>(new NPRSurveyOperation.Class436()
                    {
                        class423_0 = class423,
                        gclass85_0 = gclass85
            ...
            {
                gclass40.NPRShipBehaviour.gclass71_0 = gclass40.method_213(0M, null);
                gclass40.NPRShipBehaviour.double_2 = gclass40.method_220();
                gclass40.NPRShipBehaviour.double_3 = gclass40.NPRShipBehaviour.gclass71_0.double_0;
                if (gclass40.NPRShipBehaviour.double_2 > gclass40.NPRShipBehaviour.double_3)
                    gclass40.NPRShipBehaviour.double_3 = gclass40.NPRShipBehaviour.double_2;
                gclass40.NPRShipBehaviour.gclass72_0 = gclass40.method_214();
                if (gclass40.NPRShipBehaviour.gclass72_0 != null)
                    gclass40.NPRShipBehaviour.double_4 = (double)gclass40.NPRShipBehaviour.gclass72_0.decimal_0;
                gclass40.NPRShipBehaviour.bool_0 = false;
                gclass40.int_17 = 0;
                if (gclass40.Class.AutomatedClassDesign.MissileDesignType == MissileDesignType.const_3 && gclass40.ComponentDamages.Count == 0 &&
                    this.Game.GameTime - gclass40.gclass85_0.LastFleetDamageTime > 900M)
                    gclass40.int_17 = 1;
            }

            List<ShipData> list11 = list6
                .Where<ShipData>(gclass40_0 =>
                    gclass40_0.NPRShipBehaviour.double_3 > 0.0 || gclass40_0.NPRShipBehaviour.double_4 > 0.0).ToList<ShipData>();
            if (list11.Count == 0 && list4.Count == 0)
                return;
            List<JumpPoint> list12 = this.Game.JumpPointDictionary.Values
                .Where<JumpPoint>(gclass120_0 => gclass120_0.SystemData == this.SystemSurvey.ActualSystem)
                .Where<JumpPoint>(gclass120_0 =>
                    gclass120_0.RacialJumpPointSurveys.ContainsKey(this.SystemSurvey.Race.RaceID))
                .Where<JumpPoint>(gclass120_0 =>
                    gclass120_0.RacialJumpPointSurveys[this.SystemSurvey.Race.RaceID].Charted == 1).ToList<JumpPoint>();
            // ISSUE: reference to a compiler-generated method
            List<AlienShipIntel> list13 = this.SystemSurvey.Race.dictionary_12.Values
                .Where<AlienShipIntel>(class423.method_2).ToList<AlienShipIntel>();
            List<GClass116> gclass116List = new List<GClass116>();
            foreach (AlienShipIntel gclass117 in list13)
            {
                gclass117.method_5();
            ...
            foreach (GClass116 gclass116 in gclass116List)
            {
                // ISSUE: object of a compiler-generated type is created
                // ISSUE: variable of a compiler-generated type
                NPRSurveyOperation.Class437 class437 = new NPRSurveyOperation.Class437();
                Decimal num1 =
                    gclass116.list_0.Sum<AlienShipIntel>(gclass117_0 => gclass117_0.gclass115_0.gclass22_0.Size);
                Decimal num2 = gclass116.list_0.Sum<AlienShipIntel>(gclass117_0 => gclass117_0.gclass40_0.method_170());
                gclass116.int_0 = (int)(num2 / num1 * 1000M);
                // ISSUE: reference to a compiler-generated field
                class437.list_0 = gclass116.list_0
                    .Select<AlienShipIntel, ShipData>(gclass117_0 => gclass117_0.gclass40_0).ToList<ShipData>();
                // ISSUE: reference to a compiler-generated method
                gclass116.list_1 = this.Game.MissileSalvoes.Values.Where<MissileSalvo>(class437.method_0)
                    .ToList<MissileSalvo>();
                foreach (JumpPoint gclass120 in list12)
                {
                    if (this.Game.GetDistanceBetween(gclass120.XCoord, gclass120.YCoord, gclass116.double_0,
                            gclass116.double_1) < gclass116.int_1 * 30)
                    {
                        gclass116.bool_2 = true;
                        if (gclass116.list_1.Count > 0 && this.Game.GameTime -
                            gclass116.list_1.Min<MissileSalvo>(gclass132_0 => gclass132_0.LaunchTime) > 30M)
            ...
            foreach (ShipData gclass40 in list11
                         .Where<ShipData>(gclass40_0 => gclass40_0.NPRShipBehaviour.double_4 > 0.0)
                         .ToList<ShipData>())
            {
                // ISSUE: object of a compiler-generated type is created
                // ISSUE: variable of a compiler-generated type
                NPRSurveyOperation.Class438 class438 = new NPRSurveyOperation.Class438();
                // ISSUE: reference to a compiler-generated field
                ...
                bool flag = false;
                // ISSUE: reference to a compiler-generated field
                if (class438.gclass40_0.NPRShipBehaviour.gclass72_0.list_0.Count <= 0)
                {
                    double num3 = -1.0;
                    double num4 = -1.0;
                    if (list7.Count > 0)
                    ...
                    else
                    {
                        ...
                        if ((num3 == -1.0 || num3 > 10000000.0) && num4 > -1.0 &&
                            num4 < class438.gclass40_0.NPRShipBehaviour.double_4 &&
                            class438.gclass40_0.NPRShipBehaviour.gclass72_0.list_1.Count == 0)
                            flag = true;
                    }
                    ...
                    if (flag)
                    {
                        ...
                        {
                            // ISSUE: reference to a compiler-generated field
                            if (class438.gclass40_0.Class.MagazineCapacity > 0M)
            ...
            foreach (ShipData gclass40 in list11)
            {
                if (gclass40.NPRShipBehaviour.gclass71_0.double_0 != 0.0 || gclass40.NPRShipBehaviour.double_4 != 0.0)
                {
                    foreach (GClass116 gclass116 in gclass116List)
                    {
                        if (this.Game.GetDistanceBetween(gclass116.double_0, gclass116.double_1,
                                gclass40.gclass85_0.XCoord, gclass40.gclass85_0.YCoord) <
                            gclass40.NPRShipBehaviour.gclass71_0.double_0)
                        {
                            double num5 = 1.0;
                            if (gclass116.int_0 > 0)
                                num5 = gclass40.NPRShipBehaviour.gclass71_0.int_2 / (double)gclass116.int_0 *
                                    AuroraUtils.int_9 / 100.0;
                            if (num5 > 1.0)
                                num5 = 1.0;
                            int num6 = gclass40.NPRShipBehaviour.gclass71_0.int_0;
                            if (num6 > gclass40.NPRShipBehaviour.gclass71_0.int_1)
                                num6 = gclass40.NPRShipBehaviour.gclass71_0.int_1;
            ...
            foreach (GClass116 gclass116 in gclass116List)
            {
                // ISSUE: object of a compiler-generated type is created
                // ISSUE: variable of a compiler-generated type
                NPRSurveyOperation.Class439 class439 = new NPRSurveyOperation.Class439();
                // ISSUE: reference to a compiler-generated field
            ...
            List<ShipData> list14 = list11
                .OrderByDescending<ShipData, double>(gclass40_0 => gclass40_0.NPRShipBehaviour.gclass71_0.double_0)
                .ToList<ShipData>();
            foreach (ShipData gclass40 in list14)
            {
                // ISSUE: object of a compiler-generated type is created
                // ISSUE: variable of a compiler-generated type
                NPRSurveyOperation.Class440 class440 = new NPRSurveyOperation.Class440();
                // ISSUE: reference to a compiler-generated field
                ...
                // ISSUE: object of a compiler-generated type is created
                // ISSUE: variable of a compiler-generated type
                NPRSurveyOperation.Class441 class441 = new NPRSurveyOperation.Class441();
                // ISSUE: reference to a compiler-generated field
                ...
                if (class441.class440_0.gclass40_0.list_4.Count != 0)
                {
                    ...
                    // ISSUE: reference to a compiler-generated field
                    // ISSUE: reference to a compiler-generated field
                    if (class441.class440_0.gclass40_0.NPRShipBehaviour.gclass71_0.double_0 > 0.0 &&
                        class441.class440_0.gclass40_0.NPRShipBehaviour.gclass71_0.int_0 >
                        class441.class440_0.gclass40_0.NPRShipBehaviour.gclass71_0.int_1 &&
                        ...
                        MoveActionType.LoadOrdnanceFromColony)
                    {
                        // ISSUE: reference to a compiler-generated field
                        // ISSUE: reference to a compiler-generated field
                        if (class441.class440_0.gclass40_0.NPRShipBehaviour.double_2 != 0.0)
                        {
                            // ISSUE: reference to a compiler-generated field
                            // ISSUE: reference to a compiler-generated field
                            class441.class440_0.gclass40_0.NPRShipBehaviour.bool_0 = true;
                        }
                        else
                            continue;
                    }
                    ...
                    if (class441.list_0.Count > 0)
                    {
                        // ISSUE: reference to a compiler-generated field
                        // ISSUE: reference to a compiler-generated field
                        if (class441.class440_0.gclass40_0.Race.SpecialNPRID == SpecialNPRIDs.StarSwarm)
                        {
                            // ISSUE: reference to a compiler-generated method
                            List<ShipData> list15 = this.Game.FormationDictionary.Values
                        ...
                        if (class441.list_0.Count > 0)
                        {
                            int num7 = 1;
                            // ISSUE: reference to a compiler-generated method
                            List<AlienShipIntel> list16 = list13.Where<AlienShipIntel>(class441.method_1).ToList<AlienShipIntel>();
                            foreach (AlienShipIntel gclass117 in list16)
                            {
                                // ISSUE: reference to a compiler-generated field
                                // ISSUE: reference to a compiler-generated field
                            ...
                            List<AlienShipIntel> list17 = list16
                                .OrderByDescending<AlienShipIntel, Decimal>(gclass117_0 => gclass117_0.decimal_5)
                                .ToList<AlienShipIntel>();
                            while (true)
                            {
                                foreach (AlienShipIntel gclass117 in list17)
                                {
                                    // ISSUE: object of a compiler-generated type is created
                                    // ISSUE: variable of a compiler-generated type
                                    NPRSurveyOperation.Class425 class425 = new NPRSurveyOperation.Class425();
                                    // ISSUE: reference to a compiler-generated field
                                    ...
                                    // ISSUE: reference to a compiler-generated field
                                    // ISSUE: reference to a compiler-generated field
                                    if (class425.class441_0.class440_0.gclass40_0.NPRShipBehaviour.gclass71_0.double_0 > 0.0 &&
                                        !class425.class441_0.class440_0.gclass40_0.NPRShipBehaviour.bool_0 &&
                                         ...
                                         class425.gclass117_0.double_2 < AuroraUtils.int_13 || num7 > 1))
                                    {
                                        ...
                                        if ((!class425.gclass117_0.gclass116_0.bool_3 ||
                                            ...
                                            (!class425.gclass117_0.gclass116_0.bool_2 ||
                                             class425.gclass117_0.gclass21_0.NPR) ||
                                            class425.class441_0.class440_0.gclass40_0.Ordnances.Count <= 0 ||
                                            (double)class425.class441_0.class440_0.gclass40_0.Ordnances.Max<ShipOrdnance>(
                                                gclass130_0 => gclass130_0.RaceMissile.Speed) * 30.0 >=
                                            class425.gclass117_0.double_2)
                                        {
                                            // ISSUE: reference to a compiler-generated method
                                            Decimal num8 = this.Game.MissileSalvoes.Values
                                            ...
                                            if ((class425.gclass117_0.double_2 <= AuroraUtils.int_12 || !(num8 > 0M) ||
                                                ...
                                                (!class425.gclass117_0.gclass116_0.bool_1 ||
                                                 class425.gclass117_0.double_2 <= AuroraUtils.int_13 || num7 != 1 ||
                                                 this.Game.MissileSalvoes.Values.Where<MissileSalvo>(class425.method_1)
                                                     .Count<MissileSalvo>() <= 0))
                                            {
                                                ...
                                                // ISSUE: reference to a compiler-generated field
                                                // ISSUE: reference to a compiler-generated field
                                                RaceMissile gclass129 = class425.class441_0.class440_0.gclass40_0.Ordnances
                                                    .Where<ShipOrdnance>(
                                                        gclass130_0 => gclass130_0.RaceMissile.ShipDecoy == 0)
                                                    .Select<ShipOrdnance, RaceMissile>(
                                                ...
                                                if (!(num10 <= 0M) || num7 != 1)
                                                {
                                                    ...
                                                    // ISSUE: reference to a compiler-generated field
                                                    // ISSUE: reference to a compiler-generated field
                                                    if (class425.class441_0.class440_0.gclass40_0.NPRShipBehaviour.method_1(
                                                            ...
                                                            class425.gclass117_0.double_2))
                                                    {
                                                        ...
                                                        if (gclass129 == null || !(gclass129.Size < 3M) ||
                                                            ...
                                                            class425.class441_0.class440_0.gclass40_0.NPRShipBehaviour
                                                                ...
                                                                .Class.Size > 20M))
                                                        {
                                                                             ...
                                                                             gclass36_0.TargetID == 0).ToList<FireControlAssignment>())
                                                            {
                                                                // ISSUE: object of a compiler-generated type is created
                                                                // ISSUE: variable of a compiler-generated type
                                                                NPRSurveyOperation.Class426 class426 = new NPRSurveyOperation.Class426();
                                                                // ISSUE: reference to a compiler-generated field
                                    ...
                                    // ISSUE: reference to a compiler-generated field
                                    // ISSUE: reference to a compiler-generated field
                                    if (class425.class441_0.class440_0.gclass40_0.NPRShipBehaviour.double_2 > 0.0 &&
                                        class425.class441_0.class440_0.gclass40_0.NPRShipBehaviour.double_2 >
                                        class425.gclass117_0.double_2)
                                    {
                                        // ISSUE: reference to a compiler-generated method
                                        ...
                                        if (!(num13 - num12 <= 0M))
                                        {
                                                             ...
                                                             gclass36_0.TargetID == 0).ToList<FireControlAssignment>())
                                            {
                                                // ISSUE: object of a compiler-generated type is created
                                                // ISSUE: variable of a compiler-generated type
                                                NPRSurveyOperation.Class427 class427 = new NPRSurveyOperation.Class427();
                                                // ISSUE: reference to a compiler-generated field
                    ...
                    if (!flag1)
                    {
                        if (list9.Count > 0)
                        {
                            ...
                            while (true)
                            {
                                foreach (GClass13 gclass13 in list9)
                                {
                                    // ISSUE: object of a compiler-generated type is created
                                    // ISSUE: variable of a compiler-generated type
                                    NPRSurveyOperation.Class428 class428 = new NPRSurveyOperation.Class428()
                                    {
                                        gclass13_0 = gclass13
                                    };
                                    // ISSUE: reference to a compiler-generated field
                                    ...
                                    // ISSUE: reference to a compiler-generated field
                                    // ISSUE: reference to a compiler-generated field
                                    class428.gclass13_0.double_3 = this.Game.GetDistanceBetween(
                                    ...
                                    // ISSUE: reference to a compiler-generated field
                                    if (class441.class440_0.gclass40_0.NPRShipBehaviour.gclass71_0.double_0 > 0.0 &&
                                        !class441.class440_0.gclass40_0.NPRShipBehaviour.bool_0 &&
                                        (!class428.gclass13_0.bool_0 ||
                                         class428.gclass13_0.double_3 < AuroraUtils.int_13 || num15 > 1))
                                    {
                                        // ISSUE: reference to a compiler-generated method
                                        Decimal num16 = this.Game.MissileSalvoes.Values
                                        ...
                                        if (class428.gclass13_0.double_3 <= AuroraUtils.int_12 || !(num16 > 0M) ||
                                            num15 >= 3 ||
                                            !(this.Game.GameTime - class428.gclass13_0.gclass146_0.decimal_79 <
                                              AuroraUtils.int_15))
                                        {
                                            // ISSUE: reference to a compiler-generated method
                                            ...
                                            if (!(num18 <= 0M) || num15 != 1)
                                            {
                                                ...
                                                // ISSUE: reference to a compiler-generated field
                                                // ISSUE: reference to a compiler-generated field
                                                if (class441.class440_0.gclass40_0.NPRShipBehaviour.method_2(
                                                        class428.gclass13_0.double_3))
                                                {
                                                                     ...
                                                                     gclass36_0.TargetID == 0).ToList<FireControlAssignment>())
                                                    {
                                                        // ISSUE: object of a compiler-generated type is created
                                                        // ISSUE: variable of a compiler-generated type
                                                        NPRSurveyOperation.Class429 class429 = new NPRSurveyOperation.Class429();
                                                        // ISSUE: reference to a compiler-generated field
                                    ...
                                    // ISSUE: reference to a compiler-generated field
                                    if (class441.class440_0.gclass40_0.NPRShipBehaviour.double_2 > 0.0 &&
                                        class441.class440_0.gclass40_0.NPRShipBehaviour.double_2 >
                                        class428.gclass13_0.double_3)
                                    {
                                        // ISSUE: reference to a compiler-generated field
                                        // ISSUE: reference to a compiler-generated field
                                                     ...
                                                     .ToList<FireControlAssignment>())
                                        {
                                            // ISSUE: object of a compiler-generated type is created
                                            // ISSUE: variable of a compiler-generated type
                                            NPRSurveyOperation.Class430 class430 = new NPRSurveyOperation.Class430();
                                            // ISSUE: reference to a compiler-generated field
                        ...
                        if (!flag1 && list7.Where<MissileSalvo>(gclass132_0 => gclass132_0.MissileSpeed == 0.0)
                                .ToList<MissileSalvo>().Count > 0)
                        {
                            foreach (MissileSalvo gclass132 in list7
                                         .Where<MissileSalvo>(gclass132_0 => gclass132_0.MissileSpeed == 0.0)
                                         .ToList<MissileSalvo>())
                            {
                                // ISSUE: object of a compiler-generated type is created
                                // ISSUE: variable of a compiler-generated type
                                NPRSurveyOperation.Class431 class431 = new NPRSurveyOperation.Class431();
                                // ISSUE: reference to a compiler-generated field
                                ...
                                // ISSUE: reference to a compiler-generated field
                                // ISSUE: reference to a compiler-generated field
                                double num = this.Game.GetDistanceBetween(
                                    class441.class440_0.gclass40_0.gclass85_0.XCoord,
                                    class441.class440_0.gclass40_0.gclass85_0.YCoord, class431.gclass132_0.Xcor,
                                    class431.gclass132_0.Ycor);
                                // ISSUE: reference to a compiler-generated field
                                // ISSUE: reference to a compiler-generated field
                                // ISSUE: reference to a compiler-generated field
                                // ISSUE: reference to a compiler-generated field
                                if (class441.class440_0.gclass40_0.NPRShipBehaviour.double_2 > 0.0 &&
                                    class441.class440_0.gclass40_0.NPRShipBehaviour.double_2 > num)
                                {
                                    // ISSUE: reference to a compiler-generated field
                                    // ISSUE: reference to a compiler-generated field
                                    foreach (FireControlAssignment gclass36 in class441.class440_0.gclass40_0.list_4
                                                 ...
                                                 .ToList<FireControlAssignment>())
                                    {
                                        // ISSUE: object of a compiler-generated type is created
                                        // ISSUE: variable of a compiler-generated type
                                        NPRSurveyOperation.Class432 class432 = new NPRSurveyOperation.Class432();
                                        // ISSUE: reference to a compiler-generated field
                                                ...
                                                .Max<ShipComponent>(gclass230_0 => gclass230_0.method_18()) > num)
                                        {
                                            // ISSUE: reference to a compiler-generated field
                                            // ISSUE: reference to a compiler-generated field
                                            class432.gclass36_0.TargetID = class431.gclass132_0.MissileSalvoID;
                                            // ISSUE: reference to a compiler-generated field
            ...
            foreach (GroundUnitFormationElement gclass39 in list4)
            {
                // ISSUE: object of a compiler-generated type is created
                // ISSUE: variable of a compiler-generated type
                NPRSurveyOperation.Class433 class433 = new NPRSurveyOperation.Class433()
                {
                    class423_0 = class423,
                    gclass39_0 = gclass39
                };
    ...
    public void method_3(List<FleetData> list_0, bool bool_0, bool bool_1)
    {
        try
        {
            ...
            foreach (FleetData gclass85 in list2)
                gclass85.method_4();
            List<FleetData> list3 = this.Game.Contacts.Values.Where<Contact>(gclass65_0 =>
                    gclass65_0.method_5() == AuroraContactStatus.Hostile &&
                    gclass65_0.DetectRace == this.SystemSurvey.Race &&
                    gclass65_0.LastUpdate == this.Game.GameTime &&
                    gclass65_0.ContactType == AuroraContactType.Ship &&
                    gclass65_0.System == this.SystemSurvey.ActualSystem)
                .Select<Contact, FleetData>(gclass65_0 => gclass65_0.TargetShip.gclass85_0).Distinct<FleetData>()
                .ToList<FleetData>();
            List<PopulationData> list4 = this.Game.Contacts.Values.Where<Contact>(gclass65_0 =>
                    gclass65_0.method_5() == AuroraContactStatus.Hostile &&
                    gclass65_0.DetectRace == this.SystemSurvey.Race &&
                    gclass65_0.LastUpdate == this.Game.GameTime &&
                    gclass65_0.ContactType == AuroraContactType.STOGroundUnit &&
            ...
            if (this.SystemSurvey.Race.SpecialNPRID == SpecialNPRIDs.Eldar)
            {
                AetherGate gclass210_0_1 =
                    this.Game.dictionary_16.Values
                        .Where<AetherGate>(gclass210_0 => gclass210_0.gclass200_0 == this.SystemSurvey.ActualSystem)
                        .FirstOrDefault<AetherGate>() ??
                    this.SystemSurvey.Race.UnknownNprClass.method_2(this.SystemSurvey.ActualSystem);
                foreach (FleetData gclass85_0 in list2)
                {
                    ...
                    else
                    {
                        ...
                        if (bool_1)
                        {
                            ...
                            else if ((Decimal)this.Game.GetDistanceBetween(gclass85_0.XCoord, gclass85_0.YCoord,
                    ...
                    ? (this.genum96_0 != GEnum96.const_3
                        ? (this.genum96_0 != GEnum96.const_2
                            ? (this.genum96_0 != GEnum96.const_1
                                ? this.SystemSurvey.method_38(true, GEnum96.const_0)
                                    .Where<RacialSystemSurvey>(gclass202_0 => !gclass202_0.bool_6)
                                    .OrderByDescending<RacialSystemSurvey,
                                        NPRSystemValue>(gclass202_0 => gclass202_0.gclass3_0.genum95_0)
                                    .Select<RacialSystemSurvey,
                                        JumpPoint>(gclass202_1 =>
                                        gclass202_1.method_11(this.SystemSurvey).LinkedJumpPoint).ToList<JumpPoint>()
                                : this.SystemSurvey.method_38(true, GEnum96.const_0)
                                    .OrderByDescending<RacialSystemSurvey,
                                        NPRSystemValue>(gclass202_0 => gclass202_0.gclass3_0.genum95_0)
                                    .Select<RacialSystemSurvey,
                                        JumpPoint>(gclass202_1 =>
                                        gclass202_1.method_11(this.SystemSurvey).LinkedJumpPoint).ToList<JumpPoint>())
                            : this.SystemSurvey.method_38(true, GEnum96.const_1)
                                .OrderBy<RacialSystemSurvey, GEnum96>(gclass202_0 => gclass202_0.gclass3_0.genum96_0)
                                .ThenByDescending<RacialSystemSurvey, NPRSystemValue>(gclass202_0 => gclass202_0.gclass3_0.genum95_0)
                                .Select<RacialSystemSurvey,
                                    JumpPoint>(
                                    gclass202_1 => gclass202_1.method_11(this.SystemSurvey).LinkedJumpPoint)
                                .ToList<JumpPoint>())
                        : this.SystemSurvey.method_38(true, GEnum96.const_2)
                            .OrderBy<RacialSystemSurvey, GEnum96>(gclass202_0 => gclass202_0.gclass3_0.genum96_0)
                            .ThenByDescending<RacialSystemSurvey, NPRSystemValue>(gclass202_0 => gclass202_0.gclass3_0.genum95_0)
                            .Select<RacialSystemSurvey,
                                JumpPoint>(gclass202_1 => gclass202_1.method_11(this.SystemSurvey).LinkedJumpPoint)
                            .ToList<JumpPoint>())
                    : this.SystemSurvey.method_38(true, GEnum96.const_3)
                        .OrderBy<RacialSystemSurvey, GEnum96>(gclass202_0 => gclass202_0.gclass3_0.genum96_0)
                        .ThenByDescending<RacialSystemSurvey, NPRSystemValue>(gclass202_0 => gclass202_0.gclass3_0.genum95_0)
                        .Select<RacialSystemSurvey, JumpPoint>(gclass202_1 =>
                            gclass202_1.method_11(this.SystemSurvey).LinkedJumpPoint).ToList<JumpPoint>();
                if (gclass120List2.Count == 0 && bool_1)
                    gclass120List2 = this.SystemSurvey.method_38(true, GEnum96.const_4)
                        .OrderBy<RacialSystemSurvey, GEnum96>(gclass202_0 => gclass202_0.gclass3_0.genum96_0)
                        .ThenByDescending<RacialSystemSurvey, NPRSystemValue>(gclass202_0 => gclass202_0.gclass3_0.genum95_0)
                        .Select<RacialSystemSurvey, JumpPoint>(gclass202_1 =>
                            gclass202_1.method_11(this.SystemSurvey).LinkedJumpPoint).ToList<JumpPoint>();
                if (gclass120List2.Count > 0)
                {
                    foreach (FleetData gclass85_0 in list2)
                    {
                        ...
                        foreach (JumpPoint gclass120_1 in gclass120List2)
                        {
                            ...
                            {
                                gclass85_0.method_263();
                                gclass85_0.method_231(gclass120_1, MoveActionType.StandardTransit, this.SystemSurvey);
                                gclass85_0.NPRSomething.bRedeployOrderGiven = true;
                            }
                        }
                    }
            ...
            if (list5.Count == 0)
                return;
            List<PopulationData> list6 = this.Game.Populations.Values
                .Where<PopulationData>(gclass146_0 =>
                    gclass146_0.gclass202_0 == this.SystemSurvey && gclass146_0.SystemBodyData.DustLevel == 0M)
            ...
            foreach (FleetData gclass85_1 in list7)
            {
                // ISSUE: object of a compiler-generated type is created
                // ISSUE: variable of a compiler-generated type
                NPRSurveyOperation.Class442 class442 = new NPRSurveyOperation.Class442();
                // ISSUE: reference to a compiler-generated field
                ...
                // ISSUE: reference to a compiler-generated field
                // ISSUE: reference to a compiler-generated field
                double num = this.Game.GetDistanceBetween(class442.gclass85_0.XCoord, class442.gclass85_0.YCoord,
                ...
                GClass221 gclass221_0 = num <= 0.0
                    ? this.Game.method_592(class442.gclass85_0.XCoord, class442.gclass85_0.YCoord, 10000000.0,
                        AuroraUtils.GetRandomInteger(360) - 1)
                    : this.Game.method_525(class442.gclass85_0.XCoord, class442.gclass85_0.YCoord,
                ...
                Waypoint gclass214_0 = class442.gclass85_0.Race.method_188(
                    ...
                    gclass221_0.double_0, gclass221_0.double_1,
                    string.Format("{0} Escape Point", class442.gclass85_0.FleetName), 0);
                // ISSUE: reference to a compiler-generated field
                class442.gclass85_0.method_263();
                // ISSUE: reference to a compiler-generated field
                class442.gclass85_0.method_217(gclass214_0, MoveActionType.MoveTo, this.SystemSurvey);
                // ISSUE: reference to a compiler-generated field
        ...
        double double_2)
    {
        try
        {
            ...
            {
                double num3 = this.Game.GetDistanceBetween(gclass85.XCoord, gclass85.YCoord, gclass85_0.XCoord,
                    gclass85_0.YCoord);
                double num4 = this.Game.method_517(gclass85.XCoord, gclass85.YCoord, gclass85_0.XCoord,
            ...
            {
                double num5 = this.Game.GetDistanceBetween(gclass146.method_87(), gclass146.method_88(),
                    gclass85_0.XCoord, gclass85_0.YCoord);
                double num6 = this.Game.method_517(gclass146.method_87(), gclass146.method_88(),
        ...
        Decimal decimal_2)
    {
        try
        {
            ...
            foreach (FleetData gclass85 in list_0)
            {
                ...
                {
                    double num2 = this.Game.GetDistanceBetween(gclass85.XCoord, gclass85.YCoord, gclass85_0.XCoord,
                        gclass85_0.YCoord);
                    double num3 = this.Game.method_517(gclass85.XCoord, gclass85.YCoord, gclass85_0.XCoord,
            ...
            foreach (PopulationData gclass146 in list_1)
            {
                double num4 = this.Game.GetDistanceBetween(gclass146.method_87(), gclass146.method_88(),
                    gclass85_0.XCoord, gclass85_0.YCoord);
                double num5 = this.Game.method_517(gclass146.method_87(), gclass146.method_88(),
    ...
    public void method_6(List<FleetData> list_0)
    {
        try
        {
            ...
            foreach (FleetData gclass85 in list1)
            {
                // ISSUE: object of a compiler-generated type is created
                // ISSUE: variable of a compiler-generated type
                NPRSurveyOperation.Class443 class443 = new NPRSurveyOperation.Class443();
                // ISSUE: reference to a compiler-generated field
                ...
                if (list2.Count > 0)
                {
                    ...
                    if (object_0 == null)
                    {
                        this.Game.FleetDictionary.Remove(gclass85_5.FleetID);
                    }
                    else
                    {
                        // ISSUE: reference to a compiler-generated field
                ...
                // ISSUE: reference to a compiler-generated field
                // ISSUE: reference to a compiler-generated field
                Wreck gclass233_0 = this.SystemSurvey.ActualSystem.method_5(class443.gclass85_0.XCoord,
                    class443.gclass85_0.YCoord, this.SystemSurvey);
                if (gclass233_0 != null)
                {
                    // ISSUE: reference to a compiler-generated field
                    class443.gclass85_0.method_263();
                    // ISSUE: reference to a compiler-generated field
                    class443.gclass85_0.method_216(gclass233_0, MoveActionType.SalvageWreck, this.SystemSurvey);
                    // ISSUE: reference to a compiler-generated field
                    class443.gclass85_0.NPRSomething.bRedeployOrderGiven = true;
                }
                else
                {
                    // ISSUE: reference to a compiler-generated field
                    // ISSUE: reference to a compiler-generated field
                    PopulationData gclass146_1 = this.SystemSurvey.ActualSystem.method_6(class443.gclass85_0.XCoord,
                        class443.gclass85_0.YCoord, this.SystemSurvey);
                    if (gclass146_1 != null)
                    {
                        // ISSUE: reference to a compiler-generated field
    ...
    public void method_7(List<FleetData> list_0, List<RacialSystemSurvey> list_1, List<RacialSystemSurvey> list_2)
    {
        try
        {
            // ISSUE: object of a compiler-generated type is created
            // ISSUE: variable of a compiler-generated type
            NPRSurveyOperation.Class444 class444 = new NPRSurveyOperation.Class444();
            // ISSUE: reference to a compiler-generated field
            ...
            else
            {
                if (this.SystemSurvey.Race.SpecialNPRID == SpecialNPRIDs.Eldar &&
                    list_0.Count<FleetData>(gclass85_0 =>
                        gclass85_0.LastTransitTime > this.Game.GameTime - AuroraUtils.decimal_32) == 0 &&
                    this.Game.Contacts.Values.Count<Contact>(gclass65_0 =>
                        gclass65_0.DetectRace == this.SystemSurvey.Race &&
                        gclass65_0.LastUpdate < this.Game.GameTime - AuroraUtils.decimal_32 &&
                        gclass65_0.System == this.SystemSurvey.ActualSystem) == 0 &&
                    this.Game.Wrecks.Values.Count<Wreck>(gclass233_0 =>
                        gclass233_0.System == this.SystemSurvey.ActualSystem) == 0 &&
                    this.Game.LifePods.Values.Count<LifePod>(gclass59_0 =>
                        gclass59_0.gclass200_0 == this.SystemSurvey.ActualSystem) == 0)
                {
                    this.SystemSurvey.Race.UnknownNprClass.method_33(list1, MoveActionType.StandardTransit);
                    return;
                }

                list1 = list_0.Where<FleetData>(gclass85_0 =>
                    !gclass85_0.NPRSomething.bRedeployOrderGiven && gclass85_0.System == this.SystemSurvey).ToList<FleetData>();
            }
            ...
            List<PopulationData> list6 = this.SystemSurvey.method_46()
                .OrderByDescending<PopulationData, GEnum97>(gclass146_0 => gclass146_0.gclass6_0.genum97_0)
            ...
            List<GroundUnitFormationElement> list7 = this.Game.FormationDictionary.Values
                .Where<GroundUnitFormationData>(gclass103_0 =>
                    gclass103_0.RaceData == this.SystemSurvey.Race && gclass103_0.PopulationData != null)
                .Where<GroundUnitFormationData>(gclass103_0 => gclass103_0.PopulationData.gclass202_0 == this.SystemSurvey)
                .SelectMany<GroundUnitFormationData, GroundUnitFormationElement>(gclass103_0 => gclass103_0.ElementList).Where<GroundUnitFormationElement>(gclass39_0 =>
            ...
            List<GroundUnitFormationElement> list8 = this.Game.FormationDictionary.Values
                .Where<GroundUnitFormationData>(gclass103_0 =>
                    gclass103_0.RaceData == this.SystemSurvey.Race && gclass103_0.PopulationData != null)
                .Where<GroundUnitFormationData>(gclass103_0 => gclass103_0.PopulationData.gclass202_0 == this.SystemSurvey)
                ...
                .ToList<GroundUnitFormationElement>();
            // ISSUE: reference to a compiler-generated field
            class444.list_1 = this.Game.Contacts.Values.Where<Contact>(gclass65_0 =>
                    gclass65_0.method_5() == AuroraContactStatus.Hostile &&
                    gclass65_0.DetectRace == this.SystemSurvey.Race &&
                    gclass65_0.LastUpdate == this.Game.GameTime &&
                    gclass65_0.ContactType == AuroraContactType.Ship &&
            ...
            // ISSUE: reference to a compiler-generated field
            class444.list_0 = this.Game.Contacts.Values.Where<Contact>(gclass65_0 =>
                    gclass65_0.method_5() == AuroraContactStatus.Hostile &&
                    gclass65_0.DetectRace == this.SystemSurvey.Race &&
                    gclass65_0.LastUpdate > this.Game.GameTime - AuroraUtils.decimal_34 &&
                    gclass65_0.ContactType == AuroraContactType.Ship &&
                    gclass65_0.System == this.SystemSurvey.ActualSystem)
                .Select<Contact, ShipData>(gclass65_0 => gclass65_0.TargetShip).Distinct<ShipData>()
                .ToList<ShipData>();
            ...
            List<FleetData> list10 = class444.list_0.Select<ShipData, FleetData>(gclass40_0 => gclass40_0.gclass85_0)
                .Distinct<FleetData>().ToList<FleetData>();
            List<PopulationData> list11 = this.Game.Contacts.Values.Where<Contact>(gclass65_0 =>
                    gclass65_0.method_5() == AuroraContactStatus.Hostile &&
                    gclass65_0.DetectRace == this.SystemSurvey.Race &&
                    gclass65_0.LastUpdate == this.Game.GameTime &&
                    gclass65_0.ContactType == AuroraContactType.STOGroundUnit &&
                ...
                .ToList<PopulationData>();
            // ISSUE: reference to a compiler-generated field
            class444.gclass210_0 = this.Game.dictionary_16.Values.FirstOrDefault<AetherGate>(gclass210_0 =>
                gclass210_0.gclass200_0 == this.SystemSurvey.ActualSystem);
            List<MissileSalvo> list12 = this.Game.Contacts.Values.Where<Contact>(gclass65_0 =>
                    gclass65_0.method_5() == AuroraContactStatus.Hostile &&
                    gclass65_0.DetectRace == this.SystemSurvey.Race &&
                    this.Game.GameTime == gclass65_0.LastUpdate &&
                    gclass65_0.System == this.SystemSurvey.ActualSystem &&
                    gclass65_0.ContactType == AuroraContactType.Salvo)
            ...
            if (list12.Count > 0)
            {
                // ISSUE: object of a compiler-generated type is created
                // ISSUE: variable of a compiler-generated type
                NPRSurveyOperation.Class445 class445 = new NPRSurveyOperation.Class445();
                // ISSUE: reference to a compiler-generated field
                class445.class444_0 = class444;
                // ISSUE: reference to a compiler-generated field
                class445.int_0 = 60;
                // ISSUE: reference to a compiler-generated field
                class445.list_0 = this.Game.JumpPointDictionary.Values
                    .Where<JumpPoint>(gclass120_0 => gclass120_0.SystemData == this.SystemSurvey.ActualSystem)
                    .Where<JumpPoint>(gclass120_0 =>
                        gclass120_0.RacialJumpPointSurveys.ContainsKey(this.SystemSurvey.Race.RaceID))
                    .Where<JumpPoint>(gclass120_0 =>
                ...
                if (class445.class444_0.gclass210_0 != null &&
                    this.SystemSurvey.Race.SpecialNPRID == SpecialNPRIDs.Eldar)
                {
                    // ISSUE: reference to a compiler-generated method
                ...
                if (list13.Count > 0 || gclass85List.Count > 0)
                {
                    foreach (FleetData gclass85 in list13)
                    {
                        // ISSUE: object of a compiler-generated type is created
                        // ISSUE: variable of a compiler-generated type
                        NPRSurveyOperation.Class450 class450 = new NPRSurveyOperation.Class450();
                        // ISSUE: reference to a compiler-generated field
                        ...
                        if (source.Count > 0)
                        {
                            // ISSUE: object of a compiler-generated type is created
                            // ISSUE: variable of a compiler-generated type
                            NPRSurveyOperation.Class451 class451 = new NPRSurveyOperation.Class451();
                            // ISSUE: reference to a compiler-generated field
                            // ISSUE: reference to a compiler-generated method
                                ...
                                class450.gclass85_0.method_20((int)class451.gclass132_0.RaceMissile.Speed))
                            {
                                ...
                                // ISSUE: reference to a compiler-generated field
                                class450.gclass85_0.method_231(gclass120_1, MoveActionType.StandardTransit, this.SystemSurvey);
                                // ISSUE: reference to a compiler-generated field
                    ...
                    foreach (FleetData gclass85 in gclass85List)
                    {
                        // ISSUE: object of a compiler-generated type is created
                        // ISSUE: variable of a compiler-generated type
                        NPRSurveyOperation.Class452 class452 = new NPRSurveyOperation.Class452();
                        // ISSUE: reference to a compiler-generated field
                        ...
                        if (source.Count > 0)
                        {
                            // ISSUE: object of a compiler-generated type is created
                            // ISSUE: variable of a compiler-generated type
                            NPRSurveyOperation.Class453 class453 = new NPRSurveyOperation.Class453();
                            // ISSUE: reference to a compiler-generated field
                            // ISSUE: reference to a compiler-generated method
                                ...
                                class452.gclass85_0.method_20((int)class453.gclass132_0.RaceMissile.Speed))
                            {
                                ...
                                class452.gclass85_0.method_232(class452.class445_0.class444_0.gclass210_0,
                                    MoveActionType.StandardTransit, this.SystemSurvey);
                                // ISSUE: reference to a compiler-generated field
            ...
            if (list14.Count > 0)
            {
                this.SystemSurvey.Race.UnknownNprClass.method_35(list14, list6, list11, true);
                list2 = list2.Where<FleetData>(gclass85_0 => !gclass85_0.NPRSomething.bRedeployOrderGiven).ToList<FleetData>();
                list5 = list5.Where<FleetData>(gclass85_0 => !gclass85_0.NPRSomething.bRedeployOrderGiven).ToList<FleetData>();
                list3 = list3.Where<FleetData>(gclass85_0 => !gclass85_0.NPRSomething.bRedeployOrderGiven).ToList<FleetData>();
            }
            ...
            if (class444.list_0.Count > 0)
            {
                ...
                // ISSUE: reference to a compiler-generated field
                this.decimal_1 = class444.list_0.Where<ShipData>(gclass40_0 => !gclass40_0.Class.Commercial)
                    .Sum<ShipData>(gclass40_0 => gclass40_0.Class.ClassCrossSection * gclass40_0.Class.MaxSpeed);
                // ISSUE: reference to a compiler-generated method
                List<AlienShipIntel> list15 = this.SystemSurvey.Race.dictionary_12.Values
                    .Where<AlienShipIntel>(class444.method_0)
                    .OrderByDescending<AlienShipIntel, Decimal>(gclass117_0 => gclass117_0.gclass115_0.gclass22_0.Size)
                    .ToList<AlienShipIntel>();
                // ISSUE: reference to a compiler-generated method
                List<AlienShipIntel> list16 = this.SystemSurvey.Race.dictionary_12.Values
                    .Where<AlienShipIntel>(class444.method_1)
                    .OrderByDescending<AlienShipIntel, Decimal>(gclass117_0 => gclass117_0.gclass115_0.gclass22_0.Size)
                    .ToList<AlienShipIntel>();
                if (list15.Count > 0)
                {
                    List<FleetData> list17 = list1
                        .Where<FleetData>(gclass85_0 => this.Game.GameTime - gclass85_0.LastFleetDamageTime < 120M)
                        .Distinct<FleetData>().ToList<FleetData>();
                    List<FleetData> list18 = list1
                        .SelectMany<FleetData, ShipData>(gclass85_0 => gclass85_0.method_176())
                        .Where<ShipData>(gclass40_0 => this.Game.GameTime - gclass40_0.decimal_20 < 120M)
                        .Select<ShipData, FleetData>(gclass40_0 => gclass40_0.gclass85_0).Distinct<FleetData>()
                        .ToList<FleetData>();
                    if (list17.Count > 0)
                    {
                        foreach (FleetData gclass85_1 in list17)
                        {
                            // ISSUE: object of a compiler-generated type is created
                            // ISSUE: variable of a compiler-generated type
                            NPRSurveyOperation.Class454 class454 = new NPRSurveyOperation.Class454();
                            // ISSUE: reference to a compiler-generated field
                            ...
                            int num1 = list1.Where<FleetData>(class454.method_0)
                                ...
                                .Count<ShipData>(gclass40_0 =>
                                    gclass40_0.Class.ProtectionValue > 0M &&
                                    gclass40_0.NPRShipBehaviour.genum99_0 > GEnum99.const_0);
                            // ISSUE: reference to a compiler-generated field
                            // ISSUE: reference to a compiler-generated field
                            // ISSUE: reference to a compiler-generated field
                                ...
                                class454.gclass85_0.NPRSomething.genum103_0 != GEnum103.const_0)
                            {
                                if (source.Count<ShipData>(gclass40_0 =>
                                        this.Game.GameTime - gclass40_0.decimal_20 < 120M) > 0 && list9.Count > 0)
                                {
                                    // ISSUE: object of a compiler-generated type is created
                                    // ISSUE: variable of a compiler-generated type
                                    NPRSurveyOperation.Class456 class456 = new NPRSurveyOperation.Class456();
                                    // ISSUE: reference to a compiler-generated field
                                    // ISSUE: reference to a compiler-generated method
                                    ...
                                    if (class456.gclass85_0 != null)
                                    {
                                        ...
                                        {
                                            // ISSUE: reference to a compiler-generated method
                                            AlienShipIntel gclass117_0_1 = list16.Where<AlienShipIntel>(class456.method_0)
                                                .OrderByDescending<AlienShipIntel, Decimal>(gclass117_0 =>
                                                    gclass117_0.gclass115_0.gclass22_0.Size)
                                                .FirstOrDefault<AlienShipIntel>();
                                            // ISSUE: reference to a compiler-generated field
                                        ...
                                        else
                                        {
                                            ...
                                            if (class454.gclass85_0.NPROperationGroup.int_1 == 0)
                                            {
                                                ...
                                                List<ShipData> list19 = source.Where<ShipData>(gclass40_0 =>
                                                        gclass40_0.Class.ProtectionValue > 0M &&
                                                        gclass40_0.NPRShipBehaviour.genum99_0 > GEnum99.const_0 &&
                                                        gclass40_0.Class.AutomatedClassDesign.BeamFireControl > BFCDesignType.const_0)
                                                ...
                                                if (list19.Count > 0)
                                                {
                                                    ...
                                                    // ISSUE: reference to a compiler-generated method
                                                    AlienShipIntel gclass117_0_2 = list16.Where<AlienShipIntel>(class456.method_2)
                                                        .OrderByDescending<AlienShipIntel, Decimal>(gclass117_0 =>
                                                            gclass117_0.gclass115_0.gclass22_0.Size)
                                                        .FirstOrDefault<AlienShipIntel>();
                                ...
                                if (source.Count<ShipData>(gclass40_0 =>
                                        this.Game.GameTime - gclass40_0.decimal_19 < 120M) > 0)
                                {
                                    // ISSUE: object of a compiler-generated type is created
                                    // ISSUE: variable of a compiler-generated type
                                    NPRSurveyOperation.Class457 class457 = new NPRSurveyOperation.Class457();
                                    bool flag = true;
                                    // ISSUE: reference to a compiler-generated field
                                    // ISSUE: reference to a compiler-generated method
                                    ...
                                    if (flag && list9.Count > 0)
                                    {
                                        // ISSUE: object of a compiler-generated type is created
                                        // ISSUE: variable of a compiler-generated type
                                        NPRSurveyOperation.Class446 class446 = new NPRSurveyOperation.Class446();
                                        // ISSUE: reference to a compiler-generated field
                                        // ISSUE: reference to a compiler-generated method
                                        ...
                                        {
                                            // ISSUE: reference to a compiler-generated method
                                            AlienShipIntel gclass117_0_3 = list16.Where<AlienShipIntel>(class446.method_0)
                                                .OrderByDescending<AlienShipIntel, Decimal>(gclass117_0 =>
                                                    gclass117_0.gclass115_0.gclass22_0.Size)
                                                .FirstOrDefault<AlienShipIntel>();
                                            // ISSUE: reference to a compiler-generated field
                            ...
                            else
                            {
                                ...
                                {
                                    // ISSUE: reference to a compiler-generated field
                                    if (this.SystemSurvey.Race.SpecialNPRID != SpecialNPRIDs.Precursor &&
                                        this.SystemSurvey.Race.SpecialNPRID != SpecialNPRIDs.const_3 &&
                                        this.SystemSurvey.Race.SpecialNPRID != SpecialNPRIDs.StarSwarm &&
                                        !class454.gclass85_0.bNoSurrender)
                                    {
                                        // ISSUE: reference to a compiler-generated field
                                        if (class454.gclass85_0.decimal_3 < this.Game.GameTime - 120M)
                                        {
                                            // ISSUE: reference to a compiler-generated field
                                            class454.gclass85_0.decimal_3 = this.Game.GameTime;
                                            int num2 = source
                                            ...
                                            if (num1 == 0 && AuroraUtils.GetRandomInteger(100) < num4)
                                            {
                                                ...
                                                GameRace gclass21_1 = list15
                                                    .Select<AlienShipIntel, FleetData>(gclass117_0 =>
                                    ...
                                    else
                                    {
                                        // ISSUE: object of a compiler-generated type is created
                                        // ISSUE: reference to a compiler-generated method
                                        List<AlienShipIntel> list20 = this.SystemSurvey.Race.dictionary_12.Values
                                            .Where<AlienShipIntel>(new NPRSurveyOperation.Class455()
                                            {
                                                list_0 = this.Game.FormationDictionary.Values
                                                    .Where<GroundUnitFormationData>(gclass103_0 =>
                                                        gclass103_0.RaceData == this.SystemSurvey.Race &&
                                                        gclass103_0.ShipData != null)
                                                    .Where<GroundUnitFormationData>(gclass103_0 =>
                                                        gclass103_0.ShipData.Race !=
                                                        this.SystemSurvey.Race)
                                                    .Select<GroundUnitFormationData, ShipData>(gclass103_0 =>
                                                        gclass103_0.ShipData).Distinct<ShipData>()
                                                    .ToList<ShipData>()
                                            }.method_0).ToList<AlienShipIntel>();
                                        List<AlienShipIntel> list21 = list16.Except<AlienShipIntel>(list20).ToList<AlienShipIntel>();
                                        if (list21.Count > 0)
                                        {
                                            // ISSUE: reference to a compiler-generated field
                    ...
                    List<AlienShipIntel> list22 = list16.Where<AlienShipIntel>(gclass117_0 => gclass117_0.gclass40_0.int_15 > 0)
                        .ToList<AlienShipIntel>();
                    if (list22.Count > 0)
                    {
                        foreach (FleetData gclass85 in list2.Concat<FleetData>(list3).ToList<FleetData>())
                        {
                            ...
                            // ISSUE: object of a compiler-generated type is created
                            // ISSUE: variable of a compiler-generated type
                            NPRSurveyOperation.Class448 class448 = new NPRSurveyOperation.Class448()
                            {
                                class447_0 = new NPRSurveyOperation.Class447()
                                {
                                    class444_0 = class444,
                                    gclass85_0 = gclass85
                                }
                            ...
                            // ISSUE: reference to a compiler-generated field
                            // ISSUE: reference to a compiler-generated method
                            AlienShipIntel gclass117_0 = list22.Where<AlienShipIntel>(class448.method_0)
                                .OrderBy<AlienShipIntel, double>(class448.class447_0.method_0).FirstOrDefault<AlienShipIntel>();
                            if (gclass117_0 != null)
                            {
                                // ISSUE: reference to a compiler-generated field
                                // ISSUE: reference to a compiler-generated field
                    ...
                    else if (list9.Count > 0)
                    {
                        ...
                        int num = 0;
                        bool flag = false;
                        if (this.SystemSurvey.Race.SpecialNPRID == SpecialNPRIDs.Precursor && list6.Count == 0)
                        ...
                        else if (this.SystemSurvey.Race.SpecialNPRID == SpecialNPRIDs.Eldar)
                        {
                            ...
                            {
                                // ISSUE: reference to a compiler-generated field
                                flag = this.SystemSurvey.Race.UnknownNprClass.method_0(class444.gclass210_0,
                        ...
                        if (list2.Count > 0 || num == 0)
                        {
                            ...
                            this.SystemSurvey.Race.UnknownNprClass.method_13(list2);
                        }
                    ...
                    if (this.SystemSurvey.Race.SpecialNPRID != SpecialNPRIDs.Eldar)
                    {
                        ...
                        foreach (FleetData gclass85 in list23)
                            gclass85.NPRSomething.bRedeployOrderGiven = false;
                        this.SystemSurvey.Race.UnknownNprClass.method_35(list23, list6, list11, true);
                    }
                ...
                new List<RacialSystemSurvey>() { this.SystemSurvey };
            }

            if (this.SystemSurvey.Race.SpecialNPRID == SpecialNPRIDs.StarSwarm)
            {
            ...
            if (list2.Count > 0)
            {
                             ...
                             .ToList<FleetData>())
                {
                    // ISSUE: object of a compiler-generated type is created
                    // ISSUE: variable of a compiler-generated type
                    NPRSurveyOperation.Class449 class449 = new NPRSurveyOperation.Class449();
                    // ISSUE: reference to a compiler-generated field
            ...
            if (list6.Count > 0 && list2.Count > 0 && this.SystemSurvey.Race.SpecialNPRID != SpecialNPRIDs.StarSwarm)
            ...
            List<FleetData> list32 = list_0.Where<FleetData>(gclass85_0 =>
                !gclass85_0.NPRSomething.bRedeployOrderGiven && gclass85_0.System == this.SystemSurvey &&
                gclass85_0.EscapeTimeRemaining > 0.0).ToList<FleetData>();
            if (this.SystemSurvey.Race.SpecialNPRID == SpecialNPRIDs.Precursor)
            ...
            {
                if (gclass85_0.NPRSomething.bRedeployOrderGiven || gclass85_0.System != this.SystemSurvey)
                    return false;
            ...
            else
            {
                if (this.SystemSurvey.Race.SpecialNPRID == SpecialNPRIDs.Precursor)
                {
                    SystemBodyData gclass1_1 = this.Game.SystemBodyRecordDic.Values
                        .Where<SystemBodyData>(gclass1_0 =>
                            gclass1_0.SystemData == this.SystemSurvey.ActualSystem)
                ...
                FleetData gclass85_5 = list_0
                    .Where<FleetData>(gclass85_0 =>
                        ...
                        gclass85_0.System == this.SystemSurvey && gclass85_0.OrbitingBody != null)
                ...
                else
                {
                    foreach (FleetData gclass85 in list33)
                    {
                        SystemBodyData gclass1_1 =
                            this.SystemSurvey.ActualSystem.method_23(gclass85.XCoord, gclass85.YCoord);
                        if (gclass1_1 != null)
        ...
        GEnum104 genum104_0)
    {
        // ISSUE: object of a compiler-generated type is created
        // ISSUE: variable of a compiler-generated type
        NPRSurveyOperation.Class458 class458 = new NPRSurveyOperation.Class458();
        // ISSUE: reference to a compiler-generated field
        ...
        try
        {
            ...
            if (list_1.FirstOrDefault<FleetData>(class458.method_0) == null)
                return;
            // ISSUE: reference to a compiler-generated field
            this.SystemSurvey.Race.UnknownNprClass.method_47(this.SystemSurvey, list_2, list_0, class458.genum104_0,
                false);
            // ISSUE: reference to a compiler-generated field
            this.SystemSurvey.Race.UnknownNprClass.method_47(this.SystemSurvey, list_2, list_0, class458.genum104_0,
                true);
    ...
    public void method_9(List<FleetData> list_0)
    {
        try
        {
            List<FleetData> list = list_0.Where<FleetData>(gclass85_0 => gclass85_0.System == this.SystemSurvey)
                .ToList<FleetData>();
            if (list.Count == 0)
                return;
                         ...
                         .ToList<FleetData>())
            {
                // ISSUE: object of a compiler-generated type is created
                // ISSUE: variable of a compiler-generated type
                NPRSurveyOperation.Class459 class459 = new NPRSurveyOperation.Class459();
                // ISSUE: reference to a compiler-generated field
                ...
                {
                    // ISSUE: reference to a compiler-generated method
                    foreach (FleetData gclass85_2 in this.Game.FleetDictionary.Values
                                 .Where<FleetData>(gclass85_0 =>
                                     gclass85_0.Race == this.SystemSurvey.Race &&
        ...
        bool bool_0)
    {
        try
        {
            ...
            foreach (FleetData gclass85_1 in list_2)
            {
                // ISSUE: object of a compiler-generated type is created
                // ISSUE: variable of a compiler-generated type
                NPRSurveyOperation.Class460 class460 = new NPRSurveyOperation.Class460();
                // ISSUE: reference to a compiler-generated field
                class460.gclass85_0 = gclass85_1;
                // ISSUE: object of a compiler-generated type is created
                // ISSUE: variable of a compiler-generated type
                NPRSurveyOperation.Class461 class461 = new NPRSurveyOperation.Class461();
                // ISSUE: reference to a compiler-generated field
                ...
                foreach (FleetData gclass85_2 in list_0)
                {
                    ...
                    // ISSUE: reference to a compiler-generated field
                    // ISSUE: reference to a compiler-generated field
                    gclass85_2.double_8 = this.Game.GetDistanceToNearestGClass212(this.SystemSurvey.ActualSystem,
                ...
                if (gclass85_3 != null)
                {
                    AlienShipIntel gclass117_0 = this.SystemSurvey.Race.method_267(gclass85_3.method_176()
                        .OrderByDescending<ShipData, Decimal>(gclass40_0 => gclass40_0.Class.Size)
                        .FirstOrDefault<ShipData>());
                    // ISSUE: reference to a compiler-generated field
                    // ISSUE: reference to a compiler-generated field
                ...
                else
                {
                    ...
                    while (true)
                    {
                                     ...
                                     .ToList<FleetData>())
                        {
                            ...
                            {
                                AlienShipIntel gclass117_0 = this.SystemSurvey.Race.method_267(gclass85_1_1.method_176()
                    ...
                    if (!class461.class460_0.gclass85_0.NPRSomething.bRedeployOrderGiven)
                    {
                                     ...
                                     .ToList<FleetData>())
                        {
                            ...
                            // ISSUE: reference to a compiler-generated field
                            // ISSUE: reference to a compiler-generated field
                            double num3 = this.Game.GetDistanceBetween(gclass85_1_2.XCoord, gclass85_1_2.YCoord,
                                class461.class460_0.gclass85_0.XCoord, class461.class460_0.gclass85_0.YCoord);
                            // ISSUE: reference to a compiler-generated field
                            // ISSUE: reference to a compiler-generated field
                            // ISSUE: reference to a compiler-generated field
                            // ISSUE: reference to a compiler-generated field
                            if (this.Game.GetDistanceBetween(gclass85_1_2.XCoord, gclass85_1_2.YCoord,
                            ...
                            {
                                AlienShipIntel gclass117_0 = this.SystemSurvey.Race.method_267(gclass85_1_2.method_176()
                                    .OrderByDescending<ShipData, Decimal>(gclass40_0 =>
                                        gclass40_0.Class.Size).FirstOrDefault<ShipData>());
                                // ISSUE: reference to a compiler-generated field
                                // ISSUE: reference to a compiler-generated field
    ...
    public void method_11(List<FleetData> list_0, List<FleetData> list_1)
    {
        try
        {
            ...
            foreach (FleetData gclass85_1 in list_0)
            {
                // ISSUE: object of a compiler-generated type is created
                // ISSUE: variable of a compiler-generated type
                NPRSurveyOperation.Class462 class462 = new NPRSurveyOperation.Class462();
                // ISSUE: reference to a compiler-generated field
                ...
                if (gclass85_2 == null)
                    break;
                // ISSUE: reference to a compiler-generated field
                AlienShipIntel gclass117_0 = this.SystemSurvey.Race.method_267(class462.gclass85_0.method_176()
                    .OrderByDescending<ShipData, Decimal>(gclass40_0 => gclass40_0.Class.Size)
                    .FirstOrDefault<ShipData>());
    ...
    public void method_12(AlienShipIntel gclass117_0, List<FleetData> list_0)
    {
        // ISSUE: object of a compiler-generated type is created
        // ISSUE: variable of a compiler-generated type
        NPRSurveyOperation.Class463 class463 = new NPRSurveyOperation.Class463();
        // ISSUE: reference to a compiler-generated field
        ...
        try
        {
            if (list_5.Count > 0)
            {
                ...
                foreach (PopulationData gclass146 in list_5)
                {
                    // ISSUE: object of a compiler-generated type is created
                    // ISSUE: variable of a compiler-generated type
                    NPRSurveyOperation.Class464 class464 = new NPRSurveyOperation.Class464();
                    // ISSUE: reference to a compiler-generated field
                        ...
                        if ((list2.Count != 0 || list3.Count != 0) && !list1.Contains(class464.gclass146_0.SystemBodyData))
                        {
                            ...
                            if (list2.Count > 0)
                                num += list2.SelectMany<FleetData, ShipData>(gclass85_0 => gclass85_0.method_176())
                                    .Sum<ShipData>(gclass40_0 => gclass40_0.Class.ClassCrossSection * 5000M);
                            if (list3.Count > 0)
    ...
    public bool method_15(List<FleetData> list_0, AlienShipIntel gclass117_0, List<PopulationData> list_1)
    {
        // ISSUE: object of a compiler-generated type is created
        // ISSUE: variable of a compiler-generated type
        NPRSurveyOperation.Class465 class465 = new NPRSurveyOperation.Class465();
        // ISSUE: reference to a compiler-generated field
        ...
        try
        {
            // ISSUE: object of a compiler-generated type is created
            // ISSUE: variable of a compiler-generated type
            NPRSurveyOperation.Class466 class466 = new NPRSurveyOperation.Class466();
            // ISSUE: reference to a compiler-generated field
            class466.decimal_0 = 0M;
            // ISSUE: reference to a compiler-generated field
            if (!class465.gclass117_0.gclass40_0.Class.Commercial)
            {
                // ISSUE: reference to a compiler-generated field
                // ISSUE: reference to a compiler-generated field
                // ISSUE: reference to a compiler-generated field
                class466.decimal_0 = class465.gclass117_0.gclass40_0.Class.ClassCrossSection *
                                     class465.gclass117_0.gclass40_0.Class.MaxSpeed;
            }
    ...
    public void method_17(List<FleetData> list_0, AlienShipIntel gclass117_0, List<PopulationData> list_1)
    {
        try
        {
            foreach (FleetData gclass85 in list_0)
        ...
        bool bool_0)
    {
        try
        {
            // ISSUE: object of a compiler-generated type is created
            // ISSUE: variable of a compiler-generated type
            NPRSurveyOperation.Class467 class467 = new NPRSurveyOperation.Class467();
            List<Waypoint> list1 = this.Game.Waypoints.Values.Where<Waypoint>(gclass214_0 =>
            {
                if (gclass214_0.System != this.SystemSurvey.ActualSystem ||
                    gclass214_0.Race != this.SystemSurvey.Race)
                    return false;
            ...
            if (bool_0 && list_2.Count > 0)
            {
                foreach (Waypoint gclass214 in list1.ToList<Waypoint>())
                {
                    ...
                    {
                        if (this.Game.GetDistanceBetween(gclass214.Xcor, gclass214.Ycor, gclass85.XCoord,
            ...
            class467.list_0 = list_0.SelectMany<FleetData, MoveOrder>(gclass85_0 => gclass85_0.MoveOrderDictionary.Values)
                .Where<MoveOrder>(gclass139_0 =>
                    gclass139_0.DestinationType == DestinationType.const_3 && gclass139_0.StartSystem == this.SystemSurvey)
        ...
        int int_4)
    {
        // ISSUE: object of a compiler-generated type is created
        // ISSUE: variable of a compiler-generated type
        NPRSurveyOperation.Class468 class468 = new NPRSurveyOperation.Class468();
        // ISSUE: reference to a compiler-generated field
        ...
        try
        {
            // ISSUE: object of a compiler-generated type is created
            // ISSUE: variable of a compiler-generated type
            NPRSurveyOperation.Class469 class469 = new NPRSurveyOperation.Class469();
            // ISSUE: reference to a compiler-generated field
            ...
            for (int index = 1; index < int_4; ++index)
            {
                ...
                if (gclass214_0 != null)
                {
                    ...
                    gclass85_0.method_217(gclass214_0, MoveActionType.MoveTo, this.SystemSurvey);
    ...
    public void method_20(List<FleetData> list_0, List<FleetData> list_1)
    {
        try
        {
            List<LifePod> list = this.Game.LifePods.Values
                .Where<LifePod>(gclass59_0 => gclass59_0.gclass200_0 == this.SystemSurvey.ActualSystem)
                .ToList<LifePod>();
            LifePod gclass59 = null;
            list_0 = list_0.OrderBy<FleetData, Decimal>(gclass85_0 => gclass85_0.decimal_7).ToList<FleetData>();
            foreach (LifePod gclass59_0 in list)
            {
                if (gclass59 == null || this.Game.GetDistanceBetween(gclass59_0.double_0, gclass59_0.double_1,
                        gclass59.double_0, gclass59.double_1) >= 100000000.0)
                {
                    ...
                    if (gclass85_1 != null)
                    {
                        ...
                        gclass85_1.method_218(gclass59_0, MoveActionType.RescueSurvivors, this.SystemSurvey);
                    ...
                    else
                    {
                        ...
                        if (gclass85_2 != null)
                        {
                            ...
                            gclass85_2.method_218(gclass59_0, MoveActionType.RescueSurvivors, this.SystemSurvey);
                            gclass85_2.NPRSomething.bRedeployOrderGiven = true;
                            gclass59 = gclass59_0;
                        }
                        else
    ...
    public void method_21(List<FleetData> list_0, List<PopulationData> list_1)
    {
        try
        {
            ...
            foreach (FleetData gclass85 in list_0)
            {
                // ISSUE: object of a compiler-generated type is created
                // ISSUE: variable of a compiler-generated type
                NPRSurveyOperation.Class470 class470 = new NPRSurveyOperation.Class470();
                // ISSUE: reference to a compiler-generated field
    ...
    public void method_22(List<FleetData> list_0, List<PopulationData> list_1)
    {
        try
        {
            ...
            foreach (FleetData gclass85 in list_0)
            {
                // ISSUE: object of a compiler-generated type is created
                // ISSUE: variable of a compiler-generated type
                NPRSurveyOperation.Class471 class471 = new NPRSurveyOperation.Class471();
                // ISSUE: reference to a compiler-generated field
    ...
    public void method_23(List<PopulationData> list_0, List<FleetData> list_1)
    {
        try
        {
            list_0 = this.SystemSurvey.method_46()
                .OrderByDescending<PopulationData, GEnum97>(gclass146_0 => gclass146_0.gclass6_0.genum97_0)
                .ThenByDescending<PopulationData, int>(gclass146_0 => gclass146_0.gclass6_0.int_0)
                .ThenByDescending<PopulationData, double>(gclass146_0 => gclass146_0.gclass6_0.double_2).ToList<PopulationData>();
            foreach (PopulationData gclass146 in list_0)
            {
                // ISSUE: object of a compiler-generated type is created
                // ISSUE: variable of a compiler-generated type
                NPRSurveyOperation.Class472 class472 = new NPRSurveyOperation.Class472();
                // ISSUE: reference to a compiler-generated field
    ...
    public void method_24(List<ShipData> list_0)
    {
        try
        {
            // ISSUE: object of a compiler-generated type is created
            // ISSUE: variable of a compiler-generated type
            NPRSurveyOperation.Class473 class473 = new NPRSurveyOperation.Class473();
            if (this.genum95_0 == NPRSystemValue.const_0 || this.genum95_0 == NPRSystemValue.const_6)
                return;
            List<ShipData> list1 = list_0
                .Where<ShipData>(gclass40_0 => gclass40_0.gclass85_0.System == this.SystemSurvey)
                .ToList<ShipData>();
            // ISSUE: reference to a compiler-generated field
            class473.list_0 = this.SystemSurvey.method_46();
            if (this.SystemSurvey.Race.SpecialNPRID == SpecialNPRIDs.StarSwarm)
            {
                double num1 = 0.0;
                List<Wreck> list2 = this.Game.Wrecks.Values
                    .Where<Wreck>(gclass233_0 => gclass233_0.System == this.SystemSurvey.ActualSystem)
                    .ToList<Wreck>();
                if (list2.Count > 0)
                    num1 += (int)(list2.Sum<Wreck>(gclass233_0 => gclass233_0.ShipClass.Cost) / 50M);
                List<ShipData> list3 = list1.Where<ShipData>(gclass40_0 => !gclass40_0.Class.method_33())
                    .ToList<ShipData>();
                if (list3.Count > 0)
                    num1 += (int)(list3.Sum<ShipData>(gclass40_0 => gclass40_0.Class.Cost) / 10M);
                // ISSUE: reference to a compiler-generated field
                ...
                if (list4.Count > 0)
                    num1 += (int)(list4.SelectMany<PopulationData, PopulationInstallation>(gclass146_0 => gclass146_0.dictionary_0.Values)
                                  ...
                                  10M);
                // ISSUE: reference to a compiler-generated method
                List<Shipyard> list5 = this.Game.Shipyards.Values.Where<Shipyard>(class473.method_0)
                    .ToList<Shipyard>();
                if (list5.Count > 0)
                    num1 += (int)(list5.Sum<Shipyard>(gclass193_0 => gclass193_0.Slipways * gclass193_0.Capacity) /
                                  100M);
                // ISSUE: reference to a compiler-generated method
                List<Shipyard> list6 = this.Game.Shipyards.Values.Where<Shipyard>(class473.method_1)
                    .ToList<Shipyard>();
                if (list6.Count > 0)
                    num1 +=
                        (int)(list6.Sum<Shipyard>(gclass193_0 => gclass193_0.Slipways * gclass193_0.Capacity) / 1000M);
                double num2 = num1 + (int)(this.Game.SystemBodyRecordDic.Values
                    .Where<SystemBodyData>(gclass1_0 => gclass1_0.SystemData == this.SystemSurvey.ActualSystem)
                ...
                this.genum95_0 = num2 <= 200.0
                    ? (num2 <= 50.0 ? (num2 <= 20.0 ? NPRSystemValue.const_2 : NPRSystemValue.const_3) : NPRSystemValue.const_4)
                    : NPRSystemValue.const_5;
            }
            else if (this.SystemSurvey.Race.SpecialNPRID == SpecialNPRIDs.const_3)
            {
                Decimal num = this.Game.Populations.Values
                    .Where<PopulationData>(
                        gclass146_0 => gclass146_0.gclass202_0.ActualSystem == this.SystemSurvey.ActualSystem)
                    .Sum<PopulationData>(gclass146_0 => gclass146_0.method_190());
                if (num > 20000M)
                {
                    this.genum95_0 = NPRSystemValue.const_5;
                    return;
                }

                if (num > 5000M)
                {
                    this.genum95_0 = NPRSystemValue.const_4;
                    return;
                }

                if (num > 1000M)
                {
                    this.genum95_0 = NPRSystemValue.const_3;
                    return;
                }

                if (num > 1000M)
                {
                    this.genum95_0 = NPRSystemValue.const_2;
                    return;
                }

                this.genum95_0 = NPRSystemValue.const_1;
                return;
            }
            ...
            else
            {
                ...
                if (class473.list_0.Count > 0)
                {
                    ...
                    num4 = num4 +
                           list1.Where<ShipData>(gclass40_0 =>
                                   gclass40_0.Class.AutomatedClassDesign.AutomatedClassDesignTypeID == AutomatedClassDesignType.AsteroidMiner &&
                               ...
                               list1
                                   .Where<ShipData>(gclass40_0 =>
                                       gclass40_0.Class.AutomatedClassDesign.AutomatedClassDesignTypeID == AutomatedClassDesignType.TerraFormer &&
                ...
                List<ShipData> list7 = list1
                    .Where<ShipData>(gclass40_0 => gclass40_0.Class.AutomatedClassDesign.AutomatedClassDesignTypeID == AutomatedClassDesignType.Harvester)
                    .ToList<ShipData>();
                if (list7.Count > 0)
                {
                    // ISSUE: object of a compiler-generated type is created
                    // ISSUE: reference to a compiler-generated method
                    num4 += (int)Math.Round(list7.Where<ShipData>(new NPRSurveyOperation.Class474()
                    {
                        list_0 = this.Game.SystemBodyRecordDic.Values
                            .Where<SystemBodyData>(gclass1_0 =>
                                gclass1_0.SystemData == this.SystemSurvey.ActualSystem).Where<SystemBodyData>(
                                gclass1_0 =>
                                {
                ...
                {
                    Decimal num5 = -1M;
                    if (this.SystemSurvey.Race.SpecialNPRID == SpecialNPRIDs.const_0)
                    {
                        // ISSUE: reference to a compiler-generated field
    ...
    public void method_25(List<ShipData> list_0)
    {
        try
        {
            List<PopulationData> source = this.SystemSurvey.method_46();
            double num1 = source
    ...
    public void method_26(NPRSystemValue genum95_1)
    {
        try
        {
            foreach (RacialSystemSurvey gclass202 in this.SystemSurvey.method_37(true))
            {
                if (gclass202.gclass3_0.genum95_0 != NPRSystemValue.const_0 && gclass202.gclass3_0.genum95_0 < genum95_1)
