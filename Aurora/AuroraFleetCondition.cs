...
public enum AuroraFleetCondition
{
    ...
    [Description("Current Speed not equal to Max")]
    CurrentSpeedNotEqualtoMax = 6,
    [Description("MSP: 20% or Less")] SupplyPointsLessThan20 = 7,
    [Description("MSP: 10% or Less")] SupplyPointsLessThan10 = 8,

    [Description("Hostile Active Ship Contact in System")]
    HostileActiveShipContactinSystem = 9,
