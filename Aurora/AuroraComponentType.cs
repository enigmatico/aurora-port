...
public enum AuroraComponentType
{
    ...
    [Description("Gravitational Survey Sensors")]
    GravitationalSurveySensors = 6,

    [Description("Geological Survey Sensors")]
    GeologicalSurveySensors = 7,
    ...
    ElectronicWarfareSystems = 20, // 0x00000014
    ...
    [Description("Jump Point Stabilisation")]
    JumpPointStabilisation = 29, // 0x0000001D
    ...
    [Description("Commercial Hangar Deck")]
    CommercialHangarDeck = 58, // 0x0000003A

    [Description("Commercial Damage Control")]
    CommercialDamageControl = 59, // 0x0000003B
    [Description("Refuelling System")] RefuellingSystem = 61, // 0x0000003D

    [Description("Multiple Refuelling Stations")]
    OrdnanceTransferSystem = 63, // 0x0000003F
    ...
    MiscellaneousComponent = 69, // 0x00000045
    [Description("Mobile Repair Bay")] MobileRepairBay = 70, // 0x00000046

    [Description("Decoy Missile Launcher")]
    DecoyMissileLauncher = 71, // 0x00000047
}