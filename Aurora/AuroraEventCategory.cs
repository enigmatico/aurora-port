...
public enum AuroraEventCategory
{
    ...
    [Description("Population Production Events")]
    PopProduction = 1,
    Commander = 2,

    [Description("Population Mining Events")]
    PopMining = 3,

    [Description("Population Environment Events")]
    PopEnvironment = 4,

    [Description("Population Shipbuiding Events")]
    PopShipbuiding = 5,

    [Description("Population Ground Units Events")]
    PopGroundUnits = 6,

    [Description("Population Research Events")]
    PopResearch = 7,
    ...
    [Description("Population Summary Events")]
    PopSummary = 14, // 0x0000000E
