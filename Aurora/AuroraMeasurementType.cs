...
public enum AuroraMeasurementType
{
  ...
  [Description("Commercial Tonnage Destroyed")] CommercialShippingDestroyed,
  [Description("Hostile Missiles Destroyed")] HostileOrdnanceDestroyed,
  [Description("Military Tonnage Destroyed")] MilitaryShippingDestroyed,
  [Description("Armour Damage Taken")] ArmourDamageTaken,
  [Description("Internal Damage Taken")] InternalDamageTaken,
  [Description("Ground Tonnage Destroyed")] GroundForcesDestroyed,
  ...
  [Description("JP Stablisations Completed")] JPStablisationsCompleted,
  [Description("Ancient Constructs Discovered")] AncientConstructsDiscovered,
  [Description("LP Stablisations Completed")] LPStablisationsCompleted,
}
