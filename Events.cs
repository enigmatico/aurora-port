...
public class Events : Form
{
  ...
  public void method_0()
  {
    try
    {
      this.gclass0_0.method_565(this.lstvEvents, this.gclass21_0, (int) Math.Ceiling(Convert.ToDecimal(this.txtDays.Text)), (int) Math.Ceiling(Convert.ToDecimal(this.txtNumEvents.Text)), this.chkShowAll.CheckState, this.chkShowAllRaces.CheckState, this.gclass86_0.auroraEventCategory_0);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 647);
    }
  }
  ...
  private void method_2()
  {
    try
    {
      ...
      foreach (AuroraEventCategory enum_0 in Enum.GetValues(typeof (AuroraEventCategory)))
        ...
        {
          Description = GClass226.smethod_82((Enum) enum_0),
          auroraEventCategory_0 = enum_0
        });
      this.cboCategory.DisplayMember = "Description";
      this.cboCategory.DataSource = (object) gclass86List;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 648);
    }
  }

  public void method_3(GClass21 gclass21_1)
  {
    try
    {
      this.bool_0 = true;
    ...
    try
    {
      ...
      else
      {
        ...
        if (colorDialog.ShowDialog() != DialogResult.OK)
          return;
        if (tag.gclass21_0.dictionary_3.ContainsKey(tag.gclass88_0.genum126_0))
          tag.gclass21_0.dictionary_3[tag.gclass88_0.genum126_0].color_1 = colorDialog.Color;
        else
          tag.gclass21_0.dictionary_3.Add(tag.gclass88_0.genum126_0, new GClass90()
          {
            color_1 = colorDialog.Color,
            color_0 = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/),
            gclass88_0 = tag.gclass88_0,
            int_0 = tag.gclass21_0.RaceID
          });
        this.method_0();
      }
    }
    ...
    try
    {
      ...
      else
      {
        ...
        if (colorDialog.ShowDialog() != DialogResult.OK)
          return;
        if (tag.gclass21_0.dictionary_3.ContainsKey(tag.gclass88_0.genum126_0))
          tag.gclass21_0.dictionary_3[tag.gclass88_0.genum126_0].color_0 = colorDialog.Color;
        else
          tag.gclass21_0.dictionary_3.Add(tag.gclass88_0.genum126_0, new GClass90()
          {
            color_1 = Color.FromArgb(0, 0, 64 /*0x40*/),
  ...
  private void cmdHideEvent_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        GClass87 tag = (GClass87) this.lstvEvents.SelectedItems[0].Tag;
        tag?.gclass21_0.method_266(tag.gclass88_0.genum126_0);
        this.method_0();
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 653);
    }
  }
  ...
  private void cmdCopyColour_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        {
          GClass90 gclass90 = tag.gclass21_0.dictionary_3[tag.gclass88_0.genum126_0];
          foreach (GClass21 gclass21 in this.gclass0_0.dictionary_36.Values)
          {
            if (gclass21 != tag.gclass21_0)
            {
              if (gclass21.dictionary_3.ContainsKey(tag.gclass88_0.genum126_0))
              {
                gclass21.dictionary_3[tag.gclass88_0.genum126_0].color_0 = gclass90.color_0;
                gclass21.dictionary_3[tag.gclass88_0.genum126_0].color_1 = gclass90.color_1;
              }
              else
                gclass21.dictionary_3.Add(tag.gclass88_0.genum126_0, new GClass90()
                {
                  color_0 = gclass90.color_0,
                  color_1 = gclass90.color_1,
                  gclass88_0 = tag.gclass88_0,
                  int_0 = gclass21.RaceID
                });
            }
          }
          this.method_0();
  ...
  private void cmdImportColours_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        int num2 = (int) MessageBox.Show("Select the Event Colours CSV File. Please ensure you have the correct format");
        ...
        using (StreamReader streamReader = new StreamReader(path))
        {
          while (!streamReader.EndOfStream)
          {
            ...
            if (!(source[0] == "") && ((IEnumerable<string>) source).Count<string>() >= 3)
            {
              GClass90 gclass90 = new GClass90();
              gclass90.int_0 = this.gclass21_0.RaceID;
              GEnum126 int32_1 = (GEnum126) Convert.ToInt32(source[0]);
              if (this.gclass0_0.dictionary_46.ContainsKey(int32_1))
              {
                gclass90.gclass88_0 = this.gclass0_0.dictionary_46[int32_1];
                int int32_2 = Convert.ToInt32(source[1]);
                int int32_3 = Convert.ToInt32(source[2]);
                gclass90.color_1 = Color.FromArgb((int) byte.MaxValue, Color.FromArgb(int32_2));
                gclass90.color_0 = Color.FromArgb((int) byte.MaxValue, Color.FromArgb(int32_3));
                if (this.gclass21_0.dictionary_3.ContainsKey(int32_1))
                  this.gclass21_0.dictionary_3.Remove(int32_1);
                this.gclass21_0.dictionary_3.Add(int32_1, gclass90);
              }
            }
          }
        }
  ...
  private void cmdExportColours_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      foreach (GClass90 gclass90 in this.gclass21_0.dictionary_3.Values)
      {
        int argb1 = gclass90.color_1.ToArgb();
        int argb2 = gclass90.color_0.ToArgb();
        streamWriter.Write((int) gclass90.gclass88_0.genum126_0);
        streamWriter.Write(",");
  ...
  private void InitializeComponent()
  {
    ...
    this.lstvEvents.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvEvents.DoubleClick += new EventHandler(this.lstvEvents_DoubleClick);
    ...
    this.txtDays.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.cmdBackColour.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdTextColour.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.chkShowAll.CheckedChanged += new EventHandler(this.chkShowAllRaces_CheckedChanged);
    this.cmdHideEvent.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdHideEvent.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdTextFile.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.chkShowAllRaces.CheckedChanged += new EventHandler(this.chkShowAllRaces_CheckedChanged);
    ...
    this.flpButtons.Controls.Add((Control) this.cmdImportColours);
    this.flpButtons.Controls.Add((Control) this.cmdExportColours);
    ...
    this.cmdCopyColour.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdHeight.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdImportColours.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdImportColours.Tag = (object) "1200";
    this.cmdImportColours.Text = "Import Colours";
    this.cmdImportColours.UseVisualStyleBackColor = false;
    this.cmdImportColours.Click += new EventHandler(this.cmdImportColours_Click);
    this.cmdExportColours.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdExportColours.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.KeyDown += new KeyEventHandler(this.Events_KeyDown);
