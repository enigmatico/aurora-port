...
public class frmNPRSetup : Form
{
  ...
  public void method_0()
  {
    try
    {
      ...
      foreach (AuroraNPRSetupOption enum_0 in Enum.GetValues(typeof (AuroraNPRSetupOption)))
        stringList1.Add(GClass226.smethod_82((Enum) enum_0));
      this.cboUseMissiles.DataSource = (object) stringList1;
      List<string> stringList2 = new List<string>();
      foreach (AuroraNPRSetupOption enum_0 in Enum.GetValues(typeof (AuroraNPRSetupOption)))
        stringList2.Add(GClass226.smethod_82((Enum) enum_0));
      this.cboUseShields.DataSource = (object) stringList2;
      List<string> stringList3 = new List<string>();
      foreach (AuroraNPRSetupOption enum_0 in Enum.GetValues(typeof (AuroraNPRSetupOption)))
        stringList3.Add(GClass226.smethod_82((Enum) enum_0));
      this.cboUseCarriers.DataSource = (object) stringList3;
      List<string> stringList4 = new List<string>();
      foreach (AuroraNPRSetupOption enum_0 in Enum.GetValues(typeof (AuroraNPRSetupOption)))
        stringList4.Add(GClass226.smethod_82((Enum) enum_0));
      this.cboHybrids.DataSource = (object) stringList4;
      List<string> stringList5 = new List<string>();
      foreach (AuroraNPRSetupOption enum_0 in Enum.GetValues(typeof (AuroraNPRSetupOption)))
        stringList5.Add(GClass226.smethod_82((Enum) enum_0));
      this.cboBalanced.DataSource = (object) stringList5;
      List<string> stringList6 = new List<string>();
      foreach (AuroraNPRPrimaryBeam enum_0 in Enum.GetValues(typeof (AuroraNPRPrimaryBeam)))
        stringList6.Add(GClass226.smethod_82((Enum) enum_0));
      this.cboPrimaryBeam.DataSource = (object) stringList6;
      List<string> stringList7 = new List<string>();
      foreach (AuroraNPRPDBeam enum_0 in Enum.GetValues(typeof (AuroraNPRPDBeam)))
        stringList7.Add(GClass226.smethod_82((Enum) enum_0));
      this.cboPDBeam.DataSource = (object) stringList7;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3759);
    }
  }
  ...
  private void cmdStation_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      this.pbStation.Image = Image.FromFile($"{Application.StartupPath}\\StationIcons\\{this.gclass143_0.string_6}");
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3751);
    }
  }
  ...
  private void cmdCreate_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      this.gclass143_0.gclass140_0 = (GClass140) this.cboClassTheme.SelectedValue;
      this.gclass143_0.gclass140_1 = (GClass140) this.cboSystemTheme.SelectedValue;
      this.gclass143_0.gclass140_2 = (GClass140) this.cboGroundTheme.SelectedValue;
      this.gclass143_0.gclass140_3 = (GClass140) this.cboMissileTheme.SelectedValue;
      this.gclass143_0.gclass60_0 = (GClass60) this.cboRankTheme.SelectedValue;
      this.gclass143_0.gclass58_0 = (GClass58) this.cboCommanderTheme.SelectedValue;
      ...
      GClass208 gclass208_1 = GClass226.smethod_4(this.txtGrowth.Text);
      if (gclass208_1.bool_0)
        this.gclass143_0.decimal_0 = gclass208_1.decimal_0;
      GClass208 gclass208_2 = GClass226.smethod_4(this.txtProduction.Text);
      if (gclass208_2.bool_0)
        this.gclass143_0.decimal_2 = gclass208_2.decimal_0;
      GClass208 gclass208_3 = GClass226.smethod_4(this.txtResearch.Text);
      if (gclass208_3.bool_0)
        this.gclass143_0.decimal_1 = gclass208_3.decimal_0;
      GClass208 gclass208_4 = GClass226.smethod_4(this.txtBP.Text);
      if (gclass208_4.bool_0)
        this.gclass143_0.decimal_4 = gclass208_4.decimal_0;
      GClass208 gclass208_5 = GClass226.smethod_4(this.txtTP.Text);
      if (gclass208_5.bool_0)
        this.gclass143_0.decimal_3 = gclass208_5.decimal_0;
      GClass208 gclass208_6 = GClass226.smethod_4(this.txtSSM.Text);
      if (gclass208_6.bool_0)
        this.gclass143_0.decimal_5 = gclass208_6.decimal_0;
      GClass208 gclass208_7 = GClass226.smethod_4(this.txtPopSizeMod.Text);
      if (gclass208_7.bool_0)
        this.gclass143_0.decimal_6 = gclass208_7.decimal_0;
      foreach (GClass99 checkedItem in this.lstTerrain.CheckedItems)
      ...
      this.gclass143_0.auroraNPRSetupOption_0 = (AuroraNPRSetupOption) Enum.Parse(typeof (AuroraNPRSetupOption), (string) this.cboUseShields.SelectedValue);
      this.gclass143_0.auroraNPRSetupOption_1 = (AuroraNPRSetupOption) Enum.Parse(typeof (AuroraNPRSetupOption), (string) this.cboUseMissiles.SelectedValue);
      this.gclass143_0.auroraNPRPrimaryBeam_0 = (AuroraNPRPrimaryBeam) Enum.Parse(typeof (AuroraNPRPrimaryBeam), (string) this.cboPrimaryBeam.SelectedValue);
      this.gclass143_0.auroraNPRPDBeam_0 = (AuroraNPRPDBeam) Enum.Parse(typeof (AuroraNPRPDBeam), (string) this.cboPDBeam.SelectedValue);
      this.gclass143_0.auroraNPRSetupOption_2 = (AuroraNPRSetupOption) Enum.Parse(typeof (AuroraNPRSetupOption), (string) this.cboUseCarriers.SelectedValue);
      this.gclass143_0.auroraNPRSetupOption_3 = (AuroraNPRSetupOption) Enum.Parse(typeof (AuroraNPRSetupOption), (string) this.cboHybrids.SelectedValue);
      this.gclass143_0.auroraNPRSetupOption_4 = (AuroraNPRSetupOption) Enum.Parse(typeof (AuroraNPRSetupOption), (string) this.cboBalanced.SelectedValue);
      this.Close();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3752);
    }
  }
  ...
  private void frmNPRSetup_Load(object sender, EventArgs e)
  {
    try
    {
      ...
      this.cboClassTheme.SelectedItem = (object) this.gclass143_0.gclass140_0;
      this.cboSystemTheme.SelectedItem = (object) this.gclass143_0.gclass140_1;
      this.cboGroundTheme.SelectedItem = (object) this.gclass143_0.gclass140_2;
      this.cboMissileTheme.SelectedItem = (object) this.gclass143_0.gclass140_3;
      this.cboCommanderTheme.SelectedItem = (object) this.gclass143_0.gclass58_0;
      this.cboRankTheme.SelectedItem = (object) this.gclass143_0.gclass60_0;
      this.txtDet.Text = GClass226.smethod_37(this.gclass143_0.int_5);
      this.txtDip.Text = GClass226.smethod_37(this.gclass143_0.int_1);
      this.txtExp.Text = GClass226.smethod_37(this.gclass143_0.int_4);
      this.txtMil.Text = GClass226.smethod_37(this.gclass143_0.int_3);
      this.txtTrade.Text = GClass226.smethod_37(this.gclass143_0.int_6);
      this.txtTrans.Text = GClass226.smethod_37(this.gclass143_0.int_2);
      this.txtXen.Text = GClass226.smethod_37(this.gclass143_0.int_0);
      this.txtGrowth.Text = GClass226.smethod_45(this.gclass143_0.decimal_0, 2);
      this.txtResearch.Text = GClass226.smethod_45(this.gclass143_0.decimal_1, 2);
      this.txtProduction.Text = GClass226.smethod_45(this.gclass143_0.decimal_2, 2);
      this.txtBP.Text = GClass226.smethod_45(this.gclass143_0.decimal_4, 2);
      this.txtTP.Text = GClass226.smethod_45(this.gclass143_0.decimal_3, 2);
      this.txtSSM.Text = GClass226.smethod_45(this.gclass143_0.decimal_5, 2);
      this.txtPopSizeMod.Text = GClass226.smethod_45(this.gclass143_0.decimal_6, 2);
  ...
  private void cmdSelectSystem_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      this.txtHomeSystem.Text = this.gclass143_0.gclass198_0.string_0;
      Cursor.Current = Cursors.Default;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3754);
    }
  }
  ...
  public void method_1(CheckedListBox checkedListBox_0, bool bool_0)
  {
    try
    {
      List<GClass99> list = this.gclass0_0.dictionary_73.Values.OrderBy<GClass99, double>((Func<GClass99, double>) (gclass99_0 => gclass99_0.double_2)).ThenBy<GClass99, double>((Func<GClass99, double>) (gclass99_0 => gclass99_0.double_3)).ThenBy<GClass99, double>((Func<GClass99, double>) (gclass99_0 => gclass99_0.double_0)).ThenBy<GClass99, AuroraTectonics>((Func<GClass99, AuroraTectonics>) (gclass99_0 => gclass99_0.auroraTectonics_0)).ThenBy<GClass99, double>((Func<GClass99, double>) (gclass99_0 => gclass99_0.double_4)).ToList<GClass99>();
      if (bool_0)
        list = list.Where<GClass99>((Func<GClass99, bool>) (gclass99_0 => gclass99_0.double_2 > -100.0 && gclass99_0.double_0 < 70.0)).ToList<GClass99>();
      checkedListBox_0.DataSource = (object) list;
  ...
  private void InitializeComponent()
  {
    ...
    this.flowLayoutPanel10.Controls.Add((Control) this.panel8);
    ...
    this.panel8.Controls.Add((Control) this.txtHomeSystem);
    ...
    this.txtHomeSystem.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.flowLayoutPanel1.Controls.Add((Control) this.cmdCreate);
    this.flowLayoutPanel1.Controls.Add((Control) this.cmdSpeciesImage);
    this.flowLayoutPanel1.Controls.Add((Control) this.cmdRaceFlag);
    this.flowLayoutPanel1.Controls.Add((Control) this.cmdHull);
    this.flowLayoutPanel1.Controls.Add((Control) this.cmdStation);
    this.flowLayoutPanel1.Controls.Add((Control) this.cmdSelectSystem);
    ...
    this.cmdSelectSystem.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdSelectSystem.Tag = (object) "1200";
    this.cmdSelectSystem.Text = "Home System";
    this.cmdSelectSystem.UseVisualStyleBackColor = false;
    this.cmdSelectSystem.Click += new EventHandler(this.cmdSelectSystem_Click);
    ...
    this.flowLayoutPanel7.Controls.Add((Control) this.panel5);
    this.flowLayoutPanel7.Controls.Add((Control) this.panel1);
    this.flowLayoutPanel7.Controls.Add((Control) this.panel3);
    ...
    this.flowLayoutPanel8.Controls.Add((Control) this.panel4);
    this.flowLayoutPanel8.Controls.Add((Control) this.panel2);
    this.flowLayoutPanel8.Controls.Add((Control) this.panel7);
    ...
    this.panel2.Controls.Add((Control) this.cboGroundTheme);
    ...
    this.cboGroundTheme.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.panel7.Controls.Add((Control) this.cboMissileTheme);
    ...
    this.cboMissileTheme.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstTerrain.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.flowLayoutPanel2.Controls.Add((Control) this.panel22);
    this.flowLayoutPanel2.Controls.Add((Control) this.panel23);
    ...
    this.panel9.Controls.Add((Control) this.cboUseShields);
    ...
    this.cboUseShields.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.panel10.Controls.Add((Control) this.cboPrimaryBeam);
    ...
    this.cboPrimaryBeam.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.panel12.Controls.Add((Control) this.cboUseMissiles);
    ...
    this.cboUseMissiles.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.panel11.Controls.Add((Control) this.cboPDBeam);
    ...
    this.cboPDBeam.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.panel21.Controls.Add((Control) this.cboUseCarriers);
    this.panel21.Controls.Add((Control) this.label17);
    ...
    this.cboUseCarriers.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.panel22.Controls.Add((Control) this.cboHybrids);
    ...
    this.cboHybrids.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.panel23.Controls.Add((Control) this.cboBalanced);
    this.panel23.Controls.Add((Control) this.label26);
    ...
    this.cboBalanced.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.flowLayoutPanel3.Controls.Add((Control) this.pbShip);
    ...
    this.flowLayoutPanel6.Controls.Add((Control) this.pbStation);
    ...
    this.flpModifiers.Controls.Add((Control) this.panel14);
    this.flpModifiers.Controls.Add((Control) this.panel28);
    this.flpModifiers.Controls.Add((Control) this.panel27);
    this.flpModifiers.Controls.Add((Control) this.panel26);
    this.flpModifiers.Controls.Add((Control) this.panel47);
    this.flpModifiers.Controls.Add((Control) this.panel19);
    this.flpModifiers.Controls.Add((Control) this.panel13);
    this.flpModifiers.Controls.Add((Control) this.panel17);
    this.flpModifiers.Controls.Add((Control) this.panel18);
    this.flpModifiers.Controls.Add((Control) this.panel20);
    ...
    this.panel14.Controls.Add((Control) this.txtPopSizeMod);
    ...
    this.txtPopSizeMod.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.panel47.Controls.Add((Control) this.txtBP);
    ...
    this.txtBP.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.panel19.Controls.Add((Control) this.label4);
    ...
    this.panel13.Controls.Add((Control) this.txtSSM);
    this.panel13.Controls.Add((Control) this.label9);
    ...
    this.txtSSM.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.panel17.Controls.Add((Control) this.txtBaseExplored);
    this.panel17.Controls.Add((Control) this.label14);
    ...
    this.txtBaseExplored.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.panel18.Controls.Add((Control) this.txtRandomExplored);
    this.panel18.Controls.Add((Control) this.label15);
    ...
    this.txtRandomExplored.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.panel20.Controls.Add((Control) this.txtMaxStartingSystems);
    this.panel20.Controls.Add((Control) this.label16);
    ...
    this.txtMaxStartingSystems.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.flowLayoutPanel9.Controls.Add((Control) this.panel42);
    this.flowLayoutPanel9.Controls.Add((Control) this.panel39);
    this.flowLayoutPanel9.Controls.Add((Control) this.panel36);
    this.flowLayoutPanel9.Controls.Add((Control) this.panel38);
    this.flowLayoutPanel9.Controls.Add((Control) this.panel37);
    this.flowLayoutPanel9.Controls.Add((Control) this.panel40);
    this.flowLayoutPanel9.Controls.Add((Control) this.panel41);
    ...
    this.Controls.Add((Control) this.flpModifiers);
    this.Controls.Add((Control) this.pbRace);
    this.Controls.Add((Control) this.flowLayoutPanel3);
    this.Controls.Add((Control) this.flowLayoutPanel6);
    this.Controls.Add((Control) this.pbFlag);
    this.Controls.Add((Control) this.flowLayoutPanel2);
    this.Controls.Add((Control) this.lstTerrain);
    this.Controls.Add((Control) this.flowLayoutPanel1);
    this.Controls.Add((Control) this.flowLayoutPanel10);
    ...
    this.Text = "NPR Setup";
    this.Load += new EventHandler(this.frmNPRSetup_Load);
