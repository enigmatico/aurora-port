...
public class Economics : Form
{
  ...
  private sealed class Class1078
  {
    ...
    {
      return gclass166_1.gclass146_0 == this.gclass166_0.gclass146_0 && gclass166_1.gclass161_0 == this.gclass166_0.gclass161_0;
    }
  ...
  private sealed class Class1079
  {
    ...
    {
      return gclass39_0.gclass101_0.gclass164_0 == this.gclass164_0;
    }

    internal bool method_4(GClass39 gclass39_0)
    {
      return gclass39_0.gclass101_0.gclass164_0 == this.gclass164_0;
    }
    ...
    internal bool method_6(GClass129 gclass129_0)
    {
      return gclass129_0.gclass164_0 == this.gclass164_0;
    }

    internal bool method_7(GClass230 gclass230_0)
    {
      return gclass230_0.gclass164_0 == this.gclass164_0;
    }

    internal bool method_8(GClass101 gclass101_0)
    {
      return gclass101_0.gclass164_0 == this.gclass164_0;
    }
  }
  #endregion
  ...
  public Economics(GClass0 gclass0_1, GEnum34 genum34_1, GClass146 gclass146_1)
  {
  ...
  private void Economics_Load(object sender, EventArgs e)
  {
    try
    {
      ...
      if (!this.gclass0_0.bool_8 && this.gclass21_0.int_32 <= 0)
      ...
      if (!this.gclass0_0.bool_8 && !(this.gclass21_0.decimal_25 > 0M))
  ...
  private void method_4()
  {
    try
    {
      ...
      foreach (AuroraProductionType enum_0 in Enum.GetValues(typeof (AuroraProductionType)))
        stringList.Add(GClass226.smethod_82((Enum) enum_0));
      this.cboConstructionType.DataSource = (object) stringList;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 529);
    }
  }
  ...
  public void method_10()
  {
    try
    {
      ...
      else if (this.gclass146_0.gclass21_0 != this.gclass21_0)
        this.gclass146_0 = this.gclass21_0.method_191();
      this.chkShowSystemBody.CheckState = GClass226.smethod_28(this.gclass21_0.bool_3);
      this.chkShowStars.CheckState = GClass226.smethod_28(this.gclass21_0.bool_2);
      this.chkHideCMC.CheckState = GClass226.smethod_28(this.gclass21_0.bool_4);
      this.chkByFunction.CheckState = GClass226.smethod_28(this.gclass21_0.bool_5);
      this.chkRoman.CheckState = this.gclass21_0.checkState_0;
      this.gclass21_0.method_298();
      this.gclass21_0.method_338();
      this.Text = $"Economics   {this.gclass0_0.method_586(true)}   Racial Wealth {GClass226.smethod_38(this.gclass21_0.decimal_0)}";
      this.gclass21_0.method_59(this.tvPopList, this.chkByFunction.CheckState, this.chkShowSystemBody.CheckState, this.chkShowStars.CheckState, this.chkHideCMC.CheckState, this.gclass146_0);
      this.gclass21_0.method_330(this.cboTransferRace);
      if (this.gclass21_0.int_32 > 0)
      {
        this.lblStartingTechPoints.Text = GClass226.smethod_37(this.gclass21_0.int_32);
      ...
      {
        this.cmdSMAddUnits.Visible = true;
        if (this.gclass21_0.decimal_25 > 0M)
        {
          this.pnlStartingBuildPoints.Visible = true;
          this.txtInstantBuild.Text = GClass226.smethod_38(this.gclass21_0.decimal_25);
        }
      }
      if (!this.bool_0)
  ...
  private void method_11()
  {
    ...
    toolTip.SetToolTip((Control) this.cmdSelectGovernor, "Select a currently unassigned governor for this colony");
  }
  ...
  private void tvPopList_AfterSelect(object sender, TreeViewEventArgs e)
  {
    try
    {
      if (e.Node.Tag is GClass202)
      {
        this.gclass202_0 = (GClass202) e.Node.Tag;
      }
      else
      {
        if (!(e.Node.Tag is GClass146))
          return;
        this.gclass146_0 = (GClass146) e.Node.Tag;
        this.method_12();
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 536);
    }
  }
  ...
  private void method_12()
  {
    try
    {
      ...
      this.gclass193_0 = (GClass193) null;
      this.gclass192_0 = (GClass192) null;
      Decimal decimal_90 = this.method_17();
      this.gclass146_0.method_155(this.lstvPopSummary, this.lstvPopSummary2, this.lstvPopSummary3, this.lblGovName, this.lblSecGovName, this.cboFighters, this.cboSpaceStations, this.cboParasites, this.cboFleet, this.cboAdminCommand, this.lblRefineries, this.lblMaintenance, this.lblGeneticModification, this.cmdRefinery, this.cmdMaintenance, this.cmdGMC, this.cboGas, this.chkAddGas, this.txtMaxAtm, this.lblMDDistance);
      this.gclass146_0.method_153(this.lstvGovernor, this.cboBonusOne, this.cboBonusTwo, this.cboBonusThree, this.rdoNo, this.rdoYes, this.rdoNone, this.txtImportance);
      ...
      this.gclass146_0.method_110(this.lstvIncome, this.lstvExpenditure, this.txtAnnualWealth, this.txtRacialPerCapita, this.txtPopPerCapita, this.txtTaxRate, decimal_90);
      this.gclass146_0.method_158(this.lstPI, this.cboConstructionType.Text, this.lblIndustry, this.cboConstructionType);
      this.gclass21_0.method_214(this.lstvTemplate, this.gclass146_0, CheckState.Unchecked, (GClass102) null, CheckState.Unchecked);
      this.gclass146_0.method_102(this.lstvResearchProjects, this.lblRFAvailable, this.rdoLabs.Checked, this.cboResearchFields, this.chkMatchOnly, this.rdoPopProjects.Checked);
      this.gclass146_0.method_58(this.lstvPopMissiles, this.lstvPopComponents);
      this.gclass0_0.bool_9 = true;
      this.gclass146_0.method_23(this.cboTargetSpecies);
      this.cboTargetSpecies.SelectedItem = (object) this.gclass146_0.gclass194_1;
      this.txtFuelWarning.Text = GClass226.smethod_37(this.gclass146_0.int_10);
      this.txtMSPWarning.Text = GClass226.smethod_37(this.gclass146_0.int_11);
      if (this.gclass146_0.int_12 == 1)
        this.rdoConstant.Checked = true;
      else
        this.rdoSingleWarning.Checked = true;
      this.gclass0_0.bool_9 = false;
      if (!this.gclass146_0.gclass1_0.bool_2)
      {
        ...
        this.gclass146_0.gclass1_0.method_70(this.lstvAtmosphere, this.gclass146_0, true);
        this.gclass146_0.gclass1_0.method_71(this.gclass21_0, this.gclass146_0.gclass194_0, CheckState.Unchecked, this.lblRetention, this.lblCCGravity, this.lblCCTemp, this.lblBreathable, this.lblMaxPressure, this.lblDangerous, this.lblWater, this.lblColonyCost, this.lblPerihelionCC, this.lblAphelionCC, 3);
        this.gclass146_0.gclass194_0.method_0(this.lblGravity, this.lblOxygen, this.lblTemperature, this.lblBreathe, this.lblPressure);
      }
      else
      {
      ...
      if (this.gclass146_0.gclass194_0.gclass194_0 == null)
      ...
      this.gclass146_0.method_165(this.flpPurchase, this.rdoPurchase, this.rdoTaxMinerals, this.lblCivilianMinerals, this.txtCivilianMinerals);
      this.gclass146_0.method_166(this.cboMassDriver);
      this.bool_1 = true;
      this.chkRestricted.CheckState = !this.gclass146_0.bool_8 ? CheckState.Unchecked : CheckState.Checked;
      this.chkAutoRefuel.CheckState = !this.gclass146_0.bool_9 ? CheckState.Unchecked : CheckState.Checked;
      this.bool_1 = false;
      GClass162 selectedValue = (GClass162) this.cboResearchFields.SelectedValue;
  ...
  public void method_13()
  {
    try
    {
      ...
      if (this.chkCurrentPopulation.CheckState == CheckState.Checked)
        ...
        this.gclass21_0.method_88(this.lstvMineralData, (GClass146) null, decimal_29);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3945);
    }
  }
  ...
  private void tvPopList_AfterExpand(object sender, TreeViewEventArgs e)
  {
    try
    {
      if (this.gclass0_0.bool_9 || e.Node.Tag is GClass202 || e.Node.Tag is GClass197 || e.Node.Tag is GClass146)
        return;
  ...
  private void cmdCreate_Click(object sender, EventArgs e)
  {
    try
    {
      GClass208 gclass208_1 = GClass226.smethod_4(this.txtItems.Text);
      GClass208 gclass208_2 = GClass226.smethod_4(this.txtPercentage.Text);
      if (!gclass208_1.bool_0 || !gclass208_2.bool_0)
        return;
      this.gclass146_0.method_143(gclass208_1.decimal_0, gclass208_2.decimal_0);
      this.gclass146_0.method_132(this.lstvConstruction);
      this.gclass146_0.method_119(this.lstvMining, this.lstvMines, this.lstvUsage);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 540);
    }
  }
  ...
  private void cmdModify_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        if (!gclass208_1.bool_0 || !gclass208_2.bool_0)
          return;
        this.gclass146_0.method_142(tag, gclass208_1.decimal_0, gclass208_2.decimal_0);
        this.gclass146_0.method_132(this.lstvConstruction);
        this.gclass146_0.method_119(this.lstvMining, this.lstvMines, this.lstvUsage);
      }
    }
  ...
  private void cboShipyardUpgrade_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass0_0.bool_9)
        return;
      this.method_15();
      this.gclass146_0.method_123(this.gclass193_0, this.cboShipyardUpgrade.Text, this.txtShipyardUpgradeCost, this.txtShipyardUpgradeDate, this.cboRetoolClass, this.lblCT, this.txtCT, this.lblSetSL, this.txtSetSL, true);
      this.timer_0.Enabled = true;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 548);
    }
  }
    ...
    try
    {
      ...
      else
      {
        ...
        if (this.gclass193_0 == null)
          return;
        this.gclass146_0.method_123(this.gclass193_0, this.cboShipyardUpgrade.Text, this.txtShipyardUpgradeCost, this.txtShipyardUpgradeDate, this.cboRetoolClass, this.lblCT, this.txtCT, this.lblSetSL, this.txtSetSL, false);
        this.method_31(this.gclass193_0.int_3);
        if (this.gclass193_0.gclass85_0 != null)
          this.cboFleet.SelectedItem = (object) this.gclass193_0.gclass85_0;
        if (this.gclass193_0.gclass83_0 != null)
          this.cboAdminCommand.SelectedItem = (object) this.gclass193_0.gclass83_0;
  ...
  private void cboRetoolClass_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        this.gclass193_0 = (GClass193) this.lstvShipyards.SelectedItems[0].Tag;
        this.gclass146_0.method_127(this.gclass193_0, (GClass22) this.cboRetoolClass.SelectedItem, this.txtShipyardUpgradeCost, this.txtShipyardUpgradeDate);
        this.timer_0.Enabled = true;
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 550);
    }
  }
  ...
  private void cmdSetActivity_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        int num1 = (int) MessageBox.Show(this.gclass193_0.string_0 + " is ship-based and cannot be modified", "Action Not Possible");
      }
      else
      {
        if (this.gclass193_0.auroraShipyardUpgradeType_0 != AuroraShipyardUpgradeType.None && MessageBox.Show(this.gclass193_0.string_0 + " already has a task in progress. Are you sure you want to cancel the existing shipyard activity?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
          return;
        int int_25 = 0;
        ...
        if (text != null)
        {
          switch (text.Length)
          {
            ...
            case 24:
              ...
              {
                this.gclass193_0.decimal_0 = (Decimal) Convert.ToInt32(this.txtCT.Text);
        ...
        else
        {
          ...
          if (auroraShipyardUpgradeType_0 != AuroraShipyardUpgradeType.None && auroraShipyardUpgradeType_0 == AuroraShipyardUpgradeType.Continual && (Decimal) int_25 < this.gclass193_0.decimal_0)
          {
            int num3 = (int) MessageBox.Show("Target Capacity is less than current capacity");
          }
          else
          {
            this.gclass146_0.method_124(this.gclass193_0, auroraShipyardUpgradeType_0, selectedItem, int_25);
  ...
  private void cmdDeleteActivity_Click(object sender, EventArgs e)
  {
    try
    {
      if (!this.method_15() || this.gclass193_0.auroraShipyardUpgradeType_0 != AuroraShipyardUpgradeType.None && MessageBox.Show($" Are you sure you want to cancel the shipyard activity for {this.gclass193_0.string_0}?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
        return;
      GClass193 gclass1930 = this.gclass193_0;
      ...
      switch (this.cboShipyardTaskType.Text)
      {
        case "Construction":
          ...
          if (this.cboEligible.Items.Count <= 0)
            break;
          this.gclass193_0.method_5(this.cboShipyardTaskType, this.cboEligible, this.cboRefitFrom, this.cboShip, this.cboFleet, this.cboAdminCommand, this.lstvSYMinerals, this.txtShipName, this.lblBuildCost, this.lblShipyardConstructionDate, this.lstvRefitDetails);
          break;
        case "Repair":
        case "Scrap":
          ...
          else
          {
            ...
            if (this.cboEligible.Items.Count > 0)
              this.gclass146_0.method_129((GClass22) this.cboEligible.SelectedItem, this.cboShip, false, false, true);
          }
  ...
  private void cmdAddShipyardTask_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      GClass193 gclass1930 = this.gclass193_0;
      if (!this.gclass193_0.method_4(this.chkUseComponents.CheckState, this.chkAdminCommand.CheckState, this.cboRefitFrom, this.cboEligible, this.cboShip))
        return;
      this.gclass146_0.method_120(this.lstvShipyardTasks, this.rdoTaskSize);
      this.gclass146_0.method_119(this.lstvMining, this.lstvMines, this.lstvUsage);
      if (gclass1930 != null)
      {
        foreach (ListViewItem listViewItem in this.lstvShipyards.Items)
        {
          ...
          if (class1077.gclass193_0 == gclass1930)
          {
            ...
            List<GClass192> list = this.gclass0_0.dictionary_32.Values.Where<GClass192>(new Func<GClass192, bool>(class1077.method_0)).ToList<GClass192>();
            // ISSUE: reference to a compiler-generated field
  ...
  private void cmdDefaultFleet_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      if (this.cmdDefaultFleet.Text == "Default Fleet")
        this.gclass193_0.gclass85_0 = (GClass85) this.cboFleet.SelectedItem;
      else
        this.gclass193_0.gclass83_0 = (GClass83) this.cboAdminCommand.SelectedItem;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 561);
    }
  }
  ...
  private void cmdDeleteTask_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        if (MessageBox.Show($" Are you sure you want to delete the shipyard task: {this.gclass192_0.method_0()}?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
          return;
  ...
  private void cmdAddGUTask_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        GClass102 tag = (GClass102) this.lstvTemplate.SelectedItems[0].Tag;
        if ((int) this.gclass146_0.method_62(AuroraProductionCategory.GroundTraining) <= 0)
        {
          int num3 = (int) MessageBox.Show("You cannot build ground forces without a ground forces construction complex");
        }
        else if (this.gclass146_0.decimal_29 + this.gclass146_0.decimal_4 <= 0M)
        {
          int num4 = (int) MessageBox.Show("You cannot build ground forces without workers to man the ground forces construction complex");
        }
        else
        {
          GClass208 gclass208 = GClass226.smethod_4(this.txtGUPercentage.Text);
          if (100M - this.gclass146_0.dictionary_3.Values.Sum<GClass106>((Func<GClass106, Decimal>) (gclass106_0 => gclass106_0.decimal_2)) < gclass208.decimal_0)
            this.gclass146_0.list_0.Add(new GClass107(this.gclass0_0)
            {
              ...
              gclass102_0 = tag,
              decimal_0 = gclass208.decimal_0,
              auroraGroundFormationFieldPosition_0 = AuroraGroundFormationFieldPosition.FrontlineDefence
            });
          else
            this.gclass146_0.method_122(tag, this.txtUnitName.Text, gclass208.decimal_0, AuroraGroundFormationFieldPosition.FrontlineDefence, 0, 0);
          ++tag.int_1;
          this.gclass146_0.method_121(this.lstvGroundUnitTraining);
          this.gclass146_0.method_119(this.lstvMining, this.lstvMines, this.lstvUsage);
          string str1 = GClass226.smethod_80(tag.int_1 + 1);
          if (this.chkRoman.CheckState == CheckState.Checked)
          {
            string str2 = GClass226.smethod_79(tag.int_1 + 1);
      ...
      else
      {
        if (this.lstvGroundUnitTraining.SelectedItems[0].Tag is GClass106)
        {
          ...
          if (MessageBox.Show("Are you sure you wish to delete the selected task?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
            return;
          --tag.gclass102_0.int_1;
          this.gclass146_0.dictionary_3.Remove(tag.int_0);
        }
        else if (this.lstvGroundUnitTraining.SelectedItems[0].Tag is GClass107)
        {
          GClass107 tag = (GClass107) this.lstvGroundUnitTraining.SelectedItems[0].Tag;
          if (MessageBox.Show("Are you sure you wish to delete the selected queued task?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
            return;
          --tag.gclass102_0.int_1;
  ...
  private void cmdMaintenance_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        if (this.gclass146_0.bool_4)
        {
          this.gclass146_0.bool_4 = false;
          this.cmdMaintenance.Text = "Start";
        }
        else
        {
          this.gclass146_0.bool_4 = true;
    ...
    {
      GClass226.smethod_74(ex, 573);
    }
  }

  private void rdoOneMonth_CheckedChanged(object sender, EventArgs e)
  {
    this.gclass146_0.method_110(this.lstvIncome, this.lstvExpenditure, this.txtAnnualWealth, this.txtRacialPerCapita, this.txtPopPerCapita, this.txtTaxRate, this.method_17());
  }
  ...
  private Decimal method_17()
  {
    ...
    if (this.rdoOneMonth.Checked)
      num = GClass226.decimal_31;
    if (this.rdoThreeMonths.Checked)
      num = GClass226.decimal_32;
    if (this.rdoSixMonths.Checked)
      num = GClass226.decimal_33;
    if (this.rdoOneYear.Checked)
      num = GClass226.decimal_29;
    return num;
  }
  ...
  private void cmdRemoveQueue_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        if (MessageBox.Show("Are you sure you wish to cancel the selected queued research project?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes || !(this.lstvResearchProjects.SelectedItems[0].Tag is GClass166))
          return;
    ...
    try
    {
      ...
      else
      {
        if (this.lstvTechnology.SelectedItems.Count == 0 || this.lstvTechnology.SelectedItems[0].Tag == null)
          return;
        GClass164 tag = (GClass164) this.lstvTechnology.SelectedItems[0].Tag;
      ...
      else
      {
        ...
        if (this.lstvResearchProjects.SelectedItems[0].Tag is GClass161)
        {
          ...
          else
          {
            ...
            if ((Decimal) tag.int_0 >= tag.gclass55_0.method_5(GEnum121.const_23))
        ...
        else
        {
          ...
          // ISSUE: reference to a compiler-generated method
          int num2 = this.gclass21_0.list_5.Where<GClass166>(new Func<GClass166, bool>(class1078.method_0)).Max<GClass166>((Func<GClass166, int>) (gclass166_0 => gclass166_0.int_0));
          // ISSUE: reference to a compiler-generated method
          int num3 = this.gclass21_0.list_5.Where<GClass166>(new Func<GClass166, bool>(class1078.method_1)).Min<GClass166>((Func<GClass166, int>) (gclass166_0 => gclass166_0.int_0));
          // ISSUE: reference to a compiler-generated field
  ...
  private void cmdDeleteProject_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        {
          if (MessageBox.Show("Are you sure you wish to cancel the selected research project and any queued projects for this scientist?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes || !(this.lstvResearchProjects.SelectedItems[0].Tag is GClass161))
            return;
  ...
  private void cmdCreateResearch_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        else if (!(this.lstvTechnology.SelectedItems[0].Tag is GClass164))
        {
          int num6 = (int) MessageBox.Show("Please select a technology to research");
        }
        else
        {
          GClass164 tag1 = (GClass164) this.lstvTechnology.SelectedItems[0].Tag;
          ...
          {
            int num8 = (int) MessageBox.Show($"Too many facilities selected. There are only {this.gclass146_0.int_16.ToString()} facilities available at this population");
          }
          else
          {
  ...
  private void cmdInstant_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        GClass164 tag = (GClass164) this.lstvTechnology.SelectedItems[0].Tag;
        this.gclass21_0.method_282(tag, (GClass55) null, this.gclass146_0, (GClass21) null, false, false);
        if (this.gclass21_0.int_32 > 0)
          this.gclass21_0.int_32 -= tag.int_4;
        this.method_22();
  ...
  private void cmdInstantRST_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        if (MessageBox.Show("Are you sure you want to give all designed but unresearched tech to this race?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
          return;
  ...
  private void cmdDeleteTech_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        // ISSUE: reference to a compiler-generated field
        class1079.gclass164_0 = (GClass164) this.lstvTechnology.SelectedItems[0].Tag;
        // ISSUE: reference to a compiler-generated method
        if (this.gclass0_0.dictionary_4.Values.SelectMany<GClass40, GClass130>((Func<GClass40, IEnumerable<GClass130>>) (gclass40_0 => (IEnumerable<GClass130>) gclass40_0.list_10)).Count<GClass130>(new Func<GClass130, bool>(class1079.method_0)) > 0)
        {
          int num3 = (int) MessageBox.Show("This technology cannot be deleted as there are missiles reliant on this technology in ship magazines");
        }
        else
        {
          // ISSUE: reference to a compiler-generated method
          if (this.gclass0_0.dictionary_3.Values.SelectMany<GClass22, GClass130>((Func<GClass22, IEnumerable<GClass130>>) (gclass22_0 => (IEnumerable<GClass130>) gclass22_0.list_0)).Count<GClass130>(new Func<GClass130, bool>(class1079.method_1)) > 0)
          {
            int num4 = (int) MessageBox.Show("This technology cannot be deleted as there are missiles reliant on this technology in class loadout templates");
          }
          else
          {
            // ISSUE: reference to a compiler-generated method
            if (this.gclass0_0.dictionary_22.Values.SelectMany<GClass146, GClass130>((Func<GClass146, IEnumerable<GClass130>>) (gclass146_0 => (IEnumerable<GClass130>) gclass146_0.list_1)).Count<GClass130>(new Func<GClass130, bool>(class1079.method_2)) > 0)
            {
              int num5 = (int) MessageBox.Show("This technology cannot be deleted as there are missiles reliant on this technology in population stockpiles");
            }
            else
            {
              // ISSUE: reference to a compiler-generated method
              if (this.gclass0_0.dictionary_71.Values.SelectMany<GClass103, GClass39>((Func<GClass103, IEnumerable<GClass39>>) (gclass103_0 => (IEnumerable<GClass39>) gclass103_0.list_0)).Count<GClass39>(new Func<GClass39, bool>(class1079.method_3)) > 0)
              {
                int num6 = (int) MessageBox.Show("This technology cannot be deleted as there are ground units reliant on this technology in current ground formations");
              }
              else
              {
                // ISSUE: reference to a compiler-generated method
                if (this.gclass0_0.dictionary_72.Values.SelectMany<GClass102, GClass39>((Func<GClass102, IEnumerable<GClass39>>) (gclass102_0 => (IEnumerable<GClass39>) gclass102_0.list_0)).Count<GClass39>(new Func<GClass39, bool>(class1079.method_4)) > 0)
                {
                  int num7 = (int) MessageBox.Show("This technology cannot be deleted as there are ground units reliant on this technology in current ground formations templates");
                }
                else
                {
                  // ISSUE: reference to a compiler-generated method
                  if (this.gclass0_0.dictionary_3.Values.SelectMany<GClass22, GClass228>((Func<GClass22, IEnumerable<GClass228>>) (gclass22_0 => (IEnumerable<GClass228>) gclass22_0.dictionary_0.Values)).Count<GClass228>(new Func<GClass228, bool>(class1079.method_5)) > 0)
                  {
                    int num8 = (int) MessageBox.Show("This technology cannot be deleted as there are ship components in current class designs that are reliant on this technology");
                  }
                  else
                  {
                    // ISSUE: reference to a compiler-generated field
                    if (MessageBox.Show($"Are you sure you want to delete {class1079.gclass164_0.Name}?  Any associated ship components, ground unit designs and missile designs will also be deleted.", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
                      return;
                    // ISSUE: reference to a compiler-generated method
                    foreach (GClass129 gclass129 in this.gclass0_0.dictionary_5.Values.Where<GClass129>(new Func<GClass129, bool>(class1079.method_6)).ToList<GClass129>())
                      this.gclass0_0.dictionary_5.Remove(gclass129.int_0);
                    // ISSUE: reference to a compiler-generated method
                    foreach (GClass230 gclass230 in this.gclass0_0.dictionary_54.Values.Where<GClass230>(new Func<GClass230, bool>(class1079.method_7)).ToList<GClass230>())
                      this.gclass0_0.dictionary_54.Remove(gclass230.int_0);
                    // ISSUE: reference to a compiler-generated method
                    foreach (GClass101 gclass101 in this.gclass0_0.dictionary_70.Values.Where<GClass101>(new Func<GClass101, bool>(class1079.method_8)).ToList<GClass101>())
                      this.gclass0_0.dictionary_70.Remove(gclass101.int_0);
                    // ISSUE: reference to a compiler-generated field
  ...
  private void cmdSMAddUnits_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        {
          GClass102 tag = (GClass102) this.lstvTemplate.SelectedItems[0].Tag;
          string string_10 = $"{GClass226.smethod_80(tag.int_1 + 1)} {tag.Name}";
          if (this.chkRoman.CheckState == CheckState.Checked)
          {
            string str = GClass226.smethod_79(tag.int_1 + 1);
            string_10 = $"{tag.Name} {str}";
          }
          ++tag.int_1;
          this.gclass21_0.method_158(string_10, tag.string_1, tag, this.gclass146_0, (GClass40) null, this.gclass146_0.gclass194_0, (GClass103) null, 0, AuroraGroundFormationFieldPosition.FrontlineDefence);
          if (this.gclass21_0.decimal_25 > 0M)
            this.gclass21_0.decimal_25 -= (Decimal) (int) tag.method_3(this.gclass146_0);
        }
        this.txtInstantBuild.Text = GClass226.smethod_38(this.gclass21_0.decimal_25);
      }
    }
  ...
  private void cmdRenameType_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        int num3 = (int) new MessageEntry(this.gclass0_0).ShowDialog();
        if (!(this.gclass0_0.string_4 != tag.string_1) || this.gclass0_0.bool_21)
          return;
        tag.string_1 = this.gclass0_0.string_4;
        this.lstvTemplate.SelectedItems[0].SubItems[0].Text = tag.string_1;
        this.lstvTemplate.SelectedItems[0].SubItems[1].Text = tag.Name;
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 597);
    }
  }
  ...
  private void cmdRenamePop_Click(object sender, EventArgs e)
  {
    ...
    {
      GClass226.smethod_74(ex, 598);
    }
  }

  public void method_23(GClass146 gclass146_1)
  {
    try
    {
      foreach (TreeNode node in this.tvPopList.Nodes)
      {
        if (!(node.Tag is GClass146) || gclass146_1 != (GClass146) node.Tag)
        {
    ...
    {
      GClass226.smethod_74(ex, 599);
    }
  }

  private bool method_24(TreeNode treeNode_0, GClass146 gclass146_1)
  {
    try
    {
  ...
  private void cmdDeletePopulation_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass146_0 == null || MessageBox.Show($" Are you sure you want to delete {this.gclass146_0.PopName}?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes || this.gclass146_0.decimal_30 > 0M && MessageBox.Show($" Are you really sure you want to delete {this.gclass146_0.PopName}?  This will remove any installations, shipyards, ground units, research projects, sectors and naval admin commands and will unset all movement orders for fleets heading for that population.", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
        return;
    ...
    try
    {
      ...
      else
      {
        ...
        foreach (global::Events events in Application.OpenForms.OfType<global::Events>())
          events.method_0();
        if (this.gclass146_0.gclass21_0.chkEvents != CheckState.Checked)
          return;
  ...
  private void cmdDisassemble_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        int num3 = (int) MessageBox.Show("Components can only be disassembled at a population with at least one operating Research Facility");
      }
      else
      {
    ...
    try
    {
      ...
      else
      {
        ...
        if (this.gclass0_0.bool_21)
          return;
        GClass208 gclass208 = GClass226.smethod_4(this.gclass0_0.string_4);
        if (!gclass208.bool_0)
          return;
        GClass148 gclass148_1 = this.gclass146_0.dictionary_5.Values.FirstOrDefault<GClass148>((Func<GClass148, bool>) (gclass148_0 => gclass148_0.gclass157_0 == (GClass157) this.cboDemand.SelectedValue));
        if (gclass148_1 != null)
        {
          gclass148_1.decimal_0 += gclass208.decimal_0;
        }
        else
        {
          GClass148 gclass148_2 = new GClass148();
          gclass148_2.decimal_0 = gclass208.decimal_0;
          gclass148_2.gclass157_0 = (GClass157) this.cboDemand.SelectedValue;
          gclass148_2.bool_0 = false;
          gclass148_2.gclass146_0 = this.gclass146_0;
          this.gclass146_0.dictionary_5.Add(gclass148_2.gclass157_0.auroraInstallationType_0, gclass148_2);
        }
        this.gclass146_0.method_163(this.lstvDemand, false);
      }
    }
  ...
  private void cmdEditSupply_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        if (!gclass208.bool_0)
          return;
        tag.decimal_0 = gclass208.decimal_0;
        this.gclass146_0.method_163(this.lstvSupply, true);
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 607);
    }
  }
  ...
  private void cmdSupply_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        if (!gclass208.bool_0)
          return;
        GClass148 gclass148_1 = this.gclass146_0.dictionary_5.Values.FirstOrDefault<GClass148>((Func<GClass148, bool>) (gclass148_0 => gclass148_0.gclass157_0 == (GClass157) this.cboSupply.SelectedValue));
        if (gclass148_1 != null)
        {
          gclass148_1.decimal_0 += gclass208.decimal_0;
        }
        else
        {
          GClass148 gclass148_2 = new GClass148();
          gclass148_2.decimal_0 = gclass208.decimal_0;
          gclass148_2.gclass157_0 = (GClass157) this.cboSupply.SelectedValue;
  ...
  private void cmdDeleteDemand_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        GClass148 tag = (GClass148) this.lstvDemand.SelectedItems[0].Tag;
        if (MessageBox.Show($" Are you sure you want to delete the demand request for {tag.gclass157_0.Name}?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
          return;
        this.gclass146_0.dictionary_5.Remove(tag.gclass157_0.auroraInstallationType_0);
        this.gclass146_0.method_163(this.lstvDemand, false);
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 610);
    }
  }
  ...
  private void cmdDeleteSupply_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        GClass148 tag = (GClass148) this.lstvSupply.SelectedItems[0].Tag;
        if (MessageBox.Show($" Are you sure you want to delete the supply request for {tag.gclass157_0.Name}?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
          return;
        this.gclass146_0.dictionary_5.Remove(tag.gclass157_0.auroraInstallationType_0);
        this.gclass146_0.method_163(this.lstvSupply, true);
      }
  ...
  private void cmdSMAddInstallation_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        GClass158 gclass158 = this.gclass146_0.dictionary_0.Values.FirstOrDefault<GClass158>((Func<GClass158, bool>) (gclass158_0 => gclass158_0.gclass157_0 == (GClass157) this.cboSMInstallations.SelectedValue));
        if (gclass158 != null)
        {
        ...
        {
          GClass157 selectedValue = (GClass157) this.cboSMInstallations.SelectedValue;
          if (selectedValue != null)
            this.gclass146_0.method_65(selectedValue.auroraInstallationType_0, decimal_90);
          this.gclass146_0.method_162(this.lstvInstallations);
        }
      }
    }
  ...
  private void cmdSMEditInstallation_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        if (this.gclass0_0.bool_21)
          return;
        tag.decimal_0 = (Decimal) Convert.ToInt32(this.gclass0_0.string_4);
        this.gclass146_0.method_162(this.lstvInstallations);
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 613);
    }
  }
  ...
  private void cmdSMDeleteInstallation_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        GClass158 tag = (GClass158) this.lstvInstallations.SelectedItems[0].Tag;
        if (MessageBox.Show($" Are you sure you want to delete {tag.gclass157_0.Name}?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
          return;
        this.gclass146_0.dictionary_0.Remove(tag.gclass157_0.auroraInstallationType_0);
        this.gclass146_0.method_162(this.lstvInstallations);
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 614);
    }
  }
  ...
  private void cmdDeleteSY_Click(object sender, EventArgs e)
  {
    try
    {
      if (!this.method_15() || MessageBox.Show($" Are you sure you want to delete {this.gclass193_0.string_0}?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
        return;
  ...
  private void lstvScientists_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      if (tag == null)
        return;
      Decimal num = tag.method_5(GEnum121.const_23);
  ...
  private void cboFleet_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass0_0.bool_9 || this.lstvShipyards.SelectedItems.Count == 0 || this.cboFleet.SelectedItem == null)
        return;
      this.gclass193_0 = (GClass193) this.lstvShipyards.SelectedItems[0].Tag;
      this.gclass193_0.gclass85_1 = (GClass85) this.cboFleet.SelectedItem;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 618);
    }
  }
  ...
  private void rdoStable_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      if (this.gclass146_0 == null)
      {
        ...
        this.gclass146_0.genum19_0 = GEnum19.const_0;
      ...
      else
      {
        if (!this.rdoStable.Checked)
          return;
        this.gclass146_0.genum19_0 = GEnum19.const_2;
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 619);
    }
  }
    ...
    try
    {
      ...
      else
      {
        if (this.rdoPurchase.Checked)
          this.gclass146_0.bool_1 = true;
        else if (this.rdoTaxMinerals.Checked)
          this.gclass146_0.bool_1 = false;
        this.gclass0_0.bool_9 = true;
        this.gclass146_0.method_165(this.flpPurchase, this.rdoPurchase, this.rdoTaxMinerals, this.lblCivilianMinerals, this.txtCivilianMinerals);
        this.gclass0_0.bool_9 = false;
      }
  ...
  private void cboMassDriver_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        this.gclass146_0.gclass146_0 = !this.gclass0_0.dictionary_22.ContainsKey((int) selectedItem.decimal_0) ? (GClass146) null : this.gclass0_0.dictionary_22[(int) selectedItem.decimal_0];
        this.gclass146_0.method_156(this.lblMDDistance);
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 621);
    }
  }
  ...
  private void chkAddGas_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        this.gclass146_0.genum31_0 = this.chkAddGas.CheckState != CheckState.Checked ? GEnum31.const_0 : GEnum31.const_1;
        this.gclass146_0.gclass223_0 = (GClass223) this.cboGas.SelectedItem;
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 622);
    }
  }
    ...
    try
    {
      ...
      else
      {
        ...
        if (selectedItem == null || selectedItem.Name == "None")
          return;
        GClass208 gclass208 = GClass226.smethod_4(this.txtMaxAtm.Text);
        if (!gclass208.bool_0)
          return;
        if (gclass208.decimal_0 < 0M)
        {
          this.txtMaxAtm.Text = "0";
          gclass208.decimal_0 = 0M;
        }
        this.gclass146_0.gclass1_0.method_9(selectedItem, (double) gclass208.decimal_0, this.gclass146_0);
        this.method_12();
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 624);
    }
  }
  ...
  private void txtMaxAtm_TextChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        this.gclass146_0.double_0 = (double) gclass208.decimal_0;
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3289);
    }
  }
  ...
  private void cmdHydroExt_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        this.gclass146_0.gclass1_0.double_19 = Convert.ToDouble(this.txtHydroExt.Text);
        int num2 = (int) this.gclass146_0.gclass1_0.method_33(true, false);
        this.gclass146_0.gclass1_0.method_32();
        this.method_12();
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 626);
    }
  }
  ...
  private void cmdEditPopAmount_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        this.gclass0_0.string_4 = Math.Round(this.gclass146_0.decimal_4, 2).ToString();
        int num2 = (int) new MessageEntry(this.gclass0_0).ShowDialog();
        if (this.gclass0_0.bool_21)
          return;
        GClass208 gclass208 = GClass226.smethod_4(this.gclass0_0.string_4);
  ...
  private void cmdAddSY_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        {
          source.Add(auroraShipyardType, GClass226.smethod_82((Enum) auroraShipyardType));
          this.gclass0_0.list_32.Add(GClass226.smethod_82((Enum) auroraShipyardType));
        }
        int num2 = (int) new UserSelection(this.gclass0_0).ShowDialog();
        if (this.gclass0_0.bool_21)
          return;
        this.gclass146_0.method_150(source.FirstOrDefault<KeyValuePair<AuroraShipyardType, string>>((Func<KeyValuePair<AuroraShipyardType, string>, bool>) (keyValuePair_0 => keyValuePair_0.Value == this.gclass0_0.string_4)).Key);
        this.method_12();
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 628);
    }
  }
  ...
  private void lstvMining_DoubleClick(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        {
          Decimal num3 = this.gclass146_0.gclass123_2.method_14(tag);
          this.gclass0_0.string_3 = $"Enter New {GClass226.smethod_82((Enum) tag)} Reserve Amount";
        ...
        else
        {
          if (!this.gclass0_0.bool_8)
            return;
          Decimal num4 = this.gclass146_0.gclass123_0.method_14(tag);
          this.gclass0_0.string_3 = $"Enter New {GClass226.smethod_82((Enum) tag)} Stockpile Amount";
        ...
        if (!gclass208.bool_0)
          return;
        Decimal decimal0 = gclass208.decimal_0;
        if (this.chkReserve.CheckState == CheckState.Checked)
          this.gclass146_0.gclass123_2.method_15(tag, decimal0);
        else
          this.gclass146_0.gclass123_0.method_15(tag, decimal0);
        this.gclass146_0.method_119(this.lstvMining, this.lstvMines, this.lstvUsage);
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 630);
    }
  }
  ...
  private void cmdPopAsText_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        this.gclass21_0.method_226((GClass40) null, false);
        int num3 = (int) new PopulationText(this.gclass146_0, (TreeView) null, this.gclass0_0).ShowDialog();
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 632);
    }
  }
  ...
  private void cmdAllPopAsText_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        int num3 = (int) new PopulationText((GClass146) null, this.tvPopList, this.gclass0_0).ShowDialog();
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 633);
    }
  }
  ...
  private void chkShowStars_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass0_0.bool_9)
        return;
      this.gclass0_0.bool_9 = true;
      this.gclass21_0.method_59(this.tvPopList, this.chkByFunction.CheckState, this.chkShowSystemBody.CheckState, this.chkShowStars.CheckState, this.chkHideCMC.CheckState, (GClass146) null);
      this.gclass21_0.bool_3 = GClass226.smethod_27(this.chkShowSystemBody.CheckState);
      this.gclass21_0.bool_2 = GClass226.smethod_27(this.chkShowStars.CheckState);
      this.gclass21_0.bool_4 = GClass226.smethod_27(this.chkHideCMC.CheckState);
      this.gclass21_0.bool_5 = GClass226.smethod_27(this.chkByFunction.CheckState);
      this.gclass0_0.bool_9 = false;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 634);
    }
  }
  ...
  private void cmdToggleEmpty_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        this.gclass146_0.bool_7 = !this.gclass146_0.bool_7;
        this.method_12();
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 637);
    }
  }
  ...
  private void chkRestricted_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        if (MessageBox.Show($" Are you sure you want to restrict {this.gclass146_0.PopName} to military traffic? Any civilian freighters scheduled to visit this colony will abandon their cargo and seek new trade runs. Colony ships will be diverted", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
        {
          checkBox.CheckState = CheckState.Unchecked;
          return;
        }
        this.gclass146_0.bool_8 = true;
        this.gclass21_0.method_98(this.gclass146_0);
      }
      else
        this.gclass146_0.bool_8 = false;
      this.Refresh();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 638);
    }
  }
  ...
  private void cmdRenameAcademy_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      this.gclass0_0.string_4 = this.gclass146_0.string_1;
      int num = (int) new MessageEntry(this.gclass0_0).ShowDialog();
      if (!(this.gclass0_0.string_4 != this.gclass146_0.string_1) || this.gclass0_0.bool_21)
        return;
      this.gclass146_0.string_1 = this.gclass0_0.string_4;
      this.method_12();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 639);
    }
  }
  ...
  private void cmdIndependence_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass146_0 == null || MessageBox.Show($" Are you sure you want to grant independence to {this.gclass146_0.PopName}?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes || this.gclass146_0.decimal_4 > 0M && MessageBox.Show($" Are you really sure you want to grant independence to {this.gclass146_0.PopName}?  This will transfer all population assets to the new race, including any installations, shipyards and ground units and will unset all movement orders for fleets heading for that population.", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
        return;
      GClass21 gclass21 = this.gclass21_0.method_94(this.gclass146_0);
      this.gclass0_0.bool_9 = true;
      this.gclass0_0.method_577(this.cboRaces);
      this.gclass0_0.bool_9 = false;
      this.cboRaces.SelectedItem = (object) gclass21;
      this.gclass21_0 = gclass21;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 640);
    }
  }
  ...
  private void rdoTaskDate_CheckedChanged(object sender, EventArgs e)
  {
    ...
    {
      GClass226.smethod_74(ex, 643);
    }
  }

  private void cmdAddOG_Click(object sender, EventArgs e)
  {
    foreach (GClass21 gclass21 in this.gclass0_0.dictionary_36.Values.Where<GClass21>((Func<GClass21, bool>) (gclass21_0 => gclass21_0.bool_0)).ToList<GClass21>())
    {
      // ISSUE: object of a compiler-generated type is created
      // ISSUE: variable of a compiler-generated type
      ...
      // ISSUE: reference to a compiler-generated method
      List<GClass85> list1 = this.gclass0_0.dictionary_1.Values.Where<GClass85>(new Func<GClass85, bool>(class1074.method_0)).ToList<GClass85>();
      // ISSUE: reference to a compiler-generated method
      List<GClass146> list2 = this.gclass0_0.dictionary_22.Values.Where<GClass146>(new Func<GClass146, bool>(class1074.method_1)).ToList<GClass146>();
      foreach (GClass146 gclass146 in list2)
        gclass146.gclass6_0.method_7();
      // ISSUE: reference to a compiler-generated field
      class1074.gclass21_0.gclass2_0.method_23(list2, list1);
      // ISSUE: reference to a compiler-generated method
      this.gclass0_0.dictionary_22.Values.Where<GClass146>(new Func<GClass146, bool>(class1074.method_2)).ToList<GClass146>();
    }
  }
  ...
  private void txtItems_Leave(object sender, EventArgs e)
  {
    try
    {
      GClass208 gclass208 = GClass226.smethod_4(this.txtItems.Text);
  ...
  private void txtPercentage_Leave(object sender, EventArgs e)
  {
    try
    {
      GClass208 gclass208 = GClass226.smethod_4(this.txtPercentage.Text);
      if (!gclass208.bool_0)
        return;
      if (gclass208.decimal_0 <= 0M)
      {
  ...
  private void txtHydroExt_Leave(object sender, EventArgs e)
  {
    try
    {
      GClass208 gclass208 = GClass226.smethod_4(this.txtHydroExt.Text);
      if (gclass208.bool_0 && !(gclass208.decimal_0 <= 0M))
        return;
  ...
  private void txtAssignFacilities_Leave(object sender, EventArgs e)
  {
    try
    {
      ...
      if (tag == null)
        return;
      Decimal num = tag.method_5(GEnum121.const_23);
      if (!((Decimal) Convert.ToInt32(this.txtAssignFacilities.Text) > num))
        return;
      this.txtAssignFacilities.Text = num.ToString();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 625);
    }
  }
  ...
  private void cboFighters_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      if (this.gclass146_0 == null)
      {
        ...
        this.gclass146_0.gclass85_0 = (GClass85) this.cboFighters.SelectedItem;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3233);
    }
  }
  ...
  private void cboSpaceStations_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      if (this.gclass146_0 == null)
      {
        ...
        this.gclass146_0.gclass85_1 = (GClass85) this.cboSpaceStations.SelectedItem;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3234);
    }
  }
      ...
      else
      {
        ...
        if (class1075.gclass107_0.int_0 == 1)
        {
          ...
          if (this.gclass146_0.dictionary_3.Count > 0)
            num4 -= this.gclass146_0.dictionary_3.Values.Sum<GClass106>((Func<GClass106, Decimal>) (gclass106_0 => gclass106_0.decimal_2));
          // ISSUE: reference to a compiler-generated field
          if (num4 >= class1075.gclass107_0.decimal_0)
          {
            ...
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            this.gclass146_0.method_122(class1075.gclass107_0.gclass102_0, class1075.gclass107_0.string_0, class1075.gclass107_0.decimal_0, AuroraGroundFormationFieldPosition.FrontlineDefence, class1075.gclass107_0.int_2, class1075.gclass107_0.int_1);
            // ISSUE: reference to a compiler-generated field
          ...
          {
            int num5 = (int) MessageBox.Show("There is insufficient available capacity to move this project to the top of the queue", "Change Not Possible");
            return;
          }
        }
        else
        {
          // ISSUE: reference to a compiler-generated method
          GClass107 gclass107 = this.gclass146_0.list_0.FirstOrDefault<GClass107>(new Func<GClass107, bool>(class1075.method_0));
          if (gclass107 == null)
            return;
          // ISSUE: reference to a compiler-generated field
  ...
  private void cmdDownQueueGround_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        // ISSUE: reference to a compiler-generated method
        GClass107 gclass107 = this.gclass146_0.list_0.FirstOrDefault<GClass107>(new Func<GClass107, bool>(class1076.method_0));
        if (gclass107 == null)
          return;
        // ISSUE: reference to a compiler-generated field
  ...
  private void cmdCapital_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        if (MessageBox.Show($"Are you sure you want to change your capital to {this.gclass146_0.PopName}?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
          return;
        GClass146 gclass146 = this.gclass0_0.dictionary_22.Values.FirstOrDefault<GClass146>((Func<GClass146, bool>) (gclass146_1 => gclass146_1.bool_0 = gclass146_1.gclass21_0 == this.gclass146_0.gclass21_0));
        if (gclass146 != null)
          gclass146.bool_0 = false;
        this.gclass146_0.bool_0 = true;
      }
    }
    catch (Exception ex)
    {
  ...
  private void cboBonusOne_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      else if (this.gclass146_0 == null)
      {
        ...
        this.gclass146_0.genum121_0 = ((GClass50) this.cboBonusOne.SelectedItem).genum121_0;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3316);
    }
  }
  ...
  private void cboBonusTwo_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      else if (this.gclass146_0 == null)
      {
        ...
        this.gclass146_0.genum121_1 = ((GClass50) this.cboBonusTwo.SelectedItem).genum121_0;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3317);
    }
  }
  ...
  private void cboBonusThree_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      else if (this.gclass146_0 == null)
      {
        ...
        this.gclass146_0.genum121_2 = ((GClass50) this.cboBonusThree.SelectedItem).genum121_0;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3318);
    }
  }
  ...
  private void txtImportance_TextChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        this.gclass146_0.int_0 = Convert.ToInt32(this.txtImportance.Text);
        if (this.gclass146_0.int_0 >= 1)
          return;
        this.gclass146_0.int_0 = 1;
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3319);
    }
  }
  ...
  private void chkAutoRefuel_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      if (((CheckBox) sender).CheckState == CheckState.Checked)
        this.gclass146_0.bool_9 = true;
      else
        this.gclass146_0.bool_9 = false;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3510);
    }
  }
  ...
  private void cmdEditWealth_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        this.gclass0_0.string_4 = Math.Round(this.gclass21_0.decimal_0, 0).ToString();
        int num2 = (int) new MessageEntry(this.gclass0_0).ShowDialog();
        if (this.gclass0_0.bool_21)
          return;
        GClass208 gclass208 = GClass226.smethod_4(this.gclass0_0.string_4);
        if (!gclass208.bool_0)
          return;
        this.gclass21_0.decimal_0 = gclass208.decimal_0;
        this.Text = $"Economics   {this.gclass0_0.method_586(true)}   Racial Wealth {GClass226.smethod_38(this.gclass21_0.decimal_0)}";
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3563);
    }
  }
  ...
  private void cmdTransferItem_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else if (this.gclass0_0.dictionary_22.Values.Count<GClass146>((Func<GClass146, bool>) (gclass146_1 => gclass146_1.gclass1_0 == this.gclass146_0.gclass1_0 && gclass146_1 != this.gclass146_0)) == 0)
      {
  ...
  private void cboParasites_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      if (this.gclass146_0 == null)
      {
        ...
        this.gclass146_0.gclass85_2 = (GClass85) this.cboParasites.SelectedItem;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3582);
    }
  }
  ...
  private void cmdGMC_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        if (this.gclass146_0.bool_3)
        {
          this.gclass146_0.bool_3 = false;
          this.cmdGMC.Text = "Start";
        }
        else
        {
          this.gclass146_0.bool_3 = true;
  ...
  private void cboTargetSpecies_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      if (this.gclass146_0 == null)
      {
        ...
        this.gclass146_0.gclass194_1 = (GClass194) this.cboTargetSpecies.SelectedItem;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3690);
    }
  }
  ...
  private void cmdEditTax_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        this.gclass0_0.string_4 = Math.Round(this.gclass21_0.decimal_5 * 100M, 2).ToString();
        int num2 = (int) new MessageEntry(this.gclass0_0).ShowDialog();
        if (this.gclass0_0.bool_21)
          return;
        GClass208 gclass208 = GClass226.smethod_4(this.gclass0_0.string_4);
        if (!gclass208.bool_0)
          return;
        this.gclass21_0.decimal_5 = gclass208.decimal_0 / 100M;
        if (this.gclass21_0.decimal_5 < 0M)
          this.gclass21_0.decimal_5 = 0M;
        this.txtTaxRate.Text = GClass226.smethod_42(this.gclass21_0.decimal_5 * 100M, 2) + "%";
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3774);
    }
  }
  ...
  private void txtFuelWarning_TextChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        GClass208 gclass208 = GClass226.smethod_4(this.txtFuelWarning.Text);
        this.gclass146_0.int_10 = !gclass208.bool_0 ? 0 : (int) gclass208.decimal_0;
        if (this.gclass146_0.int_10 >= 0)
          return;
        this.gclass146_0.int_10 = 0;
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3783);
    }
  }
  ...
  private void txtMSPWarning_TextChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        GClass208 gclass208 = GClass226.smethod_4(this.txtMSPWarning.Text);
        this.gclass146_0.int_11 = !gclass208.bool_0 ? 0 : (int) gclass208.decimal_0;
        if (this.gclass146_0.int_11 >= 0)
          return;
        this.gclass146_0.int_11 = 0;
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3784);
    }
  }
  ...
  private void rdoSingleWarning_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        this.gclass146_0.int_12 = 1;
      }
      else
      {
        if (!this.rdoSingleWarning.Checked)
          return;
        this.gclass146_0.int_12 = 0;
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3785);
    }
  }
  ...
  private void cboAdminCommand_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass0_0.bool_9 || this.lstvShipyards.SelectedItems.Count == 0 || this.cboAdminCommand.SelectedItem == null)
        return;
      this.gclass193_0 = (GClass193) this.lstvShipyards.SelectedItems[0].Tag;
      this.gclass193_0.gclass83_1 = (GClass83) this.cboAdminCommand.SelectedItem;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3794);
    }
  }
  ...
  private void cmdTransferPopulation_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        GClass110 selectedItem = (GClass110) this.cboTransferRace.SelectedItem;
        if (selectedItem == null || MessageBox.Show($"Are you sure you want to transfer this population to the {selectedItem.AlienRaceName}?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
          return;
        this.gclass146_0.method_114(selectedItem.gclass21_0, GEnum27.const_0, false, false, false);
        this.method_10();
        this.cboRaces.Focus();
      }
    }
  ...
  private void lstvPopComponents_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        if (this.gclass146_0.gclass21_0.method_103(tag.gclass230_0))
        {
          this.cmdDisassemble.Visible = true;
          this.cmdDisassembleAll.Visible = true;
        }
        else if (this.gclass146_0.gclass21_0.method_104(tag.gclass230_0))
        {
        ...
        {
          if (!this.gclass146_0.gclass21_0.method_105(tag.gclass230_0))
            return;
          this.lstvPopComponents.Height = 662;
          this.lstvPopMissiles.Height = 662;
  ...
  private void cmdResearchComponent_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        {
          int num3 = (int) MessageBox.Show("Project created. Research the new project on the Research tab of the economics window");
          this.gclass146_0.method_58(this.lstvPopMissiles, this.lstvPopComponents);
        }
        else
        {
  ...
  private void lstvPOWOfficers_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        if (this.gclass21_0.method_325(((GClass180) this.lstvPOWOfficers.SelectedItems[0].Tag).gclass21_0.RaceID).auroraContactStatus_0 == AuroraContactStatus.Hostile)
      ...
      {
        if (this.gclass21_0.method_325(((GClass147) this.lstvPOWOfficers.SelectedItems[0].Tag).gclass21_0.RaceID).auroraContactStatus_0 == AuroraContactStatus.Hostile)
          this.cmdRelease.Text = "Execute";
        else
          this.cmdRelease.Text = "Release";
      }
      else
      {
        if (!(this.lstvPOWOfficers.SelectedItems[0].Tag is GClass55))
          return;
        if (this.gclass21_0.method_325(((GClass55) this.lstvPOWOfficers.SelectedItems[0].Tag).gclass21_0.RaceID).auroraContactStatus_0 == AuroraContactStatus.Hostile)
          this.cmdRelease.Text = "Execute";
        else
          this.cmdRelease.Text = "Release";
      }
    ...
    try
    {
      ...
      else
      {
        ...
        if (this.lstvPOWOfficers.SelectedItems[0].Tag is GClass180)
        {
          ...
          GClass110 gclass110 = this.gclass21_0.method_325(tag.gclass21_0.RaceID);
          if (gclass110.auroraContactStatus_0 == AuroraContactStatus.Hostile)
            str = "Execute";
          if (MessageBox.Show($"Are you sure you want to {str}{tag.int_0.ToString()} from the {gclass110.AlienRaceName}", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
            return;
          if (gclass110.auroraContactStatus_0 != AuroraContactStatus.Hostile)
            tag.gclass21_0.method_325(this.gclass21_0.RaceID).decimal_2 += (Decimal) tag.int_0 / 100M;
          tag.gclass40_0.list_1.Remove(tag);
        }
        else if (this.lstvPOWOfficers.SelectedItems[0].Tag is GClass147)
        {
          GClass147 tag = (GClass147) this.lstvPOWOfficers.SelectedItems[0].Tag;
          GClass110 gclass110_1 = this.gclass21_0.method_325(tag.gclass21_0.RaceID);
          if (gclass110_1.auroraContactStatus_0 == AuroraContactStatus.Hostile)
            str = "Execute";
          if (MessageBox.Show($"Are you sure you want to {str}{tag.int_0.ToString()} from the {gclass110_1.AlienRaceName}", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
            return;
          if (gclass110_1.auroraContactStatus_0 != AuroraContactStatus.Hostile)
          {
            GClass110 gclass110_2 = tag.gclass21_0.method_325(this.gclass21_0.RaceID);
            gclass110_2.decimal_2 = gclass110_2.decimal_2 + (Decimal) tag.int_1 / 400M + (Decimal) (tag.int_0 - tag.int_1) / 100M;
          }
        ...
        else
        {
          ...
          GClass110 gclass110_3 = this.gclass21_0.method_325(tag.gclass21_0.RaceID);
          if (gclass110_3.auroraContactStatus_0 == AuroraContactStatus.Hostile)
            str = "Execute";
          if (MessageBox.Show($"Are you sure you want to {str}{tag.method_36()} from the {gclass110_3.AlienRaceName}", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
            return;
          if (gclass110_3.auroraContactStatus_0 != AuroraContactStatus.Hostile)
          {
            GClass110 gclass110_4 = tag.gclass21_0.method_325(this.gclass21_0.RaceID);
            Decimal num3 = (Decimal) Math.Pow((double) (tag.method_0() + 1), 3.0);
            if (tag.bool_5)
              num3 /= 4M;
            gclass110_4.decimal_2 += num3;
            tag.bool_4 = false;
            tag.bool_5 = false;
            tag.gclass40_0 = (GClass40) null;
            tag.gclass146_0 = (GClass146) null;
          }
          else
  ...
  private void cmdScrapAll_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        if (MessageBox.Show($"Are you sure you want to scrap all components at {this.gclass146_0.PopName}, except for researched non-obsolete components or those that can be disassembled?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
          return;
        foreach (GClass73 gclass73 in this.gclass146_0.list_2)
        {
          ...
          else if (this.gclass146_0.gclass21_0.method_103(gclass73.gclass230_0))
            gclass73.bool_0 = false;
        }
        foreach (GClass73 gclass73_0 in this.gclass146_0.list_2.Where<GClass73>((Func<GClass73, bool>) (gclass73_0 => gclass73_0.bool_0)).ToList<GClass73>())
  ...
  private void cmdClearQueue_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        if (MessageBox.Show("Are you sure you want to remove all items in the ground construction queue for " + this.gclass146_0.PopName, "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
          return;
  ...
  private void cmdEditFuel_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        this.gclass0_0.string_4 = Math.Round(this.gclass146_0.decimal_3, 0).ToString();
        int num2 = (int) new MessageEntry(this.gclass0_0).ShowDialog();
        if (this.gclass0_0.bool_21)
          return;
        GClass208 gclass208 = GClass226.smethod_4(this.gclass0_0.string_4);
        ...
        if (gclass208.decimal_0 < 0M)
          gclass208.decimal_0 = 0M;
        this.gclass146_0.decimal_3 = gclass208.decimal_0;
        this.method_12();
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3887);
    }
  }
  ...
  private void cmdEditMSP_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        this.gclass0_0.string_4 = Math.Round(this.gclass146_0.decimal_0, 0).ToString();
        int num2 = (int) new MessageEntry(this.gclass0_0).ShowDialog();
        if (this.gclass0_0.bool_21)
          return;
        GClass208 gclass208 = GClass226.smethod_4(this.gclass0_0.string_4);
        ...
        if (gclass208.decimal_0 < 0M)
          gclass208.decimal_0 = 0M;
        this.gclass146_0.decimal_0 = gclass208.decimal_0;
        this.method_12();
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3888);
    }
  }
  ...
  private void InitializeComponent()
  {
    ...
    this.tvPopList.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tabPopulation.Controls.Add((Control) this.tabGovernor);
    this.tabPopulation.Controls.Add((Control) this.tabPOW);
    this.tabPopulation.Controls.Add((Control) this.tabEmpireMining);
    this.tabPopulation.Controls.Add((Control) this.tabMineralData);
    this.tabPopulation.Controls.Add((Control) this.tabAncientConstruct);
    ...
    this.flowLayoutPanel15.Controls.Add((Control) this.cmdCapital);
    ...
    this.cmdRenamePop.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdRenameAcademy.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdCapital.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdCapital.Tag = (object) "1200";
    this.cmdCapital.Text = "Set Capital";
    this.cmdCapital.UseVisualStyleBackColor = false;
    this.cmdCapital.Click += new EventHandler(this.cmdCapital_Click);
    this.cmdPopAsText.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdPopAsText.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdPopAsText.Click += new EventHandler(this.cmdPopAsText_Click);
    this.cmdAllPopAsText.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdAllPopAsText.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdToggleEmpty.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdIndependence.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdEditPopAmount.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDeletePopulation.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDeleteEmpty.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdAddOG.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvPopSummary.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvPopSummary2.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvPopSummary3.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tabIndustry.Controls.Add((Control) this.pnlGeneticModification);
    ...
    this.pnlGeneticModification.Controls.Add((Control) this.label46);
    this.pnlGeneticModification.Controls.Add((Control) this.cboTargetSpecies);
    this.pnlGeneticModification.Controls.Add((Control) this.lblGeneticModification);
    this.pnlGeneticModification.Controls.Add((Control) this.cmdGMC);
    ...
    this.cboTargetSpecies.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboTargetSpecies.SelectedIndexChanged += new EventHandler(this.cboTargetSpecies_SelectedIndexChanged);
    ...
    this.cmdGMC.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdGMC.Tag = (object) "1200";
    this.cmdGMC.Text = "Start";
    this.cmdGMC.UseVisualStyleBackColor = false;
    this.cmdGMC.Click += new EventHandler(this.cmdGMC_Click);
    ...
    this.panel6.Controls.Add((Control) this.cmdEditMSP);
    ...
    this.cmdEditMSP.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdEditMSP.Tag = (object) "1200";
    this.cmdEditMSP.Text = "SM: Edit MSP";
    this.cmdEditMSP.UseVisualStyleBackColor = false;
    this.cmdEditMSP.Visible = false;
    this.cmdEditMSP.Click += new EventHandler(this.cmdEditMSP_Click);
    ...
    this.cmdMaintenance.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.panel5.Controls.Add((Control) this.cmdEditFuel);
    ...
    this.cmdEditFuel.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdEditFuel.Tag = (object) "1200";
    this.cmdEditFuel.Text = "SM: Edit Fuel";
    this.cmdEditFuel.UseVisualStyleBackColor = false;
    this.cmdEditFuel.Visible = false;
    this.cmdEditFuel.Click += new EventHandler(this.cmdEditFuel_Click);
    ...
    this.cmdRefinery.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.panel4.Controls.Add((Control) this.flowLayoutPanel19);
    ...
    this.flowLayoutPanel19.Controls.Add((Control) this.label3);
    this.flowLayoutPanel19.Controls.Add((Control) this.txtItems);
    this.flowLayoutPanel19.Controls.Add((Control) this.label5);
    this.flowLayoutPanel19.Controls.Add((Control) this.txtPercentage);
    this.flowLayoutPanel19.Controls.Add((Control) this.label2);
    this.flowLayoutPanel19.Controls.Add((Control) this.cboFighters);
    this.flowLayoutPanel19.Controls.Add((Control) this.label19);
    this.flowLayoutPanel19.Controls.Add((Control) this.cboSpaceStations);
    ...
    this.txtItems.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtItems.TextChanged += new EventHandler(this.txtItems_TextChanged);
    ...
    this.txtPercentage.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.cboFighters.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboFighters.SelectedIndexChanged += new EventHandler(this.cboFighters_SelectedIndexChanged);
    ...
    this.cboSpaceStations.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboSpaceStations.SelectedIndexChanged += new EventHandler(this.cboSpaceStations_SelectedIndexChanged);
    this.cmdDownQueue.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdDownQueue.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdUpQueue.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdModify.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdPause.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvConstruction.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstPI.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboConstructionType.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tabMining.Controls.Add((Control) this.flowLayoutPanel26);
    ...
    this.flowLayoutPanel26.Controls.Add((Control) this.label17);
    this.flowLayoutPanel26.Controls.Add((Control) this.cboMassDriver);
    this.flowLayoutPanel26.Controls.Add((Control) this.label43);
    this.flowLayoutPanel26.Controls.Add((Control) this.lblMDDistance);
    ...
    this.cboMassDriver.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.rdoTaxMinerals.CheckedChanged += new EventHandler(this.rdoStable_CheckedChanged);
    ...
    this.txtCivilianMinerals.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.lstvUsage.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvMines.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvMining.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvRefitDetails.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvSYMinerals.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.panel3.Controls.Add((Control) this.chkAdminCommand);
    this.panel3.Controls.Add((Control) this.lblAdminCommand);
    this.panel3.Controls.Add((Control) this.cboAdminCommand);
    this.panel3.Controls.Add((Control) this.label44);
    this.panel3.Controls.Add((Control) this.cboParasites);
    ...
    this.chkAdminCommand.CheckedChanged += new EventHandler(this.chkAdminCommand_CheckedChanged);
    ...
    this.cboAdminCommand.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboAdminCommand.Visible = false;
    this.cboAdminCommand.SelectedIndexChanged += new EventHandler(this.cboAdminCommand_SelectedIndexChanged);
    ...
    this.cboParasites.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboParasites.SelectedIndexChanged += new EventHandler(this.cboParasites_SelectedIndexChanged);
    ...
    this.txtShipName.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.lblBuildCost.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.lblShipyardConstructionDate.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.cmdRefitDetails.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboFleet.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboShip.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboEligible.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboRefitFrom.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboShipyardTaskType.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDefaultFleet.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdAddShipyardTask.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdAddSY.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboShipyardUpgrade.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboRetoolClass.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.txtCT.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtCT.TextChanged += new EventHandler(this.txtCT_TextChanged);
    ...
    this.txtSetSL.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtShipyardUpgradeCost.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtShipyardUpgradeDate.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.cmdDeleteSY.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdAutoRename.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdRenameShipyard.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdPauseActivity.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDeleteActivity.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdSetActivity.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvShipyards.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.rdoTaskSize.CheckedChanged += new EventHandler(this.rdoTaskDate_CheckedChanged);
    ...
    this.rdoTaskDate.CheckedChanged += new EventHandler(this.rdoTaskDate_CheckedChanged);
    this.cmdSelectNameTaskShip.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdSelectNameTaskShip.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdRenameTaskShip.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdPauseTask.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDeleteTask.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvShipyardTasks.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.flowLayoutPanel3.Controls.Add((Control) this.rdoPopProjects);
    this.flowLayoutPanel3.Controls.Add((Control) this.rdoAllProjects);
    ...
    this.rdoPopProjects.CheckedChanged += new EventHandler(this.rdoAllProjects_CheckedChanged);
    ...
    this.rdoAllProjects.CheckedChanged += new EventHandler(this.rdoAllProjects_CheckedChanged);
    this.flpRPSort.BorderStyle = BorderStyle.FixedSingle;
    this.flpRPSort.Controls.Add((Control) this.rdoLabs);
    this.flpRPSort.Controls.Add((Control) this.rdoDate);
    ...
    this.rdoLabs.CheckedChanged += new EventHandler(this.rdoDate_CheckedChanged);
    ...
    this.rdoDate.CheckedChanged += new EventHandler(this.rdoDate_CheckedChanged);
    ...
    this.txtAssignFacilities.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtAssignFacilities.Leave += new EventHandler(this.txtAssignFacilities_Leave);
    ...
    this.lblRFAvailable.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.lblStartingTechPoints.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.lblStartingTechPoints.Visible = false;
    this.flpCreateProjectsBar.Controls.Add((Control) this.cmdCreateResearch);
    this.flpCreateProjectsBar.Controls.Add((Control) this.cmdAddToQueue);
    this.flpCreateProjectsBar.Controls.Add((Control) this.cmdInstant);
    this.flpCreateProjectsBar.Controls.Add((Control) this.cmdInstantRST);
    this.flpCreateProjectsBar.Controls.Add((Control) this.cmdRemoveTech);
    this.flpCreateProjectsBar.Controls.Add((Control) this.cmdDeleteTech);
    ...
    this.cmdCreateResearch.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdAddToQueue.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdInstantRST.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdRemoveTech.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDeleteTech.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.flowLayoutPanel2.Controls.Add((Control) this.cmdAssignNew);
    ...
    this.cmdDeleteProject.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdPauseResearch.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdAssignNew.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdAssignNew.Tag = (object) "1200";
    this.cmdAssignNew.Text = "Assign New";
    this.cmdAssignNew.UseVisualStyleBackColor = false;
    this.cmdAssignNew.Visible = false;
    this.cmdAssignNew.Click += new EventHandler(this.cmdAssignNew_Click);
    this.cmdAddLab.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdAddLab.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdRemoveLab.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdUpResearchQueue.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDownResearchQueue.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdRemoveQueue.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.txtTechDescription.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.flowLayoutPanel20.Controls.Add((Control) this.rdoNormalView);
    this.flowLayoutPanel20.Controls.Add((Control) this.rdoProjectOnlyView);
    ...
    this.rdoNormalView.CheckedChanged += new EventHandler(this.rdoNormalView_CheckedChanged);
    ...
    this.lstvScientists.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboResearchFields.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvTechnology.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvResearchProjects.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tabGUTraining.Controls.Add((Control) this.cmdClearQueue);
    this.tabGUTraining.Controls.Add((Control) this.label45);
    this.tabGUTraining.Controls.Add((Control) this.txtGUPercentage);
    this.tabGUTraining.Controls.Add((Control) this.chkRoman);
    this.tabGUTraining.Controls.Add((Control) this.pnlStartingBuildPoints);
    this.tabGUTraining.Controls.Add((Control) this.cmdDownQueueGround);
    this.tabGUTraining.Controls.Add((Control) this.cmdUpQueueGround);
    ...
    this.cmdClearQueue.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdClearQueue.Tag = (object) "1200";
    this.cmdClearQueue.Text = "Clear Queue";
    this.cmdClearQueue.UseVisualStyleBackColor = false;
    this.cmdClearQueue.Click += new EventHandler(this.cmdClearQueue_Click);
    ...
    this.txtGUPercentage.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.chkRoman.CheckedChanged += new EventHandler(this.chkRoman_CheckedChanged);
    ...
    this.txtInstantBuild.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.cmdDownQueueGround.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDownQueueGround.Tag = (object) "1200";
    this.cmdDownQueueGround.Text = "Down Queue";
    this.cmdDownQueueGround.UseVisualStyleBackColor = false;
    this.cmdDownQueueGround.Click += new EventHandler(this.cmdDownQueueGround_Click);
    this.cmdUpQueueGround.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdUpQueueGround.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdUpQueueGround.Tag = (object) "1200";
    this.cmdUpQueueGround.Text = "Up Queue";
    this.cmdUpQueueGround.UseVisualStyleBackColor = false;
    this.cmdUpQueueGround.Click += new EventHandler(this.cmdUpQueueGround_Click);
    ...
    this.cmdSMAddUnits.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdRenameType.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdRenameGUTask.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvGroundUnitTraining.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvGroundUnitTraining.SelectedIndexChanged += new EventHandler(this.lstvGroundUnitTraining_SelectedIndexChanged);
    ...
    this.cmdDeleteGUTask.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdAddGUTask.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tabWealth.Controls.Add((Control) this.cmdEditTax);
    this.tabWealth.Controls.Add((Control) this.label49);
    this.tabWealth.Controls.Add((Control) this.txtTaxRate);
    this.tabWealth.Controls.Add((Control) this.lstvWealthHistory);
    this.tabWealth.Controls.Add((Control) this.cmdEditWealth);
    ...
    this.cmdEditTax.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdEditTax.Tag = (object) "1200";
    this.cmdEditTax.Text = "Edit Tax Rate";
    this.cmdEditTax.UseVisualStyleBackColor = false;
    this.cmdEditTax.Click += new EventHandler(this.cmdEditTax_Click);
    ...
    this.txtTaxRate.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtTaxRate.TextChanged += new EventHandler(this.txtTaxRate_TextChanged);
    ...
    this.lstvWealthHistory.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdEditWealth.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdEditWealth.Tag = (object) "1200";
    this.cmdEditWealth.Text = "SM: Edit Wealth";
    this.cmdEditWealth.UseVisualStyleBackColor = false;
    this.cmdEditWealth.Click += new EventHandler(this.cmdEditWealth_Click);
    ...
    this.txtPopPerCapita.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtRacialPerCapita.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtAnnualWealth.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.lstvExpenditure.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvIncome.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvTradeGoods.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvTradeGoods.SelectedIndexChanged += new EventHandler(this.lstvTradeGoods_SelectedIndexChanged);
    ...
    this.tabCivilian.Controls.Add((Control) this.flowLayoutPanel25);
    ...
    this.flowLayoutPanel25.Controls.Add((Control) this.cmdSMAddInstallation);
    this.flowLayoutPanel25.Controls.Add((Control) this.cmdSMEditInstallation);
    this.flowLayoutPanel25.Controls.Add((Control) this.cmdSMDeleteInstallation);
    this.flowLayoutPanel25.Controls.Add((Control) this.cmdScrapInstallation);
    this.flowLayoutPanel25.Controls.Add((Control) this.cmdDemand);
    this.flowLayoutPanel25.Controls.Add((Control) this.cmdEditDemand);
    this.flowLayoutPanel25.Controls.Add((Control) this.cmdDeleteDemand);
    this.flowLayoutPanel25.Controls.Add((Control) this.cmdSupply);
    this.flowLayoutPanel25.Controls.Add((Control) this.cmdEditSupply);
    this.flowLayoutPanel25.Controls.Add((Control) this.cmdDeleteSupply);
    ...
    this.cmdSMAddInstallation.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdSMEditInstallation.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdSMDeleteInstallation.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdScrapInstallation.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdScrapInstallation.Tag = (object) "1200";
    this.cmdScrapInstallation.Text = "Scrap Installation";
    this.cmdScrapInstallation.UseVisualStyleBackColor = false;
    this.cmdScrapInstallation.Click += new EventHandler(this.cmdScrapInstallation_Click);
    this.cmdDemand.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdDemand.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdEditDemand.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDeleteDemand.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdSupply.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdEditSupply.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDeleteSupply.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.flowLayoutPanel10.Controls.Add((Control) this.chkAutoRefuel);
    ...
    this.rdoDestination.CheckedChanged += new EventHandler(this.rdoStable_CheckedChanged);
    ...
    this.rdoSource.CheckedChanged += new EventHandler(this.rdoStable_CheckedChanged);
    ...
    this.rdoStable.CheckedChanged += new EventHandler(this.rdoStable_CheckedChanged);
    ...
    this.chkAutoRefuel.CheckedChanged += new EventHandler(this.chkAutoRefuel_CheckedChanged);
    ...
    this.cboSMInstallations.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvInstallations.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboSupply.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboSupply.SelectedIndexChanged += new EventHandler(this.cboSupply_SelectedIndexChanged);
    ...
    this.lstvSupply.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboDemand.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboDemand.SelectedIndexChanged += new EventHandler(this.cboDemand_SelectedIndexChanged);
    ...
    this.lstvDemand.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tabStockpile.Controls.Add((Control) this.txtComponentDetail);
    this.tabStockpile.Controls.Add((Control) this.flowLayoutPanel11);
    this.tabStockpile.Controls.Add((Control) this.chkCreationDate);
    this.tabStockpile.Controls.Add((Control) this.tvPopGU);
    ...
    this.txtComponentDetail.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.txtComponentDetail.Visible = false;
    this.flowLayoutPanel11.Controls.Add((Control) this.cmdDisassemble);
    this.flowLayoutPanel11.Controls.Add((Control) this.cmdDisassembleAll);
    this.flowLayoutPanel11.Controls.Add((Control) this.cmdScrapComponent);
    this.flowLayoutPanel11.Controls.Add((Control) this.cmdConvert);
    this.flowLayoutPanel11.Controls.Add((Control) this.cmdResearchComponent);
    this.flowLayoutPanel11.Controls.Add((Control) this.cmdTransferItem);
    this.flowLayoutPanel11.Controls.Add((Control) this.cmdResearchMissile);
    this.flowLayoutPanel11.Controls.Add((Control) this.cmdTransferOrdnance);
    this.flowLayoutPanel11.Controls.Add((Control) this.cmdScrapMissile);
    this.flowLayoutPanel11.Controls.Add((Control) this.cmdScrapAll);
    ...
    this.cmdDisassemble.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDisassembleAll.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdScrapComponent.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdConvert.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdConvert.Tag = (object) "1200";
    this.cmdConvert.Text = "Modify for Use";
    this.cmdConvert.UseVisualStyleBackColor = false;
    this.cmdConvert.Visible = false;
    this.cmdConvert.Click += new EventHandler(this.cmdConvert_Click);
    this.cmdResearchComponent.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdResearchComponent.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdResearchComponent.Tag = (object) "1200";
    this.cmdResearchComponent.Text = "Research Comp";
    this.cmdResearchComponent.UseVisualStyleBackColor = false;
    this.cmdResearchComponent.Visible = false;
    this.cmdResearchComponent.Click += new EventHandler(this.cmdResearchComponent_Click);
    this.cmdTransferItem.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdTransferItem.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdTransferItem.Tag = (object) "1200";
    this.cmdTransferItem.Text = "Transfer Comp";
    this.cmdTransferItem.UseVisualStyleBackColor = false;
    this.cmdTransferItem.Visible = false;
    this.cmdTransferItem.Click += new EventHandler(this.cmdTransferItem_Click);
    this.cmdResearchMissile.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdResearchMissile.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdResearchMissile.Tag = (object) "1200";
    this.cmdResearchMissile.Text = "Research Missile";
    this.cmdResearchMissile.UseVisualStyleBackColor = false;
    this.cmdResearchMissile.Visible = false;
    this.cmdResearchMissile.Click += new EventHandler(this.cmdResearchMissile_Click);
    this.cmdTransferOrdnance.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdTransferOrdnance.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdTransferOrdnance.Tag = (object) "1200";
    this.cmdTransferOrdnance.Text = "Transfer Missile";
    this.cmdTransferOrdnance.UseVisualStyleBackColor = false;
    this.cmdTransferOrdnance.Visible = false;
    this.cmdTransferOrdnance.Click += new EventHandler(this.cmdTransferOrdnance_Click);
    this.cmdScrapMissile.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdScrapMissile.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tvPopGU.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvPopComponents.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvPopComponents.SelectedIndexChanged += new EventHandler(this.lstvPopComponents_SelectedIndexChanged);
    ...
    this.lstvPopMissiles.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvPopMissiles.SelectedIndexChanged += new EventHandler(this.lstvPopMissiles_SelectedIndexChanged);
    ...
    this.tabEnvironment.Controls.Add((Control) this.flpSpecies);
    this.tabEnvironment.Controls.Add((Control) this.flpColonyCostFactors);
    this.tabEnvironment.Controls.Add((Control) this.lstvAtmosphere);
    this.tabEnvironment.Controls.Add((Control) this.flpAddGas);
    ...
    this.flpSpecies.Controls.Add((Control) this.flowLayoutPanel21);
    this.flpSpecies.Controls.Add((Control) this.flowLayoutPanel22);
    ...
    this.flowLayoutPanel21.Controls.Add((Control) this.label34);
    this.flowLayoutPanel21.Controls.Add((Control) this.label20);
    this.flowLayoutPanel21.Controls.Add((Control) this.label21);
    this.flowLayoutPanel21.Controls.Add((Control) this.label22);
    this.flowLayoutPanel21.Controls.Add((Control) this.label31);
    this.flowLayoutPanel21.Controls.Add((Control) this.label32);
    this.flowLayoutPanel21.Controls.Add((Control) this.label33);
    ...
    this.flowLayoutPanel21.Paint += new PaintEventHandler(this.flowLayoutPanel21_Paint);
    ...
    this.flowLayoutPanel22.Controls.Add((Control) this.label35);
    this.flowLayoutPanel22.Controls.Add((Control) this.lblBreathe);
    this.flowLayoutPanel22.Controls.Add((Control) this.lblOxygen);
    this.flowLayoutPanel22.Controls.Add((Control) this.label23);
    this.flowLayoutPanel22.Controls.Add((Control) this.lblGravity);
    this.flowLayoutPanel22.Controls.Add((Control) this.lblTemperature);
    this.flowLayoutPanel22.Controls.Add((Control) this.lblPressure);
    ...
    this.label35.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.lblBreathe.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.lblOxygen.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.label23.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.lblGravity.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.lblTemperature.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.lblPressure.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.flpColonyCostFactors.Controls.Add((Control) this.flowLayoutPanel13);
    this.flpColonyCostFactors.Controls.Add((Control) this.flowLayoutPanel14);
    ...
    this.flowLayoutPanel13.Controls.Add((Control) this.label41);
    this.flowLayoutPanel13.Controls.Add((Control) this.label42);
    ...
    this.flowLayoutPanel14.Controls.Add((Control) this.lblPerihelionCC);
    this.flowLayoutPanel14.Controls.Add((Control) this.lblAphelionCC);
    ...
    this.lblColonyCost.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.lblCCTemp.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.lblBreathable.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.lblDangerous.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.lblMaxPressure.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.lblWater.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.lblCCGravity.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.lblRetention.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.lblPerihelionCC.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.lblAphelionCC.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.flpAddGas.Controls.Add((Control) this.cboGas);
    this.flpAddGas.Controls.Add((Control) this.chkAddGas);
    this.flpAddGas.Controls.Add((Control) this.label10);
    this.flpAddGas.Controls.Add((Control) this.txtMaxAtm);
    this.flpAddGas.Controls.Add((Control) this.cmdSMSetAtm);
    this.flpAddGas.Controls.Add((Control) this.lblHydroExt);
    this.flpAddGas.Controls.Add((Control) this.txtHydroExt);
    this.flpAddGas.Controls.Add((Control) this.cmdHydroExt);
    ...
    this.txtMaxAtm.Leave += new EventHandler(this.txtMaxAtm_Leave);
    this.cmdSMSetAtm.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdSMSetAtm.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.txtHydroExt.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtHydroExt.TextChanged += new EventHandler(this.txtHydroExt_TextChanged);
    this.txtHydroExt.Leave += new EventHandler(this.txtHydroExt_Leave);
    this.cmdHydroExt.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdHydroExt.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tabGovernor.Controls.Add((Control) this.panel2);
    this.tabGovernor.Controls.Add((Control) this.flowLayoutPanel12);
    this.tabGovernor.Controls.Add((Control) this.flowLayoutPanel24);
    this.tabGovernor.Controls.Add((Control) this.flowLayoutPanel23);
    this.tabGovernor.Controls.Add((Control) this.lstvGovernor);
    ...
    this.tabGovernor.Click += new EventHandler(this.tabGovernor_Click);
    this.panel2.BorderStyle = BorderStyle.FixedSingle;
    this.panel2.Controls.Add((Control) this.cboTransferRace);
    this.panel2.Controls.Add((Control) this.cmdTransferPopulation);
    ...
    this.cmdTransferPopulation.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdTransferPopulation.Tag = (object) "1200";
    this.cmdTransferPopulation.Text = "Transfer Population";
    this.cmdTransferPopulation.UseVisualStyleBackColor = false;
    this.cmdTransferPopulation.Click += new EventHandler(this.cmdTransferPopulation_Click);
    this.flowLayoutPanel12.BorderStyle = BorderStyle.FixedSingle;
    this.flowLayoutPanel12.Controls.Add((Control) this.label47);
    this.flowLayoutPanel12.Controls.Add((Control) this.txtFuelWarning);
    this.flowLayoutPanel12.Controls.Add((Control) this.label48);
    this.flowLayoutPanel12.Controls.Add((Control) this.txtMSPWarning);
    this.flowLayoutPanel12.Controls.Add((Control) this.rdoConstant);
    this.flowLayoutPanel12.Controls.Add((Control) this.rdoSingleWarning);
    ...
    this.txtFuelWarning.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtFuelWarning.TextChanged += new EventHandler(this.txtFuelWarning_TextChanged);
    ...
    this.txtMSPWarning.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtMSPWarning.TextChanged += new EventHandler(this.txtMSPWarning_TextChanged);
    ...
    this.rdoConstant.CheckedChanged += new EventHandler(this.rdoSingleWarning_CheckedChanged);
    ...
    this.rdoSingleWarning.CheckedChanged += new EventHandler(this.rdoSingleWarning_CheckedChanged);
    this.flowLayoutPanel24.BorderStyle = BorderStyle.FixedSingle;
    this.flowLayoutPanel24.Controls.Add((Control) this.cmdSelectGovernor);
    this.flowLayoutPanel24.Controls.Add((Control) this.cmdAssignGovernors);
    this.flowLayoutPanel24.Controls.Add((Control) this.cmdReassignAllGovernors);
    ...
    this.cmdSelectGovernor.TabIndex = (int) sbyte.MaxValue;
    ...
    this.flowLayoutPanel23.Controls.Add((Control) this.rdoYes);
    this.flowLayoutPanel23.Controls.Add((Control) this.rdoNo);
    this.flowLayoutPanel23.Controls.Add((Control) this.rdoNone);
    this.flowLayoutPanel23.Controls.Add((Control) this.label37);
    this.flowLayoutPanel23.Controls.Add((Control) this.txtImportance);
    this.flowLayoutPanel23.Controls.Add((Control) this.label39);
    this.flowLayoutPanel23.Controls.Add((Control) this.cboBonusOne);
    this.flowLayoutPanel23.Controls.Add((Control) this.label36);
    this.flowLayoutPanel23.Controls.Add((Control) this.cboBonusTwo);
    this.flowLayoutPanel23.Controls.Add((Control) this.label40);
    this.flowLayoutPanel23.Controls.Add((Control) this.cboBonusThree);
    ...
    this.rdoYes.CheckedChanged += new EventHandler(this.rdoNone_CheckedChanged);
    ...
    this.rdoNo.CheckedChanged += new EventHandler(this.rdoNone_CheckedChanged);
    ...
    this.lstvGovernor.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tabPOW.Controls.Add((Control) this.cmdRelease);
    this.tabPOW.Controls.Add((Control) this.flowLayoutPanel17);
    this.tabPOW.Controls.Add((Control) this.lstvPOWOfficers);
    ...
    this.cmdRelease.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdRelease.Tag = (object) "1200";
    this.cmdRelease.Text = "Release";
    this.cmdRelease.UseVisualStyleBackColor = false;
    this.cmdRelease.Click += new EventHandler(this.cmdRelease_Click);
    this.flowLayoutPanel17.Controls.Add((Control) this.rdoPOWPop);
    this.flowLayoutPanel17.Controls.Add((Control) this.rdoPOWEmpire);
    ...
    this.rdoPOWPop.Tag = (object) "1";
    this.rdoPOWPop.Text = "Population";
    this.rdoPOWPop.UseVisualStyleBackColor = true;
    this.rdoPOWPop.CheckedChanged += new EventHandler(this.rdoPOWEmpire_CheckedChanged);
    ...
    this.rdoPOWEmpire.CheckedChanged += new EventHandler(this.rdoPOWEmpire_CheckedChanged);
    ...
    this.lstvPOWOfficers.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvPOWOfficers.SelectedIndexChanged += new EventHandler(this.lstvPOWOfficers_SelectedIndexChanged);
    ...
    this.tabEmpireMining.Controls.Add((Control) this.lstvEmpireMiningProduction);
    this.tabEmpireMining.Controls.Add((Control) this.lstvEmpireStockpiles);
    ...
    this.lstvEmpireMiningProduction.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvEmpireStockpiles.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tabAncientConstruct.Controls.Add((Control) this.lstvConstructs);
    ...
    this.lstvConstructs.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tabMineralData.Controls.Add((Control) this.flowLayoutPanel27);
    this.tabMineralData.Controls.Add((Control) this.lstvMineralData);
    ...
    this.flowLayoutPanel27.Controls.Add((Control) this.chkCurrentPopulation);
    this.flowLayoutPanel27.Controls.Add((Control) this.rdoMinMonth);
    this.flowLayoutPanel27.Controls.Add((Control) this.rdoMin3Months);
    this.flowLayoutPanel27.Controls.Add((Control) this.rdoMin6Months);
    this.flowLayoutPanel27.Controls.Add((Control) this.rdoMinYear);
    ...
    this.chkCurrentPopulation.CheckedChanged += new EventHandler(this.chkCurrentPopulation_CheckedChanged);
    ...
    this.rdoMinMonth.CheckedChanged += new EventHandler(this.rdoMinYear_CheckedChanged);
    ...
    this.rdoMin3Months.CheckedChanged += new EventHandler(this.rdoMinYear_CheckedChanged);
    ...
    this.rdoMin6Months.CheckedChanged += new EventHandler(this.rdoMinYear_CheckedChanged);
    ...
    this.rdoMinYear.CheckedChanged += new EventHandler(this.rdoMinYear_CheckedChanged);
    ...
    this.lstvMineralData.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.chkShowSystemBody.CheckedChanged += new EventHandler(this.chkShowStars_CheckedChanged);
    ...
    this.chkByFunction.CheckedChanged += new EventHandler(this.chkShowStars_CheckedChanged);
    ...
    this.chkHideCMC.CheckedChanged += new EventHandler(this.chkShowStars_CheckedChanged);
    ...
    this.chkShowStars.CheckedChanged += new EventHandler(this.chkShowStars_CheckedChanged);
    ...
    this.KeyDown += new KeyEventHandler(this.Economics_KeyDown);
