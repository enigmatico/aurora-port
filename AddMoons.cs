...
public class AddMoons : Form
{
  ...
  public AddMoons(GClass0 gclass0_1, GClass1 gclass1_1)
  {
  ...
  private void AddMoons_Load(object sender, EventArgs e)
  {
    try
    {
      ...
      stringList1.Add(GClass226.smethod_82((Enum) AuroraSystemBodyType.None));
      stringList1.Add(GClass226.smethod_82((Enum) AuroraSystemBodyType.SmallMoon));
      stringList1.Add(GClass226.smethod_82((Enum) AuroraSystemBodyType.Moon));
      stringList1.Add(GClass226.smethod_82((Enum) AuroraSystemBodyType.LargeMoon));
      stringList1.Add(GClass226.smethod_82((Enum) AuroraSystemBodyType.SmallTerrestrial));
      stringList1.Add(GClass226.smethod_82((Enum) AuroraSystemBodyType.TerrestrialMoon));
      ...
      double num1 = 4.0 * Math.Pow(this.gclass1_0.gclass197_0.double_4, 0.5);
      double num2 = 50.0 * Math.Pow(this.gclass1_0.gclass197_0.double_4, 0.5);
      double num3 = 0.75 * Math.Pow(this.gclass1_0.gclass197_0.double_4, 0.5);
      Math.Pow(this.gclass1_0.gclass197_0.double_4, 0.5);
      double num4 = 1.4 * Math.Pow(this.gclass1_0.gclass197_0.double_4, 0.5);
      this.gclass1_0.genum4_0 = this.gclass1_0.double_2 > num1 ? (this.gclass1_0.double_2 > num2 ? GEnum4.const_2 : GEnum4.const_1) : GEnum4.const_0;
      this.gclass1_0.bool_4 = this.gclass1_0.double_2 >= num3 && this.gclass1_0.double_2 <= num4;
      this.cboMoonType1.DataSource = (object) stringList1;
      this.cboMoonType2.DataSource = (object) stringList2;
      this.cboMoonType3.DataSource = (object) stringList3;
      this.cboMoonType4.DataSource = (object) stringList4;
      this.cboMoonType5.DataSource = (object) stringList5;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 182);
    }
  }
  ...
  private void cmdOK_Click(object sender, EventArgs e)
  {
    try
    {
      this.method_0(Enum.GetValues(typeof (AuroraSystemBodyType)).Cast<AuroraSystemBodyType>().FirstOrDefault<AuroraSystemBodyType>((Func<AuroraSystemBodyType, bool>) (auroraSystemBodyType_0 => GClass226.smethod_82((Enum) auroraSystemBodyType_0) == (string) this.cboMoonType1.SelectedValue)), Convert.ToDouble(this.txtDistance1.Text));
      this.method_0(Enum.GetValues(typeof (AuroraSystemBodyType)).Cast<AuroraSystemBodyType>().FirstOrDefault<AuroraSystemBodyType>((Func<AuroraSystemBodyType, bool>) (auroraSystemBodyType_0 => GClass226.smethod_82((Enum) auroraSystemBodyType_0) == (string) this.cboMoonType2.SelectedValue)), Convert.ToDouble(this.txtDistance2.Text));
      this.method_0(Enum.GetValues(typeof (AuroraSystemBodyType)).Cast<AuroraSystemBodyType>().FirstOrDefault<AuroraSystemBodyType>((Func<AuroraSystemBodyType, bool>) (auroraSystemBodyType_0 => GClass226.smethod_82((Enum) auroraSystemBodyType_0) == (string) this.cboMoonType3.SelectedValue)), Convert.ToDouble(this.txtDistance3.Text));
      this.method_0(Enum.GetValues(typeof (AuroraSystemBodyType)).Cast<AuroraSystemBodyType>().FirstOrDefault<AuroraSystemBodyType>((Func<AuroraSystemBodyType, bool>) (auroraSystemBodyType_0 => GClass226.smethod_82((Enum) auroraSystemBodyType_0) == (string) this.cboMoonType4.SelectedValue)), Convert.ToDouble(this.txtDistance4.Text));
      this.method_0(Enum.GetValues(typeof (AuroraSystemBodyType)).Cast<AuroraSystemBodyType>().FirstOrDefault<AuroraSystemBodyType>((Func<AuroraSystemBodyType, bool>) (auroraSystemBodyType_0 => GClass226.smethod_82((Enum) auroraSystemBodyType_0) == (string) this.cboMoonType5.SelectedValue)), Convert.ToDouble(this.txtDistance5.Text));
  ...
  private void InitializeComponent()
  {
    ...
    this.cboMoonType1.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.flowLayoutPanel1.Controls.Add((Control) this.lblDistance);
    this.flowLayoutPanel1.Controls.Add((Control) this.cboMoonType1);
    this.flowLayoutPanel1.Controls.Add((Control) this.cboMoonType2);
    this.flowLayoutPanel1.Controls.Add((Control) this.cboMoonType3);
    this.flowLayoutPanel1.Controls.Add((Control) this.cboMoonType4);
    this.flowLayoutPanel1.Controls.Add((Control) this.cboMoonType5);
    ...
    this.cboMoonType2.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboMoonType3.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboMoonType4.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboMoonType5.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.flowLayoutPanel3.Controls.Add((Control) this.txtDistance1);
    this.flowLayoutPanel3.Controls.Add((Control) this.txtDistance2);
    this.flowLayoutPanel3.Controls.Add((Control) this.txtDistance3);
    this.flowLayoutPanel3.Controls.Add((Control) this.txtDistance4);
    this.flowLayoutPanel3.Controls.Add((Control) this.txtDistance5);
    ...
    this.txtDistance1.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtDistance2.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtDistance3.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtDistance4.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtDistance5.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.flowLayoutPanel2.Controls.Add((Control) this.flowLayoutPanel1);
    this.flowLayoutPanel2.Controls.Add((Control) this.flowLayoutPanel3);
    ...
    this.Name = nameof (AddMoons);
    this.Text = "Add Moons";
    this.FormClosing += new FormClosingEventHandler(this.AddMoons_FormClosing);
    this.Load += new EventHandler(this.AddMoons_Load);
