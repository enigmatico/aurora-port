...
public class GameDetails : Form
{
  ...
  private void cmdCreate_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      Decimal decimal_13 = (Decimal) Convert.ToInt32(this.txtEarthDeposits.Text) / 100M;
      ...
      this.tacticalMap_0.gclass0_1.method_54(int32_1, int32_2, int32_3, decimal_13, double_8, double_9, checkState, int32_5, int32_4, int32_6, this.chkNPRSetup.CheckState, int32_7, int32_8, int32_9, int32_10);
  ...
  private void method_0()
  {
    try
    {
      DataTable dataTable = new Class1181().method_0("select * from FCT_Game order by LastViewed desc");
      this.list_0.Clear();
      foreach (DataRow row in (InternalDataCollectionBase) dataTable.Rows)
      {
        ...
        this.list_0.Add(new GClass170(string_1, (Decimal) int32, double_1));
      }
      ...
      else
      {
        ...
        GClass170 gclass170_1 = (GClass170) null;
        if (this.tacticalMap_0.gclass0_1 != null)
        {
          foreach (GClass170 gclass170_2 in this.list_0)
          {
            if (gclass170_2.decimal_0 == (Decimal) this.tacticalMap_0.gclass0_1.int_66)
            {
          ...
          this.list_0 = this.list_0.OrderByDescending<GClass170, double>((System.Func<GClass170, double>) (gclass170_0 => gclass170_0.double_0)).ToList<GClass170>();
        this.cboGame.DataSource = (object) null;
        this.cboGame.DisplayMember = "DisplayText";
        this.cboGame.DataSource = (object) this.list_0;
        if (gclass170_1 != null)
          this.cboGame.SelectedItem = (object) gclass170_1;
        else
          this.cboGame.SelectedItem = (object) this.list_0[0];
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 1699);
    }
  }
  ...
  private void method_1()
  {
    try
    {
      if (this.cboGame.SelectedIndex <= -1)
        return;
      this.tacticalMap_0.gclass0_1 = this.tacticalMap_0.method_3((int) ((GClass170) this.cboGame.SelectedValue).decimal_0);
      this.method_2();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 1702);
    }
  }
  ...
  private void method_2()
  {
    try
    {
      ...
      this.txtTruceCountdown.Text = GClass226.smethod_42(this.tacticalMap_0.gclass0_1.decimal_6 / GClass226.decimal_29, 2);
      ...
      this.chkConquerTech.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_105);
      this.chkCivilianShippingLinesActive.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_77);
      this.chkAllowCivilianHarvesters.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_78);
      this.chkOrb.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_80);
      this.chkOrbAst.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_81);
      this.chkPoliticalAdmirals.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_82);
      this.chkInexpFleets.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_87);
      this.chkAutoJumpGates.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_88);
      this.chkPrecursors.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_89);
      this.chkRakhas.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_90);
      this.chkStarSwarm.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_92);
      this.chkInvaders.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_93);
      this.chkEldar.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_91);
      this.chkUseKnownStars.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_99);
      this.chkConstellationNames.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_84);
      this.chkGenerateNPRs.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_94);
      this.chkHumanNPRs.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_95);
      this.chkGenerateNonTNOnly.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_96);
      this.chkNoOverhauls.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_97);
      this.chkRealisticPromotions.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_98);
      this.chkNPRsGeneratePrecursors.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_102);
      this.chkNPRsGenerateSwarm.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_101);
      this.chkNPRsGenerateRifts.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_103);
      this.chkNPRsEncounterRaiders.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_104);
      this.chkStarEccentricity.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_85);
      this.chkGasGiantEffects.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_86);
      this.chkLimitedLabs.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_114);
      this.chkOneSecondSubPulse.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_115);
      this.chkLimitPlanetaryDistance.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_120);
      this.chkParallelUniverse.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_121);
      this.chkUseThemeInKnownStars.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_122);
      this.chkEnhancedInvaders.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_123);
      this.chkEnhancedPrecursors.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_125);
      this.chkEnhancedSwarm.Checked = GClass226.smethod_68(this.tacticalMap_0.gclass0_1.int_124);
  ...
  private GClass0 method_4()
  {
    try
    {
      ...
      {
        int_66 = this.tacticalMap_0.gclass0_0.method_26(GEnum0.const_0),
        bool_2 = true,
        int_68 = 1000,
        int_70 = 50,
        int_71 = 15,
  ...
  private void method_6(bool bool_1)
  {
    try
    {
      ...
      else
      {
        ...
        if (this.tacticalMap_0.gclass0_0.int_66 == this.tacticalMap_0.gclass0_1.int_66)
          this.method_7(this.tacticalMap_0.gclass0_0);
        using (SQLiteConnection sqliteConnection_0 = new SQLiteConnection(GClass226.string_1))
        {
  ...
  private void method_7(GClass0 gclass0_0)
  {
    try
    {
      ...
      if (gclass0_0.int_129 < 0)
        gclass0_0.int_129 = 0;
      GClass208 gclass208 = GClass226.smethod_4(this.txtTruceCountdown.Text);
      if (gclass208.bool_0)
        gclass0_0.decimal_6 = gclass208.decimal_0;
      gclass0_0.int_105 = GClass226.smethod_69(this.chkConquerTech.Checked);
      gclass0_0.int_77 = GClass226.smethod_69(this.chkCivilianShippingLinesActive.Checked);
      gclass0_0.int_78 = GClass226.smethod_69(this.chkAllowCivilianHarvesters.Checked);
      gclass0_0.int_80 = GClass226.smethod_69(this.chkOrb.Checked);
      gclass0_0.int_81 = GClass226.smethod_69(this.chkOrbAst.Checked);
      gclass0_0.int_82 = GClass226.smethod_69(this.chkPoliticalAdmirals.Checked);
      gclass0_0.int_87 = GClass226.smethod_69(this.chkInexpFleets.Checked);
      gclass0_0.int_88 = GClass226.smethod_69(this.chkAutoJumpGates.Checked);
      gclass0_0.int_89 = GClass226.smethod_69(this.chkPrecursors.Checked);
      gclass0_0.int_90 = GClass226.smethod_69(this.chkRakhas.Checked);
      gclass0_0.int_92 = GClass226.smethod_69(this.chkStarSwarm.Checked);
      gclass0_0.int_93 = GClass226.smethod_69(this.chkInvaders.Checked);
      gclass0_0.int_91 = GClass226.smethod_69(this.chkEldar.Checked);
      gclass0_0.int_99 = GClass226.smethod_69(this.chkUseKnownStars.Checked);
      gclass0_0.int_94 = GClass226.smethod_69(this.chkGenerateNPRs.Checked);
      gclass0_0.int_95 = GClass226.smethod_69(this.chkHumanNPRs.Checked);
      gclass0_0.int_96 = GClass226.smethod_69(this.chkGenerateNonTNOnly.Checked);
      gclass0_0.int_97 = GClass226.smethod_69(this.chkNoOverhauls.Checked);
      gclass0_0.int_98 = GClass226.smethod_69(this.chkRealisticPromotions.Checked);
      gclass0_0.int_102 = GClass226.smethod_69(this.chkNPRsGeneratePrecursors.Checked);
      gclass0_0.int_101 = GClass226.smethod_69(this.chkNPRsGenerateSwarm.Checked);
      gclass0_0.int_103 = GClass226.smethod_69(this.chkNPRsGenerateRifts.Checked);
      gclass0_0.int_104 = GClass226.smethod_69(this.chkNPRsEncounterRaiders.Checked);
      gclass0_0.int_84 = GClass226.smethod_69(this.chkConstellationNames.Checked);
      gclass0_0.int_85 = GClass226.smethod_69(this.chkStarEccentricity.Checked);
      gclass0_0.int_86 = GClass226.smethod_69(this.chkGasGiantEffects.Checked);
      gclass0_0.int_114 = GClass226.smethod_69(this.chkLimitedLabs.Checked);
      gclass0_0.int_115 = GClass226.smethod_69(this.chkOneSecondSubPulse.Checked);
      gclass0_0.int_120 = GClass226.smethod_69(this.chkLimitPlanetaryDistance.Checked);
      gclass0_0.int_121 = GClass226.smethod_69(this.chkParallelUniverse.Checked);
      gclass0_0.int_122 = GClass226.smethod_69(this.chkUseThemeInKnownStars.Checked);
      gclass0_0.int_123 = GClass226.smethod_69(this.chkEnhancedInvaders.Checked);
      gclass0_0.int_125 = GClass226.smethod_69(this.chkEnhancedPrecursors.Checked);
      gclass0_0.int_124 = GClass226.smethod_69(this.chkEnhancedSwarm.Checked);
      ...
      GClass197 gclass197 = gclass0_0.dictionary_10.Values.FirstOrDefault<GClass197>((System.Func<GClass197, bool>) (gclass197_0 => gclass197_0.gclass200_0.bool_0));
      if (gclass197 == null)
        return;
      if (gclass0_0.genum30_0 != GEnum30.const_4 && gclass0_0.genum30_0 != GEnum30.const_5 && gclass0_0.genum30_0 != GEnum30.const_6 && gclass0_0.genum30_0 != GEnum30.const_1 && gclass0_0.genum30_0 != GEnum30.const_2 && gclass0_0.genum30_0 != GEnum30.const_7 && gclass0_0.genum30_0 != GEnum30.const_8 && gclass0_0.genum30_0 != GEnum30.const_9 && gclass0_0.genum30_0 != GEnum30.const_3)
    ...
    try
    {
      ...
      switch (name.Length)
      {
        ...
        case 8:
          if (!(name == "chkEldar"))
            break;
          this.txtOptionDescription.Text = "Aether Raiders are one of the lower technology non-NPR threats, but have a couple of technologies that allow them to launch effective raiding operations on unprotected ships and colonies.";
          break;
        case 9:
          switch (name[3])
          {
            case 'C':
              if (!(name == "txtChance"))
                return;
              this.txtOptionDescription.Text = "The chance of a newly discovered system linking to a 'Local System'. A Local System is definied as having a system number close to that of the system from which it was entered. This setting does not apply to Known Stars games";
              return;
            case 'O':
              if (!(name == "chkOrbAst"))
                return;
            ...
            case 'S':
              if (!(name == "txtSpread"))
                return;
              this.txtOptionDescription.Text = "The maximum difference in system numbers between a newly discovered 'Local System' and the system from which it was entered. This setting does not apply to Known Stars games";
              return;
            default:
              return;
          }
        case 10:
          switch (name[0])
          {
            case 'c':
              if (!(name == "chkPlanetX"))
                return;
              this.txtOptionDescription.Text = "Add a ninth major planet to the Sol system. This may be a gas giant, superjovian or terrestrial world and it may have moons.";
              return;
            case 't':
              if (!(name == "txtPlayers"))
                return;
        ...
        case 11:
          switch (name[4])
          {
            case 'P':
              if (!(name == "chkNPRSetup"))
                return;
              this.txtOptionDescription.Text = "If this option is chosen, a window will popup for each NPR allowing you to choose themes, pictures, starting system (for known stars), terrain type, etc.";
              return;
            case 'a':
              if (!(name == "txtPassword"))
                return;
          ...
          switch (name[3])
          {
            ...
            case 'M':
              if (!(name == "txtMinorRaces"))
                return;
              this.txtOptionDescription.Text = "The % of new NPRs that are generated as minor races. Minor races will be approximately 25% of the size of normal NPRs. They will be Trans-Newtonian, but not jump capable.";
              return;
            case 'N':
              if (!(name == "txtNumSystems"))
                return;
              this.txtOptionDescription.Text = "The maximum number of systems in the game. This setting does not affect Known Stars games.";
              return;
            case 'O':
              return;
            case 'P':
          ...
          switch (name[3])
          {
            ...
            case 'L':
              if (!(name == "chkLimitedLabs"))
                return;
              this.txtOptionDescription.Text = "Scientists will start with 20% of their normal research administration capacity and admin increases via experience will be for one or two facilities only";
              return;
            case 'N':
        ...
        case 15:
          if (!(name == "chkGenerateNPRs"))
            break;
          this.txtOptionDescription.Text = "Any non-starting races created during system generation will be computer-controlled (non-player races). If this option is not checked, any new races will require manual control (player races).";
          break;
        case 16 /*0x10*/:
          switch (name[4])
          {
          ...
          switch (name[4])
          {
            case 'a':
              if (!(name == "lblMaxNPRDistance"))
                return;
              this.txtOptionDescription.Text = "Applies only to known stars games. This is the maximum distance from Sol at which an NPR home system will be generated.";
              return;
            case 'r':
            ...
            case 'u':
              if (!(name == "lblMubNPRDistance"))
                return;
              this.txtOptionDescription.Text = "Applies only to known stars games. This is the minimum distance from Sol at which an NPR home system will be generated.";
              return;
            default:
              return;
          }
        case 18:
          if (!(name == "chkGasGiantEffects"))
            break;
          this.txtOptionDescription.Text = "Gas giants and Superjovians with a mass of 50 or more will have an effect on nearby planets. This can cause more eccentrics orbits, capturing as a moon, ejection from the system or replacement by asteroid belt.";
          break;
        case 19:
          switch (name[3])
          {
            case 'E':
              if (!(name == "chkEnhancedInvaders"))
                return;
              this.txtOptionDescription.Text = "Enhanced Invaders function in exactly the samw way as basic invaders, except that new rifts may be larger, in some cases much larger, than the standard 10m kilometres";
              return;
            case 'P':
              if (!(name == "chkParallelUniverse"))
                return;
              this.txtOptionDescription.Text = "All new systems discovered will be parallel universe versions of the Sol system";
              return;
            case 'S':
              if (!(name == "chkStarEccentricity"))
                return;
              this.txtOptionDescription.Text = "Stars and planets will be generated with an eccentricity in their orbit.";
              return;
            default:
              return;
          }
          ...
          switch (name[6])
          {
            case 'I':
              if (!(name == "txtPreIndustralRaces"))
                return;
              this.txtOptionDescription.Text = "The % of new NPRs that are generated as pre-industrial races. Pre-industrial races will be approximately 12.5% of the size of normal NPRs. They will not have any industry or ships.";
              return;
            case 'S':
              if (!(name == "chkOneSecondSubPulse"))
                return;
              this.txtOptionDescription.Text = "Increments of 5 seconds will have five 1 second sub-pulses for movement purposes";
              return;
            case 'a':
              if (!(name == "chkEnhancedStarSwarm"))
                return;
              this.txtOptionDescription.Text = "Enhanced Star Swarm are similar to the basic version in terms of capability. However, once the first star swarm appears, new swarms will randomly appear at the edge of existing systems that are close to the original contact system in real space";
              return;
            case 'e':
            ...
            case 's':
              switch (name)
              {
                case "chkNPRsGenerateSwarm":
                  this.txtOptionDescription.Text = "If this option is checked, NPRs may generate Star Swarm during system generation";
                  return;
                case "chkNPRsGenerateRifts":
                  this.txtOptionDescription.Text = "If this option is checked, NPRs may generate aether rifts during system generation";
                  return;
                default:
                  return;
              }
            case 't':
              if (!(name == "txtHostilityModifier") && !(name == "lblHostilityModifier"))
                return;
              this.txtOptionDescription.Text = "This amount is added to the Xenophobia and Militarism attributes of newly generated NPRs and deducted from their Diplomacy and Trade attributes";
              return;
            default:
              return;
          }
          ...
          switch (name[3])
          {
            case 'C':
              if (!(name == "chkConstellationNames"))
                return;
              this.txtOptionDescription.Text = "Where a known system has a generic name such as Gliese 101, a new name will be generated based on unused Bayer and Flamsteed nomenclature for the star's constellation. This is set for the closest 1000 stars to Earth.";
              return;
            case 'D':
            ...
            case 'E':
              if (!(name == "chkEnhancedPrecursors"))
                return;
              this.txtOptionDescription.Text = "Enhanced Precursors have existed for millenia in ancient tombs. They will not be visible until they awaken, sending forces on to the surface and launching ships from deep beneath the surface. Not all their forces may emerge at once";
              return;
            default:
              return;
          }
          ...
          switch (name[3])
          {
            case 'N':
              if (!(name == "chkNPRsEncounterRaiders"))
                return;
              this.txtOptionDescription.Text = "If this option is checked, NPRs may suffer from raider attacks";
              return;
            case 'U':
              if (!(name == "chkUseThemeInKnownStars"))
                return;
              this.txtOptionDescription.Text = "The race system naming theme will be used instead of the real system name in known stars games";
              return;
            default:
              return;
          }
          ...
          switch (name[3])
          {
            case 'L':
              if (!(name == "chkLimitPlanetaryDistance"))
                return;
              this.txtOptionDescription.Text = "Planets and other bodies will not be created beyond twice the distance of the outer survey location ring. Stars without LG points will not be created more than 24b km from the primary";
              return;
            case 'N':
              if (!(name == "chkNPRsGeneratePrecursors"))
                return;
              this.txtOptionDescription.Text = "If this option is checked, NPRs may generate Precursors during system generation";
              return;
            default:
              return;
          }
  ...
  private void cmdDelete_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        int int66 = this.tacticalMap_0.gclass0_1.int_66;
        if (MessageBox.Show($" Are you sure you want to delete the game {this.tacticalMap_0.gclass0_1.string_1}?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes || MessageBox.Show(" Are you really, really sure?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
          return;
        Cursor.Current = Cursors.WaitCursor;
        List<string> stringList = new List<string>();
        foreach (DataRow row in (InternalDataCollectionBase) new Class1181().method_0("SELECT name FROM sqlite_master WHERE type = 'table'").Rows)
        {
          string string_2 = row["Name"].ToString();
          if (GClass226.smethod_25(string_2, 3) == "FCT" && string_2 != "FCT_HullDescription" && string_2 != "FCT_ClassComponentTemplate" && string_2 != "FCT_ShipClassTemplate" && string_2 != "FCT_ShipComponentTemplate")
        ...
        foreach (string str in stringList)
          new SQLiteCommand($"DELETE FROM {str} WHERE GameID = {int66.ToString()}", connection).ExecuteNonQuery();
        this.cboGame.DataSource = (object) null;
        this.method_0();
  ...
  private void txtPlayers_Leave(object sender, EventArgs e)
  {
    try
    {
      GClass208 gclass208 = GClass226.smethod_4(this.txtPlayers.Text);
  ...
  private void cmdRename_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      if (!(this.tacticalMap_0.gclass0_1.string_4 != this.tacticalMap_0.gclass0_1.string_1) || this.tacticalMap_0.gclass0_1.bool_21)
        return;
      this.tacticalMap_0.gclass0_1.string_1 = this.tacticalMap_0.gclass0_1.string_4;
      this.tacticalMap_0.gclass0_1.method_157(this.tacticalMap_0.gclass0_1.int_66, this.tacticalMap_0.gclass0_1.string_4);
      this.bool_0 = true;
      this.method_0();
      this.bool_0 = false;
      this.method_1();
  ...
  private void InitializeComponent()
  {
    ...
    this.txtNumSystems.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtNumSystems.Enter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.txtNumSystems.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.txtChance.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtChance.Enter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.txtChance.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.label5.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.txtSpread.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtSpread.Enter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.txtSpread.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.label6.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.txtProdTime.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtProdTime.Enter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.txtProdTime.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.label8.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.panel1.Enter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.panel1.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.txtDifficultyModifier.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.txtDifficultyModifier.BorderStyle = BorderStyle.None;
    this.txtDifficultyModifier.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtDifficultyModifier.Enter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.txtDifficultyModifier.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.label1.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.txtResearchSpeed.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtResearchSpeed.Enter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.txtResearchSpeed.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.label21.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.txtTerraformingSpeed.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtTerraformingSpeed.Enter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.txtTerraformingSpeed.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.label22.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.txtSurveySpeed.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtSurveySpeed.Enter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.txtSurveySpeed.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.label25.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.txtNewRuinCreationChance.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtNewRuinCreationChance.Enter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.txtNewRuinCreationChance.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.label11.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.txtMinComets.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtMinComets.Enter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.txtMinComets.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.label12.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.panel11.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.txtTruceCountdown.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.txtTruceCountdown.BorderStyle = BorderStyle.None;
    this.txtTruceCountdown.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtTruceCountdown.Enter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.txtTruceCountdown.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.txtPassword.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtPassword.Enter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.txtPassword.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.label14.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.txtConfirm.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.cboDetection.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboDetection.SelectedIndexChanged += new EventHandler(this.cboDetection_SelectedIndexChanged);
    this.cboDetection.Enter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.cboDisaster.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboDisaster.Items.AddRange(new object[10]
    {
      ...
      (object) "Earth Death Spiral 0.01 AU",
      (object) "Earth Death Spiral 0.02 AU",
      (object) "Earth Death Spiral 0.03 AU"
    });
    ...
    this.cboDisaster.Enter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.txtRaceChance.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtRaceChance.Enter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.txtRaceChance.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.label9.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.txtRaceChanceNPR.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtRaceChanceNPR.Enter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.txtRaceChanceNPR.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.label10.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.panel29.Controls.Add((Control) this.txtMinorRaces);
    this.panel29.Controls.Add((Control) this.label23);
    ...
    this.txtMinorRaces.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtMinorRaces.EnabledChanged += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.txtMinorRaces.TextChanged += new EventHandler(this.txtMinorRaces_TextChanged);
    this.txtMinorRaces.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.label23.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.panel28.Controls.Add((Control) this.txtHostilityModifier);
    this.panel28.Controls.Add((Control) this.lblHostilityModifier);
    ...
    this.txtHostilityModifier.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtHostilityModifier.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.lblHostilityModifier.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.txtYear.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtYear.Enter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.txtYear.Leave += new EventHandler(this.txtYear_Leave);
    this.txtYear.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.flowLayoutPanel1.Controls.Add((Control) this.chkConstellationNames);
    ...
    this.flowLayoutPanel1.Controls.Add((Control) this.chkEnhancedPrecursors);
    this.flowLayoutPanel1.Controls.Add((Control) this.chkEnhancedSwarm);
    this.flowLayoutPanel1.Controls.Add((Control) this.chkEnhancedInvaders);
    this.flowLayoutPanel1.Controls.Add((Control) this.chkRakhas);
    this.flowLayoutPanel1.Controls.Add((Control) this.chkEldar);
    this.flowLayoutPanel1.Controls.Add((Control) this.chkNPRsGeneratePrecursors);
    this.flowLayoutPanel1.Controls.Add((Control) this.chkNPRsGenerateSwarm);
    this.flowLayoutPanel1.Controls.Add((Control) this.chkNPRsGenerateRifts);
    this.flowLayoutPanel1.Controls.Add((Control) this.chkNPRsEncounterRaiders);
    this.flowLayoutPanel1.Controls.Add((Control) this.chkRealisticPromotions);
    this.flowLayoutPanel1.Controls.Add((Control) this.chkLimitedLabs);
    ...
    this.flowLayoutPanel1.Controls.Add((Control) this.chkStarEccentricity);
    this.flowLayoutPanel1.Controls.Add((Control) this.chkGasGiantEffects);
    this.flowLayoutPanel1.Controls.Add((Control) this.chkOneSecondSubPulse);
    this.flowLayoutPanel1.Controls.Add((Control) this.chkLimitPlanetaryDistance);
    this.flowLayoutPanel1.Controls.Add((Control) this.chkUseThemeInKnownStars);
    ...
    this.chkUseKnownStars.CheckedChanged += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.chkUseKnownStars.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.chkConstellationNames.CheckedChanged += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.chkConstellationNames.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.chkOrb.CheckedChanged += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.chkOrb.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.chkOrbAst.CheckedChanged += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.chkOrbAst.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.chkGenerateNPRs.CheckedChanged += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.chkGenerateNPRs.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.chkHumanNPRs.CheckedChanged += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.chkHumanNPRs.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.chkGenerateNonTNOnly.CheckedChanged += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.chkGenerateNonTNOnly.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.chkPrecursors.CheckedChanged += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.chkPrecursors.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.chkStarSwarm.CheckedChanged += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.chkStarSwarm.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.chkInvaders.CheckedChanged += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.chkInvaders.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.chkRakhas.CheckedChanged += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.chkRakhas.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.chkEldar.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.chkNPRsGeneratePrecursors.CheckedChanged += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.chkNPRsGeneratePrecursors.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.chkNPRsGenerateSwarm.CheckedChanged += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.chkNPRsGenerateSwarm.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.chkNPRsGenerateRifts.CheckedChanged += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.chkNPRsGenerateRifts.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.chkNPRsEncounterRaiders.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.chkRealisticPromotions.CheckedChanged += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.chkRealisticPromotions.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.chkLimitedLabs.CheckedChanged += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.chkLimitedLabs.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.chkInexpFleets.CheckedChanged += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.chkInexpFleets.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.chkPoliticalAdmirals.CheckedChanged += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.chkPoliticalAdmirals.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.chkAutoJumpGates.CheckedChanged += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.chkAutoJumpGates.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.chkNoOverhauls.CheckedChanged += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.chkNoOverhauls.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.chkCivilianShippingLinesActive.CheckedChanged += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.chkCivilianShippingLinesActive.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.chkAllowCivilianHarvesters.CheckedChanged += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.chkAllowCivilianHarvesters.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.chkConquerTech.CheckedChanged += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.chkConquerTech.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.chkStarEccentricity.CheckedChanged += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.chkStarEccentricity.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.chkGasGiantEffects.CheckedChanged += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.chkGasGiantEffects.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.chkOneSecondSubPulse.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.chkLimitPlanetaryDistance.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.chkUseThemeInKnownStars.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.cboGame.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdSave.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdSelect.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.txtOptionDescription.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtOptionDescription.TextChanged += new EventHandler(this.txtOptionDescription_TextChanged);
    ...
    this.flpNewGame.Controls.Add((Control) this.panel25);
    this.flpNewGame.Controls.Add((Control) this.panel26);
    this.flpNewGame.Controls.Add((Control) this.panel27);
    this.flpNewGame.Controls.Add((Control) this.panel33);
    this.flpNewGame.Controls.Add((Control) this.panel34);
    this.flpNewGame.Controls.Add((Control) this.panel35);
    this.flpNewGame.Controls.Add((Control) this.panel36);
    ...
    this.txtPlayers.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtPlayers.Enter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.txtPlayers.Leave += new EventHandler(this.txtPlayers_Leave);
    this.txtPlayers.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.txtNPRs.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtNPRs.Enter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.txtNPRs.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.txtJumpPoints.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtJumpPoints.Enter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.txtJumpPoints.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.txtEarthDeposits.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtEarthDeposits.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.panel23.Controls.Add((Control) this.lblMinNPRDistance);
    ...
    this.txtMinNPRDistance.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.lblMinNPRDistance.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.panel22.Controls.Add((Control) this.txtMaxNPRDistance);
    this.panel22.Controls.Add((Control) this.lblMaxNPRDistance);
    ...
    this.txtMaxNPRDistance.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.lblMaxNPRDistance.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.panel25.Controls.Add((Control) this.txtSwarmSystems);
    ...
    this.txtSwarmSystems.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.panel26.Controls.Add((Control) this.txtRaiderSystems);
    ...
    this.txtRaiderSystems.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.panel27.Controls.Add((Control) this.txtInvaderSystems);
    this.panel27.Controls.Add((Control) this.label28);
    this.panel27.Location = new Point(3, (int) byte.MaxValue);
    ...
    this.txtInvaderSystems.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.panel33.Controls.Add((Control) this.txtPrecursorRP);
    this.panel33.Controls.Add((Control) this.label31);
    ...
    this.txtPrecursorRP.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.panel34.Controls.Add((Control) this.txtSwarmRP);
    this.panel34.Controls.Add((Control) this.label32);
    ...
    this.txtSwarmRP.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.panel35.Controls.Add((Control) this.txtRaiderRP);
    this.panel35.Controls.Add((Control) this.label33);
    ...
    this.txtRaiderRP.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.panel36.Controls.Add((Control) this.txtInvaderRP);
    this.panel36.Controls.Add((Control) this.label34);
    ...
    this.txtInvaderRP.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.flowLayoutPanel3.Controls.Add((Control) this.chkNPRSetup);
    this.flowLayoutPanel3.Controls.Add((Control) this.chkPlanetX);
    this.flowLayoutPanel3.Controls.Add((Control) this.chkParallelUniverse);
    ...
    this.chkNPRSetup.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.chkPlanetX.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    ...
    this.chkParallelUniverse.CheckedChanged += new EventHandler(this.chkParallelUniverse_CheckedChanged);
    this.chkParallelUniverse.MouseEnter += new EventHandler(this.chkParallelUniverse_MouseEnter);
    this.panel30.Controls.Add((Control) this.txtNPRBaseTransits);
    this.panel30.Controls.Add((Control) this.label24);
    ...
    this.txtNPRBaseTransits.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.panel31.Controls.Add((Control) this.txtNPRRandomTransits);
    this.panel31.Controls.Add((Control) this.label29);
    ...
    this.txtNPRRandomTransits.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.panel32.Controls.Add((Control) this.txtNPRMaxStartingSystems);
    this.panel32.Controls.Add((Control) this.label30);
    ...
    this.txtNPRMaxStartingSystems.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.textBox4.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtStartOnly.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.flowLayoutPanel4.Controls.Add((Control) this.cmdRename);
    ...
    this.txtNewGameName.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.flowLayoutPanel5.Controls.Add((Control) this.flowLayoutPanel2);
    this.flowLayoutPanel5.Controls.Add((Control) this.flowLayoutPanel6);
    this.flowLayoutPanel5.Controls.Add((Control) this.flowLayoutPanel1);
    this.flowLayoutPanel5.Controls.Add((Control) this.flpNewGame);
    ...
    this.flowLayoutPanel6.Controls.Add((Control) this.panel30);
    this.flowLayoutPanel6.Controls.Add((Control) this.panel31);
    this.flowLayoutPanel6.Controls.Add((Control) this.panel32);
    this.flowLayoutPanel6.Controls.Add((Control) this.panel37);
    this.flowLayoutPanel6.Controls.Add((Control) this.panel38);
    this.flowLayoutPanel6.Controls.Add((Control) this.panel29);
    ...
    this.panel37.Controls.Add((Control) this.txtPreIndustrialRaces);
    this.panel37.Controls.Add((Control) this.label35);
    ...
    this.txtPreIndustrialRaces.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.panel38.Controls.Add((Control) this.txtConventionalRaces);
    this.panel38.Controls.Add((Control) this.label36);
    ...
    this.txtConventionalRaces.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
