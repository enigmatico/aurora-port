...
public class Diplomacy : Form
{
  ...
  private void method_2(bool bool_1)
  {
    try
    {
      ...
      this.gclass21_0.method_31(this, this.gclass110_0, this.lstvStatus, this.cboTheme, this.txtAbbreviation, this.chkReal, this.lblRaceIntelligence, this.chkAlienNameRandom);
      this.gclass21_0.method_382(this.tvIntelligence, this.gclass110_0, bool_1);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 486);
    }
  }
  ...
  private void method_3(GClass115 gclass115_0)
  {
    try
    {
      this.gclass21_0.method_29(this.lstvAlienShips, this.lstvClassDetails, this.lstvKnownSensors, this.lstvWeapons, this.lstvTechnology, this.txtSummary, gclass115_0);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 487);
    }
  }
  ...
  private void cboRaces_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      if (this.cboAlienRaces.Items.Count == 0)
      {
        this.gclass110_0 = (GClass110) null;
        this.method_1();
      }
      if (!this.bool_0)
  ...
  private void cboAlienRaces_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      this.gclass110_0 = (GClass110) this.cboAlienRaces.SelectedValue;
      this.method_1();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 493);
    }
  }
    ...
    AuroraContactStatus auroraContactStatus_0)
  {
    try
    {
      ...
      if (decimal_0 < (Decimal) GClass226.int_65)
        this.chkTrade.Visible = false;
      if (decimal_0 < (Decimal) GClass226.int_66)
        this.chkGeo.Visible = false;
      if (decimal_0 < (Decimal) GClass226.int_67)
        this.chkGrav.Visible = false;
      if (decimal_0 < (Decimal) GClass226.int_68)
        this.chkResearch.Visible = false;
      if (decimal_0 < (Decimal) GClass226.int_70)
        this.rdoFriendly.Visible = false;
      if (decimal_0 < (Decimal) GClass226.int_71)
        this.rdoAllied.Visible = false;
      this.chkTrade.CheckState = GClass226.smethod_28(bool_1);
      this.chkGeo.CheckState = GClass226.smethod_28(bool_2);
      this.chkGrav.CheckState = GClass226.smethod_28(bool_3);
      this.chkResearch.CheckState = GClass226.smethod_28(bool_4);
  ...
  private void cmdRename_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      GClass110 gclass1100 = this.gclass110_0;
      this.gclass21_0.method_330(this.cboAlienRaces);
      this.cboAlienRaces.SelectedItem = (object) gclass1100;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 497);
    }
  }
  ...
  private void cmdCommunicate_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass110_0 == null)
        return;
      if (this.gclass110_0.auroraCommStatus_0 == AuroraCommStatus.None)
        this.gclass110_0.auroraCommStatus_0 = AuroraCommStatus.AttemptingCommunication;
      else if (this.gclass110_0.auroraCommStatus_0 == AuroraCommStatus.AttemptingCommunication)
      {
        int num1 = (int) MessageBox.Show("Communication attempts are already underway", "Action Not Possible");
      }
      else if (this.gclass110_0.auroraCommStatus_0 == AuroraCommStatus.CommunicationImpossible)
      {
      ...
      else if (this.gclass110_0.auroraCommStatus_0 == AuroraCommStatus.CommunicationEstablished)
      {
  ...
  private void chkReal_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass110_0 == null)
        return;
      this.gclass110_0.int_2 = GClass226.smethod_29(this.chkReal.CheckState);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 499);
    }
  }
  ...
  private void cboTheme_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass110_0 == null)
        return;
      GClass140 selectedItem = (GClass140) this.cboTheme.SelectedItem;
      if (selectedItem == null)
        return;
      this.gclass110_0.gclass140_0 = selectedItem;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 500);
    }
  }
  ...
  private void txtAbbreviation_TextChanged(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass110_0 == null || this.txtAbbreviation.Text == "")
        return;
      this.gclass110_0.string_0 = this.txtAbbreviation.Text;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 501);
    }
  }
  ...
  private void chkTrade_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass110_0 == null)
        return;
      this.gclass110_0.bool_0 = GClass226.smethod_27(this.chkTrade.CheckState);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 502);
    }
  }
  ...
  private void chkGeo_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass110_0 == null)
        return;
      this.gclass110_0.bool_2 = GClass226.smethod_27(this.chkGeo.CheckState);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 503);
    }
  }
  ...
  private void chkGrav_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass110_0 == null)
        return;
      this.gclass110_0.bool_3 = GClass226.smethod_27(this.chkGrav.CheckState);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 504);
    }
  }
  ...
  private void chkResearch_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass110_0 == null)
        return;
      this.gclass110_0.bool_1 = GClass226.smethod_27(this.chkResearch.CheckState);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 505);
    }
  }
  ...
  private void rdoAllied_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      if (this.rdoHostile.Checked)
        this.gclass110_0.auroraContactStatus_0 = AuroraContactStatus.Hostile;
      else if (this.rdoNeutral.Checked)
        this.gclass110_0.auroraContactStatus_0 = AuroraContactStatus.Neutral;
      else if (this.rdoFriendly.Checked)
      {
        this.gclass110_0.auroraContactStatus_0 = AuroraContactStatus.Friendly;
      }
      else
      {
        if (!this.rdoAllied.Checked)
          return;
        this.gclass110_0.auroraContactStatus_0 = AuroraContactStatus.Allied;
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 506);
    }
  }
  ...
  private void cmdChangeDR_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      this.gclass0_0.string_4 = this.gclass110_0.decimal_2.ToString();
      int num = (int) new MessageEntry(this.gclass0_0).ShowDialog();
      GClass208 gclass208 = GClass226.smethod_4(this.gclass0_0.string_4);
      if (!gclass208.bool_0)
        return;
      this.gclass110_0.decimal_2 = gclass208.decimal_0;
      this.method_1();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 507);
    }
  }
  ...
  private void cmdRenameClass_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      this.tvIntelligence.SelectedNode.Text = $"{class894.gclass115_0.gclass21_1.dictionary_12.Values.Count<GClass117>(new Func<GClass117, bool>(class894.method_0)).ToString()}x {class894.gclass115_0.gclass76_0.Abbreviation} {class894.gclass115_0.ClassName}";
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 508);
    }
  }
  ...
  private void cmdToggleFixed_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass110_0 == null)
        return;
      this.gclass110_0.int_1 = this.gclass110_0.int_1 != 1 ? 1 : 0;
      this.method_1();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 510);
    }
  }
  ...
  private void cmdHull_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      foreach (GClass76 gclass76 in this.gclass0_0.dictionary_24.Values.OrderBy<GClass76, string>((Func<GClass76, string>) (gclass76_0 => gclass76_0.Description)).ToList<GClass76>())
      ...
      if (this.gclass0_0.bool_21)
        return;
      gclass115_0.gclass76_0 = this.gclass0_0.dictionary_24.Values.FirstOrDefault<GClass76>((Func<GClass76, bool>) (gclass76_0 => gclass76_0.Description == this.gclass0_0.string_4));
      this.method_3(gclass115_0);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 511 /*0x01FF*/);
    }
  }
  ...
  private void cmdSetComm_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass110_0 == null)
        return;
      this.gclass110_0.auroraCommStatus_0 = AuroraCommStatus.CommunicationEstablished;
      this.method_1();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 512 /*0x0200*/);
    }
  }
  ...
  private void lstvAlienShips_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        if (this.lstvAlienShips.SelectedItems.Count == 0 || this.lstvAlienShips.SelectedItems[0].Tag == null || !(this.lstvAlienShips.SelectedItems[0].Tag is GClass117))
          return;
        GClass117 tag = (GClass117) this.lstvAlienShips.SelectedItems[0].Tag;
        if (tag == null)
          return;
  ...
  private void cmdRenumber_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      int int_72 = 1;
      // ISSUE: reference to a compiler-generated method
      List<GClass117> list = this.gclass21_0.dictionary_12.Values.Where<GClass117>(new Func<GClass117, bool>(class895.method_0)).OrderBy<GClass117, Decimal>((Func<GClass117, Decimal>) (gclass117_0 => gclass117_0.decimal_1)).ToList<GClass117>();
      // ISSUE: reference to a compiler-generated field
      class895.gclass115_0.int_4 = list.Count;
      foreach (GClass117 gclass117 in list)
      {
        // ISSUE: reference to a compiler-generated field
        gclass117.string_0 = $"{class895.gclass115_0.ClassName} {GClass226.smethod_33(int_72)}";
        ++int_72;
      }
      // ISSUE: reference to a compiler-generated field
  ...
  private void cmdAutoName_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      if (gclass115 == null)
        return;
      gclass115.ClassName = this.gclass110_0.gclass140_0.method_0(this.gclass21_0, GEnum21.const_3);
      this.method_1();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 516);
    }
  }
  ...
  private void cmdCorrectNames_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass21_0 == null || this.gclass110_0 == null)
        return;
      foreach (GClass115 gclass115 in this.gclass21_0.dictionary_11.Values.Where<GClass115>((Func<GClass115, bool>) (gclass115_0 => gclass115_0.gclass110_0 == this.gclass110_0)).ToList<GClass115>())
        gclass115.ClassName = gclass115.gclass22_0.ClassName;
      foreach (GClass117 gclass117 in this.gclass21_0.dictionary_12.Values.Where<GClass117>((Func<GClass117, bool>) (gclass117_0 => gclass117_0.gclass110_0 == this.gclass110_0)).ToList<GClass117>())
      {
  ...
  private void cmdAddSpecies_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      this.gclass0_0.string_9 = "";
      this.gclass0_0.list_32 = new List<string>();
      foreach (GClass194 gclass194 in this.gclass0_0.dictionary_22.Values.Where<GClass146>((Func<GClass146, bool>) (gclass146_0 => gclass146_0.gclass21_0 == this.gclass21_0)).Select<GClass146, GClass194>((Func<GClass146, GClass194>) (gclass146_0 => gclass146_0.gclass194_0)).Distinct<GClass194>().OrderBy<GClass194, string>((Func<GClass194, string>) (gclass194_0 => gclass194_0.SpeciesName)).ToList<GClass194>())
        this.gclass0_0.list_32.Add(gclass194.SpeciesName);
      int num = (int) new UserSelection(this.gclass0_0).ShowDialog();
      if (this.gclass0_0.bool_21)
        return;
      this.gclass21_0.method_163(this.gclass110_0, this.gclass0_0.dictionary_37.Values.FirstOrDefault<GClass194>((Func<GClass194, bool>) (gclass194_0 => gclass194_0.SpeciesName == this.gclass0_0.string_4)), GEnum25.const_0);
      this.method_1();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 519);
    }
  }
  ...
  private void method_11(TreeNode treeNode_1)
  {
    try
    {
      ...
      else if (treeNode_1.Tag is GClass202)
      {
        GClass202 tag = (GClass202) treeNode_1.Tag;
        if (tag == null)
          return;
        this.gclass21_0.method_317(this.tvContacts, this.lstvSystemSummary, tag, true);
        this.cboStatus.SelectedItem = !tag.dictionary_0.ContainsKey(this.gclass110_0) ? (object) GClass226.smethod_82((Enum) AuroraSystemProtectionStatus.NoProtection) : (object) GClass226.smethod_82((Enum) tag.dictionary_0[this.gclass110_0].auroraSystemProtectionStatus_0);
  ...
  private void cmdDeleteClass_Click(object sender, EventArgs e)
  {
    ...
    {
      GClass115 gclass115 = this.method_9();
      if (gclass115 == null || MessageBox.Show($" Are you sure you want to delete {gclass115.ClassName}?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
        return;
  ...
  private void cmdClearClassData_Click(object sender, EventArgs e)
  {
    ...
    {
      GClass115 gclass115 = this.method_9();
      if (gclass115 == null || MessageBox.Show($" Are you sure you want to clear all data for {gclass115.ClassName}?", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
        return;
  ...
  private void cboStatus_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      if (this.treeNode_0 == null || this.gclass110_0 == null || !(this.treeNode_0.Tag is GClass202))
        return;
      // ISSUE: object of a compiler-generated type is created
      // ISSUE: variable of a compiler-generated type
      Diplomacy.Class896 class896 = new Diplomacy.Class896();
      GClass202 tag = (GClass202) this.treeNode_0.Tag;
      if (tag == null)
        return;
      // ISSUE: reference to a compiler-generated field
      class896.string_0 = (string) this.cboStatus.SelectedValue;
      // ISSUE: reference to a compiler-generated method
      AuroraSystemProtectionStatus key = this.dictionary_0.FirstOrDefault<KeyValuePair<AuroraSystemProtectionStatus, string>>(new Func<KeyValuePair<AuroraSystemProtectionStatus, string>, bool>(class896.method_0)).Key;
      if (tag.dictionary_0.ContainsKey(this.gclass110_0))
        tag.dictionary_0[this.gclass110_0].auroraSystemProtectionStatus_0 = key;
      else
        tag.dictionary_0.Add(this.gclass110_0, new GClass111()
        {
          auroraSystemProtectionStatus_0 = key,
          gclass202_0 = tag,
          gclass110_0 = this.gclass110_0
        });
      this.treeNode_0.Text = tag.Name + GClass226.smethod_6(tag.dictionary_0[this.gclass110_0].auroraSystemProtectionStatus_0);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 524);
    }
  }
  ...
  private void cmdSpeciesImage_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass110_0 == null)
        return;
      if (!this.gclass110_0.gclass21_0.bool_0)
      {
        int num1 = (int) MessageBox.Show("Players can only change images for AI races");
      }
      else
      {
        GClass194 gclass194 = this.gclass110_0.gclass21_0.method_164();
        if (gclass194 == null)
          return;
  ...
  private void cmdRaceFlag_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        {
          int num2 = str.LastIndexOf("\\");
          this.gclass110_0.gclass21_0.string_1 = str.Substring(num2 + 1);
        }
        this.gclass110_0.gclass21_0.image_0 = Image.FromFile($"{Application.StartupPath}\\Flags\\{this.gclass110_0.gclass21_0.string_1}");
        this.pbFlag.Image = this.gclass110_0.gclass21_0.image_0;
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3302);
    }
  }
  ...
  private void cmdChangeHull_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        {
          int num2 = str.LastIndexOf("\\");
          this.gclass110_0.gclass21_0.string_3 = str.Substring(num2 + 1);
        }
        this.gclass110_0.gclass21_0.image_1 = Image.FromFile($"{Application.StartupPath}\\ShipIcons\\{this.gclass110_0.gclass21_0.string_3}");
        this.pbShip.Image = this.gclass110_0.gclass21_0.image_1;
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3303);
    }
  }
  ...
  private void cmdSMRaceName_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        this.gclass110_0.gclass21_0.string_0 = this.gclass0_0.string_4;
        this.gclass0_0.string_3 = "Enter New Race Title";
        this.gclass0_0.string_4 = this.gclass110_0.gclass21_0.RaceTitle;
        int num3 = (int) new MessageEntry(this.gclass0_0).ShowDialog();
        if (this.gclass0_0.bool_21)
          return;
        this.gclass110_0.gclass21_0.RaceTitle = this.gclass0_0.string_4;
  ...
  private void chkAlienNameRandom_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass110_0 == null)
        return;
      this.gclass110_0.int_3 = GClass226.smethod_29(this.chkAlienNameRandom.CheckState);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3765);
    }
  }
  ...
  private void InitializeComponent()
  {
    ...
    this.cboAlienRaces.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.rdoHostile.CheckedChanged += new EventHandler(this.rdoAllied_CheckedChanged);
    ...
    this.rdoNeutral.CheckedChanged += new EventHandler(this.rdoAllied_CheckedChanged);
    ...
    this.rdoFriendly.CheckedChanged += new EventHandler(this.rdoAllied_CheckedChanged);
    ...
    this.rdoAllied.CheckedChanged += new EventHandler(this.rdoAllied_CheckedChanged);
    ...
    this.cmdCommunicate.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvStatus.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.flowLayoutPanel7.Controls.Add((Control) this.lblRaceIntelligence);
    ...
    this.flowLayoutPanel7.Controls.Add((Control) this.chkAlienNameRandom);
    ...
    this.cboTheme.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.chkAlienNameRandom.CheckedChanged += new EventHandler(this.chkAlienNameRandom_CheckedChanged);
    ...
    this.lstvKnownSpecies.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvAlienShips.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvKnownSensors.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvClassDetails.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdChangeDR.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.flowLayoutPanel12.Controls.Add((Control) this.cmdSMRaceName);
    this.flowLayoutPanel12.Controls.Add((Control) this.cmdSpeciesImage);
    this.flowLayoutPanel12.Controls.Add((Control) this.cmdRaceFlag);
    this.flowLayoutPanel12.Controls.Add((Control) this.cmdChangeHull);
    ...
    this.cmdAutoName.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDestroyShip.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdCorrectNames.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdToggleFixed.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdSetComm.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdAddSpecies.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdSMRaceName.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdSMRaceName.Tag = (object) "1200";
    this.cmdSMRaceName.Text = "SM Race Title";
    this.cmdSMRaceName.UseVisualStyleBackColor = false;
    this.cmdSMRaceName.Click += new EventHandler(this.cmdSMRaceName_Click);
    ...
    this.cmdChangeHull.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdChangeHull.Tag = (object) "1200";
    this.cmdChangeHull.Text = "SM Hull";
    this.cmdChangeHull.UseVisualStyleBackColor = false;
    this.cmdChangeHull.Click += new EventHandler(this.cmdChangeHull_Click);
    this.cmdRenameShip.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdRenameShip.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdRenumber.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdRenameClass.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tabIntelligence.Controls.Add((Control) this.tabSensor);
    ...
    this.cmdText.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdClearClassData.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDeleteClass.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tabGroundUnits.Controls.Add((Control) this.cmdRenameUnit);
    ...
    this.lstvGroundUnitWeapons.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvGroundUnitClassData.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tabKnownSystems.Controls.Add((Control) this.lstvSystemSummary);
    ...
    this.lstvSystemSummary.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tabSensor.Controls.Add((Control) this.cndRenameSensor);
    this.tabSensor.Controls.Add((Control) this.lstvMountingClasses);
    ...
    this.cndRenameSensor.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cndRenameSensor.Tag = (object) "1200";
    this.cndRenameSensor.Text = "Rename Sensor";
    this.cndRenameSensor.UseVisualStyleBackColor = false;
    this.cndRenameSensor.Click += new EventHandler(this.cndRenameSensor_Click);
    ...
    this.lstvMountingClasses.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.tvIntelligence.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.KeyDown += new KeyEventHandler(this.Diplomacy_KeyDown);
