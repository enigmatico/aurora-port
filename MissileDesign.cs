...
public class MissileDesign : Form
{
  ...
  private GClass164 gclass164_0;
  private GClass164 gclass164_1;
  ...
  private void method_6()
  {
    try
    {
      this.gclass164_0 = this.gclass21_0.method_387(GEnum122.const_27);
      this.gclass164_1 = this.gclass21_0.method_387(GEnum122.const_36);
      this.gclass0_0.bool_9 = true;
      this.gclass0_0.method_478(this.gclass21_0, this.cboEnginePower, GEnum122.const_181, 0, CheckState.Unchecked, 0);
      this.gclass0_0.method_478(this.gclass21_0, this.cboEngineSize, GEnum122.const_188, 0, CheckState.Unchecked, 0);
  ...
  private void method_7()
  {
    try
    {
      if (this.gclass0_0.bool_9)
        return;
      Decimal num = GClass226.smethod_2(this.txtWHSize.Text, 0M);
      if (this.chkShipDecoy.CheckState == CheckState.Checked)
      {
        this.gclass0_0.method_449(this.gclass21_0, num, 1, true, this.lblWHStrength, 0M, this.lblFuelCapacity, this.txtReactorSize, this.lblReactorValue, 0M, 100, this.lblSensorValue, 0M, this.lblThermalValue, 0M, this.lblEMValue, 0M, this.lblGeoValue, 0, false, this.lblECCMValue, false, this.lblRadiationValue, false, this.lblATGValue, false, false, this.lblLaserWarheadValue, 0M, 0M, this.gclass230_0, 0, (GClass129) null, 0, 0M, this.lblSecondStageMissileSize, this.lblSecondStageMissileCost, this.lblSecondStageTotalSize, this.lblSecondStageTotalCost, CheckState.Unchecked, CheckState.Unchecked, CheckState.Unchecked, this.lblBombardmentPodValue, this.lblAutocannonPodValue, this.lblATAValue, this.txtMissileName, this.txtMissileSummary, this.chkFreezeName.CheckState, num, false);
      }
      else
      {
        Decimal decimal_14 = GClass226.smethod_2(this.txtFCSize.Text, 0M);
        Decimal decimal_15 = GClass226.smethod_2(this.txtSensorSize.Text, 0M);
        Decimal decimal_16 = GClass226.smethod_2(this.txtThermalSize.Text, 0M);
        Decimal decimal_17 = GClass226.smethod_2(this.txtEMSize.Text, 0M);
        Decimal decimal_18 = GClass226.smethod_2(this.txtGeoSize.Text, 0M);
        Decimal decimal_21 = GClass226.smethod_2(this.txtSeparationRange.Text, 0M);
        int int_138 = (int) GClass226.smethod_2(this.txtNumDecoys.Text, 0M);
        int int_136 = (int) GClass226.smethod_2(this.txtMultipleWarheads.Text, 0M);
        GClass164 gclass164 = this.gclass21_0.method_388(this.gclass0_0.dictionary_49[GEnum122.const_208]);
        if (gclass164 != null)
        {
        ...
        int int_139 = 0;
        if (this.chkNoEngine.CheckState == CheckState.Unchecked && this.chkBombardmentPod.CheckState == CheckState.Unchecked && this.chkAutocannonoPod.CheckState == CheckState.Unchecked && this.chkATAPod.CheckState == CheckState.Unchecked)
        {
          int_139 = 1;
          this.gclass230_0 = this.method_8();
          this.lblTotalEnginePower.Text = GClass226.smethod_42(this.gclass230_0.decimal_3, 2);
          this.lblTotalEngineCost.Text = GClass226.smethod_42(this.gclass230_0.decimal_2, 2);
          this.lblFuelEfficiency.Text = GClass226.smethod_42(this.gclass230_0.decimal_8, 2);
          this.lblFuelEPH.Text = GClass226.smethod_42(this.gclass230_0.decimal_8 * this.gclass230_0.decimal_3, 2);
        }
        else
        {
        ...
        GClass129 selectedValue = (GClass129) this.cboSecond.SelectedValue;
        this.gclass0_0.method_449(this.gclass21_0, num, int_136, bool_25, this.lblWHStrength, decimal_14, this.lblFuelCapacity, this.txtReactorSize, this.lblReactorValue, decimal_15, int_137, this.lblSensorValue, decimal_16, this.lblThermalValue, decimal_17, this.lblEMValue, decimal_18, this.lblGeoValue, int_138, bool_26, this.lblECCMValue, bool_27, this.lblRadiationValue, bool_28, this.lblATGValue, bool_29, bool_30, this.lblLaserWarheadValue, (Decimal) decimal_19, (Decimal) decimal_20, this.gclass230_0, int_139, selectedValue, int_140, decimal_21, this.lblSecondStageMissileSize, this.lblSecondStageMissileCost, this.lblSecondStageTotalSize, this.lblSecondStageTotalCost, this.chkBombardmentPod.CheckState, this.chkAutocannonoPod.CheckState, this.chkATAPod.CheckState, this.lblBombardmentPodValue, this.lblAutocannonPodValue, this.lblATAValue, this.txtMissileName, this.txtMissileSummary, this.chkFreezeName.CheckState, 0M, false);
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 2043);
    }
  }

  private GClass230 method_8()
  {
    try
    {
      ...
      return selectedItem2 == null ? (GClass230) null : this.gclass0_0.method_454(this.gclass21_0, this.gclass164_0, this.gclass164_1, selectedItem1.decimal_0, selectedItem2.decimal_0, (TextBox) null, (TextBox) null, false);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 2044);
  ...
  private void cmdCompanyName_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass21_0 == null)
        return;
      this.txtCompanyName.Text = this.gclass0_0.method_479(this.gclass21_0, this.gclass0_0.dictionary_64[GEnum119.const_3].int_8);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 2046);
    }
  }
  ...
  private void method_9(string string_0)
  {
    try
    {
      int num = this.gclass0_0.dictionary_50.Values.Max<GClass164>((Func<GClass164, int>) (gclass164_0 => gclass164_0.int_0)) + 1;
      if (num > this.gclass230_0.gclass164_0.int_0)
      {
        this.gclass230_0.gclass164_0.int_0 = num;
        this.gclass230_0.int_0 = num;
      }
      this.gclass0_0.dictionary_50.Add(this.gclass230_0.gclass164_0.int_0, this.gclass230_0.gclass164_0);
      this.gclass0_0.dictionary_54.Add(this.gclass230_0.int_0, this.gclass230_0);
      if (this.gclass21_0 == null)
        return;
      this.gclass21_0.method_282(this.gclass230_0.gclass164_0, (GClass55) null, (GClass146) null, (GClass21) null, false, false);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 2047 /*0x07FF*/);
    }
  }
  ...
  private void cmdInstant_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        this.gclass0_0.gclass164_0.Name = !(this.txtCompanyName.Text == "") ? $"{this.txtCompanyName.Text} {this.txtMissileName.Text}" : this.txtMissileName.Text;
        if (this.chkNoEngine.CheckState == CheckState.Unchecked)
          this.method_9(this.gclass0_0.gclass164_0.Name + " Engine");
        int num2 = this.gclass0_0.dictionary_50.Values.Max<GClass164>((Func<GClass164, int>) (gclass164_0 => gclass164_0.int_0)) + 1;
        ...
        this.gclass0_0.dictionary_5.Add(this.gclass0_0.gclass129_0.int_0, this.gclass0_0.gclass129_0);
    ...
    {
      GClass226.smethod_74(ex, 2048 /*0x0800*/);
    }
  }
  ...
  private void cmdCreate_Click(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass0_0.gclass164_0.genum119_0 != GEnum119.const_3)
      {
        ...
        this.gclass0_0.gclass164_0.genum119_0 = GEnum119.const_3;
        this.gclass0_0.gclass164_0.gclass163_0 = this.gclass0_0.dictionary_49[GEnum122.const_80];
        this.gclass0_0.gclass164_0.string_1 = "Race-designed Missile";
      }
      this.gclass0_0.gclass164_0.Name = !(this.txtCompanyName.Text == "") ? $"{this.txtCompanyName.Text} {this.txtMissileName.Text}" : this.txtMissileName.Text;
      if (this.chkNoEngine.CheckState == CheckState.Unchecked)
        this.method_9(this.gclass0_0.gclass164_0.Name + " Engine");
      int num1 = this.gclass0_0.dictionary_50.Values.Max<GClass164>((Func<GClass164, int>) (gclass164_0 => gclass164_0.int_0)) + 1;
      ...
      this.gclass0_0.gclass129_0.Name = this.gclass0_0.gclass164_0.Name;
      this.gclass0_0.dictionary_5.Add(this.gclass0_0.gclass129_0.int_0, this.gclass0_0.gclass129_0);
      int num2 = (int) MessageBox.Show("Missile Design Created. Research the new missile on the Research tab of the economics window");
      this.method_7();
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 2049);
    }
  }
  ...
  private void cboPreviousDesigns_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass0_0.bool_9 || this.gclass21_0 == null)
        return;
      this.gclass129_0 = (GClass129) this.cboPreviousDesigns.SelectedValue;
      ...
      this.cboEngineSize.SelectedItem = (object) ((IEnumerable<GClass170>) this.cboEngineSize.DataSource).FirstOrDefault<GClass170>((Func<GClass170, bool>) (gclass170_0 => gclass170_0.decimal_0 == this.gclass129_0.decimal_8));
      this.cboEnginePower.SelectedItem = (object) ((IEnumerable<GClass170>) this.cboEnginePower.DataSource).FirstOrDefault<GClass170>((Func<GClass170, bool>) (gclass170_0 => gclass170_0.decimal_0 == this.gclass129_0.decimal_23));
      this.cboSecond.SelectedItem = (object) ((IEnumerable<GClass129>) this.cboSecond.DataSource).FirstOrDefault<GClass129>((Func<GClass129, bool>) (gclass129_1 => gclass129_1 == this.gclass129_0.gclass129_0));
      ...
      this.chkERW.CheckState = !(this.gclass129_0.decimal_2 > this.gclass129_0.decimal_0) ? CheckState.Unchecked : CheckState.Checked;
      this.chkNoEngine.CheckState = this.gclass129_0.gclass230_0 != null ? CheckState.Unchecked : CheckState.Checked;
      ...
      this.chkLaserWarhead.CheckState = !(this.gclass129_0.decimal_1 > 0M) ? CheckState.Unchecked : CheckState.Checked;
      this.gclass0_0.bool_9 = false;
      this.method_7();
  ...
  private void InitializeComponent()
  {
    ...
    this.flowLayoutPanel1.Controls.Add((Control) this.txtNumDecoys);
    this.flowLayoutPanel1.Controls.Add((Control) this.txtMultipleWarheads);
    this.flowLayoutPanel1.Controls.Add((Control) this.txtResolution);
    this.flowLayoutPanel1.Controls.Add((Control) this.chkECCM);
    this.flowLayoutPanel1.Controls.Add((Control) this.chkATG);
    this.flowLayoutPanel1.Controls.Add((Control) this.chkRetarget);
    this.flowLayoutPanel1.Controls.Add((Control) this.chkLaserWarhead);
    this.flowLayoutPanel1.Controls.Add((Control) this.txtMinDetonationRange);
    this.flowLayoutPanel1.Controls.Add((Control) this.txtMaxDetonationRange);
    this.flowLayoutPanel1.Controls.Add((Control) this.chkShipDecoy);
    ...
    this.txtWHSize.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtWHSize.TextChanged += new EventHandler(this.txtMaxDetonationRange_TextChanged);
    ...
    this.txtFCSize.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtFCSize.TextChanged += new EventHandler(this.txtMaxDetonationRange_TextChanged);
    ...
    this.txtReactorSize.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.txtSensorSize.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtSensorSize.TextChanged += new EventHandler(this.txtMaxDetonationRange_TextChanged);
    ...
    this.txtThermalSize.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtThermalSize.TextChanged += new EventHandler(this.txtMaxDetonationRange_TextChanged);
    ...
    this.txtEMSize.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtEMSize.TextChanged += new EventHandler(this.txtMaxDetonationRange_TextChanged);
    ...
    this.txtGeoSize.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtGeoSize.TextChanged += new EventHandler(this.txtMaxDetonationRange_TextChanged);
    ...
    this.txtNumDecoys.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtNumDecoys.TextChanged += new EventHandler(this.txtNumDecoys_TextChanged);
    ...
    this.txtMultipleWarheads.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtMultipleWarheads.TextChanged += new EventHandler(this.txtMultipleWarheads_TextChanged);
    ...
    this.txtResolution.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtResolution.TextChanged += new EventHandler(this.txtMaxDetonationRange_TextChanged);
    ...
    this.chkECCM.CheckedChanged += new EventHandler(this.txtMaxDetonationRange_TextChanged);
    ...
    this.chkATG.CheckedChanged += new EventHandler(this.txtMaxDetonationRange_TextChanged);
    ...
    this.chkRetarget.CheckedChanged += new EventHandler(this.txtMaxDetonationRange_TextChanged);
    ...
    this.chkLaserWarhead.CheckedChanged += new EventHandler(this.txtMaxDetonationRange_TextChanged);
    ...
    this.txtMinDetonationRange.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtMinDetonationRange.TextChanged += new EventHandler(this.txtMaxDetonationRange_TextChanged);
    ...
    this.chkShipDecoy.CheckedChanged += new EventHandler(this.txtMaxDetonationRange_TextChanged);
    ...
    this.chkERW.CheckedChanged += new EventHandler(this.txtMaxDetonationRange_TextChanged);
    ...
    this.chkBombardmentPod.CheckedChanged += new EventHandler(this.chkATAPod_CheckedChanged);
    ...
    this.chkAutocannonoPod.CheckedChanged += new EventHandler(this.chkATAPod_CheckedChanged);
    ...
    this.chkATAPod.CheckedChanged += new EventHandler(this.chkATAPod_CheckedChanged);
    ...
    this.chkNoEngine.CheckedChanged += new EventHandler(this.chkNoEngine_CheckedChanged);
    ...
    this.flowLayoutPanel2.Controls.Add((Control) this.label20);
    this.flowLayoutPanel2.Controls.Add((Control) this.label2);
    this.flowLayoutPanel2.Controls.Add((Control) this.label27);
    this.flowLayoutPanel2.Controls.Add((Control) this.lblECCMValue);
    this.flowLayoutPanel2.Controls.Add((Control) this.lblATGValue);
    this.flowLayoutPanel2.Controls.Add((Control) this.label16);
    this.flowLayoutPanel2.Controls.Add((Control) this.lblLaserWarheadValue);
    this.flowLayoutPanel2.Controls.Add((Control) this.label19);
    this.flowLayoutPanel2.Controls.Add((Control) this.label29);
    this.flowLayoutPanel2.Controls.Add((Control) this.lblShipDecoyBlank);
    ...
    this.flowLayoutPanel3.Controls.Add((Control) this.lblGeo);
    this.flowLayoutPanel3.Controls.Add((Control) this.label17);
    this.flowLayoutPanel3.Controls.Add((Control) this.label22);
    ...
    this.flowLayoutPanel3.Controls.Add((Control) this.label14);
    this.flowLayoutPanel3.Controls.Add((Control) this.label15);
    this.flowLayoutPanel3.Controls.Add((Control) this.label26);
    this.flowLayoutPanel3.Controls.Add((Control) this.lblShipDecoy);
    ...
    this.cboEnginePower.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboEnginePower.SelectedIndexChanged += new EventHandler(this.cboEngineSize_SelectedIndexChanged);
    ...
    this.cboEngineSize.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboEngineSize.SelectedIndexChanged += new EventHandler(this.cboEngineSize_SelectedIndexChanged);
    ...
    this.flowLayoutPanel10.Controls.Add((Control) this.cboSecond);
    ...
    this.cboSecond.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboSecond.SelectedIndexChanged += new EventHandler(this.cboSecond_SelectedIndexChanged);
    ...
    this.txtNumSS.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtNumSS.TextChanged += new EventHandler(this.txtMaxDetonationRange_TextChanged);
    ...
    this.txtSeparationRange.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtSeparationRange.TextChanged += new EventHandler(this.txtMaxDetonationRange_TextChanged);
    ...
    this.lstvMissileTech.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.txtMissileSummary.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.txtMissileName.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.cboPreviousDesigns.AccessibleDescription = "Used to populate all the fields using a previously designed missile";
    ...
    this.cboPreviousDesigns.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.txtMaxDetonationRange.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.txtMaxDetonationRange.TextChanged += new EventHandler(this.txtMaxDetonationRange_TextChanged);
    ...
    this.KeyDown += new KeyEventHandler(this.MissileDesign_KeyDown);
