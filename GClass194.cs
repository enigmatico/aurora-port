...
public class GClass194
{
  ...
  public Dictionary<GEnum113, GClass98> dictionary_1 = new Dictionary<GEnum113, GClass98>();
  ...
  public void method_0(Label label_0, Label label_1, Label label_2, Label label_3, Label label_4)
  {
    try
    {
      ...
      double num2 = Math.Round(this.double_12 - (double) GClass226.int_17, 2);
      string str4 = num2.ToString();
      num2 = Math.Round(this.double_11 - (double) GClass226.int_17, 2);
