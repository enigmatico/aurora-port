...
public class UserSelection : Form
{
  ...
  private void UserSelection_Load(object sender, EventArgs e)
  {
    try
    {
      ...
      this.cboOption.DataSource = (object) this.gclass0_0.list_32;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 3182);
    }
  }
  ...
  private void InitializeComponent()
  {
    ...
    this.cboOption.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.Controls.Add((Control) this.chkOption3);
