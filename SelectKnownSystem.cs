...
public class SelectKnownSystem : Form
{
  ...
  private void SelectKnownSystem_Load(object sender, EventArgs e)
  {
    try
    {
      ...
      this.gclass0_0.method_544(this.lstvSystems, this.chkExisting.CheckState, this.bool_0, Convert.ToDouble(this.txtMinMass.Text), (GClass198) null);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 2668);
    }
  }
  ...
  private void chkExisting_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      this.gclass0_0.method_544(this.lstvSystems, this.chkExisting.CheckState, this.bool_0, Convert.ToDouble(this.txtMinMass.Text), this.gclass198_0);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 2671);
    }
  }
  ...
  private void lstvSystems_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        this.gclass198_0 = (GClass198) this.lstvSystems.SelectedItems[0].Tag;
        ...
        this.gclass198_0 = (GClass198) null;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 2672);
    }
  }
  ...
  private void InitializeComponent()
  {
    ...
    this.cmdGenerate.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDistSol.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDistSelected.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdSortByName.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.txtMinMass.ForeColor = Color.FromArgb(128 /*0x80*/, (int) byte.MaxValue, 128 /*0x80*/);
    ...
    this.lstvSystems.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
