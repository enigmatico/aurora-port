...
public class CommandersWindow : Form
{
  ...
  private sealed class Class892
  {
    ...
    internal bool method_0(GClass162 gclass162_0)
    {
      return !gclass162_0.bool_0 && gclass162_0 != this.gclass55_0.gclass162_0;
    }
  }
  ...
  private void cboRaces_SelectedIndexChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      this.chkAutoAssign.CheckState = this.gclass21_0.int_22 != 1 ? CheckState.Unchecked : CheckState.Checked;
  ...
  private void tvCommanderList_AfterSelect(object sender, TreeViewEventArgs e)
  {
    try
    {
      ...
      if (e.Node.Tag is GClass55)
      {
        ...
        else if (this.gclass55_0.auroraCommanderType_0 != AuroraCommanderType.Naval && this.gclass55_0.auroraCommanderType_0 != AuroraCommanderType.GroundForce)
        {
        ...
        this.gclass55_0.method_19(this.lstvCmdrSummary, this.lstvBonus, this.lstvHistory, this.lstvAssign, this.cboAssign, this.chkEligible, this.chkAvailable, this.lblName, this.lblAssignment, this.gclass55_1, this.flpMedals, this.chkDoNotPromote, this.chkStory);
      }
      else
      {
        if (!(e.Node.Tag is GClass61))
          return;
        this.gclass61_0 = (GClass61) e.Node.Tag;
        this.cmdRename.Visible = true;
        if (this.gclass61_0.auroraCommanderType_0 == AuroraCommanderType.Naval || this.gclass61_0.auroraCommanderType_0 == AuroraCommanderType.GroundForce)
        {
          this.cmdAddNavalRank.Visible = true;
          this.cmdDeleteNavalRank.Visible = true;
        }
        this.gclass0_0.method_510(this.cboAssign, this.gclass61_0.auroraCommanderType_0);
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 423);
    }
  }
  ...
  private void cmdRename_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        if (!(this.tvCommanderList.SelectedNode.Tag is GClass61))
          return;
        GClass61 tag = (GClass61) this.tvCommanderList.SelectedNode.Tag;
        string str1 = this.gclass0_0.method_562("Enter New Rank Name", tag.RankName);
        if (!(str1 != ""))
          return;
        string str2 = this.gclass0_0.method_562("Enter New Rank Abbreviation", tag.string_0);
        if (!(str2 != ""))
          return;
        tag.RankName = str1;
        tag.string_0 = str2;
        this.tvCommanderList.SelectedNode.Text = $"{tag.string_0} {tag.RankName}";
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 424);
    }
  }
  ...
  private void cmdPromote_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        GClass55 tag = (GClass55) this.tvCommanderList.SelectedNode.Tag;
        if (tag.auroraCommanderType_0 != AuroraCommanderType.Scientist && tag.auroraCommanderType_0 != AuroraCommanderType.Administrator)
        {
          ...
          foreach (TreeNode node1 in this.tvCommanderList.Nodes)
          {
            ...
            {
              if (node2.Tag is GClass61 && (GClass61) node2.Tag == tag.gclass61_0)
              {
  ...
  private void cmdAssign_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        {
          GClass49 selectedValue = (GClass49) this.cboAssign.SelectedValue;
          tag.method_24(selectedValue, this.lstvAssign);
          tag.method_19(this.lstvCmdrSummary, this.lstvBonus, this.lstvHistory, this.lstvAssign, this.cboAssign, this.chkEligible, this.chkAvailable, this.lblName, this.lblAssignment, this.gclass55_1, this.flpMedals, this.chkDoNotPromote, this.chkStory);
  ...
  private void method_4()
  {
    try
    {
      GClass61 gclass61_2 = (GClass61) null;
      GClass61 gclass61_3 = (GClass61) null;
      int int_56 = 1;
      int int_57 = 8;
      AuroraCommanderType auroraCommanderType_0 = this.method_3((string) this.cboType.SelectedItem);
      GClass50 selectedItem1 = (GClass50) this.cboSort1.SelectedItem;
      GClass50 selectedItem2 = (GClass50) this.cboSort2.SelectedItem;
      GClass50 selectedItem3 = (GClass50) this.cboSort3.SelectedItem;
      GClass50 selectedItem4 = (GClass50) this.cboSort4.SelectedItem;
      switch (auroraCommanderType_0)
      {
        case AuroraCommanderType.Naval:
        case AuroraCommanderType.GroundForce:
          gclass61_2 = (GClass61) this.cboMinRank.SelectedItem;
          gclass61_3 = (GClass61) this.cboMaxRank.SelectedItem;
          break;
      ...
      this.gclass21_0.method_231(this.lstvSearch, auroraCommanderType_0, selectedItem1, selectedItem2, selectedItem3, selectedItem4, gclass61_2, gclass61_3, int_56, int_57);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 434);
    }
  }
  ...
  private void cmdAwardMedal_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      this.gclass55_0.method_2(this.gclass0_0.gclass42_0, (GClass43) null, string_4);
      this.gclass55_0.method_19(this.lstvCmdrSummary, this.lstvBonus, this.lstvHistory, this.lstvAssign, this.cboAssign, this.chkEligible, this.chkAvailable, this.lblName, this.lblAssignment, this.gclass55_1, this.flpMedals, this.chkDoNotPromote, this.chkStory);
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 439);
    }
  }
  ...
  private void cmdReplaceAll_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        foreach (GClass55 gclass55 in this.gclass0_0.dictionary_42.Values.Where<GClass55>((Func<GClass55, bool>) (gclass55_2 => gclass55_2.gclass21_0 == this.gclass21_0)).ToList<GClass55>())
        {
          gclass55.method_40(false);
          this.gclass0_0.dictionary_42.Remove(gclass55.int_0);
        }
        for (int index = 1; index <= int32; ++index)
          this.gclass21_0.method_256(gclass146_1, false, (GClass55) null);
  ...
  private void chkAutoAssign_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      if (this.gclass21_0 == null)
      {
        ...
        this.gclass21_0.int_22 = 1;
      else
        this.gclass21_0.int_22 = 0;
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 443);
    }
  }
  ...
  private void cmdAddNavalRank_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        if (str2 == "")
          return;
        foreach (GClass61 gclass61 in this.gclass21_0.dictionary_1.Values.Where<GClass61>((Func<GClass61, bool>) (gclass61_1 => gclass61_1.auroraCommanderType_0 == this.gclass61_0.auroraCommanderType_0)).OrderBy<GClass61, int>((Func<GClass61, int>) (gclass61_0 => gclass61_0.int_1)).ToList<GClass61>())
          ++gclass61.int_1;
        GClass61 gclass61_2 = new GClass61();
        gclass61_2.int_0 = this.gclass0_0.method_26(GEnum0.const_14);
        gclass61_2.gclass21_0 = this.gclass21_0;
        gclass61_2.auroraCommanderType_0 = this.gclass61_0.auroraCommanderType_0;
        gclass61_2.int_1 = 1;
        gclass61_2.RankName = str1;
        gclass61_2.string_0 = str2;
        this.gclass21_0.dictionary_1.Add(gclass61_2.int_0, gclass61_2);
        this.gclass21_0.method_234(this.tvCommanderList);
      }
    }
    catch (Exception ex)
    {
      GClass226.smethod_74(ex, 446);
    }
  }
  ...
  private void cmdDeleteNavalRank_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      {
        if (MessageBox.Show($"Are you sure you wish to delete the rank '{this.gclass61_0.RankName}'? All commanders with this rank will be lost.", "Confirmation Required", MessageBoxButtons.YesNo) != DialogResult.Yes)
          return;
        foreach (GClass55 gclass55 in this.gclass0_0.dictionary_42.Values.Where<GClass55>((Func<GClass55, bool>) (gclass55_2 => gclass55_2.gclass61_0 == this.gclass61_0)).ToList<GClass55>())
        {
          gclass55.method_40(false);
          this.gclass0_0.dictionary_42.Remove(gclass55.int_0);
        }
        this.gclass21_0.dictionary_1.Remove(this.gclass61_0.int_0);
        List<GClass61> list = this.gclass21_0.dictionary_1.Values.Where<GClass61>((Func<GClass61, bool>) (gclass61_1 => gclass61_1.auroraCommanderType_0 == this.gclass61_0.auroraCommanderType_0)).OrderBy<GClass61, int>((Func<GClass61, int>) (gclass61_0 => gclass61_0.int_1)).ToList<GClass61>();
        int num3 = 1;
  ...
  private void cmdChangeField_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      else
      {
        ...
        foreach (GClass162 gclass162 in this.gclass0_0.dictionary_48.Values.Where<GClass162>(new Func<GClass162, bool>(class892.method_0)).ToList<GClass162>())
          this.gclass0_0.list_32.Add(gclass162.FieldName);
        int num3 = (int) new UserSelection(this.gclass0_0).ShowDialog();
        if (this.gclass0_0.bool_21)
          return;
        // ISSUE: reference to a compiler-generated field
        class892.gclass55_0.gclass162_0 = this.gclass0_0.dictionary_48.Values.FirstOrDefault<GClass162>((Func<GClass162, bool>) (gclass162_0 => gclass162_0.FieldName == this.gclass0_0.string_4));
        // ISSUE: reference to a compiler-generated field
        if (class892.gclass55_0.dictionary_0.ContainsKey(GEnum121.const_2))
        {
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          class892.gclass55_0.dictionary_0[GEnum121.const_2].decimal_0 = Math.Round((class892.gclass55_0.dictionary_0[GEnum121.const_2].decimal_0 - 1M) * 0.25M + 1M, 2, MidpointRounding.AwayFromZero);
        }
        // ISSUE: reference to a compiler-generated field
  ...
  private void cmdRestore_Click(object sender, EventArgs e)
  {
    try
    {
      ...
      if (this.tvCommanderList.SelectedNode.Tag is GClass55)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        if (class893.gclass55_0.auroraCommanderType_0 != AuroraCommanderType.Naval && class893.gclass55_0.auroraCommanderType_0 != AuroraCommanderType.GroundForce)
        {
          // ISSUE: reference to a compiler-generated field
          ...
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          this.gclass0_0.gclass92_0.method_2(GEnum126.const_193, class893.gclass55_0.string_0 + " restored to active service", class893.gclass55_0.gclass21_0, (GClass200) null, 0.0, 0.0, AuroraEventCategory.Commander);
          // ISSUE: reference to a compiler-generated field
          if (class893.gclass55_0.auroraCommanderType_0 == AuroraCommanderType.Scientist)
          {
            foreach (TreeNode node1 in this.tvCommanderList.Nodes)
            {
              ...
              {
                // ISSUE: reference to a compiler-generated field
                if (node2.Tag is GClass162 && (GClass162) node2.Tag == class893.gclass55_0.gclass162_0)
                {
                  node2.Nodes.Add(selectedNode);
                  // ISSUE: reference to a compiler-generated field
          ...
          else
          {
            ...
            if (class893.gclass55_0.auroraCommanderType_0 == AuroraCommanderType.Administrator)
            {
              foreach (TreeNode node3 in this.tvCommanderList.Nodes)
              {
                ...
                {
                  // ISSUE: reference to a compiler-generated field
                  if (node4.Tag is int && (Decimal) (int) node4.Tag == class893.gclass55_0.method_5(GEnum121.const_21))
                  {
        ...
        {
          // ISSUE: reference to a compiler-generated method
          int num = this.gclass0_0.dictionary_42.Values.Count<GClass55>(new Func<GClass55, bool>(class893.method_0));
          // ISSUE: reference to a compiler-generated field
          class893.gclass55_0.int_4 = num + 1;
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          class893.gclass55_0.method_46("Restored to " + class893.gclass55_0.gclass61_0.RankName, GEnum28.const_0);
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          this.gclass0_0.gclass92_0.method_2(GEnum126.const_193, $"{class893.gclass55_0.string_0} restored to {class893.gclass55_0.gclass61_0.RankName}", class893.gclass55_0.gclass21_0, (GClass200) null, 0.0, 0.0, AuroraEventCategory.Commander);
          foreach (TreeNode node5 in this.tvCommanderList.Nodes)
          {
            foreach (TreeNode node6 in node5.Nodes)
            {
              // ISSUE: reference to a compiler-generated field
              if (node6.Tag is GClass61 && (GClass61) node6.Tag == class893.gclass55_0.gclass61_0)
              {
    ...
    {
      GClass226.smethod_74(ex, 3583 /*0x0DFF*/);
    }
  }
  ...
  private void chkAvailable_CheckedChanged(object sender, EventArgs e)
  {
    try
    {
      ...
      GClass55 tag = (GClass55) this.tvCommanderList.SelectedNode.Tag;
      GClass49 selectedValue = (GClass49) this.cboAssign.SelectedValue;
      if (selectedValue.auroraCommandType_0 > AuroraCommandType.Ship)
        this.chkEligible.Visible = false;
      else
        this.chkEligible.Visible = true;
      GClass49 gclass49_0 = selectedValue;
  ...
  private void InitializeComponent()
  {
    ...
    this.tvCommanderList.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdPromote.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.flowLayoutPanel1.Controls.Add((Control) this.cmdAddExtra);
    ...
    this.flowLayoutPanel1.Controls.Add((Control) this.cmdRestore);
    this.flowLayoutPanel1.Controls.Add((Control) this.cmdRetain);
    ...
    this.cmdDemote.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdAssign.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdUnassign.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdRetire.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdChangeField.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdReplaceAll.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdAddExtra.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdAddExtra.Tag = (object) "1200";
    this.cmdAddExtra.Text = "SM: Add Extra";
    this.cmdAddExtra.UseVisualStyleBackColor = false;
    this.cmdAddExtra.Click += new EventHandler(this.cmdAddExtra_Click);
    this.cmdReassignNaval.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cmdReassignNaval.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdHideMedals.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdCreateMedal.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdAddNavalRank.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdDeleteNavalRank.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdRestore.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdRestore.Tag = (object) "1200";
    ...
    this.cmdRetain.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cmdRetain.Tag = (object) "1200";
    this.cmdRetain.Text = "Retain";
    this.cmdRetain.UseVisualStyleBackColor = false;
    this.cmdRetain.Visible = false;
    this.cmdRetain.Click += new EventHandler(this.cmdRetain_Click);
    ...
    this.lstvCmdrSummary.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.lstvBonus.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboAssign.SelectedIndexChanged += new EventHandler(this.chkAvailable_CheckedChanged);
    ...
    this.chkEligible.CheckedChanged += new EventHandler(this.chkAvailable_CheckedChanged);
    ...
    this.chkAvailable.CheckedChanged += new EventHandler(this.chkAvailable_CheckedChanged);
    ...
    this.lstvAssign.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboType.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboMinRank.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboMinRank.SelectedIndexChanged += new EventHandler(this.cboSort4_SelectedIndexChanged);
    ...
    this.cboMaxRank.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboMaxRank.SelectedIndexChanged += new EventHandler(this.cboSort4_SelectedIndexChanged);
    ...
    this.cboSort1.SelectedIndexChanged += new EventHandler(this.cboSort4_SelectedIndexChanged);
    ...
    this.cboSort2.SelectedIndexChanged += new EventHandler(this.cboSort4_SelectedIndexChanged);
    this.cboSort3.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cboSort3.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboSort3.SelectedIndexChanged += new EventHandler(this.cboSort4_SelectedIndexChanged);
    this.cboSort4.BackColor = Color.FromArgb(0, 0, 64 /*0x40*/);
    this.cboSort4.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.cboSort4.SelectedIndexChanged += new EventHandler(this.cboSort4_SelectedIndexChanged);
    ...
    this.lstvSearch.ForeColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 192 /*0xC0*/);
    ...
    this.KeyDown += new KeyEventHandler(this.CommandersWindow_KeyDown);
